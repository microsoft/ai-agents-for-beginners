...
![מאגר משוכפל](../../../translated_images/forked-repo.33f27ca1901baa6a.he.png)
...
1. בחרו באפשרות `Fine-grained tokens` בצד השמאלי של המסך על ידי מעבר ל-**Developer settings**
   ...
   ![הגדרות מפתחים](../../../translated_images/profile_developer_settings.410a859fe749c755.he.png)

   לאחר מכן בחרו `Generate new token`.

   ![יצירת טוקן](../../../translated_images/fga_new_token.1c1a234afe202ab3.he.png)
...
2. הזינו שם תיאורי לטוקן שלכם שמשקף את מטרתו, כך שיהיה קל לזהות אותו מאוחר יותר.
    ...
    ![שם הטוקן ותאריך תפוגה](../../../translated_images/token-name-expiry-date.a095fb0de6386864.he.png)

3. הגבילו את תחום הטוקן למאגר המשוכפל שלכם.

    ![הגבלת תחום למאגר משוכפל](../../../translated_images/token_repository_limit.924ade5e11d9d8bb.he.png)
...
4. הגבלות הרשאות הטוקן: תחת **Permissions**, לחצו על לשונית **Account**, ולחצו על כפתור "+ Add permissions". תופיע רשימה נפתחת. חפשו **Models** וסמנו את התיבה עבורו.
    ...
    ![הוספת הרשאות Models](../../../translated_images/add_models_permissions.c0c44ed8b40fc143.he.png)

5. ודאו את ההרשאות הנדרשות לפני יצירת הטוקן. ![אימות הרשאות](../../../translated_images/verify_permissions.06bd9e43987a8b21.he.png)

6. לפני יצירת הטוקן, ודאו שאתם מוכנים לשמור את הטוקן במקום בטוח כמו כספת מנהל סיסמאות, מכיוון שהוא לא יוצג שוב לאחר יצירתו. ![שמירת טוקן בצורה בטוחה](../../../translated_images/store_token_securely.08ee2274c6ad6caf.he.png)
...
![שדה טוקן GitHub](../../../translated_images/github_token_field.20491ed3224b5f4a.he.png)
...
![מחרוזת חיבור פרויקט](../../../translated_images/project-endpoint.8cf04c9975bbfbf1.he.png)
