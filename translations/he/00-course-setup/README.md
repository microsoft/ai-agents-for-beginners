...
![מאגר משוכפל](../../../translated_images/he/forked-repo.33f27ca1901baa6a.png)
...
1. בחרו באפשרות `Fine-grained tokens` בצד השמאלי של המסך על ידי מעבר ל-**Developer settings**
   ...
   ![הגדרות מפתחים](../../../translated_images/he/profile_developer_settings.410a859fe749c755.png)

   לאחר מכן בחרו `Generate new token`.

   ![יצירת טוקן](../../../translated_images/he/fga_new_token.1c1a234afe202ab3.png)
...
2. הזינו שם תיאורי לטוקן שלכם שמשקף את מטרתו, כך שיהיה קל לזהות אותו מאוחר יותר.
    ...
    ![שם הטוקן ותאריך תפוגה](../../../translated_images/he/token-name-expiry-date.a095fb0de6386864.png)

3. הגבילו את תחום הטוקן למאגר המשוכפל שלכם.

    ![הגבלת תחום למאגר משוכפל](../../../translated_images/he/token_repository_limit.924ade5e11d9d8bb.png)
...
4. הגבלות הרשאות הטוקן: תחת **Permissions**, לחצו על לשונית **Account**, ולחצו על כפתור "+ Add permissions". תופיע רשימה נפתחת. חפשו **Models** וסמנו את התיבה עבורו.
    ...
    ![הוספת הרשאות Models](../../../translated_images/he/add_models_permissions.c0c44ed8b40fc143.png)

5. ודאו את ההרשאות הנדרשות לפני יצירת הטוקן. ![אימות הרשאות](../../../translated_images/he/verify_permissions.06bd9e43987a8b21.png)

6. לפני יצירת הטוקן, ודאו שאתם מוכנים לשמור את הטוקן במקום בטוח כמו כספת מנהל סיסמאות, מכיוון שהוא לא יוצג שוב לאחר יצירתו. ![שמירת טוקן בצורה בטוחה](../../../translated_images/he/store_token_securely.08ee2274c6ad6caf.png)
...
![שדה טוקן GitHub](../../../translated_images/he/github_token_field.20491ed3224b5f4a.png)
...
![מחרוזת חיבור פרויקט](../../../translated_images/he/project-endpoint.8cf04c9975bbfbf1.png)
