...
יש תמיכה בריבוי שפות עבור הקורס הזה. עברו ל[השפות הזמינות כאן](../..).
...
אל תשכחו [לתת כוכב (🌟) לריפוזיטורי הזה](https://docs.github.com/en/get-started/exploring-projects-on-github/saving-repositories-with-stars?WT.mc_id=academic-105485-koreyst) ו[לעשות מזלג לריפוזיטורי הזה](https://github.com/microsoft/ai-agents-for-beginners/fork) כדי להריץ את הקוד.

### פגשו לומדים אחרים, קבלו מענה לשאלותיכם

אם נתקעתם או יש לכם שאלות לגבי בניית סוכני בינה מלאכותית, הצטרפו לערוץ ה-Discord הייעודי שלנו ב[Microsoft Foundry Discord](https://aka.ms/ai-agents/discord).

### מה אתם צריכים

כל שיעור בקורס כולל דוגמאות קוד, שניתן למצוא בתיקיית code_samples. אתם יכולים [לעשות מזלג לריפוזיטורי הזה](https://github.com/microsoft/ai-agents-for-beginners/fork) כדי ליצור עותק משלכם.

דוגמת הקוד בתרגילים אלה משתמשת ב-Azure AI Foundry ובקטלוגי מודלים של GitHub לאינטראקציה עם מודלי שפה:
