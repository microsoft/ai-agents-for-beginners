...
- 🔄 **סטרימינג בזמן אמת**: תומך בתגובות מיידיות וגם בתגובות בסטרימינג
...
- **שילוב מודלים של GitHub**: משתמש בשירות הסקת המודלים של GitHub
...
הריצו את התאים למטה לפי הסדר כדי לראות את סוכן הנסיעות בפעולה!
