...
![Forked Repo](../../../translated_images/ru/forked-repo.33f27ca1901baa6a.png)
...
1. Выберите опцию `Fine-grained tokens` на левой стороне экрана, перейдя в **Developer settings**.
   ...
   ![Developer settings](../../../translated_images/ru/profile_developer_settings.410a859fe749c755.png)

   Затем выберите `Generate new token`.

   ![Generate Token](../../../translated_images/ru/fga_new_token.1c1a234afe202ab3.png)
...
2. Введите описательное имя для вашего токена, которое отражает его назначение, чтобы его было легко идентифицировать позже.
    ...
    ![Token Name and Expiration](../../../translated_images/ru/token-name-expiry-date.a095fb0de6386864.png)

3. Ограничьте область действия токена вашим форком этого репозитория.

    ![Limit scope to fork repository](../../../translated_images/ru/token_repository_limit.924ade5e11d9d8bb.png)
...
4. Ограничьте разрешения токена: В разделе **Permissions** нажмите вкладку **Account** и кнопку "+ Add permissions". Появится выпадающее меню. Найдите **Models** и установите галочку.
    ...
    ![Add Models Permission](../../../translated_images/ru/add_models_permissions.c0c44ed8b40fc143.png)

5. Проверьте необходимые разрешения перед созданием токена. ![Verify Permissions](../../../translated_images/ru/verify_permissions.06bd9e43987a8b21.png)

6. Перед созданием токена убедитесь, что вы готовы сохранить токен в безопасном месте, например, в хранилище паролей, так как он не будет показан снова после создания. ![Store Token Securely](../../../translated_images/ru/store_token_securely.08ee2274c6ad6caf.png)
...
![GitHub Token Field](../../../translated_images/ru/github_token_field.20491ed3224b5f4a.png)
...
![Project Connection String](../../../translated_images/ru/project-endpoint.8cf04c9975bbfbf1.png)
