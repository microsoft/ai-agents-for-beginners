...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-11-11T10:50:34+00:00",
...
Этот ноутбук демонстрирует, как создать интеллектуального агента для планирования путешествий, используя Microsoft Agent Framework для .NET. Агента можно использовать для автоматического создания персонализированных маршрутов однодневных поездок в случайные места по всему миру.
