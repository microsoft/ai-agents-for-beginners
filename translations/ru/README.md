...
## Курс, обучающий всему, что нужно знать, чтобы начать создавать AI Агенты
...
**Если вы хотите, чтобы поддерживались дополнительные языки перевода, они перечислены [здесь](https://github.com/Azure/co-op-translator/blob/main/getting_started/supported-languages.md)**
...
Этот курс содержит уроки, охватывающие основы создания AI Агентов. Каждый урок посвящён своей теме, так что начинайте с любого понравившегося!

В этом курсе есть многоязычная поддержка. Смотрите наши [доступные языки здесь](../..).

Если вы впервые работаете с генеративными моделями ИИ, ознакомьтесь с нашим курсом [Генеративный ИИ для начинающих](https://aka.ms/genai-beginners), который включает 21 урок по созданию на GenAI.
...
Каждый урок этого курса включает примеры кода, которые находятся в папке code_samples. Вы можете [форкнуть репозиторий](https://github.com/microsoft/ai-agents-for-beginners/fork), чтобы создать свою копию.

Примеры кода в этих упражнениях используют Azure AI Foundry и каталоги моделей GitHub для взаимодействия с языковыми моделями:
...
Этот курс также использует следующие фреймворки и сервисы AI Агента от Microsoft:

- [Microsoft Agent Framework (MAF) - Новый!](https://aka.ms/ai-agents-beginners/agent-framewrok)
- [Сервис Azure AI Agent](https://aka.ms/ai-agents-beginners/ai-agent-service)
- [Semantic Kernel](https://aka.ms/ai-agents-beginners/semantic-kernel)
- [AutoGen](https://aka.ms/ai-agents/autogen)


Для получения дополнительной информации о запуске кода для этого курса перейдите к разделу [Настройка курса](./00-course-setup/README.md).

## 🙏 Хотите помочь?

Есть предложения или нашли ошибки в орфографии или коде? [Создайте issue](https://github.com/microsoft/ai-agents-for-beginners/issues?WT.mc_id=academic-105485-koreyst) или [Создайте pull request](https://github.com/microsoft/ai-agents-for-beginners/pulls?WT.mc_id=academic-105485-koreyst)
...
- Примеры Python кода с поддержкой Azure AI Foundry и моделей Github (бесплатно)
...
|----------------------------------------------|--------------------------------------------------|------------------------------------------------------------|----------------------------------------------------------------------------------------|
| Введение в AI Агентов и области применения   | [Ссылка](./01-intro-to-ai-agents/README.md)       | [Видео](https://youtu.be/3zgm60bXmQk?si=z8QygFvYQv-9WtO1)  | [Ссылка](https://aka.ms/ai-agents-beginners/collection?WT.mc_id=academic-105485-koreyst) |
...
| Паттерн дизайна метакогниции                | [Ссылка](./09-metacognition/README.md)             | [Видео](https://youtu.be/His9R6gw6Ec?si=8gck6vvdSNCt6OcF)  | [Ссылка](https://aka.ms/ai-agents-beginners/collection?WT.mc_id=academic-105485-koreyst) |
...
| Контекстная разработка для AI агентов        | [Ссылка](./12-context-engineering/README.md)       | [Видео](https://youtu.be/F5zqRV7gEag)                               | [Ссылка](https://aka.ms/ai-agents-beginners/collection?WT.mc_id=academic-105485-koreyst) |
...
Лицензионным соглашением для участников (CLA), подтверждающим, что вы имеете право и действительно предоставляете нам
права использовать ваш вклад. Подробности доступны на <https://cla.opensource.microsoft.com>.

При подаче pull request, бот CLA автоматически определит необходимость подачи
CLA и отметит PR соответствующим образом (например, проверка состояния, комментарий). Просто следуйте инструкциям
бота. Вам нужно будет сделать это только один раз для всех репозиториев с нашим CLA.

Этот проект принял [Кодекс поведения Microsoft в Open Source](https://opensource.microsoft.com/codeofconduct/).
Больше информации см. в [FAQ по Кодексу поведения](https://opensource.microsoft.com/codeofconduct/faq/) или
обратитесь по адресу [opencode@microsoft.com](mailto:opencode@microsoft.com) с любыми дополнительными вопросами или комментариями.

## Торговые марки

Этот проект может содержать торговые марки или логотипы проектов, продуктов или услуг. Разрешенное использование торговых марок или логотипов Microsoft регулируется и должно следовать
...
Если вы столкнулись с трудностями или у вас есть вопросы по созданию AI приложений, присоединяйтесь к:

[![Microsoft Foundry Discord](https://dcbadge.limes.pink/api/server/nTYy5BXMWG)](https://discord.gg/nTYy5BXMWG)

Если у вас есть отзывы о продукте или ошибки в процессе создания, посетите:
