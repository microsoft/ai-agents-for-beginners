...
![分叉倉庫](../../../translated_images/zh-HK/forked-repo.33f27ca1901baa6a.webp)
...
1. 在屏幕左側的 **開發者設置** 中選擇 `精細化令牌` 選項。
   ...
   ![開發者設置](../../../translated_images/zh-HK/profile_developer_settings.410a859fe749c755.webp)

   然後選擇 `生成新令牌`。

   ![生成令牌](../../../translated_images/zh-HK/fga_new_token.1c1a234afe202ab3.webp)
...
2. 為你的令牌輸入一個描述性名稱，反映其用途，方便日後識別。
    ...
    ![令牌名稱和到期日期](../../../translated_images/zh-HK/token-name-expiry-date.a095fb0de6386864.webp)

3. 將令牌的範圍限制為此倉庫的分叉。

    ![限制範圍到分叉倉庫](../../../translated_images/zh-HK/token_repository_limit.924ade5e11d9d8bb.webp)

4. 限制令牌的權限：在 **權限** 下，點擊 **帳戶** 標籤，然後點擊 "+ 添加權限" 按鈕。會出現一個下拉菜單。請搜索 **Models** 並勾選它。

    ![添加模型權限](../../../translated_images/zh-HK/add_models_permissions.c0c44ed8b40fc143.webp)

5. 在生成令牌之前，確認所需的權限。 ![確認權限](../../../translated_images/zh-HK/verify_permissions.06bd9e43987a8b21.webp)

6. 在生成令牌之前，確保你準備好將令牌存儲在安全的地方，例如密碼管理器保險庫，因為生成後將無法再次查看。 ![安全存儲令牌](../../../translated_images/zh-HK/store_token_securely.08ee2274c6ad6caf.webp)
...
![GitHub 令牌欄位](../../../translated_images/zh-HK/github_token_field.20491ed3224b5f4a.webp)
...
![項目連接字符串](../../../translated_images/zh-HK/project-endpoint.8cf04c9975bbfbf1.webp)
