...
## Ein Kurs, der alles vermittelt, was Sie wissen müssen, um mit dem Bau von KI-Agenten zu beginnen
...
>
> Dieses Repository enthält mehr als 50 Sprachübersetzungen, wodurch die Downloadgröße erheblich steigt. Um ohne Übersetzungen zu klonen, verwenden Sie einen Sparse-Checkout:
>
> **Bash / macOS / Linux:**
> ```bash
...
> ```
>
> Dies gibt Ihnen alles, was Sie benötigen, um den Kurs abzuschließen, mit einem deutlich schnelleren Download.
<!-- CO-OP TRANSLATOR LANGUAGES TABLE END -->

**Wenn Sie wünschen, dass weitere Übersetzungssprachen unterstützt werden, sind diese [hier](https://github.com/Azure/co-op-translator/blob/main/getting_started/supported-languages.md) gelistet.**
...
Dieser Kurs enthält Lektionen, die die Grundlagen des Baus von KI-Agenten abdecken. Jede Lektion behandelt ein eigenes Thema, starten Sie also, wo Sie möchten!
...
Wenn Sie zum ersten Mal mit generativen KI-Modellen arbeiten, sehen Sie sich unseren Kurs [Generative AI For Beginners](https://aka.ms/genai-beginners) an, der 21 Lektionen zum Bauen mit GenAI enthält.

Vergessen Sie nicht, dieses Repository zu [starren (🌟)](https://docs.github.com/en/get-started/exploring-projects-on-github/saving-repositories-with-stars?WT.mc_id=academic-105485-koreyst) und dieses Repository zu [forken](https://github.com/microsoft/ai-agents-for-beginners/fork), um den Code auszuführen.

### Treffen Sie andere Lernende, erhalten Sie Antworten auf Ihre Fragen

Wenn Sie stecken bleiben oder Fragen zum Bau von KI-Agenten haben, treten Sie unserem speziellen Discord-Kanal im [Microsoft Foundry Discord](https://aka.ms/ai-agents/discord) bei.
...
Die Codebeispiele in diesen Übungen verwenden das Microsoft Agent Framework mit dem Microsoft Foundry Agent Service V2:

- [Microsoft Foundry](https://aka.ms/ai-agents-beginners/ai-foundry) - Azure-Konto erforderlich

Dieser Kurs verwendet folgende KI-Agenten-Frameworks und -Services von Microsoft:
...
Für weitere Informationen zum Ausführen des Codes für diesen Kurs gehen Sie zur [Kurseinrichtung](./00-course-setup/README.md).

## 🙏 Möchten Sie helfen?

Haben Sie Vorschläge oder Fehler in Rechtschreibung oder Code gefunden? [Erstellen Sie ein Issue](https://github.com/microsoft/ai-agents-for-beginners/issues?WT.mc_id=academic-105485-koreyst) oder [erstelle eine Pull-Anfrage](https://github.com/microsoft/ai-agents-for-beginners/pulls?WT.mc_id=academic-105485-koreyst)



## 📂 Jede Lektion beinhaltet

- Eine schriftliche Lektion, die im README zu finden ist, und ein kurzes Video
- Python-Codebeispiele unter Verwendung des Microsoft Agent Framework mit Microsoft Foundry
- Links zu zusätzlichen Ressourcen, um Ihr Lernen fortzusetzen


## 🗃️ Lektionen

| **Lektion**                                  | **Text & Code**                                    | **Video**                                                  | **Weiteres Lernen**                                                                   |
|----------------------------------------------|----------------------------------------------------|------------------------------------------------------------|----------------------------------------------------------------------------------------|
| Einführung in KI-Agenten und Agenten-Anwendungsfälle | [Link](./01-intro-to-ai-agents/README.md)          | [Video](https://youtu.be/3zgm60bXmQk?si=z8QygFvYQv-9WtO1)  | [Link](https://aka.ms/ai-agents-beginners/collection?WT.mc_id=academic-105485-koreyst) |
...
| Werkzeug-Nutzungs-Designmuster                  | [Link](./04-tool-use/README.md)                    | [Video](https://youtu.be/vieRiPRx-gI?si=2z6O2Xu2cu_Jz46N)  | [Link](https://aka.ms/ai-agents-beginners/collection?WT.mc_id=academic-105485-koreyst) |
...
| Erforschung des Microsoft Agent Frameworks   | [Link](./14-microsoft-agent-framework/README.md)                            |                                                            |                                                                                        |
| Erstellen von Computer Use Agents (CUA)      | [Link](./15-browser-use/README.md)     |                                                            | [Link](https://docs.browser-use.com/examples/templates/playwright-integration)         |
| Bereitstellung skalierbarer Agenten          | [Link](./16-deploying-scalable-agents/README.md) |                                                    | [Link](https://learn.microsoft.com/azure/ai-foundry/agents/overview)                   |
| Erstellen lokaler KI-Agenten                  | [Link](./17-creating-local-ai-agents/README.md)  |                                                    | [Link](https://learn.microsoft.com/azure/ai-foundry/foundry-local/)                    |
...
Danke an [Shivam Goyal](https://www.linkedin.com/in/shivam2003/) für die wichtigen Codebeispiele, die agentisches RAG demonstrieren. 

## Beitrag leisten

Dieses Projekt begrüßt Beiträge und Vorschläge. Die meisten Beiträge erfordern, dass Sie einer
Contributor License Agreement (CLA) zustimmen, die erklärt, dass Sie berechtigt sind und tatsächlich uns
die Rechte zur Nutzung Ihres Beitrags gewähren. Für Details besuchen Sie <https://cla.opensource.microsoft.com>.

Wenn Sie eine Pull-Anfrage einreichen, wird ein CLA-Bot automatisch feststellen, ob Sie eine CLA benötigen
und die PR entsprechend auszeichnen (z. B. Statusüberprüfung, Kommentar). Folgen Sie einfach den Anweisungen
des Bots. Dies müssen Sie nur einmal für alle Repos, die unsere CLA verwenden, tun.
...
Marken oder Logos unterliegt und muss
den [Microsoft Trademark- & Markenrichtlinien](https://www.microsoft.com/legal/intellectualproperty/trademarks/usage/general) folgen.
...
Wenn Sie feststecken oder Fragen zum Erstellen von KI-Anwendungen haben, treten Sie bei:

[![Microsoft Foundry Discord](https://img.shields.io/badge/Discord-Azure_AI_Foundry_Community_Discord-blue?style=for-the-badge&logo=discord&color=5865f2&logoColor=fff)](https://aka.ms/foundry/discord)

Wenn Sie Produkt-Feedback oder Fehler beim Entwickeln haben, besuchen Sie:
