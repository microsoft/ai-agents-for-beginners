...
**Wenn Sie möchten, dass weitere Übersetzungssprachen unterstützt werden, finden Sie diese [hier](https://github.com/Azure/co-op-translator/blob/main/getting_started/supported-languages.md)**
...
Dieser Kurs enthält Lektionen, die die Grundlagen des Erstellens von KI-Agenten abdecken. Jede Lektion behandelt ein eigenes Thema, also beginnen Sie, wo immer Sie möchten!

Für diesen Kurs gibt es mehrsprachige Unterstützung. Gehen Sie zu unseren [verfügbaren Sprachen hier](../..).

Wenn Sie zum ersten Mal mit generativen KI-Modellen arbeiten, sehen Sie sich unseren Kurs [Generative KI für Anfänger](https://aka.ms/genai-beginners) an, der 21 Lektionen zum Erstellen mit GenAI enthält.
...
Haben Sie Vorschläge oder Fehler in Rechtschreibung oder Code gefunden? [Erstellen Sie ein Issue](https://github.com/microsoft/ai-agents-for-beginners/issues?WT.mc_id=academic-105485-koreyst) oder [Erstellen Sie einen Pull Request](https://github.com/microsoft/ai-agents-for-beginners/pulls?WT.mc_id=academic-105485-koreyst)
...
- Python-Codebeispiele zur Unterstützung von Azure AI Foundry und Github-Modellen (kostenlos)
