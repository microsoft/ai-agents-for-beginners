...
![Generative KI für Einsteiger](../../translated_images/de/repo-thumbnailv2.06f4a48036fde647.webp)

## Ein Kurs, der alles lehrt, was Sie wissen müssen, um KI-Agenten zu erstellen
...
> ```
>
> Damit erhalten Sie alles, was Sie brauchen, um den Kurs mit einem viel schnelleren Download abzuschließen.
...
Dieser Kurs enthält Lektionen, die die Grundlagen des Erstellens von KI-Agenten behandeln. Jede Lektion behandelt ein eigenes Thema, starten Sie also, wo immer Sie möchten!

Für diesen Kurs gibt es eine mehrsprachige Unterstützung. Gehen Sie zu unseren [verfügbaren Sprachen hier](../..).

Wenn Sie zum ersten Mal mit generativen KI-Modellen arbeiten, sehen Sie sich unseren Kurs [Generative KI für Einsteiger](https://aka.ms/genai-beginners) an, der 21 Lektionen zum Aufbau mit GenAI enthält.
...
Wenn Sie nicht weiterkommen oder Fragen zum Erstellen von KI-Agenten haben, treten Sie unserem dedizierten Discord-Kanal im [Microsoft Foundry Discord](https://aka.ms/ai-agents/discord) bei.

### Was Sie benötigen

Jede Lektion in diesem Kurs enthält Codebeispiele, die im Ordner code_samples zu finden sind. Sie können dieses Repo [forken](https://github.com/microsoft/ai-agents-for-beginners/fork), um eine eigene Kopie zu erstellen.
...
Für weitere Informationen zum Ausführen des Codes für diesen Kurs gehen Sie zu [Kurseinrichtung](./00-course-setup/README.md).
...
- Python-Codebeispiele mit dem Microsoft Agent Framework und Azure AI Foundry
...
| Tool-Einsatz-Designmuster                      | [Link](./04-tool-use/README.md)                    | [Video](https://youtu.be/vieRiPRx-gI?si=2z6O2Xu2cu_Jz46N)  | [Link](https://aka.ms/ai-agents-beginners/collection?WT.mc_id=academic-105485-koreyst) |
...
Dieses Projekt freut sich über Beiträge und Vorschläge. Die meisten Beiträge erfordern, dass Sie einer Contributor License Agreement (CLA) zustimmen, die besagt, dass Sie das Recht haben und tatsächlich die Rechte gewähren, um Ihren Beitrag zu verwenden. Für Details besuchen Sie <https://cla.opensource.microsoft.com>.

Wenn Sie eine Pull-Anfrage einreichen, wird ein CLA-Bot automatisch feststellen, ob Sie eine CLA bereitstellen müssen, und die PR entsprechend kennzeichnen (z.B. Statusprüfung, Kommentar). Befolgen Sie einfach die vom Bot bereitgestellten Anweisungen. Sie müssen dies nur einmal für alle Repos durchführen, die unsere CLA verwenden.
...
Dieses Projekt kann Marken oder Logos für Projekte, Produkte oder Dienste enthalten. Die autorisierte Nutzung von Microsoft-Marken oder Logos unterliegt und muss den
...
Die Nutzung von Marken oder Logos Dritter unterliegt den Richtlinien dieser Drittparteien.
