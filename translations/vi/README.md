...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-08-21T12:32:08+00:00",
...
Khóa học này có 11 bài học bao quát các kiến thức cơ bản về xây dựng Tác Nhân AI. Mỗi bài học tập trung vào một chủ đề riêng, vì vậy bạn có thể bắt đầu từ bất kỳ đâu!

Khóa học này hỗ trợ đa ngôn ngữ. Hãy xem danh sách [ngôn ngữ có sẵn tại đây](../..).

Nếu đây là lần đầu tiên bạn làm việc với các mô hình AI Tạo Sinh, hãy tham khảo khóa học [Generative AI For Beginners](https://aka.ms/genai-beginners), bao gồm 21 bài học về xây dựng với GenAI.
...
Mỗi bài học trong khóa học này bao gồm các ví dụ mã, được tìm thấy trong thư mục code_samples. Bạn có thể [fork repo này](https://github.com/microsoft/ai-agents-for-beginners/fork) để tạo bản sao của riêng mình.
...
Khi bạn gửi một yêu cầu pull, bot CLA sẽ tự động xác định xem bạn có cần cung cấp
CLA hay không và đánh dấu PR một cách phù hợp (ví dụ: kiểm tra trạng thái, bình luận). Chỉ cần làm theo hướng dẫn
...
Dự án này có thể chứa các thương hiệu hoặc logo cho các dự án, sản phẩm hoặc dịch vụ. Việc sử dụng thương hiệu hoặc logo của Microsoft phải tuân theo và tuân thủ
...
Việc sử dụng thương hiệu hoặc logo của Microsoft trong các phiên bản đã chỉnh sửa của dự án này không được gây nhầm lẫn hoặc ngụ ý tài trợ từ Microsoft.
