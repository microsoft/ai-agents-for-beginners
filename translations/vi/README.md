...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-11-11T11:26:41+00:00",
...
Khóa học này bao gồm các bài học về những kiến thức cơ bản để xây dựng AI Agents. Mỗi bài học tập trung vào một chủ đề riêng, bạn có thể bắt đầu từ bất kỳ đâu!

Khóa học này hỗ trợ đa ngôn ngữ. Hãy xem danh sách [ngôn ngữ có sẵn tại đây](../..). 
...
Nếu bạn gặp khó khăn hoặc có bất kỳ câu hỏi nào về việc xây dựng AI Agents, hãy tham gia kênh Discord chuyên biệt của chúng tôi trong [Azure AI Foundry Community Discord](https://aka.ms/ai-agents/discord).

### Những gì bạn cần

Mỗi bài học trong khóa học này đều có các ví dụ mã, được tìm thấy trong thư mục code_samples. Bạn có thể [fork repo này](https://github.com/microsoft/ai-agents-for-beginners/fork) để tạo bản sao của riêng mình.  
...
Bạn có đề xuất hoặc phát hiện lỗi chính tả hay mã? [Tạo một issue](https://github.com/microsoft/ai-agents-for-beginners/issues?WT.mc_id=academic-105485-koreyst) hoặc [Tạo một pull request](https://github.com/microsoft/ai-agents-for-beginners/pulls?WT.mc_id=academic-105485-koreyst)
...
| Các Tác Nhân AI trong Sản Xuất               | [Liên kết](./10-ai-agents-production/README.md)        | [Video](https://youtu.be/l4TP6IyJxmQ?si=31dnhexRo6yLRJDl)  | [Liên kết](https://aka.ms/ai-agents-beginners/collection?WT.mc_id=academic-105485-koreyst) |
| Sử dụng Giao thức Tác Nhân (MCP, A2A và NLWeb) | [Liên kết](./11-agentic-protocols/README.md)           | [Video](https://youtu.be/X-Dh9R3Opn8)                                 | [Liên kết](https://aka.ms/ai-agents-beginners/collection?WT.mc_id=academic-105485-koreyst) |
...
| Quản lý Bộ Nhớ Tác Nhân                      | [Liên kết](./13-agent-memory/README.md)     |      [Video](https://youtu.be/QrYbHesIxpw?si=vZkVwKrQ4ieCcIPx)                                                      |                                                                                        |
| Khám phá Khung Tác Nhân của Microsoft        | [Liên kết](./14-microsoft-agent-framework/README.md)                            |                                                            |                                                                                        |
| Xây dựng Tác Nhân Sử Dụng Máy Tính (CUA)     | Sắp ra mắt                            |                                                            |                                                                                        |
| Triển khai Tác Nhân Quy Mô Lớn               | Sắp ra mắt                            |                                                            |                                                                                        |
...
Dự án này hoan nghênh các đóng góp và gợi ý. Hầu hết các đóng góp yêu cầu bạn đồng ý với Thỏa Thuận Giấy Phép Người Đóng Góp (CLA) tuyên bố rằng bạn có quyền và thực sự cấp cho chúng tôi quyền sử dụng đóng góp của bạn. Để biết chi tiết, hãy truy cập <https://cla.opensource.microsoft.com>.

Khi bạn gửi một yêu cầu kéo (pull request), bot CLA sẽ tự động xác định liệu bạn có cần cung cấp CLA hay không và trang trí PR một cách thích hợp (ví dụ: kiểm tra trạng thái, bình luận). Chỉ cần làm theo hướng dẫn của bot. Bạn chỉ cần làm điều này một lần trên tất cả các kho sử dụng CLA của chúng tôi.
...
Dự án này có thể chứa nhãn hiệu hoặc logo cho các dự án, sản phẩm hoặc dịch vụ. Việc sử dụng nhãn hiệu hoặc logo của Microsoft phải tuân theo và tuân thủ [Hướng Dẫn Về Nhãn Hiệu & Thương Hiệu của Microsoft](https://www.microsoft.com/legal/intellectualproperty/trademarks/usage/general).
