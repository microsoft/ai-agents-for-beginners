...
![AI Agents for Beginners](../../translated_images/vi/repo-thumbnailv2.06f4a48036fde647.webp)
...
**Nếu bạn muốn có thêm các ngôn ngữ dịch được hỗ trợ, chúng được liệt kê [ở đây](https://github.com/Azure/co-op-translator/blob/main/getting_started/supported-languages.md).**
...
Khóa học này có các bài học bao quát các kiến thức cơ bản để xây dựng Đại lý AI. Mỗi bài học đề cập chủ đề riêng nên bạn có thể bắt đầu ở bất kỳ đâu bạn muốn!

Có hỗ trợ đa ngôn ngữ cho khóa học này. Vui lòng xem [ngôn ngữ có sẵn tại đây](#-multi-language-support). 

Nếu đây là lần đầu bạn xây dựng với các mô hình AI Tạo sinh, hãy xem khóa học [AI Tạo sinh Cho Người mới bắt đầu](https://aka.ms/genai-beginners), bao gồm 21 bài học về xây dựng với GenAI.

Đừng quên [gửi sao (🌟) cho kho lưu trữ này](https://docs.github.com/en/get-started/exploring-projects-on-github/saving-repositories-with-stars?WT.mc_id=academic-105485-koreyst) và [giao kho lưu trữ này thành nhánh riêng của bạn](https://github.com/microsoft/ai-agents-for-beginners/fork) để chạy mã.

### Gặp gỡ Những Người học khác, Có được Câu trả lời cho Câu hỏi của bạn

Nếu bạn gặp khó khăn hoặc có bất kỳ câu hỏi nào về cách xây dựng Đại lý AI, hãy tham gia Kênh Discord chuyên dụng của chúng tôi tại [Microsoft Foundry Discord](https://aka.ms/ai-agents/discord).

### Những gì Bạn Cần 

Mỗi bài học trong khóa học này đều bao gồm các ví dụ mã, có thể tìm thấy trong thư mục code_samples. Bạn có thể [giao kho lưu trữ này thành nhánh riêng của bạn](https://github.com/microsoft/ai-agents-for-beginners/fork) để tạo bản sao riêng.
...
Một số ví dụ mã cũng hỗ trợ các nhà cung cấp tương thích OpenAI thay thế như [MiniMax](https://platform.minimaxi.com/), cung cấp mô hình ngữ cảnh lớn (lên tới 204K tokens). Xem [Cài đặt Khóa học](./00-course-setup/README.md) để biết chi tiết cấu hình.

Để biết thêm thông tin về cách chạy mã cho khóa học này, hãy truy cập [Cài đặt Khóa học](./00-course-setup/README.md).

## 🙏 Muốn giúp đỡ?

Bạn có gợi ý hoặc phát hiện lỗi chính tả hay lỗi mã? [Tạo một vấn đề](https://github.com/microsoft/ai-agents-for-beginners/issues?WT.mc_id=academic-105485-koreyst) hoặc [Tạo yêu cầu kéo](https://github.com/microsoft/ai-agents-for-beginners/pulls?WT.mc_id=academic-105485-koreyst)



## 📂 Mỗi bài học bao gồm

- Một bài học bằng văn bản nằm trong README và một video ngắn
...
|----------------------------------------------|----------------------------------------------------|------------------------------------------------------------|----------------------------------------------------------------------------------------|
| Giới thiệu về Đại lý AI và Các trường hợp sử dụng Đại lý       | [Link](./01-intro-to-ai-agents/README.md)          | [Video](https://youtu.be/3zgm60bXmQk?si=z8QygFvYQv-9WtO1)  | [Link](https://aka.ms/ai-agents-beginners/collection?WT.mc_id=academic-105485-koreyst) |
| Khám phá các Framework Đại lý AI              | [Link](./02-explore-agentic-frameworks/README.md)  | [Video](https://youtu.be/ODwF-EZo_O8?si=Vawth4hzVaHv-u0H)  | [Link](https://aka.ms/ai-agents-beginners/collection?WT.mc_id=academic-105485-koreyst) |
| Hiểu các Mẫu thiết kế Đại lý AI     | [Link](./03-agentic-design-patterns/README.md)     | [Video](https://youtu.be/m9lM8qqoOEA?si=BIzHwzstTPL8o9GF)  | [Link](https://aka.ms/ai-agents-beginners/collection?WT.mc_id=academic-105485-koreyst) |
...
| Đại lý RAG                                   | [Link](./05-agentic-rag/README.md)                 | [Video](https://youtu.be/WcjAARvdL7I?si=gKPWsQpKiIlDH9A3)  | [Link](https://aka.ms/ai-agents-beginners/collection?WT.mc_id=academic-105485-koreyst) |
| Xây dựng Đại lý AI Đáng tin cậy               | [Link](./06-building-trustworthy-agents/README.md) | [Video](https://youtu.be/iZKkMEGBCUQ?si=jZjpiMnGFOE9L8OK ) | [Link](https://aka.ms/ai-agents-beginners/collection?WT.mc_id=academic-105485-koreyst) |
...
| Mẫu thiết kế Đa Đại lý                   | [Link](./08-multi-agent/README.md)                 | [Video](https://youtu.be/V6HpE9hZEx0?si=rMgDhEu7wXo2uo6g)  | [Link](https://aka.ms/ai-agents-beginners/collection?WT.mc_id=academic-105485-koreyst) |

| Mẫu Thiết Kế Metacognition                 | [Link](./09-metacognition/README.md)               | [Video](https://youtu.be/His9R6gw6Ec?si=8gck6vvdSNCt6OcF)  | [Link](https://aka.ms/ai-agents-beginners/collection?WT.mc_id=academic-105485-koreyst) |
...
| Sử dụng Giao thức Đại lý (MCP, A2A và NLWeb) | [Link](./11-agentic-protocols/README.md)           | [Video](https://youtu.be/X-Dh9R3Opn8)                                 | [Link](https://aka.ms/ai-agents-beginners/collection?WT.mc_id=academic-105485-koreyst) |
...
| Quản lý Bộ nhớ Đại lý                      | [Link](./13-agent-memory/README.md)     |      [Video](https://youtu.be/QrYbHesIxpw?si=vZkVwKrQ4ieCcIPx)                                                      |                                                                                        |
...
Cảm ơn [Shivam Goyal](https://www.linkedin.com/in/shivam2003/) đã đóng góp các mẫu code quan trọng minh họa Agentic RAG. 

## Góp Phần

Dự án này hoan nghênh các đóng góp và đề xuất. Hầu hết các đóng góp yêu cầu bạn đồng ý với một
Thỏa thuận Giấy phép Đóng góp (CLA) tuyên bố rằng bạn có quyền, và thực sự có, cấp cho chúng tôi
...
một CLA và đánh dấu PR phù hợp (ví dụ: kiểm tra trạng thái, bình luận). Chỉ cần làm theo hướng dẫn
...
Để biết thêm thông tin, xem [FAQ về Bộ Quy tắc Ứng xử](https://opensource.microsoft.com/codeofconduct/faq/) hoặc
liên hệ [opencode@microsoft.com](mailto:opencode@microsoft.com) nếu có thêm câu hỏi hoặc nhận xét.

## Nhãn Hiệu

Dự án này có thể chứa nhãn hiệu hoặc logo của các dự án, sản phẩm hoặc dịch vụ. Việc sử dụng được phép nhãn hiệu hoặc logo Microsoft
phải tuân theo và đảm bảo phù hợp với
