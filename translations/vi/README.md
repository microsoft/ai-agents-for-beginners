...
## Một khóa học dạy tất cả những gì bạn cần biết để bắt đầu xây dựng các Tác Nhân AI
...
Mỗi bài học trong khóa học này bao gồm các ví dụ mã, có thể tìm thấy trong thư mục code_samples. Bạn có thể [fork repo này](https://github.com/microsoft/ai-agents-for-beginners/fork) để tạo bản sao của riêng bạn.
