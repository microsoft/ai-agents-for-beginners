...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-07-24T09:59:02+00:00",
...
> Tóm tắt - Bạn có thể xây dựng giao tiếp giữa các tác nhân trên MCP không? Có thể!
...
Để tham khảo, chúng ta sẽ gọi một tác nhân là một "công cụ" có sẵn trên máy chủ MCP. Điều này ngụ ý sự tồn tại của một ứng dụng chủ thực hiện một khách hàng MCP thiết lập phiên với máy chủ MCP và có thể gọi tác nhân.
...
<strong>Hình 1:</strong> Sơ đồ này minh họa cách một tác nhân MCP truyền cập nhật tiến độ theo thời gian thực và kết quả từng phần cho ứng dụng chủ trong quá trình thực hiện nhiệm vụ lâu dài, cho phép người dùng theo dõi tiến trình thực thi trong thời gian thực.
</div>
...
<div align="center" style="font-style: italic; font-size: 0.95em; margin-bottom: 0.5em;">
<strong>Hình 2:</strong> Sơ đồ này cho thấy cách giao thức StreamableHTTP của MCP và kho sự kiện cho phép tiếp tục phiên liền mạch: nếu khách hàng bị ngắt kết nối, nó có thể kết nối lại và phát lại các sự kiện bị bỏ lỡ, tiếp tục nhiệm vụ mà không mất tiến độ.
</div>
...
Khả năng tiếp tục đảm bảo rằng các nhiệm vụ tác nhân chạy lâu dài có thể tồn tại qua các gián đoạn khách hàng và tiếp tục liền mạch khi kết nối lại. Điều này được triển khai thông qua kho sự kiện và token tiếp tục.
...
**Metadata Khách hàng với Token Tiếp tục (khách hàng kết nối lại sử dụng trạng thái được lưu trữ):**
...
- **Khả năng Chịu lỗi & Thử lại**: Ứng dụng chủ quản lý các lỗi, triển khai logic thử lại, và định tuyến lại nhiệm vụ khi các tác nhân không khả dụng
