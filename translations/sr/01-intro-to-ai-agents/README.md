...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-08-30T08:47:25+00:00",
...
**Извршавање радњи** - Изван система AI агената, LLM-ови су ограничени на ситуације где је радња генерисање садржаја или информација на основу корисничког упита. Унутар система AI агената, LLM-ови могу обављати задатке интерпретирајући кориснички захтев и користећи алате доступне у њиховом окружењу.

**Приступ алатима** - Које алате LLM има на располагању дефинише 1) окружење у коме функционише и 2) програмер AI агента. У примеру нашег агента за путовања, алати агента су ограничени операцијама доступним у систему за резервацију, а/или програмер може ограничити приступ агента алатима за летове.
...
| ----------------------------- | -------------------------------------------------------------------------------------------------------------------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| **Једноставни рефлексни агенти**      | Извршавају непосредне радње на основу унапред дефинисаних правила.                                                                                  | Агент за путовања интерпретира контекст е-поште и прослеђује жалбе на путовања корисничкој служби.                                                                                                                          |
...
| **Агенти засновани на циљу**         | Креирају планове за постизање одређених циљева интерпретирајући циљ и одређујући радње за његово постизање.                                  | Агент за путовања резервише путовање одређујући неопходне аранжмане (аутомобил, јавни превоз, летови) од тренутне локације до одредишта.                                                                                |
| **Агенти засновани на корисности**      | Разматрају преференције и нумерички процењују компромисе како би одредили како да постигну циљеве.                                               | Агент за путовања максимизира корисност процењујући погодност у односу на цену приликом резервације путовања.                                                                                                                                          |
...
| **Хијерархијски агенти**       | Имају више агената у вишеслојном систему, где агенти на вишем нивоу деле задатке на подзадатке које агенти на нижем нивоу извршавају. | Агент за путовања отказује путовање делећи задатак на подзадатке (на пример, отказивање одређених резервација) и агенти на нижем нивоу их извршавају, извештавајући агента на вишем нивоу.                                     |
| **Системи са више агената (MAS)** | Агенти самостално извршавају задатке, било сараднички или конкурентно.                                                           | Сараднички: Више агената резервише одређене услуге путовања као што су хотели, летови и забавни садржаји. Конкурентно: Више агената управља и такмичи се око заједничког календара резервација хотела како би резервисали клијенте у хотелу. |
