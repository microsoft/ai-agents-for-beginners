...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-07-24T07:44:56+00:00",
...
Протокол Контекста Модела (MCP) је напредни оквир осмишљен да стандардизује интеракције између AI модела и клијентских апликација. MCP служи као мост између AI модела и апликација које их користе, пружајући конзистентан интерфејс без обзира на основну имплементацију модела.
...
MCP је посебно користан у развоју AI агената јер омогућава агентима да комуницирају са различитим системима и изворима података кроз унифицирани протокол, чинећи их флексибилнијим и моћнијим.
...
1. Проблеми са MCP везом
   - Проверите да ли сервер ради
   - Проверите доступност порта
   - Потврдите GitHub токене

2. Проблеми са Azure претраживањем
   - Потврдите стрингове за повезивање
