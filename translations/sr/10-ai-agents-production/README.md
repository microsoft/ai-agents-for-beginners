...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-07-24T09:07:33+00:00",
...
_**Напомена:** Важно је поставити AI агенте који су безбедни и поуздани. Погледајте лекцију [Изградња поузданих AI агената](./06-building-trustworthy-agents/README.md)._

## Трагови и распони

Алати за опсервабилност као што су [Langfuse](https://langfuse.com/) или [Azure AI Foundry](https://learn.microsoft.com/en-us/azure/ai-foundry/what-is-azure-ai-foundry) обично представљају рад агента као трагове и распоне.
...
*   **Дебаговање и анализа узрока проблема**: Када агент не успе или произведе неочекивани резултат, алати за опсервабилност пружају трагове потребне за идентификацију извора грешке. Ово је посебно важно код сложених агената који могу укључивати више позива LLM-а, интеракције са алатима и условну логику.
*   **Управљање кашњењем и трошковима**: AI агенти често зависе од LLM-ова и других екстерних API-ја који се наплаћују по токену или позиву. Опсервабилност омогућава прецизно праћење ових позива, помажући у идентификацији операција које су претерано споре или скупе. Ово омогућава тимовима да оптимизују упите, изаберу ефикасније моделе или редизајнирају токове рада како би управљали оперативним трошковима и осигурали добро корисничко искуство.
...
Ево неких од најчешћих метрика које алати за опсервабилност прате:
...
У пракси, комбинација ових метрика пружа најбољу покривеност здравља AI агента. У [примеру нотебука](../../../10-ai-agents-production/code_samples/10_autogen_evaluation.ipynb) овог поглавља, показаћемо вам како ове метрике изгледају у стварним примерима, али прво ћемо научити како изгледа типичан ток евалуације.

## Инструментујте вашег агента

Да бисте прикупили податке о траговима, потребно је да инструментујете ваш код. Циљ је инструментовати код агента да емитује трагове и метрике које могу бити ухваћене, обрађене и визуализоване помоћу платформе за опсервабилност.

**OpenTelemetry (OTel):** [OpenTelemetry](https://opentelemetry.io/) је постао индустријски стандард за опсервабилност LLM-а. Пружа сет API-ја, SDK-ова и алата за генерисање, прикупљање и извоз телеметријских података.

Постоје многе библиотеке за инструментовање које обавијају постојеће оквире агената и олакшавају извоз OpenTelemetry распона у алат за опсервабилност. Испод је пример инструментовања AutoGen агента помоћу библиотеке [OpenLit](https://github.com/openlit/openlit):
...
[Пример нотебука](../../../10-ai-agents-production/code_samples/10_autogen_evaluation.ipynb) у овом поглављу демонстрираће како да инструментујете вашег AutoGen агента.
...
На пример, можете пратити стопе успеха, оцене задовољства корисника или друге метрике на живом саобраћају. Предност онлајн евалуације је што **обухвата ствари које можда не предвидите у лабораторијском окружењу** – можете посматрати промене модела током времена (ако се ефикасност агента погоршава како се обрасци улазних података мењају) и ухватити неочекиване упите или ситуације које нису биле у вашем тест датасету​. Пружа праву слику о томе како се агент понаша у стварном свету.

Онлајн евалуација често укључује прикупљање имплицитних и експлицитних повратних информација корисника, као што је већ поменуто, и могуће покретање shadow тестова или A/B тестова (где нова верзија агента ради паралелно ради поређења са старом). Изазов је што може бити тешко добити поуздане ознаке или оцене за интеракције уживо – можете се ослонити на повратне информације корисника или метрике низводно (као што је да ли је корисник кликнуо на

- Прецизирајте дефинисане параметре, упутства и називе алата.  |
| Вишеструки агентски систем не ради доследно | - Прецизирајте упутства која се дају сваком агенту како би била специфична и различита једна од других.<br>- Изградите хијерархијски систем користећи "рутирајућег" или контролни агента који ће одредити који је агент исправан. |

Многи од ових проблема могу се ефикасније идентификовати ако постоји систем за посматрање. Трагови и метрике које смо раније поменули помажу у прецизном утврђивању где у току рада агента настају проблеми, чинећи отклањање грешака и оптимизацију много ефикаснијим.
...
**Коришћење модела за рутирање:** Слична стратегија је коришћење различитих модела различитих величина. Можете користити LLM/SLM или серверлес функцију за рутирање захтева на основу сложености ка моделима који најбоље одговарају. Ово ће такође помоћи у смањењу трошкова, а истовремено обезбедити перформансе за одговарајуће задатке. На пример, усмерите једноставне упите ка мањим, бржим моделима, а скупе велике моделе користите само за сложене задатке резоновања.
...
У [примеру нотебука из овог одељка](../../../10-ai-agents-production/code_samples/10_autogen_evaluation.ipynb), видећемо примере како можемо користити алате за посматрање да пратимо и евалуирамо нашег агента.

## Претходна лекција

[Шаблон дизајна метакогниције](../09-metacognition/README.md)
