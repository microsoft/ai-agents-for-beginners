...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-08-30T08:46:48+00:00",
...
## 11 лекција које вас уче свему што треба да знате да бисте започели изградњу АИ агената
...
Овај курс садржи 11 лекција које покривају основе изградње АИ агената. Свака лекција покрива своју тему, па можете почети где год желите!
...
| Употреба агентских протокола (MCP, A2A и NLWeb)| [Линк](./11-agentic-protocols/README.md)         | [Видео](https://youtu.be/X-Dh9R3Opn8)                      | [Линк](https://aka.ms/ai-agents-beginners/collection?WT.mc_id=academic-105485-koreyst) |
| Инжењеринг контекста за АИ агенте            | Долази - 3. септембар                             |                                                            |                                                                                        |
