...
[![ПР су добродошли](https://img.shields.io/badge/PRs-welcome-brightgreen.svg?style=flat-square)](http://makeapullrequest.com?WT.mc_id=academic-105485-koreyst)
...
> **Визуелно преферирате да клонирате локално?**
>
> Овај репозиторијум садржи преко 50 превода на језике што значајно повећава величину скидања. Да бисте клонирали без превода, користите sparse checkout:
>
> **Bash / macOS / Linux:**
> ```bash
...
> ```
>
> Ово вам пружа све што вам треба за завршетак курса са много бржим скидањем.
<!-- CO-OP TRANSLATOR LANGUAGES TABLE END -->

**Ако желите да додатне језичке преводе подржимо, они су наведени [овде](https://github.com/Azure/co-op-translator/blob/main/getting_started/supported-languages.md).**
...
Овај курс садржи лекције које покривају теме оснивања AI агената. Свака лекција обрађује своју тему, па започните од било ког дела који вам се допада!

Постоји подршка за више језика за овај курс. Погледајте наше [доступне језике овде](#-multi-language-support).

Ако је ово ваш први пут да правите решења са генеративним AI моделима, погледајте наш курс [Генеративни AI за почетнике](https://aka.ms/genai-beginners), који укључује 21 лекцију о раду са GenAI.

Не заборавите да [озвездишете (🌟) овај репо](https://docs.github.com/en/get-started/exploring-projects-on-github/saving-repositories-with-stars?WT.mc_id=academic-105485-koreyst) и [форкујете овај репо](https://github.com/microsoft/ai-agents-for-beginners/fork) да бисте покренули код.

### Упознајте друге полазнике, добијте одговоре на питања

Ако запнете или имате питања о развоју AI агената, придружите се нашем посвећеном Discord каналу у [Microsoft Foundry Discord](https://aka.ms/ai-agents/discord).

### Шта вам треба

Свака лекција у овом курсу садржи примере кода који се налазе у фасцикли code_samples. Можете [форковати овај репо](https://github.com/microsoft/ai-agents-for-beginners/fork) да направите своју копију.
...
Неки примери кода такође подржавају и алтернативне OpenAI-компатибилне провајдере као што је [MiniMax](https://platform.minimaxi.com/), који нуди моделе великог контекста (до 204K токена). Погледајте детаље у [Course Setup](./00-course-setup/README.md).

За више информација о покретању кода за овај курс, идите на [Course Setup](./00-course-setup/README.md).

## 🙏 Желите да помогнете?

Имате предлоге или сте нашли правописне или кодне грешке? [Подигните проблем](https://github.com/microsoft/ai-agents-for-beginners/issues?WT.mc_id=academic-105485-koreyst) или [Направите pull request](https://github.com/microsoft/ai-agents-for-beginners/pulls?WT.mc_id=academic-105485-koreyst)
...
|-------------------------------------------------|-----------------------------------------------------|--------------------------------------------------------------|-----------------------------------------------------------------------------------------|
| Увод у AI агенте и примену агената               | [Линк](./01-intro-to-ai-agents/README.md)            | [Видео](https://youtu.be/3zgm60bXmQk?si=z8QygFvYQv-9WtO1)    | [Линк](https://aka.ms/ai-agents-beginners/collection?WT.mc_id=academic-105485-koreyst)   |
...
| Шаблон коришћења алата                            | [Линк](./04-tool-use/README.md)                      | [Видео](https://youtu.be/vieRiPRx-gI?si=2z6O2Xu2cu_Jz46N)    | [Линк](https://aka.ms/ai-agents-beginners/collection?WT.mc_id=academic-105485-koreyst)   |
...
| Шаблон планирања дизајна                          | [Линк](./07-planning-design/README.md)               | [Видео](https://youtu.be/kPfJ2BrBCMY?si=6SC_iv_E5-mzucnC)    | [Линк](https://aka.ms/ai-agents-beginners/collection?WT.mc_id=academic-105485-koreyst)   |
| Мулти-агентски шаблон дизајна                     | [Линк](./08-multi-agent/README.md)                   | [Видео](https://youtu.be/V6HpE9hZEx0?si=rMgDhEu7wXo2uo6g)    | [Линк](https://aka.ms/ai-agents-beginners/collection?WT.mc_id=academic-105485-koreyst)   |
...
| AI агенте у продукцији                      | [Линк](./10-ai-agents-production/README.md)        | [Видео](https://youtu.be/l4TP6IyJxmQ?si=31dnhexRo6yLRJDl)  | [Линк](https://aka.ms/ai-agents-beginners/collection?WT.mc_id=academic-105485-koreyst) |
| Коришћење агентивних протокола (MCP, A2A и NLWeb) | [Линк](./11-agentic-protocols/README.md)           | [Видео](https://youtu.be/X-Dh9R3Opn8)                                 | [Линк](https://aka.ms/ai-agents-beginners/collection?WT.mc_id=academic-105485-koreyst) |
...
| Управљање агентивном меморијом                      | [Линк](./13-agent-memory/README.md)     |      [Видео](https://youtu.be/QrYbHesIxpw?si=vZkVwKrQ4ieCcIPx)                                                      |                                                                                        |
...
| Осигуравање AI агената                           | [Линк](./18-securing-ai-agents/README.md)  |                                                            | [Линк](https://aka.ms/ai-agents-beginners/collection?WT.mc_id=academic-105485-koreyst) |
...
[![Датa сајенс за почетнике](https://img.shields.io/badge/Data%20Science%20for%20Beginners-84CC16?style=for-the-badge&labelColor=E5E7EB&color=84CC16)](https://aka.ms/datascience-beginners?WT.mc_id=academic-105485-koreyst)
...
## 🌟 Захваљујемо заједници

Захваљујемо [Шиваму Гојалу](https://www.linkedin.com/in/shivam2003/) на доприносу важних примера кода који демонстрирају Agentic RAG.

## Допринеси

Овај пројекат поздравља доприносе и предлоге. Већина доприноса захтева да се сложите са
Уговором о лиценцирању доприноса (CLA) којим изјављујете да имате право и заиста дајете
дозволу за коришћење вашег доприноса. За детаље посетите <https://cla.opensource.microsoft.com>.

Када пошаљете захтев за повлачење, CLA бот ће аутоматски препознати да ли је потребно да доставите
CLA и адекватно означити PR (нпр., контролу статуса, коментар). Једноставно пратите упутства
која даје бот. Ово ћете морати урадити само једном за све репозиторијуме који користе наш CLA.
...
[Microsoft важећа упутства о заштитним знаковима и бренду](https://www.microsoft.com/legal/intellectualproperty/trademarks/usage/general).
Употреба Microsoft заштитних знакова или логотипа у измењеним верзијама овог пројекта не сме изазивати конфузију нити имплицирати да Microsoft сponзорише.
Свака употреба трећих заштитних знакова или логотипа подлеже политикама тих трећих страна.
