...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-08-30T08:53:43+00:00",
...
Ово можете урадити кликом на линк.
...
- Python 3.12+
  - **НАПОМЕНА**: Ако немате Python 3.12 инсталиран, уверите се да сте га инсталирали. Затим креирајте ваш venv користећи python3.12 како бисте осигурали да су исправне верзије инсталиране из датотеке requirements.txt.
...
Ово можете урадити тако што ћете отићи на ваш GitHub налог.
...
4. Ограничите дозволе токена: Под **Permissions**, кликните на **Account** таб, а затим на дугме "+ Add permissions". Појавиће се падајући мени. Потражите **Models** и означите поље за њега.
...
- `GLOBAL_LLM_SERVICE` - Под **Connected resources**, пронађите име везе за **Azure AI Services**. Ако није наведено, проверите **Azure портал** у вашој групи ресурса за име ресурса AI Services.
...
Уместо да хардкодујете ваше креденцијале, користићемо везу без кључа са Azure OpenAI. Да бисмо то урадили, увешћемо `DefaultAzureCredential` и касније позвати функцију `DefaultAzureCredential` да добијемо креденцијал.
