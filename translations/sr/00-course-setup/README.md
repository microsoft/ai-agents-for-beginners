...
![Forked Repo](../../../translated_images/sr/forked-repo.33f27ca1901baa6a.png)
...
1. Изаберите опцију `Fine-grained tokens` на левој страни екрана тако што ћете отићи на **Developer settings**.
   ...
   ![Developer settings](../../../translated_images/sr/profile_developer_settings.410a859fe749c755.png)

   Затим изаберите `Generate new token`.

   ![Generate Token](../../../translated_images/sr/fga_new_token.1c1a234afe202ab3.png)
...
2. Унесите описно име за ваш токен које одражава његову сврху, чинећи га лако препознатљивим касније.
    ...
    ![Token Name and Expiration](../../../translated_images/sr/token-name-expiry-date.a095fb0de6386864.png)

3. Ограничите опсег токена на ваш форк овог репозиторијума.

    ![Limit scope to fork repository](../../../translated_images/sr/token_repository_limit.924ade5e11d9d8bb.png)
...
4. Ограничите дозволе токена: Под **Permissions**, кликните на **Account** таб, и кликните на дугме "+ Add permissions". Појавиће се падајући мени. Молимо вас да потражите **Models** и означите поље за то.
    ...
    ![Add Models Permission](../../../translated_images/sr/add_models_permissions.c0c44ed8b40fc143.png)

5. Потврдите потребне дозволе пре него што генеришете токен. ![Verify Permissions](../../../translated_images/sr/verify_permissions.06bd9e43987a8b21.png)

6. Пре него што генеришете токен, уверите се да сте спремни да га сачувате на сигурном месту као што је менаџер лозинки, јер неће бити поново приказан након креирања. ![Store Token Securely](../../../translated_images/sr/store_token_securely.08ee2274c6ad6caf.png)
...
![GitHub Token Field](../../../translated_images/sr/github_token_field.20491ed3224b5f4a.png)
...
![Project Connection String](../../../translated_images/sr/project-endpoint.8cf04c9975bbfbf1.png)
