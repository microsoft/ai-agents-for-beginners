...
> Questo repository include oltre 50 traduzioni linguistiche che aumentano notevolmente la dimensione del download. Per clonare senza traduzioni, usa sparse checkout:
> ```bash
...
Questo corso contiene lezioni che coprono le basi per costruire Agenti AI. Ogni lezione tratta un proprio argomento, quindi inizia dove preferisci!

C'è il supporto multilingue per questo corso. Vai alle nostre [lingue disponibili qui](../..).

Se è la tua prima volta che costruisci con modelli Generativi AI, dai un’occhiata al nostro corso [Generative AI For Beginners](https://aka.ms/genai-beginners), che include 21 lezioni sulla costruzione con GenAI.

Non dimenticare di [aggiungere una stella (🌟) a questo repo](https://docs.github.com/en/get-started/exploring-projects-on-github/saving-repositories-with-stars?WT.mc_id=academic-105485-koreyst) e di [fare il fork di questo repo](https://github.com/microsoft/ai-agents-for-beginners/fork) per eseguire il codice.
...
Ogni lezione di questo corso include esempi di codice, che possono essere trovati nella cartella code_samples. Puoi [fare il fork di questo repo](https://github.com/microsoft/ai-agents-for-beginners/fork) per creare una tua copia.

L'esempio di codice in questi esercizi utilizza Azure AI Foundry e i Cataloghi Modelli di GitHub per interagire con modelli linguistici:
...
Questo corso utilizza anche i seguenti framework e servizi AI Agent di Microsoft:
...
Per ulteriori informazioni sull'esecuzione del codice per questo corso, consulta il [Setup del Corso](./00-course-setup/README.md).
...
| Pattern di Progettazione Multi-Agent         | [Link](./08-multi-agent/README.md)                   | [Video](https://youtu.be/V6HpE9hZEx0?si=rMgDhEu7wXo2uo6g)  | [Link](https://aka.ms/ai-agents-beginners/collection?WT.mc_id=academic-105485-koreyst) |
...
| Esplorare il Microsoft Agent Framework              | [Link](./14-microsoft-agent-framework/README.md)   |                                                            |                                                                                        |
| Costruire Agenti per l'Uso del Computer (CUA)      | In Arrivo                                            |                                                            |                                                                                        |
| Distribuire Agenti Scalabili                        | In Arrivo                                            |                                                            |                                                                                        |
| Creare Agenti AI Locali                             | In Arrivo                                            |                                                            |                                                                                        |
| Mettere in Sicurezza gli Agenti AI                  | In Arrivo                                            |                                                            |                                                                                        |
...
Grazie a [Shivam Goyal](https://www.linkedin.com/in/shivam2003/) per aver contribuito con campioni di codice importanti che dimostrano Agentic RAG.

## Contributi

Questo progetto accoglie contributi e suggerimenti. La maggior parte dei contributi richiede l'accettazione di un
Accordo di Licenza per i Contributori (CLA) che dichiara che hai il diritto di, e effettivamente concedi,
...
un CLA e decorerà il PR in modo appropriato (ad es., controllo stato, commento). Segui semplicemente le istruzioni
fornite dal bot. Dovrai farlo una sola volta per tutti i repo che usano il nostro CLA.
...
Questo progetto potrebbe contenere marchi o loghi di progetti, prodotti o servizi. L'uso autorizzato di marchi Microsoft
o loghi è soggetto a e deve seguire
[Le Linee Guida per Marchi & Brand di Microsoft](https://www.microsoft.com/legal/intellectualproperty/trademarks/usage/general).
L'uso dei marchi o loghi Microsoft in versioni modificate di questo progetto non deve causare confusione né implicare sponsorizzazione da parte di Microsoft.
