...
![AI Agents for Beginners](../../translated_images/it/repo-thumbnailv3.917487e234b90100.webp)
...
>
> Questo repository include traduzioni in oltre 50 lingue, il che aumenta significativamente la dimensione del download. Per clonare senza traduzioni, usa lo sparse checkout:
>
> **Bash / macOS / Linux:**
> ```bash
...
**Se desideri aggiungere il supporto per altre lingue di traduzione, sono elencate [qui](https://github.com/Azure/co-op-translator/blob/main/getting_started/supported-languages.md).**
...
Questo corso ha lezioni che coprono i fondamenti per costruire Agenti AI. Ogni lezione tratta un argomento specifico quindi inizia dove preferisci!

È disponibile il supporto multilingue per questo corso. Vai alle nostre [lingue disponibili qui](#-multi-language-support).

Se è la prima volta che costruisci con modelli di AI Generativa, dai un'occhiata al nostro corso [Generative AI For Beginners](https://aka.ms/genai-beginners), che include 21 lezioni su come costruire con GenAI.

Non dimenticare di [dare una stella (🌟) a questo repo](https://docs.github.com/en/get-started/exploring-projects-on-github/saving-repositories-with-stars?WT.mc_id=academic-105485-koreyst) e di [forkare questo repo](https://github.com/microsoft/ai-agents-for-beginners/fork) per eseguire il codice.
...
Ogni lezione in questo corso include esempi di codice, che si trovano nella cartella code_samples. Puoi [forkare questo repo](https://github.com/microsoft/ai-agents-for-beginners/fork) per creare la tua copia.  
...
Questo corso usa i seguenti framework e servizi AI Agent di Microsoft:

- [Microsoft Agent Framework (MAF)](https://learn.microsoft.com/agent-framework/overview/)
- [Microsoft Foundry Agent Service V2](https://aka.ms/ai-agents-beginners/ai-agent-service)

Alcuni campioni di codice supportano anche provider alternativi compatibili con OpenAI come [MiniMax](https://platform.minimaxi.com/), che offre modelli con contesti grandi (fino a 204K token). Vedi la [Configurazione del Corso](./00-course-setup/README.md) per i dettagli di configurazione.
...
- Esempi di codice Python usando Microsoft Agent Framework con Microsoft Foundry
...
| Esplorare i Framework Agenti                   | [Link](./02-explore-agentic-frameworks/README.md)  | [Video](https://youtu.be/ODwF-EZo_O8?si=Vawth4hzVaHv-u0H)  | [Link](https://aka.ms/ai-agents-beginners/collection?WT.mc_id=academic-105485-koreyst)       |
| Comprendere i Pattern di Progettazione Agente | [Link](./03-agentic-design-patterns/README.md)     | [Video](https://youtu.be/m9lM8qqoOEA?si=BIzHwzstTPL8o9GF)  | [Link](https://aka.ms/ai-agents-beginners/collection?WT.mc_id=academic-105485-koreyst)       |
...
| Modello di Progettazione Metacognitiva       | [Link](./09-metacognition/README.md)               | [Video](https://youtu.be/His9R6gw6Ec?si=8gck6vvdSNCt6OcF)  | [Link](https://aka.ms/ai-agents-beginners/collection?WT.mc_id=academic-105485-koreyst) |
...
| Uso dei Protocolli Agentici (MCP, A2A e NLWeb) | [Link](./11-agentic-protocols/README.md)           | [Video](https://youtu.be/X-Dh9R3Opn8)                                 | [Link](https://aka.ms/ai-agents-beginners/collection?WT.mc_id=academic-105485-koreyst) |
...
| Sicurezza degli Agenti AI                       | [Link](./18-securing-ai-agents/README.md)  |                                                            | [Link](https://aka.ms/ai-agents-beginners/collection?WT.mc_id=academic-105485-koreyst) |
...
Accordo di Licenza del Contributore (CLA) dichiarando che hai il diritto e che effettivamente concedi a noi
...
fornite dal bot. Dovrai farlo solo una volta per tutti i repo che utilizzano il nostro CLA.

Questo progetto ha adottato il [Codice di Condotta per il Software Open Source Microsoft](https://opensource.microsoft.com/codeofconduct/).
Per ulteriori informazioni vedi le [FAQ sul Codice di Condotta](https://opensource.microsoft.com/codeofconduct/faq/) o
...
o dei loghi Microsoft è soggetto a e deve seguire
