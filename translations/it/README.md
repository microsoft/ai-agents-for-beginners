...
## Un corso che insegna tutto ciò che hai bisogno di sapere per iniziare a costruire Agenti AI
...
[![PR Benvenuti](https://img.shields.io/badge/PRs-welcome-brightgreen.svg?style=flat-square)](http://makeapullrequest.com?WT.mc_id=academic-105485-koreyst)
...
Questo corso include lezioni che coprono le basi per costruire Agenti AI. Ogni lezione tratta un argomento specifico, quindi inizia dove vuoi!

C'è supporto multilingue per questo corso. Vai alle [lingue disponibili qui](#-multi-language-support).

Se è la tua prima volta a costruire con modelli di AI Generativa, dai un'occhiata al nostro corso [Generative AI For Beginners](https://aka.ms/genai-beginners), che include 21 lezioni su come costruire con GenAI.

Non dimenticare di [mettere una stella (🌟) a questo repository](https://docs.github.com/en/get-started/exploring-projects-on-github/saving-repositories-with-stars?WT.mc_id=academic-105485-koreyst) e [fare un fork di questo repository](https://github.com/microsoft/ai-agents-for-beginners/fork) per eseguire il codice.

### Incontra Altri Studenti, Ottieni le Risposte alle Tue Domande

Se ti blocchi o hai domande sulla costruzione di Agenti AI, unisciti al nostro canale Discord dedicato nel [Microsoft Foundry Discord](https://aka.ms/ai-agents/discord).
...
Alcuni esempi di codice supportano anche fornitori alternativi compatibili con OpenAI come [MiniMax](https://platform.minimaxi.com/), che offre modelli a contesto esteso (fino a 204K token). Vedi la [Configurazione del Corso](./00-course-setup/README.md) per i dettagli di configurazione.

Per maggiori informazioni sull'esecuzione del codice per questo corso, vai alla [Configurazione del Corso](./00-course-setup/README.md).

## 🙏 Vuoi Aiutare?

Hai suggerimenti o hai trovato errori di ortografia o nel codice? [Apri un problema](https://github.com/microsoft/ai-agents-for-beginners/issues?WT.mc_id=academic-105485-koreyst) oppure [Crea una pull request](https://github.com/microsoft/ai-agents-for-beginners/pulls?WT.mc_id=academic-105485-koreyst)



## 📂 Ogni lezione include

- Una lezione scritta presente nel README e un breve video
...
| Esplorare Framework Agenti                   | [Link](./02-explore-agentic-frameworks/README.md)  | [Video](https://youtu.be/ODwF-EZo_O8?si=Vawth4hzVaHv-u0H)  | [Link](https://aka.ms/ai-agents-beginners/collection?WT.mc_id=academic-105485-koreyst) |
...
| Design Pattern della Metacognizione          | [Link](./09-metacognition/README.md)               | [Video](https://youtu.be/His9R6gw6Ec?si=8gck6vvdSNCt6OcF)  | [Link](https://aka.ms/ai-agents-beginners/collection?WT.mc_id=academic-105485-koreyst) |
...
Grazie a [Shivam Goyal](https://www.linkedin.com/in/shivam2003/) per aver contribuito con esempi di codice importanti che dimostrano Agentic RAG.

## Contribuire

Questo progetto accoglie contributi e suggerimenti. La maggior parte dei contributi richiede di accettare un
Accordo di Licenza del Contributore (CLA) che dichiara che hai il diritto e effettivamente concedi a noi
...
un CLA e decorerà il PR di conseguenza (ad esempio, controllo stato, commento). Segui semplicemente le istruzioni
...
Questo progetto potrebbe contenere marchi o loghi per progetti, prodotti o servizi. L'uso autorizzato dei marchi o loghi di Microsoft
è soggetto a e deve seguire
[Linee Guida sui Marchi e Marchi di Fabbrica Microsoft](https://www.microsoft.com/legal/intellectualproperty/trademarks/usage/general).
...
Se sei in difficoltà o hai domande sulla creazione di app AI, unisciti a:

[![Microsoft Foundry Discord](https://img.shields.io/badge/Discord-Azure_AI_Foundry_Community_Discord-blue?style=for-the-badge&logo=discord&color=5865f2&logoColor=fff)](https://aka.ms/foundry/discord)

Se hai feedback sui prodotti o errori durante lo sviluppo visita:
