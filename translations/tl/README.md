...
> **Mas gusto mo bang I-clone ng Lokal?**
>
> Ang repositoryong ito ay may higit sa 50 mga pagsasalin ng wika na labis na nagpapalaki sa laki ng pag-download. Upang mag-clone nang walang mga pagsasalin, gamitin ang sparse checkout:
>
> **Bash / macOS / Linux:**
> ```bash
...
**Kung nais mong magkaroon ng karagdagang suporta sa mga wika ng pagsasalin ay nakalista [dito](https://github.com/Azure/co-op-translator/blob/main/getting_started/supported-languages.md)**
...
Ang kursong ito ay may mga aralin na sumasaklaw sa mga pundasyon ng pagbuo ng AI Agents. Bawat aralin ay may sariling paksa kaya magsimula ka kahit saan mo gusto!

May suporta ng maramihang wika para sa kursong ito. Pumunta sa aming [mga available na wika dito](../..).

Kung ito ang unang beses mong bumuo gamit ang mga Generative AI models, tingnan ang aming [Generative AI Para sa mga Baguhan](https://aka.ms/genai-beginners) na kurso, na may 21 aralin sa pagbuo gamit ang GenAI.
...
Kung ikaw ay mahirapan o may mga tanong tungkol sa pagbuo ng AI Agents, sumali sa aming dedikadong Discord Channel sa [Microsoft Foundry Discord](https://aka.ms/ai-agents/discord).

### Mga Kailangan Mo

Bawat aralin sa kursong ito ay may kasamang mga halimbawa ng code, na makikita sa folder na code_samples. Maaari mong [i-fork ang repo na ito](https://github.com/microsoft/ai-agents-for-beginners/fork) upang gumawa ng sarili mong kopya.
...
Mayroon ka bang mga suhestiyon o nakakita ng mga pagkakamali sa spelling o code? [Mag-raise ng isyu](https://github.com/microsoft/ai-agents-for-beginners/issues?WT.mc_id=academic-105485-koreyst) o [Gumawa ng pull request](https://github.com/microsoft/ai-agents-for-beginners/pulls?WT.mc_id=academic-105485-koreyst)
...
- Mga link sa dagdag na pinagkukunan upang ipagpatuloy ang iyong pag-aaral
...
|----------------------------------------------|--------------------------------------------------|------------------------------------------------------------|----------------------------------------------------------------------------------------|
| Panimula sa AI Agents at Mga Kaso ng Paggamit ng Agent | [Link](./01-intro-to-ai-agents/README.md)          | [Video](https://youtu.be/3zgm60bXmQk?si=z8QygFvYQv-9WtO1)  | [Link](https://aka.ms/ai-agents-beginners/collection?WT.mc_id=academic-105485-koreyst) |
...
| Inhinyeriyang Konteksto para sa Mga AI Agent            | [Link](./12-context-engineering/README.md)         | [Video](https://youtu.be/F5zqRV7gEag)                                 | [Link](https://aka.ms/ai-agents-beginners/collection?WT.mc_id=academic-105485-koreyst) |
| Pamamahala ng Agentic Memory                      | [Link](./13-agent-memory/README.md)     |      [Video](https://youtu.be/QrYbHesIxpw?si=vZkVwKrQ4ieCcIPx)                                                      |                                                                                        |
| Pagsaliksik sa Microsoft Agent Framework                         | [Link](./14-microsoft-agent-framework/README.md)                            |                                                            |                                                                                        |
| Pagbuo ng Computer Use Agents (CUA)           | Malapit Nang Ilabas                            |                                                            |                                                                                        |
| Pag-deploy ng Scalable Agents                    | Malapit Nang Ilabas                            |                                                            |                                                                                        |
| Paglikha ng Lokal na Mga AI Agent                     | Malapit Nang Ilabas                               |                                                            |                                                                                        |
| Pag-secure ng Mga AI Agent                           | Malapit Nang Ilabas                               |                                                            |                                                                                        |

## 🎒 Iba Pang Kurso

Ang aming koponan ay gumagawa ng ibang mga kurso! Tingnan ang:
...
[![Mga AI Agent para sa mga Nagsisimula](https://img.shields.io/badge/AI%20Agents%20for%20Beginners-00C49A?style=for-the-badge&labelColor=E5E7EB&color=00C49A)](https://github.com/microsoft/ai-agents-for-beginners?WT.mc_id=academic-105485-koreyst)
...
Salamat kay [Shivam Goyal](https://www.linkedin.com/in/shivam2003/) sa pagbibigay ng mahahalagang sample na code na nagpapakita ng Agentic RAG. 
...
karapatan na gamitin ang iyong kontribusyon. Para sa mga detalye, bisitahin ang <https://cla.opensource.microsoft.com>.

Kapag naghain ka ng pull request, ang CLA bot ay awtomatikong magtatakda kung kailangan mo ng CLA at bibigyan ang PR ng angkop na dekorasyon (hal., status check, komento). Sundin lamang ang mga tagubiling ibibigay ng bot. Isang beses mo lang ito kailangang gawin sa lahat ng repos na gumagamit ng aming CLA.
...
Maaaring maglaman ang proyektong ito ng mga tatak-pangkalakal o mga logo para sa mga proyekto, produkto, o serbisyo. Ang awtorisadong paggamit ng mga tatak-pangkalakal o logo ng Microsoft ay napapailalim at dapat sumunod sa
[Microsoft's Trademark & Brand Guidelines](https://www.microsoft.com/legal/intellectualproperty/trademarks/usage/general).
Ang paggamit ng mga tatak-pangkalakal o logo ng Microsoft sa binagong mga bersyon ng proyekto ay hindi dapat magdulot ng kalituhan o magpahiwatig ng pagsuporta mula sa Microsoft.
Anumang paggamit ng mga tatak-pangkalakal o logo ng ikatlong partido ay napapailalim sa mga patakaran ng mga iyon.
...
Kung mayroon kang feedback sa produkto o may mga error habang ginagawa, bisitahin ang:
...
**Pagtatanggol**:  
Ang dokumentong ito ay isinalin gamit ang AI translation service na [Co-op Translator](https://github.com/Azure/co-op-translator). Bagamat nagsusumikap kami para sa katumpakan, pakatandaan na ang awtomatikong salin ay maaaring maglaman ng mga pagkakamali o hindi pagkakatugma. Ang orihinal na dokumento sa orihinal nitong wika ang dapat ituring na pinagmulan ng katotohanan. Para sa mahahalagang impormasyon, inirerekomenda ang propesyonal na pagsasalin ng tao. Hindi kami mananagot sa anumang mga hindi pagkakaunawaan o maling interpretasyon na nagmumula sa paggamit ng pagsasaling ito.
