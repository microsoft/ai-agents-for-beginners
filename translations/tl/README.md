...
## Isang kurso na nagtuturo ng lahat ng kailangan mong malaman upang makapagsimula sa paggawa ng mga AI Agent
...
**Kung nais mo ng dagdag na suportadong wika sa pagsasalin, nakalista ang mga ito [dito](https://github.com/Azure/co-op-translator/blob/main/getting_started/supported-languages.md).**
...
May suporta sa maramihang wika para sa kursong ito. Pumunta sa aming [mga magagamit na wika dito](#-multi-language-support).

Kung ito ang unang pagkakataon mong gumawa gamit ang mga Generative AI na modelo, tingnan ang aming [Generative AI Para sa mga Nagsisimula](https://aka.ms/genai-beginners) na kurso, na may kasamang 21 leksyon sa paggawa gamit ang GenAI.
...
### Makipagkita sa Ibang mga Mag-aaral, Sagutin ang Iyong mga Tanong

Kung ikaw ay ma-stuck o may mga tanong tungkol sa paggawa ng mga AI Agent, sumali sa aming dedikadong Discord Channel sa [Microsoft Foundry Discord](https://aka.ms/ai-agents/discord).

### Ano ang Kailangan Mo

Bawat leksyon sa kursong ito ay may mga halimbawa ng kodigo, na matatagpuan sa code_samples folder. Maaari mong [i-fork ang repo na ito](https://github.com/microsoft/ai-agents-for-beginners/fork) upang gumawa ng sarili mong kopya.
...
Ang ilang mga halimbawa ng kodigo ay sumusuporta rin sa mga alternatibong OpenAI-compatible providers kagaya ng [MiniMax](https://platform.minimaxi.com/), na nag-aalok ng malalaking kontekstong mga modelo (hanggang 204K tokens). Tingnan ang [Course Setup](./00-course-setup/README.md) para sa mga detalye ng pagsasaayos.
...
May mga suhestiyon ka ba o nakakita ng mga pagkakamali sa baybay o kodigo? [Mag-raise ng isyu](https://github.com/microsoft/ai-agents-for-beginners/issues?WT.mc_id=academic-105485-koreyst) o [Gumawa ng pull request](https://github.com/microsoft/ai-agents-for-beginners/pulls?WT.mc_id=academic-105485-koreyst)
...
- Mga halimbawa ng Python code gamit ang Microsoft Agent Framework kasama ang Microsoft Foundry
- Mga link sa mga dagdag na mapagkukunan upang ipagpatuloy ang iyong pag-aaral
...
| Pagbuo ng Mapagkakatiwalaang AI Agent        | [Link](./06-building-trustworthy-agents/README.md) | [Video](https://youtu.be/iZKkMEGBCUQ?si=jZjpiMnGFOE9L8OK ) | [Link](https://aka.ms/ai-agents-beginners/collection?WT.mc_id=academic-105485-koreyst) |
...
| Disenyo ng Metacognition Pattern                | [Link](./09-metacognition/README.md)               | [Video](https://youtu.be/His9R6gw6Ec?si=8gck6vvdSNCt6OcF)  | [Link](https://aka.ms/ai-agents-beginners/collection?WT.mc_id=academic-105485-koreyst) |
...
| Pag-aayos ng Context Engineering para sa AI Agents | [Link](./12-context-engineering/README.md)         | [Video](https://youtu.be/F5zqRV7gEag)                                 | [Link](https://aka.ms/ai-agents-beginners/collection?WT.mc_id=academic-105485-koreyst) |
| Pamamahala ng Agentic Memory                    | [Link](./13-agent-memory/README.md)     |      [Video](https://youtu.be/QrYbHesIxpw?si=vZkVwKrQ4ieCcIPx)                                                      |                                                                                        |
| Pagsisiyasat sa Microsoft Agent Framework              | [Link](./14-microsoft-agent-framework/README.md)                            |                                                            |                                                                                        |
| Paggawa ng Computer Use Agents (CUA)             | [Link](./15-browser-use/README.md)     |                                                            | [Link](https://docs.browser-use.com/examples/templates/playwright-integration)         |
| Pagde-deploy ng Scalable Agents                  | [Link](./16-deploying-scalable-agents/README.md) |                                                    | [Link](https://learn.microsoft.com/azure/ai-foundry/agents/overview)                   |
| Paglikha ng Mga Lokal na AI Agents               | [Link](./17-creating-local-ai-agents/README.md)  |                                                    | [Link](https://learn.microsoft.com/azure/ai-foundry/foundry-local/)                    |
| Pag-secure ng AI Agents                          | [Link](./18-securing-ai-agents/README.md)  |                                                            | [Link](https://aka.ms/ai-agents-beginners/collection?WT.mc_id=academic-105485-koreyst) |
...
Salamat kay [Shivam Goyal](https://www.linkedin.com/in/shivam2003/) para sa pagsuporta ng mahahalagang halimbawa ng code na nagpapakita ng Agentic RAG. 

## Pagsali

Tinatanggap ng proyekto na ito ang mga kontribusyon at suhestiyon. Karamihan sa mga kontribusyon ay nangangailangan na pumayag ka sa isang
Contributor License Agreement (CLA) na nagsasaad na ikaw ay may karapatan, at talagang ipinagkakaloob mo sa amin
...
CLA at bibigyan ng tamang dekorasyon ang PR (hal. status check, komento). Sundin lamang ang mga tagubiling
...
Ang proyektong ito ay maaaring maglaman ng mga tanda ng kalakal o mga logo para sa mga proyekto, produkto, o serbisyo. Ang awtorisadong paggamit ng mga tanda ng Microsoft
ay sumasailalim at dapat sumunod sa
[Microsoft's Trademark & Brand Guidelines](https://www.microsoft.com/legal/intellectualproperty/trademarks/usage/general).
Ang paggamit ng mga tanda o logo ng Microsoft sa mga binagong bersyon ng proyektong ito ay hindi dapat magdulot ng kalituhan o magpahiwatig ng sponsorship ng Microsoft.
Anumang paggamit ng mga tanda o logo ng third-party ay alinsunod sa mga patakaran ng mga third-party na iyon.
