...
> Kasama sa repositoryong ito ang 50+ salin ng wika na malaki ang dagdag sa laki ng download. Para mag-clone nang walang mga salin ng wika, gamitin ang sparse checkout:
> ```bash
...
**Kung nais mong magkaroon ng suporta para sa karagdagang mga wika ng pagsasalin, nakalista ang mga ito [dito](https://github.com/Azure/co-op-translator/blob/main/getting_started/supported-languages.md)**
...
Ang kursong ito ay may mga aralin na sumasaklaw sa mga pundasyon ng paggawa ng AI Agents. Bawat aralin ay may sariling paksa kaya maaari kang magsimula kahit saan mo gusto!

May suporta para sa maramihang wika sa kursong ito. Pumunta sa aming [mga available na wika dito](../..).

Kung ito ang iyong unang beses na gumawa gamit ang Generative AI models, tingnan ang aming [Generative AI Para sa mga Nagsisimula](https://aka.ms/genai-beginners) na kurso, na may 21 aralin tungkol sa paggawa gamit ang GenAI.
...
Kung ikaw ay maipit o may mga tanong tungkol sa paggawa ng AI Agents, sumali sa aming dedikadong Discord Channel sa [Microsoft Foundry Discord](https://aka.ms/ai-agents/discord).

### Ano ang Kailangan Mo

Bawat aralin sa kursong ito ay may kasamang mga halimbawa ng code, na matatagpuan sa folder na code_samples. Maaari kang [mag-fork ng repo na ito](https://github.com/microsoft/ai-agents-for-beginners/fork) para makagawa ng sarili mong kopya.

Ang mga halimbawa ng code sa mga ehersisyong ito, gumagamit ng Azure AI Foundry at GitHub Model Catalogs para makipag-ugnayan sa Language Models:
...
Mayroon ka bang mga mungkahi o nakakita ng mga mali sa baybay o code? [Mag-raise ng isyu](https://github.com/microsoft/ai-agents-for-beginners/issues?WT.mc_id=academic-105485-koreyst) o [Gumawa ng pull request](https://github.com/microsoft/ai-agents-for-beginners/pulls?WT.mc_id=academic-105485-koreyst)



## 📂 Bawat aralin ay naglalaman ng

- Isang nakasulat na aralin na makikita sa README at isang maikling video
- Mga halimbawang Python code na sumusuporta sa Azure AI Foundry at Github Models (Libre)
- Mga link sa mga karagdagang mapagkukunan para ipagpatuloy ang iyong pag-aaral
...
|----------------------------------------------|----------------------------------------------------|------------------------------------------------------------|----------------------------------------------------------------------------------------|
| Panimula sa AI Agents at Mga Case ng Paggamit ng Agent  | [Link](./01-intro-to-ai-agents/README.md)          | [Video](https://youtu.be/3zgm60bXmQk?si=z8QygFvYQv-9WtO1)  | [Link](https://aka.ms/ai-agents-beginners/collection?WT.mc_id=academic-105485-koreyst) |
...
| Building Computer Use Agents (CUA)           | Malapit Nang Ilabas                            |                                                            |                                                                                        |
| Deploying Scalable Agents                    | Malapit Nang Ilabas                            |                                                            |                                                                                        |
| Creating Local AI Agents                     | Malapit Nang Ilabas                               |                                                            |                                                                                        |
| Securing AI Agents                           | Malapit Nang Ilabas                               |                                                            |                                                                                        |
...
Contributor License Agreement (CLA) na nagsasaad na may karapatan ka, at talagang iginagawad mo,
...
Kapag nagsumite ka ng pull request, awtomatikong tutukuyin ng isang CLA bot kung kailangan mong magbigay
ng CLA at lalagyan ng angkop na palamuti ang PR (hal., status check, komento). Sundin lamang ang mga tagubilin
na ibinigay ng bot. Isang beses mo lang kailangang gawin ito sa lahat ng mga repos na gumagamit ng aming CLA.
...
Maaaring maglaman ang proyektong ito ng mga trademark o logo para sa mga proyekto, produkto, o serbisyo. Ang awtorisadong paggamit ng Microsoft
mga trademark o logo ay napapailalim sa at kailangang sundin ang
...
Ang anumang paggamit ng third-party trademarks o logo ay napapailalim sa mga polisiya ng mga third-party na iyon.

## Pagtanggap ng Tulong

Kung ikaw ay natigil o may mga katanungan tungkol sa paggawa ng AI apps, sumali sa:
...
**Paunawa**:  
Ang dokumentong ito ay isinalin gamit ang AI translation service na [Co-op Translator](https://github.com/Azure/co-op-translator). Bagamat aming pinagsisikapang maging tama ang pagsasalin, pakatandaan na maaaring may mga pagkakamali o hindi pagkakatugma sa awtomatikong pagsasalin. Ang orihinal na dokumento sa kanyang orihinal na wika ang dapat ituring na pinagmulan ng katotohanan. Para sa mahahalagang impormasyon, inirerekomenda ang propesyonal na pagsasalin ng tao. Hindi kami mananagot sa anumang pagkalito o maling pagkaintindi na nagmula sa paggamit ng salin na ito.
