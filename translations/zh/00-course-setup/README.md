...
![分叉的代码库](../../../translated_images/zh/forked-repo.33f27ca1901baa6a.png)
...
1. 在屏幕左侧的 **开发者设置** 中选择 `精细化令牌` 选项。
   ...
   ![开发者设置](../../../translated_images/zh/profile_developer_settings.410a859fe749c755.png)

   然后选择 `生成新令牌`。

   ![生成令牌](../../../translated_images/zh/fga_new_token.1c1a234afe202ab3.png)
...
2. 输入一个描述性名称，反映令牌的用途，便于以后识别。
    ...
    ![令牌名称和到期日期](../../../translated_images/zh/token-name-expiry-date.a095fb0de6386864.png)

3. 将令牌的作用域限制为此代码库的分叉。

    ![将作用域限制为分叉代码库](../../../translated_images/zh/token_repository_limit.924ade5e11d9d8bb.png)

4. 限制令牌的权限：在 **权限** 下，点击 **账户** 标签，然后点击 "+ 添加权限" 按钮。会出现一个下拉菜单。请搜索 **Models** 并勾选它。

    ![添加 Models 权限](../../../translated_images/zh/add_models_permissions.c0c44ed8b40fc143.png)

5. 在生成令牌之前，验证所需权限。![验证权限](../../../translated_images/zh/verify_permissions.06bd9e43987a8b21.png)

6. 在生成令牌之前，请确保您已准备好将令牌存储在安全的地方，例如密码管理器，因为生成后将无法再次查看。![安全存储令牌](../../../translated_images/zh/store_token_securely.08ee2274c6ad6caf.png)
...
![GitHub Token 字段](../../../translated_images/zh/github_token_field.20491ed3224b5f4a.png)
...
![项目连接字符串](../../../translated_images/zh/project-endpoint.8cf04c9975bbfbf1.png)
