...
Denne notesbog demonstrerer planlægning og designmønstre på virksomhedsniveau til at bygge intelligente agenter ved hjælp af Microsoft Agent Framework i .NET med Azure OpenAI (Responses API). Du vil lære at skabe agenter, der kan nedbryde komplekse problemer, planlægge flerstegs-løsninger og udføre avancerede arbejdsgange med .NETs virksomhedsfunktioner.
...
- Konfiguration af Azure OpenAI-klienten til Responses API
- Definition af strukturerede datamodeller (Plan og TravelPlan) med JSON-serialisering
- Oprettelse af en AI-agent med struktureret output ved brug af JSON-skema
...
Når du kører agenten med en rejseplanlægningsanmodning, vil den analysere anmodningen og generere en struktureret plan med passende opgavefordeling til specialiserede agenter, formateret som JSON i overensstemmelse med TravelPlan-skemaet.
