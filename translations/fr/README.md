...
**Si vous souhaitez avoir d'autres langues de traduction prises en charge, elles sont listées [ici](https://github.com/Azure/co-op-translator/blob/main/getting_started/supported-languages.md).**
...
Ce cours comprend des leçons couvrant les fondamentaux de la création d'Agents IA. Chaque leçon aborde son propre sujet, donc commencez où vous voulez !

Il y a un support multilingue pour ce cours. Consultez nos [langues disponibles ici](#-multi-language-support).

Si c’est la première fois que vous créez avec des modèles d’IA générative, découvrez notre cours [Generative AI For Beginners](https://aka.ms/genai-beginners), qui comprend 21 leçons sur la création avec GenAI.
...
Ce cours utilise les cadres et services d’agents IA suivants de Microsoft :

- [Microsoft Agent Framework (MAF)](https://learn.microsoft.com/agent-framework/overview/)
- [Microsoft Foundry Agent Service V2](https://aka.ms/ai-agents-beginners/ai-agent-service)

Certains exemples de code prennent également en charge des fournisseurs alternatifs compatibles OpenAI tels que [MiniMax](https://platform.minimaxi.com/), qui offre des modèles à grand contexte (jusqu’à 204K tokens). Voir la [Configuration du cours](./00-course-setup/README.md) pour les détails de configuration.
...
Avez-vous des suggestions ou avez-vous trouvé des fautes d’orthographe ou des erreurs dans le code ? [Signalez un problème](https://github.com/microsoft/ai-agents-for-beginners/issues?WT.mc_id=academic-105485-koreyst) ou [Créez une demande de tirage](https://github.com/microsoft/ai-agents-for-beginners/pulls?WT.mc_id=academic-105485-koreyst)
...
| Exploration des cadres Agentic IA          | [Lien](./02-explore-agentic-frameworks/README.md)| [Vidéo](https://youtu.be/ODwF-EZo_O8?si=Vawth4hzVaHv-u0H)  | [Lien](https://aka.ms/ai-agents-beginners/collection?WT.mc_id=academic-105485-koreyst) |
| Comprendre les modèles de conception Agentic IA | [Lien](./03-agentic-design-patterns/README.md)   | [Vidéo](https://youtu.be/m9lM8qqoOEA?si=BIzHwzstTPL8o9GF)  | [Lien](https://aka.ms/ai-agents-beginners/collection?WT.mc_id=academic-105485-koreyst) |
| Modèle de conception d’utilisation d’outil | [Lien](./04-tool-use/README.md)                   | [Vidéo](https://youtu.be/vieRiPRx-gI?si=2z6O2Xu2cu_Jz46N)  | [Lien](https://aka.ms/ai-agents-beginners/collection?WT.mc_id=academic-105485-koreyst) |
...
| Utilisation des Protocoles Agentic (MCP, A2A et NLWeb) | [Link](./11-agentic-protocols/README.md)           | [Video](https://youtu.be/X-Dh9R3Opn8)                                 | [Link](https://aka.ms/ai-agents-beginners/collection?WT.mc_id=academic-105485-koreyst) |
| Ingénierie du Contexte pour les Agents IA   | [Link](./12-context-engineering/README.md)         | [Video](https://youtu.be/F5zqRV7gEag)                                 | [Link](https://aka.ms/ai-agents-beginners/collection?WT.mc_id=academic-105485-koreyst) |
| Gestion de la Mémoire Agentic                 | [Link](./13-agent-memory/README.md)     |      [Video](https://youtu.be/QrYbHesIxpw?si=vZkVwKrQ4ieCcIPx)                                                      |                                                                                        |
| Exploration du Framework Agent Microsoft      | [Link](./14-microsoft-agent-framework/README.md)                            |                                                            |                                                                                        |
| Création d’Agents d’Utilisation d’Ordinateur (CUA) | [Link](./15-browser-use/README.md)     |                                                            | [Link](https://docs.browser-use.com/examples/templates/playwright-integration)         |
| Déploiement d’Agents Scalables               | [Link](./16-deploying-scalable-agents/README.md) |                                                    | [Link](https://learn.microsoft.com/azure/ai-foundry/agents/overview)                   |
...
Merci à [Shivam Goyal](https://www.linkedin.com/in/shivam2003/) pour avoir contribué des exemples de code importants montrant Agentic RAG.

## Contribution

Ce projet accueille avec plaisir contributions et suggestions. La plupart des contributions requièrent que vous acceptiez un
...
Lorsque vous soumettez une demande de tirage, un bot CLA déterminera automatiquement si vous devez fournir
un CLA et marquera la PR en conséquence (par ex., vérification de statut, commentaire). Suivez simplement les instructions
...
marques déposées ou logos Microsoft est soumise et doit respecter
...
L’utilisation des marques déposées ou logos Microsoft dans des versions modifiées de ce projet ne doit pas induire en erreur ni impliquer un parrainage par Microsoft.
