# Agents d'IA pour débutants - Un cours

![Generative AI For Beginners](../../translated_images/fr/repo-thumbnailv2.06f4a48036fde647.webp)

## Un cours qui enseigne tout ce que vous devez savoir pour commencer à créer des agents d'IA
...
Ce cours propose des leçons couvrant les fondamentaux de la création d'agents d'IA. Chaque leçon traite d'un sujet spécifique, commencez donc où vous le souhaitez !

Ce cours bénéficie du support multilingue. Consultez nos [langues disponibles ici](../..).
...
### Rencontrez d’autres apprenants, obtenez vos réponses

Si vous êtes bloqué ou avez des questions sur la création d’agents d’IA, rejoignez notre chaîne Discord dédiée dans le [Microsoft Foundry Discord](https://aka.ms/ai-agents/discord).
...
Pour plus d’informations sur l’exécution du code pour ce cours, consultez la page [Configuration du cours](./00-course-setup/README.md).
...
- Des exemples de code Python supportant Azure AI Foundry et les modèles Github (gratuits)
...
|----------------------------------------------|----------------------------------------------------|------------------------------------------------------------|----------------------------------------------------------------------------------------|
| Introduction aux agents d’IA et cas d’usage     | [Lien](./01-intro-to-ai-agents/README.md)          | [Vidéo](https://youtu.be/3zgm60bXmQk?si=z8QygFvYQv-9WtO1)  | [Lien](https://aka.ms/ai-agents-beginners/collection?WT.mc_id=academic-105485-koreyst) |
...
| Pattern de conception pour la planification                      | [Lien](./07-planning-design/README.md)             | [Vidéo](https://youtu.be/kPfJ2BrBCMY?si=6SC_iv_E5-mzucnC)  | [Lien](https://aka.ms/ai-agents-beginners/collection?WT.mc_id=academic-105485-koreyst) |
...
| Motif de conception métacognition                 | [Link](./09-metacognition/README.md)               | [Video](https://youtu.be/His9R6gw6Ec?si=8gck6vvdSNCt6OcF)  | [Link](https://aka.ms/ai-agents-beginners/collection?WT.mc_id=academic-105485-koreyst) |
...
| Ingénierie de Contexte pour Agents IA            | [Link](./12-context-engineering/README.md)         | [Video](https://youtu.be/F5zqRV7gEag)                                 | [Link](https://aka.ms/ai-agents-beginners/collection?WT.mc_id=academic-105485-koreyst) |
...
Accord de Licence de Contributeur (CLA) déclarant que vous avez le droit, et accordez effectivement, à Microsoft
...
L'utilisation des marques ou logos Microsoft dans des versions modifiées de ce projet ne doit pas provoquer de confusion ni impliquer un parrainage de Microsoft.
...
**Avertissement** :
Ce document a été traduit à l’aide du service de traduction automatique [Co-op Translator](https://github.com/Azure/co-op-translator). Bien que nous nous efforcions d’assurer l’exactitude, veuillez noter que les traductions automatiques peuvent contenir des erreurs ou des inexactitudes. Le document original dans sa langue native doit être considéré comme la source faisant foi. Pour des informations critiques, il est recommandé de recourir à une traduction professionnelle humaine. Nous déclinons toute responsabilité en cas de malentendus ou de mauvaises interprétations résultant de l’utilisation de cette traduction.
