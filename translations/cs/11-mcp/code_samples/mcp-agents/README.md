...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-07-24T10:06:12+00:00",
...
Jak více vývojářů zkoumá nástroje s agentními chováními (běh po dlouhou dobu, potřeba dodatečných vstupů během provádění atd.), vzniká běžná mylná představa, že MCP není vhodný, zejména proto, že rané příklady jeho primitivních nástrojů se zaměřovaly na jednoduché vzory požadavek-odpověď.
...
- Lidské objasnění nebo schválení
...
| Funkce                 | Případ použití                                                                                                                                     | Podpora MCP                                           |
| ----------------------- | -------------------------------------------------------------------------------------------------------------------------------------------- | ----------------------------------------------------- |
| Víceotáčkové interakce | Agent pro rezervaci cestování požádá uživatele o potvrzení ceny, poté požádá AI o shrnutí cestovních dat před dokončením transakce. | ✅ Vyžádání pro lidský vstup, sampling pro AI vstup |

<div align="center" style="font-style: italic; font-size: 0.95em; margin-bottom: 0.5em;">
<strong>Obrázek 4:</strong> Tento diagram ukazuje, jak MCP agenti mohou interaktivně vyžádat lidský vstup nebo požádat o AI asistenci během provádění, podporující složité, víceotáčkové pracovní postupy, jako jsou potvrzení a dynamické rozhodování.
</div>
...
Konkrétně implementujeme server s dvěma primárními nástroji agentů:
...
Vyžádání umožňuje agentům požadovat vstup uživatele během provádění. To je zásadní pro potvrzení, objasnění nebo schválení během dlouhodobých úkolů.
