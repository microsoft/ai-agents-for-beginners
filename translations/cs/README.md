...
## Kurz, který vás naučí vše potřebné k začátku tvorby AI Agentů
...
> ```
> To vám dá vše, co potřebujete k dokončení kurzu, s mnohem rychlejším stahováním.
<!-- CO-OP TRANSLATOR LANGUAGES TABLE END -->

**Pokud si přejete podporovat další překladové jazyky, jsou uvedeny [zde](https://github.com/Azure/co-op-translator/blob/main/getting_started/supported-languages.md)**
...
Tento kurz obsahuje lekce pokrývající základy tvorby AI Agentů. Každá lekce pokrývá své vlastní téma, takže začněte, kde chcete!

Kurz podporuje více jazyků. Přejděte na naše [dostupné jazyky zde](../..). 

Pokud tvoříte s generativními AI modely poprvé, podívejte se na náš kurz [Generative AI For Beginners](https://aka.ms/genai-beginners), který zahrnuje 21 lekcí o tvorbě s GenAI.

Nezapomeňte [označit tento repozitář hvězdičkou (🌟)](https://docs.github.com/en/get-started/exploring-projects-on-github/saving-repositories-with-stars?WT.mc_id=academic-105485-koreyst) a [forkovat tento repozitář](https://github.com/microsoft/ai-agents-for-beginners/fork) pro spuštění kódu.

### Potkejte ostatní studenty, získejte odpovědi na své otázky

Pokud narazíte na problém nebo máte otázky ohledně tvorby AI Agentů, připojte se k našemu dedikovanému Discord kanálu v [Microsoft Foundry Discord](https://aka.ms/ai-agents/discord).
...
Příklad kódu v těchto cvičeních využívá Azure AI Foundry a GitHub Model Catalogs pro práci s jazykovými modely:
...
Tento kurz také používá následující AI Agent frameworky a služby od Microsoftu:
...
Pro více informací o spuštění kódu pro tento kurz přejděte na [Course Setup](./00-course-setup/README.md).

## 🙏 Chcete pomoci?

Máte návrhy nebo jste našli pravopisné či kódové chyby? [Vytvořte issue](https://github.com/microsoft/ai-agents-for-beginners/issues?WT.mc_id=academic-105485-koreyst) nebo [nějaký pull request](https://github.com/microsoft/ai-agents-for-beginners/pulls?WT.mc_id=academic-105485-koreyst)
...
- Příkladové python kódy podporující Azure AI Foundry a Github Models (zdarma)
- Odkazy na další zdroje pro pokračování ve vašem učení
...
| Průzkum AI Agent Frameworků                  | [Odkaz](./02-explore-agentic-frameworks/README.md)  | [Video](https://youtu.be/ODwF-EZo_O8?si=Vawth4hzVaHv-u0H)  | [Odkaz](https://aka.ms/ai-agents-beginners/collection?WT.mc_id=academic-105485-koreyst) |
| Pochopení AI Agentických návrhových vzorů   | [Odkaz](./03-agentic-design-patterns/README.md)     | [Video](https://youtu.be/m9lM8qqoOEA?si=BIzHwzstTPL8o9GF)  | [Odkaz](https://aka.ms/ai-agents-beginners/collection?WT.mc_id=academic-105485-koreyst) |
| Vzor pro použití nástrojů                     | [Odkaz](./04-tool-use/README.md)                    | [Video](https://youtu.be/vieRiPRx-gI?si=2z6O2Xu2cu_Jz46N)  | [Odkaz](https://aka.ms/ai-agents-beginners/collection?WT.mc_id=academic-105485-koreyst) |
...
| Vzor plánování                               | [Odkaz](./07-planning-design/README.md)             | [Video](https://youtu.be/kPfJ2BrBCMY?si=6SC_iv_E5-mzucnC)  | [Odkaz](https://aka.ms/ai-agents-beginners/collection?WT.mc_id=academic-105485-koreyst) |
| Vzor multi-agentů                            | [Odkaz](./08-multi-agent/README.md)                 | [Video](https://youtu.be/V6HpE9hZEx0?si=rMgDhEu7wXo2uo6g)  | [Odkaz](https://aka.ms/ai-agents-beginners/collection?WT.mc_id=academic-105485-koreyst) |
| Metakognitivní návrhový vzor                 | [Link](./09-metacognition/README.md)               | [Video](https://youtu.be/His9R6gw6Ec?si=8gck6vvdSNCt6OcF)  | [Link](https://aka.ms/ai-agents-beginners/collection?WT.mc_id=academic-105485-koreyst) |
...
| Použití agentních protokolů (MCP, A2A a NLWeb) | [Link](./11-agentic-protocols/README.md)           | [Video](https://youtu.be/X-Dh9R3Opn8)                                 | [Link](https://aka.ms/ai-agents-beginners/collection?WT.mc_id=academic-105485-koreyst) |
...
| Průzkum Microsoft Agent Framework            | [Link](./14-microsoft-agent-framework/README.md)                            |                                                            |                                                                                        |
| Vytváření agentů pro počítačové použití (CUA) | Připravujeme                            |                                                            |                                                                                        |
...
Náš tým produkuje další kurzy! Podívejte se na:
...
Tento projekt vítá příspěvky a návrhy. Většina přispění vyžaduje souhlas s
...
Při odesílání pull requestu automaticky CLA bot určí, zda je potřeba poskytnout
CLA, a vhodně označí PR (např. kontrola stavu, komentář). Stačí pouze následovat instrukce
bota. Toto je potřeba udělat pouze jednou pro všechny repozitáře používající naši CLA.

Tento projekt přijal [Kodex chování Microsoft Open Source](https://opensource.microsoft.com/codeofconduct/).
Více informací naleznete v [Často kladených otázkách ke Kodexu chování](https://opensource.microsoft.com/codeofconduct/faq/) nebo kontaktujte [opencode@microsoft.com](mailto:opencode@microsoft.com) s dalšími dotazy či připomínkami.
...
[Pravidla pro ochranné známky a značky Microsoft](https://www.microsoft.com/legal/intellectualproperty/trademarks/usage/general).
Použití ochranných známek nebo log Microsoftu v upravených verzích tohoto projektu nesmí způsobovat zmatení nebo naznačovat sponzorování Microsoftem.
Jakékoliv použití ochranných známek nebo log třetích stran podléhá zásadám těchto třetích stran.

## Získání pomoci

Pokud máte potíže nebo otázky ohledně vytváření AI aplikací, připojte se:
