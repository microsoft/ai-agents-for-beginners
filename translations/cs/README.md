...
## Kurz, který vás naučí vše, co potřebujete vědět, abyste mohli začít tvořit AI Agenty
...
>
> Tento repozitář obsahuje více než 50 jazykových překladů, což výrazně zvyšuje velikost stahování. Pro klonování bez překladů použijte sparsní checkout:
>
> **Bash / macOS / Linux:**
> ```bash
...
**Pokud si přejete podporu dalších jazykových překladů, jsou uvedeny [zde](https://github.com/Azure/co-op-translator/blob/main/getting_started/supported-languages.md).**
...
Tento kurz obsahuje lekce pokrývající základy vytváření AI Agentů. Každá lekce se věnuje vlastnímu tématu, takže začněte, kde chcete!

Kurz má podporu více jazyků. Podívejte se na dostupné jazyky [zde](#-multi-language-support). 

Pokud je to váš první kontakt s tvorbou pomocí generativních AI modelů, podívejte se na náš kurz [Generative AI For Beginners](https://aka.ms/genai-beginners), který zahrnuje 21 lekcí o práci s GenAI.

Nezapomeňte [ohvězdičkovat (🌟) tento repozitář](https://docs.github.com/en/get-started/exploring-projects-on-github/saving-repositories-with-stars?WT.mc_id=academic-105485-koreyst) a [rozvětvit tento repozitář](https://github.com/microsoft/ai-agents-for-beginners/fork), abyste mohli spustit kód.
...
Každá lekce v tomto kurzu obsahuje příklady kódu, které naleznete ve složce code_samples. Můžete si [rozvětvit tento repozitář](https://github.com/microsoft/ai-agents-for-beginners/fork) a vytvořit si vlastní kopii.  

Příklady kódu v těchto cvičeních využívají Microsoft Agent Framework s Microsoft Foundry Agent Service V2:
...
Některé příklady kódu také podporují alternativní poskytovatele kompatibilní s OpenAI, jako je [MiniMax](https://platform.minimaxi.com/), který nabízí modely s velkým kontextem (až 204K tokenů). Podrobnosti konfigurace najdete v [Nastavení kurzu](./00-course-setup/README.md).

Pro více informací o spuštění kódu tohoto kurzu navštivte [Nastavení kurzu](./00-course-setup/README.md).

## 🙏 Chcete pomoci?

Máte návrhy nebo jste našli pravopisné či kódové chyby? [Vytvořte issue](https://github.com/microsoft/ai-agents-for-beginners/issues?WT.mc_id=academic-105485-koreyst) nebo [vytvořte pull request](https://github.com/microsoft/ai-agents-for-beginners/pulls?WT.mc_id=academic-105485-koreyst)
...
- Příklady kódů v Pythonu používající Microsoft Agent Framework s Microsoft Foundry
...
| Návrhový vzor multi-agentního systému                   | [Odkaz](./08-multi-agent/README.md)                 | [Video](https://youtu.be/V6HpE9hZEx0?si=rMgDhEu7wXo2uo6g)  | [Odkaz](https://aka.ms/ai-agents-beginners/collection?WT.mc_id=academic-105485-koreyst) |
...
| Tvorba agentů pro použití počítače (CUA)           | [Link](./15-browser-use/README.md)     |                                                            | [Link](https://docs.browser-use.com/examples/templates/playwright-integration)         |
| Nasazení škálovatelných agentů                    | Brzy dostupné                            |                                                            |                                                                                        |
| Vytváření lokálních AI agentů                     | Brzy dostupné                               |                                                            |                                                                                        |
...
Děkujeme [Shivam Goyal](https://www.linkedin.com/in/shivam2003/) za příspěvek důležitých ukázek kódu demonstrujících Agentic RAG.

## Přispívání

Tento projekt vítá příspěvky a návrhy. Většina příspěvků vyžaduje souhlas s
Licenční smlouvou pro přispěvatele (CLA), která prohlašuje, že máte právo a skutečně nám udělujete
práva používat váš příspěvek. Podrobnosti naleznete na <https://cla.opensource.microsoft.com>.

Po odeslání pull requestu automatický bot CLA zjistí, zda je potřeba CLA dodat,
a označí PR odpovídajícím způsobem (například kontrola stavu, komentář). Jednoduše postupujte podle pokynů
...
Pro více informací si přečtěte [Často kladené dotazy ke Kodexu chování](https://opensource.microsoft.com/codeofconduct/faq/) nebo
kontaktujte [opencode@microsoft.com](mailto:opencode@microsoft.com) s jakýmikoli dalšími dotazy či připomínkami.
...
podléhá a musí být v souladu s
