# AI Agent pro začátečníky - Kurz

![Generative AI For Beginners](../../translated_images/cs/repo-thumbnailv2.06f4a48036fde647.webp)

## Kurz, který vás naučí vše potřebné k začátkům s tvorbou AI agentů
...
> ```
> Tím získáte vše potřebné ke splnění kurzu při mnohem rychlejším stahování.
...
Tento kurz obsahuje lekce pokrývající základy tvorby AI agentů. Každá lekce se věnuje samostatnému tématu, takže můžete začít kdekoli chcete!

Kurz podporuje více jazyků. Podívejte se na naše [dostupné jazyky zde](../..). 

Pokud je to váš první kontakt s modely generativní AI, podívejte se na náš kurz [Generative AI For Beginners](https://aka.ms/genai-beginners), který obsahuje 21 lekcí o tvorbě s GenAI.

Nezapomeňte [označit tento repozitář hvězdičkou (🌟)](https://docs.github.com/en/get-started/exploring-projects-on-github/saving-repositories-with-stars?WT.mc_id=academic-105485-koreyst) a [provest fork repozitáře](https://github.com/microsoft/ai-agents-for-beginners/fork), pokud chcete spustit kód.

### Poznejte ostatní studenty, získejte odpovědi na své otázky

Pokud narazíte na problémy nebo máte otázky ohledně tvorby AI agentů, připojte se k našemu speciálnímu Discord kanálu v [Microsoft Foundry Discord](https://aka.ms/ai-agents/discord).

### Co budete potřebovat

Každá lekce v kurzu obsahuje příklady kódu, které najdete ve složce code_samples. Můžete si [provednout fork tohoto repozitáře](https://github.com/microsoft/ai-agents-for-beginners/fork) a vytvořit si tak vlastní kopii.  

Příklad kódu v těchto cvičeních využívá Azure AI Foundry a GitHub Model Catalogs k interakci s jazykovými modely:
...
Pro více informací o spuštění kódu tohoto kurzu přejděte na [Nastavení kurzu](./00-course-setup/README.md).

## 🙏 Chcete pomoci?

Máte návrhy nebo jste našli pravopisné či chybné kódy? [Vytvořte issue](https://github.com/microsoft/ai-agents-for-beginners/issues?WT.mc_id=academic-105485-koreyst) nebo [pull request](https://github.com/microsoft/ai-agents-for-beginners/pulls?WT.mc_id=academic-105485-koreyst)
...
| Prozkoumání agentních rámců                   | [Odkaz](./02-explore-agentic-frameworks/README.md)  | [Video](https://youtu.be/ODwF-EZo_O8?si=Vawth4hzVaHv-u0H)  | [Odkaz](https://aka.ms/ai-agents-beginners/collection?WT.mc_id=academic-105485-koreyst) |
| Porozumění agentním návrhovým vzorům          | [Odkaz](./03-agentic-design-patterns/README.md)     | [Video](https://youtu.be/m9lM8qqoOEA?si=BIzHwzstTPL8o9GF)  | [Odkaz](https://aka.ms/ai-agents-beginners/collection?WT.mc_id=academic-105485-koreyst) |
| Vzor používání nástrojů                        | [Odkaz](./04-tool-use/README.md)                    | [Video](https://youtu.be/vieRiPRx-gI?si=2z6O2Xu2cu_Jz46N)  | [Odkaz](https://aka.ms/ai-agents-beginners/collection?WT.mc_id=academic-105485-koreyst) |
...
| Vzor plánovacího návrhu                        | [Odkaz](./07-planning-design/README.md)             | [Video](https://youtu.be/kPfJ2BrBCMY?si=6SC_iv_E5-mzucnC)  | [Odkaz](https://aka.ms/ai-agents-beginners/collection?WT.mc_id=academic-105485-koreyst) |
...
| Vytváření agentů pro použití počítače (CUA)           | Brzy k dispozici                            |                                                            |                                                                                        |
| Nasazení škálovatelných agentů                    | Brzy k dispozici                            |                                                            |                                                                                        |
| Tvorba lokálních AI agentů                     | Brzy k dispozici                               |                                                            |                                                                                        |
...
Díky [Shivam Goyal](https://www.linkedin.com/in/shivam2003/) za příspěvek důležitých ukázek kódu demonstrujících Agentic RAG.
...
poskytujete práva k využití vašeho příspěvku. Podrobnosti najdete na <https://cla.opensource.microsoft.com>.

Když podáte pull request, bot CLA automaticky zjistí, zda je potřeba poskytnout
CLA a příslušně označí PR (např. kontrola stavu, komentář). Stačí postupovat podle
pokynů bota. Toto bude potřeba pouze jednou pro všechny repozitáře používající náš CLA.

Tento projekt přijal [Microsoft Open Source Code of Conduct](https://opensource.microsoft.com/codeofconduct/).
Další informace naleznete v [Často kladených dotazech o kodexu chování](https://opensource.microsoft.com/codeofconduct/faq/) nebo
kontaktujte [opencode@microsoft.com](mailto:opencode@microsoft.com) s případnými dalšími otázkami či připomínkami.
...
[Pokyny Microsoft pro ochranné známky a značky](https://www.microsoft.com/legal/intellectualproperty/trademarks/usage/general).
Použití ochranných známek nebo log Microsoftu v upravených verzích tohoto projektu nesmí způsobovat zmatení ani naznačovat sponzorství Microsoftem.
Jakékoli použití ochranných známek či log třetích stran podléhá zásadám těchto třetích stran.
...
Pokud máte zpětnou vazbu k produktu nebo hlásíte chyby při vývoji, navštivte:
...
Tento dokument byl přeložen pomocí služby AI překladu [Co-op Translator](https://github.com/Azure/co-op-translator). Přestože usilujeme o přesnost, mějte prosím na paměti, že automatizované překlady mohou obsahovat chyby nebo nepřesnosti. Původní dokument v jeho rodném jazyce by měl být považován za autoritativní zdroj. Pro důležité informace se doporučuje profesionální lidský překlad. Nejsme odpovědní za jakékoliv nedorozumění nebo nesprávné interpretace vzniklé použitím tohoto překladu.
