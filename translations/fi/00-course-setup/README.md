...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-10-15T11:49:38+00:00",
...
Tämä käyttää osittaista kloonausta ja sparse-checkoutia (vaatii Git 2.25+ ja suositellaan modernia Git-versiota osittaisen kloonauksen tukemiseksi):
...
- Huomio: Jos haluat avata repoa suoraan Codespacesissa (ilman ylimääräistä kloonausta), huomaa, että Codespaces rakentaa devcontainer-ympäristön ja saattaa silti varata enemmän kuin tarvitset. Kloonaamalla pintakopion uudessa Codespacessa saat enemmän hallintaa levytilan käytöstä.
...
Voit asentaa ne suorittamalla seuraavan komennon terminaalissasi repositorion juuresta:
...
## VSCode-asennus
Varmista, että käytät oikeaa Python-versiota VSCode-ohjelmassa.

![image](https://github.com/user-attachments/assets/a85e776c-2edb-4331-ae5b-6bfdfb98ee0e)

## Näytteiden asennus GitHub Models -palvelua käyttäen 
...
2. Anna tokenille kuvaava nimi, joka heijastaa sen tarkoitusta, jotta se on helppo tunnistaa myöhemmin.
    ...
    Se on hyvä tapa asettaa henkilökohtainen tavoite ja suorittaa kurssi, kun oppimisen momentum on korkea 🚀.
...
3. Rajoita tokenin käyttöoikeus tämän repositorion haarautumiseen.
    ...
    ![Rajoita käyttöoikeus haarautumisrepositorioon](../../../translated_images/token_repository_limit.924ade5e11d9d8bb6cd21293987e4579dea860e2ba66d607fb46e49524d53644.fi.png)

4. Rajoita tokenin käyttöoikeudet: **Permissions**-kohdassa, klikkaa **Account**-välilehteä ja paina "+ Add permissions" -painiketta. Näkyviin tulee pudotusvalikko. Etsi **Models** ja valitse sen ruutu.
...
6. Ennen tokenin luomista varmista, että olet valmis tallentamaan tokenin turvalliseen paikkaan, kuten salasanaholviin, koska sitä ei näytetä uudelleen luomisen jälkeen. ![Tallenna token turvallisesti](../../../translated_images/store_token_securely.08ee2274c6ad6caf3482f1cd1bad7ca3fdca1ce737bc485bfa6499c84297c789.fi.png)

Kopioi juuri luomasi uusi token. Lisää se nyt tähän kurssiin sisältyvään `.env`-tiedostoon.
...
## Näytteiden asennus Azure AI Foundry ja Azure AI Agent Service -palveluita käyttäen
...
Jos haluat suorittaa nämä näytteet, sinun tulee lisätä seuraavat ympäristömuuttujat `.env`-tiedostoosi:
...
- `GLOBAL_LLM_SERVICE` - **Liitetyt resurssit**-kohdassa, etsi **Azure AI Services**-yhteyden nimi. Jos ei ole listattu, tarkista **Azure-portaali** resurssiryhmäsi alta AI Services -resurssin nimi.
...
- `AZURE_OPENAI_ENDPOINT` - Etsi **Azure AI services**, klikkaa sitä, mene **Resurssien hallinta**, **Avaimet ja päätepiste**, selaa alas kohtaan "Azure OpenAI endpoints" ja kopioi se, joka sanoo "Language APIs".
...
Sen sijaan, että kovakoodaisimme tunnistetietosi, käytämme avaimetonta yhteyttä Azure OpenAI:hin. Tätä varten tuomme `DefaultAzureCredential` ja kutsumme myöhemmin `DefaultAzureCredential`-funktiota saadaksemme tunnistetiedot.
...
Jos sinulla on ongelmia tämän asennuksen kanssa, liity <a href="https://discord.gg/kzRShWzttr" target="_blank">Azure AI Community Discordiin</a> tai <a href="https://github.com/microsoft/ai-agents-for-beginners/issues?WT.mc_id=academic-105485-koreyst" target="_blank">luo uusi ongelmaraportti</a>.
