...
## Kurssi, joka opettaa kaiken, mitä sinun tarvitsee tietää aloittaaksesi AI-agenttien rakentamisen
...
>
> Tämä repositorio sisältää yli 50 käännöstä, mikä kasvattaa merkittävästi latauskokoa. Kloonaaaksesi ilman käännöksiä, käytä sparse checkoutia:
>
> **Bash / macOS / Linux:**
> ```bash
...
Tämä kurssi sisältää oppitunteja, jotka käsittelevät AI-agenttien rakentamisen perusteita. Jokainen oppitunti kattaa oman aiheensa, joten aloita mistä tahansa haluat!

Kurssilla on monikielinen tuki. Katso [saatavilla olevat kielet tästä](#-multi-language-support). 

Jos tämä on ensimmäinen kerta kun rakennat generatiivisilla AI-malleilla, tutustu kurssiimme [Generative AI For Beginners](https://aka.ms/genai-beginners), joka sisältää 21 oppituntia GenAI:n käytöstä.

Älä unohda [tähtiä (🌟) tälle repositoriolle](https://docs.github.com/en/get-started/exploring-projects-on-github/saving-repositories-with-stars?WT.mc_id=academic-105485-koreyst) ja [haarukoi tämä repo](https://github.com/microsoft/ai-agents-for-beginners/fork) ajaaksesi koodin.
...
Jokainen kurssin oppitunti sisältää koodiesimerkkejä, jotka löytyvät kansiosta code_samples. Voit [haarukoida tämän repositorion](https://github.com/microsoft/ai-agents-for-beginners/fork) luodaksesi oman kopiosi.  
...
Tämä kurssi käyttää seuraavia Microsoftin AI-agenttirakenteita ja palveluita:

- [Microsoft Agent Framework (MAF)](https://learn.microsoft.com/agent-framework/overview/)
- [Microsoft Foundry Agent Service V2](https://aka.ms/ai-agents-beginners/ai-agent-service)

Jotkut koodiesimerkit tukevat myös vaihtoehtoisia OpenAI-yhteensopivia tarjoajia, kuten [MiniMax](https://platform.minimaxi.com/), joka tarjoaa laajakonseptimalleja (jopa 204K tokenia). Katso [Kurssin asennus](./00-course-setup/README.md) lisätietoja.

Lisätietoja kurssin koodin suorittamisesta löydät kohdasta [Kurssin asennus](./00-course-setup/README.md).

## 🙏 Haluatko auttaa?

Onko sinulla ehdotuksia tai olet löytänyt kirjoitus- tai koodivirheitä? [Laita issue](https://github.com/microsoft/ai-agents-for-beginners/issues?WT.mc_id=academic-105485-koreyst) tai [Luo pull request](https://github.com/microsoft/ai-agents-for-beginners/pulls?WT.mc_id=academic-105485-koreyst)
...
- Python-koodiesimerkit Microsoft Agent Frameworkin ja Microsoft Foundryn kanssa
...
| Ymmärtäminen AI-agenttisuunnittelumalleista | [Linkki](./03-agentic-design-patterns/README.md)   | [Video](https://youtu.be/m9lM8qqoOEA?si=BIzHwzstTPL8o9GF)  | [Linkki](https://aka.ms/ai-agents-beginners/collection?WT.mc_id=academic-105485-koreyst) |
...
| Suunnittelun suunnittelumalli               | [Linkki](./07-planning-design/README.md)            | [Video](https://youtu.be/kPfJ2BrBCMY?si=6SC_iv_E5-mzucnC)  | [Linkki](https://aka.ms/ai-agents-beginners/collection?WT.mc_id=academic-105485-koreyst) |
...
Kiitos [Shivam Goyal](https://www.linkedin.com/in/shivam2003/) tärkeiden koodiesimerkkien tuottamisesta, jotka osoittavat Agenttisen RAG:n toimintaa.

## Osallistuminen

Tämä projekti toivottaa tervetulleeksi osallistumiset ja ehdotukset. Useimmat osallistumiset edellyttävät, että hyväksyt
Kontribuuttisopimuksen (CLA), joka vahvistaa, että sinulla on oikeus ja että myönnät meille
oikeudet käyttää panostasi. Lisätietoja on osoitteessa <https://cla.opensource.microsoft.com>.

Kun teet vedäpyynnön, CLA-botti automaattisesti päättää, tarvitseeko sinun toimittaa
CLA ja koristaa vedäpyynnön asianmukaisesti (esim. tilan tarkistus, kommentti). Noudata vain botin ohjeita.
Tätä tarvitsee tehdä vain kerran kaikissa CLA:a käyttäviä arkistoja koskien.

Tämä projekti on omaksunut [Microsoftin avoimen lähdekoodin käytännesäännöt](https://opensource.microsoft.com/codeofconduct/).
Lisätietoja on osiossa [Käytännesääntöjen UKK](https://opensource.microsoft.com/codeofconduct/faq/) tai
ota yhteyttä osoitteeseen [opencode@microsoft.com](mailto:opencode@microsoft.com) kysymyksissä tai kommenteissa.

## Tavara-merkit

Tämä projekti saattaa sisältää tavaramerkkejä tai logoja projekteista, tuotteista tai palveluista. Microsoftin
tavaramerkkien tai logojen luvallinen käyttö on alistettu ja sitä on noudatettava
[Microsoftin tavaramerkki- ja brändiohjeistuksiin](https://www.microsoft.com/legal/intellectualproperty/trademarks/usage/general).
Microsoftin tavaramerkkien tai logojen käyttö tämän projektin muunnelluissa versioissa ei saa aiheuttaa sekaannusta tai antaa ymmärtää, että Microsoft sponsoroisi.
Kolmansien osapuolien tavaramerkkien tai logojen käyttö on näiden osapuolten politiikkojen alaista.
...
Jos sinulla on tuotepalautetta tai virheitä rakentaessasi, käy:
