...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-08-21T12:28:35+00:00",
...
Jos jäät jumiin tai sinulla on kysymyksiä AI-agenttien rakentamisesta, liity [Azure AI Foundry Community Discord](https://discord.gg/kzRShWzttr) -yhteisöön.

Jos sinulla on tuotepalautetta tai virheitä rakentamisen aikana, käy [Azure AI Foundry Developer Forum](https://aka.ms/azureaifoundry/forum).
...
| Moni-agentti -suunnittelumalli           | [Linkki](./08-multi-agent/README.md)              | [Video](https://youtu.be/V6HpE9hZEx0?si=rMgDhEu7wXo2uo6g)  | [Linkki](https://aka.ms/ai-agents-beginners/collection?WT.mc_id=academic-105485-koreyst) |
...
Kiitos [Shivam Goyalille](https://www.linkedin.com/in/shivam2003/) tärkeiden koodiesimerkkien jakamisesta, jotka havainnollistavat Agentic RAG:ia. 

## Osallistuminen

Tämä projekti toivottaa tervetulleeksi osallistumisen ja ehdotukset. Useimmat osallistumiset edellyttävät, että hyväksyt 
Contributor License Agreementin (CLA), jossa vakuutat, että sinulla on oikeus ja todella annat meille 
oikeudet käyttää panostasi. Lisätietoja löydät osoitteesta 
...
Lisätietoja löydät [käytännesääntöjen UKK:sta](https://opensource.microsoft.com/codeofconduct/faq/) tai 
...
tavaramerkkien tai logojen valtuutettu käyttö on sidottu ja sen on noudatettava 
...
Kolmannen osapuolen tavaramerkkien tai logojen käyttö on sidottu kyseisten osapuolten käytäntöihin.
