...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-07-24T07:46:24+00:00",
...
- **Сумісність між платформами**: Працює з різними мовами програмування, включаючи C#, Java, JavaScript, Python та TypeScript
...
1. Проблеми з підключенням MCP
   ...
   - Переконайтеся, що токени GitHub правильні
