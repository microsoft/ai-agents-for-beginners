...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-11-11T11:46:24+00:00",
...
Якщо ви вперше працюєте з моделями Генеративного AI, ознайомтеся з нашим курсом [Генеративний AI для початківців](https://aka.ms/genai-beginners), який включає 21 урок про роботу з GenAI.
...
Contributor License Agreement (CLA), що підтверджує ваше право та згоду надати нам
...
Цей проєкт може містити торгові марки або логотипи проєктів, продуктів чи послуг. Авторизоване використання торгових марок або логотипів Microsoft підлягає і повинно відповідати
