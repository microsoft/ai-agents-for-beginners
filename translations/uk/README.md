...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-08-21T12:49:25+00:00",
...
Якщо ви вперше працюєте з генеративними AI моделями, ознайомтеся з нашим курсом [Генеративний AI для Початківців](https://aka.ms/genai-beginners), який включає 21 урок зі створення з використанням GenAI.
