# AI Агент для Початківців - Курс

![AI Agents for Beginners](../../translated_images/uk/repo-thumbnailv3.917487e234b90100.webp)

## Курс, який навчає всьому необхідному для початку створення AI Агентів
...
**Якщо ви бажаєте підтримку додаткових мов перекладу, вони перелічені [тут](https://github.com/Azure/co-op-translator/blob/main/getting_started/supported-languages.md).**
...
Цей курс містить уроки, що охоплюють основи створення AI Агентів. Кожен урок присвячений своїй темі, тож починайте з будь-якого, який вам до вподоби!

Для цього курсу передбачена багатомовна підтримка. Перегляньте [доступні мови тут](#-multi-language-support). 

Якщо це ваш перший досвід створення з генеративними AI моделями, перегляньте наш курс [Generative AI For Beginners](https://aka.ms/genai-beginners), який містить 21 урок про роботу з GenAI.

Не забудьте [поставити зірку (🌟) цьому репозиторію](https://docs.github.com/en/get-started/exploring-projects-on-github/saving-repositories-with-stars?WT.mc_id=academic-105485-koreyst) і [форкнути репозиторій](https://github.com/microsoft/ai-agents-for-beginners/fork) для запуску коду.

### Познайомтеся з іншими учнями, отримуйте відповіді на запитання

Якщо ви натрапили на труднощі або маєте запитання щодо створення AI Агентів, приєднуйтесь до нашого спеціального Discord-каналу у [Microsoft Foundry Discord](https://aka.ms/ai-agents/discord).

### Що вам потрібно

У кожному уроці цього курсу є приклади коду, які можна знайти у папці code_samples. Ви можете [форкнути цей репозиторій](https://github.com/microsoft/ai-agents-for-beginners/fork), щоб створити власну копію.  
...
Для цього курсу використовуються такі фреймворки та сервіси AI Агентів від Microsoft:

- [Microsoft Agent Framework (MAF)](https://learn.microsoft.com/agent-framework/overview/)
- [Microsoft Foundry Agent Service V2](https://aka.ms/ai-agents-beginners/ai-agent-service)

Деякі приклади коду також підтримують альтернативних постачальників, сумісних з OpenAI, таких як [MiniMax](https://platform.minimaxi.com/), що пропонує моделі з великим контекстом (до 204 тис. токенів). Деталі конфігурації дивіться у [Course Setup](./00-course-setup/README.md).

Для детальнішої інформації про запуск коду для цього курсу дивіться [Course Setup](./00-course-setup/README.md).

## 🙏 Бажаєте допомогти?

Якщо у вас є пропозиції або ви знайшли помилки у правописі чи коді, [створіть issue](https://github.com/microsoft/ai-agents-for-beginners/issues?WT.mc_id=academic-105485-koreyst) або [запропонуйте pull request](https://github.com/microsoft/ai-agents-for-beginners/pulls?WT.mc_id=academic-105485-koreyst)
...
|----------------------------------------------|----------------------------------------------------|------------------------------------------------------------|----------------------------------------------------------------------------------------|
| Вступ до AI Агентів і Use Cases               | [Посилання](./01-intro-to-ai-agents/README.md)     | [Відео](https://youtu.be/3zgm60bXmQk?si=z8QygFvYQv-9WtO1)  | [Посилання](https://aka.ms/ai-agents-beginners/collection?WT.mc_id=academic-105485-koreyst) |
...
| Розуміння патернів проектування AI Агентів    | [Посилання](./03-agentic-design-patterns/README.md) | [Відео](https://youtu.be/m9lM8qqoOEA?si=BIzHwzstTPL8o9GF)  | [Посилання](https://aka.ms/ai-agents-beginners/collection?WT.mc_id=academic-105485-koreyst) |
...
| Патерн проектування планування                 | [Посилання](./07-planning-design/README.md)          | [Відео](https://youtu.be/kPfJ2BrBCMY?si=6SC_iv_E5-mzucnC)  | [Посилання](https://aka.ms/ai-agents-beginners/collection?WT.mc_id=academic-105485-koreyst) |
| Патерн проектування мультиагентності           | [Посилання](./08-multi-agent/README.md)              | [Відео](https://youtu.be/V6HpE9hZEx0?si=rMgDhEu7wXo2uo6g)  | [Посилання](https://aka.ms/ai-agents-beginners/collection?WT.mc_id=academic-105485-koreyst) |

| Патерн дизайну метакогніції                 | [Link](./09-metacognition/README.md)               | [Video](https://youtu.be/His9R6gw6Ec?si=8gck6vvdSNCt6OcF)  | [Link](https://aka.ms/ai-agents-beginners/collection?WT.mc_id=academic-105485-koreyst) |
...
| Контекстне інженерство для AI агентів            | [Link](./12-context-engineering/README.md)         | [Video](https://youtu.be/F5zqRV7gEag)                                 | [Link](https://aka.ms/ai-agents-beginners/collection?WT.mc_id=academic-105485-koreyst) |
| Керування агентською пам’яттю                      | [Link](./13-agent-memory/README.md)     |      [Video](https://youtu.be/QrYbHesIxpw?si=vZkVwKrQ4ieCcIPx)                                                      |                                                                                        |
| Огляд Microsoft Agent Framework                         | [Link](./14-microsoft-agent-framework/README.md)                            |                                                            |                                                                                        |
| Створення агентів для керування комп’ютером (CUA)           | [Link](./15-browser-use/README.md)     |                                                            | [Link](https://docs.browser-use.com/examples/templates/playwright-integration)         |
| Впровадження масштабованих агентів                    | [Link](./16-deploying-scalable-agents/README.md) |                                                    | [Link](https://learn.microsoft.com/azure/ai-foundry/agents/overview)                   |
...
| Захист AI агентів                           | [Link](./18-securing-ai-agents/README.md)  |                                                            | [Link](https://aka.ms/ai-agents-beginners/collection?WT.mc_id=academic-105485-koreyst) |
...
Угодою про ліцензію для контриб’юторів (CLA), в якій ви підтверджуєте, що маєте право і фактично надаєте нам
права на використання вашого внеску. Деталі див. на <https://cla.opensource.microsoft.com>.

Коли ви надсилаєте pull request, бот CLA автоматично визначить, чи потрібно подавати
CLA, і відповідно позначить PR (наприклад, перевірка статусу, коментар). Просто дотримуйтеся інструкцій,
наданих ботом. Вам потрібно зробити це лише один раз для всіх репозиторіїв, що використовують нашу CLA.

Цей проєкт прийняв [Кодекс поведінки Microsoft з відкритим кодом](https://opensource.microsoft.com/codeofconduct/).
Для детальнішої інформації див. [Поширені питання про Кодекс поведінки](https://opensource.microsoft.com/codeofconduct/faq/) або
зв’яжіться з [opencode@microsoft.com](mailto:opencode@microsoft.com) для додаткових питань або коментарів.

## Торговельні марки

Цей проєкт може містити торговельні марки або логотипи проєктів, продуктів чи сервісів. Авторизоване використання торговельних
марок або логотипів Microsoft підпорядковується і повинно відповідати
...
Використання торговельних марок або логотипів Microsoft у змінених версіях цього проєкту не повинно вводити в оману або натякати на спонсорство Microsoft.
Будь-яке використання торговельних марок або логотипів третіх сторін підпорядковується політикам тих третіх сторін.
