...
![AI Agents for Beginners](../../translated_images/uk/repo-thumbnailv3.917487e234b90100.webp)

## Курс, який навчає всьому, що потрібно знати для початку створення AI Агентів
...
>
> У цьому репозиторії є понад 50 мовних перекладів, що значно збільшує розмір завантаження. Щоб клонувати без перекладів, використовуйте вибіркове клонування:
>
> **Bash / macOS / Linux:**
> ```bash
...
**Якщо ви хочете, щоб підтримувалися додаткові мови перекладу, вони перераховані [тут](https://github.com/Azure/co-op-translator/blob/main/getting_started/supported-languages.md).**
...
Цей курс містить уроки, що охоплюють основи створення AI Агентів. Кожен урок охоплює свою тему, тож починайте з будь-якого, який вам подобається!

Для цього курсу передбачена підтримка кількох мов. Перейдіть до нашого [переліку доступних мов тут](#-multi-language-support). 

Якщо ви вперше працюєте з моделями генеративного ШІ, ознайомтеся з нашим курсом [Генеративний ШІ для початківців](https://aka.ms/genai-beginners), що містить 21 урок зі створення на основі Генеративного ШІ.
...
Якщо ви застрягли або маєте питання про створення AI Агентів, приєднуйтесь до нашого спеціального каналу Discord у [Microsoft Foundry Discord](https://aka.ms/ai-agents/discord).
...
Цей курс використовує наступні AI Agent фреймворки та сервіси від Microsoft:

- [Microsoft Agent Framework (MAF)](https://learn.microsoft.com/agent-framework/overview/)
- [Microsoft Foundry Agent Service V2](https://aka.ms/ai-agents-beginners/ai-agent-service)

Деякі приклади коду також підтримують альтернативних сумісних з OpenAI провайдерів, таких як [MiniMax](https://platform.minimaxi.com/), який пропонує моделі з великим контекстом (до 204 тисяч токенів). Деталі налаштування дивіться в [Course Setup](./00-course-setup/README.md).

Для більш детальної інформації про запуск коду цього курсу перейдіть до [Course Setup](./00-course-setup/README.md).

## 🙏 Бажаєте допомогти?

Маєте пропозиції або знайшли орфографічні чи помилки в коді? [Створіть issue](https://github.com/microsoft/ai-agents-for-beginners/issues?WT.mc_id=academic-105485-koreyst) або [запропонуйте пул реквест](https://github.com/microsoft/ai-agents-for-beginners/pulls?WT.mc_id=academic-105485-koreyst)
...
- Приклади коду на Python з використанням Microsoft Agent Framework із Microsoft Foundry
...
|----------------------------------------------|--------------------------------------------------|----------------------------------------------------------|-----------------------------------------------------------------------------------------|
| Вступ до AI Агентів і Кейси Використання     | [Link](./01-intro-to-ai-agents/README.md)         | [Video](https://youtu.be/3zgm60bXmQk?si=z8QygFvYQv-9WtO1) | [Link](https://aka.ms/ai-agents-beginners/collection?WT.mc_id=academic-105485-koreyst)  |
| Вивчення AI Агентських Фреймворків            | [Link](./02-explore-agentic-frameworks/README.md) | [Video](https://youtu.be/ODwF-EZo_O8?si=Vawth4hzVaHv-u0H) | [Link](https://aka.ms/ai-agents-beginners/collection?WT.mc_id=academic-105485-koreyst)  |
| Розуміння патернів проектування AI агентів    | [Link](./03-agentic-design-patterns/README.md)    | [Video](https://youtu.be/m9lM8qqoOEA?si=BIzHwzstTPL8o9GF) | [Link](https://aka.ms/ai-agents-beginners/collection?WT.mc_id=academic-105485-koreyst)  |
...
| Патерн проектування планування                 | [Link](./07-planning-design/README.md)            | [Video](https://youtu.be/kPfJ2BrBCMY?si=6SC_iv_E5-mzucnC) | [Link](https://aka.ms/ai-agents-beginners/collection?WT.mc_id=academic-105485-koreyst)  |
| Патерн проектування з багатьма агентами       | [Link](./08-multi-agent/README.md)                | [Video](https://youtu.be/V6HpE9hZEx0?si=rMgDhEu7wXo2uo6g) | [Link](https://aka.ms/ai-agents-beginners/collection?WT.mc_id=academic-105485-koreyst)  |

| Метакогнітивний шаблон проектування            | [Link](./09-metacognition/README.md)               | [Video](https://youtu.be/His9R6gw6Ec?si=8gck6vvdSNCt6OcF)  | [Link](https://aka.ms/ai-agents-beginners/collection?WT.mc_id=academic-105485-koreyst) |
| Штучні агенти у виробництві                    | [Link](./10-ai-agents-production/README.md)        | [Video](https://youtu.be/l4TP6IyJxmQ?si=31dnhexRo6yLRJDl)  | [Link](https://aka.ms/ai-agents-beginners/collection?WT.mc_id=academic-105485-koreyst) |
...
| Інженерія контексту для штучних агентів       | [Link](./12-context-engineering/README.md)         | [Video](https://youtu.be/F5zqRV7gEag)                                 | [Link](https://aka.ms/ai-agents-beginners/collection?WT.mc_id=academic-105485-koreyst) |
| Керування агентною пам'яттю                      | [Link](./13-agent-memory/README.md)     |      [Video](https://youtu.be/QrYbHesIxpw?si=vZkVwKrQ4ieCcIPx)                                                      |                                                                                        |
...
| Створення локальних ШІ агентів                   | [Link](./17-creating-local-ai-agents/README.md)  |                                                    | [Link](https://learn.microsoft.com/azure/ai-foundry/foundry-local/)                    |
| Захист ШІ агентів                              | [Link](./18-securing-ai-agents/README.md)  |                                                            | [Link](https://aka.ms/ai-agents-beginners/collection?WT.mc_id=academic-105485-koreyst) |
...
### Серія курсів з генеративного ШІ
...
Подяка [Shivam Goyal](https://www.linkedin.com/in/shivam2003/) за внесок важливих прикладів коду, що демонструють Agentic RAG.

## Внесок у проєкт

Цей проєкт вітає внески та пропозиції. Більшість внесків вимагають, щоб ви погодилися з
Угодою про ліцензію учасника (CLA), що підтверджує ваше право і фактичну згоду надати нам
права на використання вашого внеску. Деталі наведено на <https://cla.opensource.microsoft.com>.

Після подання запиту на злиття, бот CLA автоматично визначить, чи потрібно вам надати
CLA, і відповідним чином позначить PR (наприклад, статус перевірки, коментар). Просто дотримуйтеся вказівок
, наданих ботом. Вам потрібно буде зробити це лише один раз для всіх репозиторіїв з нашим CLA.

Цей проєкт прийняв [Кодекс поведінки відкритого програмного забезпечення Microsoft](https://opensource.microsoft.com/codeofconduct/).
Для отримання додаткової інформації перегляньте [Питання та відповіді з Кодексу поведінки](https://opensource.microsoft.com/codeofconduct/faq/) або
...
Цей проєкт може містити торговельні марки або логотипи проєктів, продуктів чи послуг. Авторизоване використання торгових марок або логотипів Microsoft
підпорядковується та має відповідати
...
Використання торговельних марок або логотипів Microsoft у змінених версіях цього проєкту не повинно спричиняти плутанину або створювати враження спонсорства Microsoft.
Будь-яке використання торгових марок чи логотипів третіх сторін підпорядковується політикам цих третіх сторін.

## Отримання допомоги


Якщо ви застрягли або у вас є запитання щодо створення AI-додатків, приєднуйтесь:

[![Microsoft Foundry Discord](https://img.shields.io/badge/Discord-Azure_AI_Foundry_Community_Discord-blue?style=for-the-badge&logo=discord&color=5865f2&logoColor=fff)](https://aka.ms/foundry/discord)

Якщо у вас є відгуки про продукт або ви зіткнулися з помилками під час створення, відвідайте:
