...
[![Запити на вилучення GitHub](https://img.shields.io/github/issues-pr/microsoft/ai-agents-for-beginners.svg)](https://GitHub.com/microsoft/ai-agents-for-beginners/pulls/?WT.mc_id=academic-105485-koreyst)
...
> Цей репозиторій містить понад 50 перекладів мов, що суттєво збільшує розмір завантаження. Щоб клонувати без перекладів, використовуйте sparse checkout:
> ```bash
...
**Якщо ви хочете, щоб підтримувались додаткові мови перекладу, вони наведені [тут](https://github.com/Azure/co-op-translator/blob/main/getting_started/supported-languages.md)**
...
Цей курс містить уроки, що охоплюють основи створення AI агентів. Кожен урок присвячений окремій темі, тому починайте з будь-якого, який вам подобається!

Цей курс підтримує кілька мов. Перейдіть до наших [доступних мов тут](../..).

Якщо ви вперше створюєте з допомогою моделей генеративного ШІ, ознайомтеся з нашим курсом [Генеративний ШІ для початківців](https://aka.ms/genai-beginners), який містить 21 урок зі створення за допомогою GenAI.
...
### Познайомтеся з іншими учнями, отримуйте відповіді на свої запитання

Якщо ви застрягли або маєте будь-які запитання щодо створення AI агентів, приєднуйтесь до нашого спеціального Discord-каналу у [Microsoft Foundry Discord](https://aka.ms/ai-agents/discord).
...
Приклад коду в цих вправах використовує Azure AI Foundry і каталоги моделей GitHub для взаємодії з мовними моделями:
...
У вас є пропозиції або помітили помилки у написанні чи коді? [Створіть проблему](https://github.com/microsoft/ai-agents-for-beginners/issues?WT.mc_id=academic-105485-koreyst) або [створіть запит на вилучення](https://github.com/microsoft/ai-agents-for-beginners/pulls?WT.mc_id=academic-105485-koreyst)
...
- Приклади коду Python, що підтримують Azure AI Foundry і GitHub Models (безкоштовно)
...
|----------------------------------------------|----------------------------------------------------|------------------------------------------------------------|-----------------------------------------------------------------------------------------|
| Вступ до AI агентів та сценарії використання | [Посилання](./01-intro-to-ai-agents/README.md)          | [Відео](https://youtu.be/3zgm60bXmQk?si=z8QygFvYQv-9WtO1)  | [Посилання](https://aka.ms/ai-agents-beginners/collection?WT.mc_id=academic-105485-koreyst) |
| Огляд AI агентних фреймворків                | [Посилання](./02-explore-agentic-frameworks/README.md)  | [Відео](https://youtu.be/ODwF-EZo_O8?si=Vawth4hzVaHv-u0H)  | [Посилання](https://aka.ms/ai-agents-beginners/collection?WT.mc_id=academic-105485-koreyst) |
...
| Побудова надійних AI агентів                 | [Посилання](./06-building-trustworthy-agents/README.md) | [Відео](https://youtu.be/iZKkMEGBCUQ?si=jZjpiMnGFOE9L8OK ) | [Посилання](https://aka.ms/ai-agents-beginners/collection?WT.mc_id=academic-105485-koreyst) |
...
| Патерн мультиагентної розробки               | [Посилання](./08-multi-agent/README.md)                 | [Відео](https://youtu.be/V6HpE9hZEx0?si=rMgDhEu7wXo2uo6g)  | [Посилання](https://aka.ms/ai-agents-beginners/collection?WT.mc_id=academic-105485-koreyst) |
| Метакогнітивний дизайн шаблону                 | [Посилання](./09-metacognition/README.md)               | [Відео](https://youtu.be/His9R6gw6Ec?si=8gck6vvdSNCt6OcF)  | [Посилання](https://aka.ms/ai-agents-beginners/collection?WT.mc_id=academic-105485-koreyst) |
...
| Контекстне інжиніринг для AI-агентів            | [Посилання](./12-context-engineering/README.md)         | [Відео](https://youtu.be/F5zqRV7gEag)                                 | [Посилання](https://aka.ms/ai-agents-beginners/collection?WT.mc_id=academic-105485-koreyst) |
...
| Створення агентів для комп’ютерного використання (CUA)           | Незабаром                            |                                                            |                                                                                        |
| Розгортання масштабованих агентів                    | Незабаром                            |                                                            |                                                                                        |
| Створення локальних AI-агентів                     | Незабаром                               |                                                            |                                                                                        |
| Забезпечення безпеки AI-агентів                           | Незабаром                               |                                                            |                                                                                        |
...
Дякуємо [Shivam Goyal](https://www.linkedin.com/in/shivam2003/) за внесок у важливі приклади коду, що демонструють Agentic RAG.

## Внесок

Цей проєкт вітає внески та пропозиції. Більшість внесків вимагає від вас погодження
Згоди на ліцензію учасника (CLA), що засвідчує, що ви маєте право і насправді надаєте нам
права на використання вашого внеску. Для деталей відвідайте <https://cla.opensource.microsoft.com>.

Коли ви надсилаєте запит на вилучення, бот CLA автоматично визначить, чи потрібно вам надати
CLA та відповідно позначить PR (наприклад, перевірка статусу, коментар). Просто дотримуйтесь інструкцій,
наданих ботом. Це потрібно зробити лише один раз для всіх репозиторіїв, що використовують наш CLA.

Цей проєкт прийняв [Кодекс поведінки відкритого коду Microsoft](https://opensource.microsoft.com/codeofconduct/).
Для додаткової інформації див. [Питання та відповіді щодо Кодексу поведінки](https://opensource.microsoft.com/codeofconduct/faq/) або
зв’язатися з [opencode@microsoft.com](mailto:opencode@microsoft.com) з будь-якими додатковими питаннями чи коментарями.

## Торгові марки

Цей проєкт може містити торгові марки або логотипи проєктів, продуктів чи сервісів. Авторизоване використання торгових марок або логотипів Microsoft
підлягає та має відповідати
...
Якщо ви застрягли або маєте будь-які питання щодо створення AI-застосунків, приєднуйтесь:
...
Цей документ був перекладений за допомогою сервісу AI перекладу [Co-op Translator](https://github.com/Azure/co-op-translator). Хоча ми прагнемо до точності, будь ласка, майте на увазі, що автоматичні переклади можуть містити помилки або неточності. Оригінальний документ рідною мовою слід вважати авторитетним джерелом. Для критично важливої інформації рекомендується звертатися до професійного людського перекладу. Ми не несемо відповідальності за будь-які непорозуміння або неправильні тлумачення, що виникли внаслідок використання цього перекладу.
