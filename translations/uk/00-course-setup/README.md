...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-08-30T09:50:09+00:00",
...
Перед тим як клонувати репозиторій, приєднайтеся до [каналу Discord "AI Agents For Beginners"](https://aka.ms/ai-agents/discord), щоб отримати допомогу з налаштуванням, поставити запитання щодо курсу або поспілкуватися з іншими учасниками.
...
2. Введіть описову назву для вашого токена, яка відображає його призначення, щоб його було легко ідентифікувати пізніше.
    ...
    Це чудовий спосіб поставити собі особисту мету і завершити курс, поки ваш навчальний імпульс високий 🚀.
...
Дотримуйтесь інструкцій зі створення хабу та проекту в Azure AI Foundry, які можна знайти тут: [Hub resources overview](https://learn.microsoft.com/en-us/azure/ai-foundry/concepts/ai-resources)
