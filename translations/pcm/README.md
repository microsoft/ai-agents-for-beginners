...
## A course wey dey teach everytin wey you need sabi to start to build AI Agents
...
> **You Dey Prefer Make You Clone E Locally?**

> Dis repository get 50+ language translations wey dey add plenty to the download size. To clone without translations, make you use sparse checkout:
> ```bash
> git clone --filter=blob:none --sparse https://github.com/microsoft/ai-agents-for-beginners.git
> cd ai-agents-for-beginners
> git sparse-checkout set --no-cone '/*' '!translations' '!translated_images'
> ```
> Dis one go give you everything you need to complete the course fast well well.
<!-- CO-OP TRANSLATOR LANGUAGES TABLE END -->

**If you want make dem support more translation languages, dem dey listed [here](https://github.com/Azure/co-op-translator/blob/main/getting_started/supported-languages.md)**
...
Dis course get lessons wey dey cover the basic tins of how to build AI Agents. Every lesson get e own topic so you fit start from anywhere you want!

Dis course get multi-language support. Check out our [available languages here](../..). 

If na your first time to dey build with Generative AI models, make you try our [Generative AI For Beginners](https://aka.ms/genai-beginners) course wey get 21 lessons on how to build with GenAI.
...
If you jam wahala or you get any questions about how to build AI Agents, join our dedicated Discord Channel for inside the [Microsoft Foundry Discord](https://aka.ms/ai-agents/discord).

### Wetin You Need

Every lesson for dis course get code examples, wey you go fit find for the code_samples folder. You fit [fork dis repo](https://github.com/microsoft/ai-agents-for-beginners/fork) make you get your own copy.  

The code examples inside these exercises use Azure AI Foundry and GitHub Model Catalogs to dey interact with Language Models:

- [Github Models](https://aka.ms/ai-agents-beginners/github-models) - Free / Limited
- [Azure AI Foundry](https://aka.ms/ai-agents-beginners/ai-foundry) - You go need Azure Account

Dis course also dey use the following AI Agent frameworks and services from Microsoft:
...
If you want know more about how to run the code for this course, check the [Course Setup](./00-course-setup/README.md).

## 🙏 You Wan Help?

You get any suggestions or you see any spelling or code errors? [Raise an issue](https://github.com/microsoft/ai-agents-for-beginners/issues?WT.mc_id=academic-105485-koreyst) or [Create a pull request](https://github.com/microsoft/ai-agents-for-beginners/pulls?WT.mc_id=academic-105485-koreyst)



## 📂 Every Lesson Get

- Written lesson for inside the README and short video
- Python code samples wey support Azure AI Foundry and Github Models (Free)
- Links to extra resources to help you continue dey learn
...
| Building Computer Use Agents (CUA)           | Dem cam soon                            |                                                            |                                                                                        |
| Deploying Scalable Agents                    | Dem cam soon                            |                                                            |                                                                                        |
| Creating Local AI Agents                     | Dem cam soon                               |                                                            |                                                                                        |
| Securing AI Agents                           | Dem cam soon                               |                                                            |                                                                                        |
...
Tanks to [Shivam Goyal](https://www.linkedin.com/in/shivam2003/) for to contribute important code samples wey dey show Agentic RAG. 

## Contributing

Dis project dey welcome contributions and suggestions.  Most contributions require say you agree to a
Contributor License Agreement (CLA) wey dey talk say you get di right, and you really dey give us
...
CLA and go decorate di PR well well (for example, status check, comment). Just follow all di instructions
wey di bot provide. You go only need to do dis one time for all repos wey dey use our CLA.

Dis project don adopt di [Microsoft Open Source Code of Conduct](https://opensource.microsoft.com/codeofconduct/).
For more info make you check di [Code of Conduct FAQ](https://opensource.microsoft.com/codeofconduct/faq/) or
contact [opencode@microsoft.com](mailto:opencode@microsoft.com) if you get any extra questions or comments.

## Trademarks

Dis project fit get trademarks or logos for some projects, products, or services. Authorized use of Microsoft
trademarks or logos na subject to and you must follow
[Microsoft's Trademark & Brand Guidelines](https://www.microsoft.com/legal/intellectualproperty/trademarks/usage/general).
Use of Microsoft trademarks or logos for modified versions of dis project must no cause confusion or make person think Microsoft sponsor am.
Any use of third-party trademarks or logos na subject to di rules of di third-parties dem.
...
**Disclaimer**:  
Dis document na so AI translation service [Co-op Translator](https://github.com/Azure/co-op-translator) translate am. Even though we dey try make am correct, make you sabi say automated translation fit get some mistakes or no too clear. Di original document wey dem write for dia own language na di correct one wey you suppose trust pass. If na serious information, better to use professional human translation. We no go hold ground if you jam misunderstanding or misinterpretation because of dis translation.
