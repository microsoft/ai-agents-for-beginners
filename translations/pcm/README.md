...
## A course wey dey teach everytin wey you need to sabi to start build AI Agents
...
> **You prefer make you Clone am Local?**
>
> This repository get 50+ language translations wey go big well-well your download size. If you wan clone without all the translations, use sparse checkout:
>
> **Bash / macOS / Linux:**
> ```bash
...
> ```
>
> Dis wan go give you everything wey you need to finish the course faster.
...
Dis course get lessons wey dey cover the basics of how to build AI Agents. Each lesson dey talk about one topic so feel free to start anywhere you like!

This course get multi-language support. Check our [available languages here](../..). 
...
No forget to [star (🌟) dis repo](https://docs.github.com/en/get-started/exploring-projects-on-github/saving-repositories-with-stars?WT.mc_id=academic-105485-koreyst) and [fork this repo](https://github.com/microsoft/ai-agents-for-beginners/fork) to run the code.

### Meet Other Learners, Get Your Questions Answered

If you jam problem or get any question about building AI Agents, join our special Discord Channel for [Microsoft Foundry Discord](https://aka.ms/ai-agents/discord).

### Wetin You Need

Every lesson for this course get code examples, wey you fit find for the code_samples folder. You fit [fork this repo](https://github.com/microsoft/ai-agents-for-beginners/fork) to make your own copy.  

The code examples for these exercises use Microsoft Agent Framework with Azure AI Foundry Agent Service V2:

- [Microsoft Foundry](https://aka.ms/ai-agents-beginners/ai-foundry) - Azure Account Required

This course dey use these AI Agent frameworks and services from Microsoft:

- [Microsoft Agent Framework (MAF)](https://aka.ms/ai-agents-beginners/agent-framewrok)
- [Azure AI Foundry Agent Service V2](https://aka.ms/ai-agents-beginners/ai-agent-service)


If you wan more info on how to run the code for this course, check the [Course Setup](./00-course-setup/README.md).

## 🙏 You Want Help?

You get any suggestion or you find spelling or code mistakes? [Raise an issue](https://github.com/microsoft/ai-agents-for-beginners/issues?WT.mc_id=academic-105485-koreyst) or [Make a pull request](https://github.com/microsoft/ai-agents-for-beginners/pulls?WT.mc_id=academic-105485-koreyst)



## 📂 Every lesson get

- Written lesson wey dey the README plus short video
...
Thanks to [Shivam Goyal](https://www.linkedin.com/in/shivam2003/) for putting important code samples wey dey show how Agentic RAG dey work. 

## Contributing

Dis project dey welcome contributions and suggestions. Most contributions go require say you gree to
Contributor License Agreement (CLA) wey talk say you get the right, and you really dey give us
the rights to use your contribution. For details, check <https://cla.opensource.microsoft.com>.

When you submit pull request, CLA bot go automatically check whether you need to provide
CLA and go put the correct decoration for the PR (e.g., status check, comment). Just follow the instructions
wey bot provide. You go only need to do am once for all repos wey dey use our CLA.

Dis project don adopt the [Microsoft Open Source Code of Conduct](https://opensource.microsoft.com/codeofconduct/).
For more info, see the [Code of Conduct FAQ](https://opensource.microsoft.com/codeofconduct/faq/) or
...
Use of Microsoft trademarks or logos for modified versions of dis project must no cause confusion or make people think say Microsoft dey sponsor am.
Any use of third-party trademarks or logos dey subject to those third-party policies.
...
**Disclaimer**:  
Dis document don translate wit AI translation service wey dem call [Co-op Translator](https://github.com/Azure/co-op-translator). Even tho we dey try make am correct, make you sabi say machine translation fit get mistake or no too correct. Di original document wey dey im correct language na di real correct one. If na important information, e better make human professional translate am. We no go responsible if pipo misunderstand or use dis translation wrong.
