...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-11-11T14:16:31+00:00",
  "source_file": "03-agentic-design-patterns/README.md",
  "language_code": "pcm"
}
-->
[![How to Design Good AI Agents](../../../translated_images/lesson-3-thumbnail.1092dd7a8f1074a5b26e35aa8f810814e05a22fed1765c20c14b2b508c7ae379.pcm.png)](https://youtu.be/m9lM8qqoOEA?si=4KimounNKvArQQ0K)
...
- Help human beings expand and scale wetin dem fit do (brainstorming, problem-solving, automation, etc.)
...
- Make us better versions of ourselves (e.g., life coach/task master, help us learn emotional regulation and mindfulness skills, build resilience, etc.)

## Wetin Dis Lesson Go Cover

- Wetin be di Agentic Design Principles
- Guidelines wey you go follow when you dey implement di design principles
...
![Agentic Design Principles](../../../translated_images/agentic-design-principles.1cfdf8b6d3cc73c2b738951ee7b2043e224441d98babcf654be69d866120f93a.pcm.png)
...
- Agents dey bring people closer together. Dem no dey designed to replace or make people feel less important.
- **E dey easy to access but sometimes e dey invisible** – agent dey operate for background and e go only show face when e dey relevant and appropriate.
  ...
  - Agent fit dey operate for invisible form, but di background process path and di way e dey collaborate with other Agents go dey transparent and user go fit control am.
...
- **Now**: Nudging more than notifying.
  - Agent dey use one comprehensive approach to interact with people. When event happen, di Agent dey go beyond static notification or other static formality. Agent fit simplify flows or dynamically generate cues to direct di user attention at di right moment.
  ...
  - Agent interaction fit dey gradual, dey evolve/grow in complexity to empower users over time.
...
- **Accept uncertainty but build trust**.
  ...
  - Humans dey in control of when di Agent dey on/off and di Agent status go dey clearly visible all di time.
...
Join di [Azure AI Foundry Discord](https://aka.ms/ai-agents/discord) to meet with other learners, attend office hours and get your AI Agents questions answered.
