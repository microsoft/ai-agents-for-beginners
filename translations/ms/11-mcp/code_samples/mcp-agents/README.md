...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-08-21T13:30:23+00:00",
...
Sebagai rujukan, kita akan merujuk kepada ejen sebagai "alat" yang tersedia di pelayan MCP. Ini menyiratkan kewujudan aplikasi hos yang melaksanakan pelanggan MCP yang mewujudkan sesi dengan pelayan MCP dan boleh memanggil ejen.
...
| Hasil Sebahagian            | Tugas "Hasilkan buku" menstrim hasil sebahagian, contohnya, 1) Garis besar arka cerita, 2) Senarai bab, 3) Setiap bab apabila selesai. Hos boleh memeriksa, membatalkan, atau mengarahkan semula pada mana-mana peringkat. | ✅ Notifikasi boleh "diperluaskan" untuk memasukkan hasil sebahagian lihat cadangan pada PR 383, 776 |
...
Boleh disambung semula memastikan bahawa tugas ejen yang beroperasi untuk tempoh yang panjang boleh bertahan daripada gangguan pelanggan dan diteruskan dengan lancar apabila disambung semula. Ini dilaksanakan melalui stor acara dan token penyambungan semula.
