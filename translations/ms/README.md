...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-12-21T11:28:50+00:00",
...
**Jika anda ingin mempunyai sokongan tambahan untuk terjemahan, bahasa yang disokong disenaraikan [di sini](https://github.com/Azure/co-op-translator/blob/main/getting_started/supported-languages.md)**
...
Jika ini kali pertama anda membina dengan model AI Generatif, lihat kursus [Generative AI For Beginners](https://aka.ms/genai-beginners) kami, yang merangkumi 21 pelajaran mengenai pembangunan dengan GenAI.
...
Adakah anda mempunyai cadangan atau menemui kesalahan ejaan atau kod? [Buka isu](https://github.com/microsoft/ai-agents-for-beginners/issues?WT.mc_id=academic-105485-koreyst) atau [Buat permintaan tarik](https://github.com/microsoft/ai-agents-for-beginners/pulls?WT.mc_id=academic-105485-koreyst)



## 📂 Setiap pelajaran merangkumi

- Satu pelajaran bertulis yang terletak dalam README dan sebuah video ringkas
...
| Meneroka Microsoft Agent Framework                         | [Pautan](./14-microsoft-agent-framework/README.md)                            |                                                            |                                                                                        |
...
Projek ini mengalu-alukan sumbangan dan cadangan. Kebanyakan sumbangan menghendaki anda bersetuju dengan Perjanjian Lesen Penyumbang (CLA) yang menyatakan bahawa anda mempunyai hak, dan benar-benar memberikan kami hak untuk menggunakan sumbangan anda. Untuk maklumat lanjut, lawati <https://cla.opensource.microsoft.com>.

Apabila anda menghantar permintaan tarik (pull request), bot CLA akan secara automatik menentukan sama ada anda perlu menyediakan CLA dan menghiasi PR dengan sewajarnya (contohnya, semakan status, komen). Ikuti sahaja arahan yang diberikan oleh bot. Anda hanya perlu melakukan ini sekali untuk semua repositori yang menggunakan CLA kami.

Projek ini telah menerima [Microsoft Open Source Code of Conduct](https://opensource.microsoft.com/codeofconduct/).
Untuk maklumat lanjut lihat [Code of Conduct FAQ](https://opensource.microsoft.com/codeofconduct/faq/) atau hubungi [opencode@microsoft.com](mailto:opencode@microsoft.com) untuk sebarang soalan atau komen tambahan.

## Tanda Niaga

Projek ini mungkin mengandungi tanda niaga atau logo untuk projek, produk, atau perkhidmatan. Penggunaan yang dibenarkan bagi tanda niaga atau logo Microsoft tertakluk kepada dan mesti mematuhi
[Microsoft's Trademark & Brand Guidelines](https://www.microsoft.com/legal/intellectualproperty/trademarks/usage/general).
Penggunaan tanda niaga atau logo Microsoft dalam versi projek yang diubah mesti tidak menyebabkan kekeliruan atau memberi tanggapan bahawa Microsoft menaja.
Sebarang penggunaan tanda niaga atau logo pihak ketiga tertakluk kepada polisi pihak ketiga tersebut.

## Mendapatkan Bantuan


Jika anda tersekat atau mempunyai sebarang soalan mengenai membangunkan aplikasi AI, sertai:
