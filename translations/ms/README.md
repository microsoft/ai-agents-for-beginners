...
![Generative AI For Beginners](../../translated_images/ms/repo-thumbnailv2.06f4a48036fde647.webp)
...
**Jika anda ingin supaya bahasa terjemahan tambahan disokong, disenaraikan [di sini](https://github.com/Azure/co-op-translator/blob/main/getting_started/supported-languages.md)**
...
Kursus ini mempunyai pelajaran yang merangkumi asas-asas pembinaan Ejen AI. Setiap pelajaran meliputi topiknya sendiri jadi mulakan di mana sahaja yang anda suka!

Terdapat sokongan pelbagai bahasa untuk kursus ini. Pergi ke [bahasa-bahasa yang tersedia di sini](../..). 

Jika ini adalah kali pertama anda membina dengan model Generative AI, lihat kursus kami [Generative AI For Beginners](https://aka.ms/genai-beginners), yang merangkumi 21 pelajaran tentang membina dengan GenAI.

Jangan lupa untuk [menyimpan (🌟) repo ini](https://docs.github.com/en/get-started/exploring-projects-on-github/saving-repositories-with-stars?WT.mc_id=academic-105485-koreyst) dan [fork repo ini](https://github.com/microsoft/ai-agents-for-beginners/fork) untuk menjalankan kod.

### Temui Pelajar Lain, Dapatkan Soalan Anda Dijawab

Jika anda menghadapi kesukaran atau mempunyai sebarang soalan mengenai pembinaan Ejen AI, sertai Saluran Discord khusus kami di [Microsoft Foundry Discord](https://aka.ms/ai-agents/discord).
...
Contoh kod dalam latihan ini, menggunakan Azure AI Foundry dan Katalog Model GitHub untuk berinteraksi dengan Model Bahasa:
...
Adakah anda mempunyai cadangan atau terjumpa kesalahan ejaan atau kod? [Buka isu](https://github.com/microsoft/ai-agents-for-beginners/issues?WT.mc_id=academic-105485-koreyst) atau [Buat permintaan tarik](https://github.com/microsoft/ai-agents-for-beginners/pulls?WT.mc_id=academic-105485-koreyst)



## 📂 Setiap pelajaran termasuk

- Pelajaran bertulis yang terletak di README dan video ringkas
- Contoh kod Python yang menyokong Azure AI Foundry dan Model Github (Percuma)
...
| Meneroka Rangka Kerja AI Agentic             | [Pautan](./02-explore-agentic-frameworks/README.md)| [Video](https://youtu.be/ODwF-EZo_O8?si=Vawth4hzVaHv-u0H)  | [Pautan](https://aka.ms/ai-agents-beginners/collection?WT.mc_id=academic-105485-koreyst) |
| Memahami Corak Reka Bentuk AI Agentic        | [Pautan](./03-agentic-design-patterns/README.md)   | [Video](https://youtu.be/m9lM8qqoOEA?si=BIzHwzstTPL8o9GF)  | [Pautan](https://aka.ms/ai-agents-beginners/collection?WT.mc_id=academic-105485-koreyst) |
...
| Membina Ejen AI Boleh Dipercayai              | [Pautan](./06-building-trustworthy-agents/README.md)| [Video](https://youtu.be/iZKkMEGBCUQ?si=jZjpiMnGFOE9L8OK ) | [Pautan](https://aka.ms/ai-agents-beginners/collection?WT.mc_id=academic-105485-koreyst) |
...
| Corak Reka Bentuk Pelbagai Ejen               | [Pautan](./08-multi-agent/README.md)                | [Video](https://youtu.be/V6HpE9hZEx0?si=rMgDhEu7wXo2uo6g)  | [Pautan](https://aka.ms/ai-agents-beginners/collection?WT.mc_id=academic-105485-koreyst) |
...
Pasukan kami mengeluarkan kursus lain! Lihat:
...
Perjanjian Lesen Penyumbang (CLA) yang menyatakan anda mempunyai hak untuk, dan benar-benar,
memberi kami hak untuk menggunakan sumbangan anda. Untuk maklumat lanjut, layari <https://cla.opensource.microsoft.com>.

Apabila anda menghantar permintaan tarik, bot CLA akan secara automatik menentukan sama ada anda perlu memberikan
CLA dan menghias PR dengan sewajarnya (contoh, pemeriksaan status, komen). Ikut sahaja arahan
yang diberikan oleh bot. Anda hanya perlu melakukan ini sekali sahaja di semua repositori yang menggunakan CLA kami.
...
Penggunaan tanda dagangan atau logo Microsoft dalam versi projek yang diubah suai tidak boleh menyebabkan kekeliruan atau mengaitkan dengan tajaan Microsoft.
