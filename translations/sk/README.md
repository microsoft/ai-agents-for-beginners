...
![AI Agent pre Začiatočníkov](../../translated_images/sk/repo-thumbnailv2.06f4a48036fde647.webp)

## Kurz, ktorý učí všetko, čo potrebujete vedieť, aby ste mohli začať budovať AI Agentov

[![GitHub licencie](https://img.shields.io/github/license/microsoft/ai-agents-for-beginners.svg)](https://github.com/microsoft/ai-agents-for-beginners/blob/master/LICENSE?WT.mc_id=academic-105485-koreyst)
...
**Ak si želáte mať podporované ďalšie prekladové jazyky, sú uvedené [tu](https://github.com/Azure/co-op-translator/blob/main/getting_started/supported-languages.md).**
...
Tento kurz obsahuje lekcie pokrývajúce základy budovania AI Agentov. Každá lekcia obsahuje svoje vlastné témy, takže začnite tam, kde chcete!

Tento kurz má podporu viacerých jazykov. Prejdite na naše [dostupné jazyky tu](#-multi-language-support).
...
Nezabudnite [dajte hviezdičku (🌟) tomuto repozitáru](https://docs.github.com/en/get-started/exploring-projects-on-github/saving-repositories-with-stars?WT.mc_id=academic-105485-koreyst) a [forknite tento repozitár](https://github.com/microsoft/ai-agents-for-beginners/fork), aby ste mohli spustiť kód.

### Spoznajte Iných Študentov, Získajte Odpovede na Vaše Otázky

Ak sa zaseknete alebo budete mať akékoľvek otázky ohľadom budovania AI Agentov, pridajte sa do nášho špeciálneho Discord kanála v [Microsoft Foundry Discord](https://aka.ms/ai-agents/discord).

### Čo Potrebujete

Každá lekcia v tomto kurze obsahuje ukážky kódu, ktoré nájdete v priečinku code_samples. Môžete si [forknúť tento repozitár](https://github.com/microsoft/ai-agents-for-beginners/fork) a vytvoriť si vlastnú kópiu.

Ukážky kódu v týchto cvičeniach používajú Microsoft Agent Framework s Microsoft Foundry Agent Service V2:
...
Niektoré ukážky kódu tiež podporujú alternatívnych poskytovateľov kompatibilných s OpenAI, ako je [MiniMax](https://platform.minimaxi.com/), ktorý ponúka modely s veľkým kontextom (až do 204K tokenov). Pozrite si [Nastavenie Kurzu](./00-course-setup/README.md) pre detaily konfigurácie.
...
- Ukážky Python kódu používajúce Microsoft Agent Framework s Microsoft Foundry
...
| Preskúmanie AI Agentic Frameworks              | [Odkaz](./02-explore-agentic-frameworks/README.md)  | [Video](https://youtu.be/ODwF-EZo_O8?si=Vawth4hzVaHv-u0H)  | [Odkaz](https://aka.ms/ai-agents-beginners/collection?WT.mc_id=academic-105485-koreyst) |
| Porozumenie AI Agentic Dizajnovým Vzorom       | [Odkaz](./03-agentic-design-patterns/README.md)     | [Video](https://youtu.be/m9lM8qqoOEA?si=BIzHwzstTPL8o9GF)  | [Odkaz](https://aka.ms/ai-agents-beginners/collection?WT.mc_id=academic-105485-koreyst) |
...
| Používanie agentných protokolov (MCP, A2A a NLWeb) | [Link](./11-agentic-protocols/README.md)           | [Video](https://youtu.be/X-Dh9R3Opn8)                                 | [Link](https://aka.ms/ai-agents-beginners/collection?WT.mc_id=academic-105485-koreyst) |
...
| Tvorba agentov na použitie počítača (CUA)           | [Link](./15-browser-use/README.md)     |                                                            | [Link](https://docs.browser-use.com/examples/templates/playwright-integration)         |
| Nasadzovanie škálovateľných agentov                    | čoskoro                            |                                                            |                                                                                        |
| Tvorba lokálnych AI agentov                     | čoskoro                               |                                                            |                                                                                        |
...
Ďakujeme [Shivam Goyal](https://www.linkedin.com/in/shivam2003/) za príspevok dôležitých príkladov kódu demonštrujúcich Agentic RAG. 

## Príspevky

Tento projekt víta príspevky a návrhy. Väčšina príspevkov vyžaduje súhlas s
Licenčnou zmluvou prispievateľa (CLA), ktorá deklaruje, že máte právo a skutočne nám dávate
práva použiť váš príspevok. Pre detaily navštívte <https://cla.opensource.microsoft.com>.

Keď odošlete pull request, bot CLA automaticky určí, či musíte poskytnúť
CLA a vhodne označí PR (napr. kontrolou stavu, komentárom). Jednoducho nasledujte pokyny
poskytnuté botom. Túto požiadavku budete musieť splniť iba raz vo všetkých repozitároch používajúcich našu CLA.

Tento projekt prijal [Microsoft Open Source Code of Conduct](https://opensource.microsoft.com/codeofconduct/).
Pre viac informácií pozrite [FAQ o Kódexe správania](https://opensource.microsoft.com/codeofconduct/faq/) alebo
kontaktujte [opencode@microsoft.com](mailto:opencode@microsoft.com) s ďalšími otázkami alebo komentármi.

## Ochranné známky

Tento projekt môže obsahovať ochranné známky alebo logá projektov, produktov či služieb. Povolené používanie Microsoft
ochranných známok alebo log je predmetom a musí dodržiavať
[Microsoft's Trademark & Brand Guidelines](https://www.microsoft.com/legal/intellectualproperty/trademarks/usage/general).
Použitie Microsoft ochranných známok alebo log vo upravených verziách tohto projektu nesmie spôsobovať zmätok alebo naznačovať podporu Microsoftu.
Akékoľvek použitie ochranných známok alebo log tretích strán je predmetom pravidiel týchto tretích strán.
