...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-11-11T11:35:43+00:00",
...
Tento kurz obsahuje lekcie pokrývajúce základy tvorby AI agentov. Každá lekcia sa venuje konkrétnej téme, takže môžete začať kdekoľvek!
...
Ak narazíte na problém alebo máte otázky ohľadom tvorby AI agentov, pripojte sa k našemu vyhradenému kanálu na Discorde v [Azure AI Foundry Community Discord](https://aka.ms/ai-agents/discord).
...
| Vzor používania nástrojov                   | [Link](./04-tool-use/README.md)                    | [Video](https://youtu.be/vieRiPRx-gI?si=2z6O2Xu2cu_Jz46N)  | [Link](https://aka.ms/ai-agents-beginners/collection?WT.mc_id=academic-105485-koreyst) |
...
| Vzor pre viac agentov                       | [Link](./08-multi-agent/README.md)                 | [Video](https://youtu.be/V6HpE9hZEx0?si=rMgDhEu7wXo2uo6g)  | [Link](https://aka.ms/ai-agents-beginners/collection?WT.mc_id=academic-105485-koreyst) |
| Vzor metakognície                           | [Link](./09-metacognition/README.md)               | [Video](https://youtu.be/His9R6gw6Ec?si=8gck6vvdSNCt6OcF)  | [Link](https://aka.ms/ai-agents-beginners/collection?WT.mc_id=academic-105485-koreyst) |
...
| Správa pamäte agentov                       | [Link](./13-agent-memory/README.md)     |      [Video](https://youtu.be/QrYbHesIxpw?si=vZkVwKrQ4ieCcIPx)                                                      |                                                                                        |
| Preskúmanie Microsoft Agent Framework       | [Link](./14-microsoft-agent-framework/README.md)                            |                                                            |                                                                                        |
| Vytváranie agentov na používanie počítača (CUA) | Čoskoro dostupné                            |                                                            |                                                                                        |
