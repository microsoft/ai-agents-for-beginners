...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2026-01-01T11:23:51+00:00",
...
![Generatívne AI pre začiatočníkov](../../translated_images/repo-thumbnailv2.06f4a48036fde647.sk.png)
...
[![Pull requesty na GitHub](https://img.shields.io/github/issues-pr/microsoft/ai-agents-for-beginners.svg)](https://GitHub.com/microsoft/ai-agents-for-beginners/pulls/?WT.mc_id=academic-105485-koreyst)
...
Tento kurz obsahuje lekcie pokrývajúce základy vytvárania AI agentov. Každá lekcia sa venuje vlastnej téme, takže začnite kdekoľvek chcete!

Kurz má podporu viacerých jazykov. Prejdite na naše [dostupné jazyky tu](../..). 

Ak je toto váš prvýkrát pri práci s generatívnymi modelmi AI, pozrite si náš kurz [Generatívne AI pre začiatočníkov](https://aka.ms/genai-beginners), ktorý obsahuje 21 lekcií o budovaní s GenAI.

Nezabudnite [pridať hviezdu (🌟) tomuto repozitáru](https://docs.github.com/en/get-started/exploring-projects-on-github/saving-repositories-with-stars?WT.mc_id=academic-105485-koreyst) a [forknúť tento repozitár](https://github.com/microsoft/ai-agents-for-beginners/fork) na spustenie kódu.

### Spojte sa s ostatnými študentmi a získajte odpovede na svoje otázky

Ak sa zaseknete alebo máte otázky týkajúce sa vytvárania AI agentov, pridajte sa do nášho vyhradeného kanála na Discorde v [Microsoft Foundry Discord](https://aka.ms/ai-agents/discord).
...
Príklady kódu v týchto cvičeniach využívajú Azure AI Foundry a GitHub Model Catalogs na interakciu s jazykovými modelmi:

- [Github Models](https://aka.ms/ai-agents-beginners/github-models) - Zadarmo / Obmedzené
- [Azure AI Foundry](https://aka.ms/ai-agents-beginners/ai-foundry) - Vyžaduje sa Azure účet
...
For more information on running the code for this course, go to the [Nastavenie kurzu](./00-course-setup/README.md).
...
- Písomná lekcia umiestnená v README a krátke video
- Ukážky kódu v Pythone podporujúce Azure AI Foundry a Github Models (zadarmo)
- Odkazy na doplnkové zdroje pre ďalšie vzdelávanie


## 🗃️ Lekcie

| **Lekcia**                                   | **Text a kód**                                    | **Video**                                                  | **Doplnkové materiály**                                                                     |
|----------------------------------------------|----------------------------------------------------|------------------------------------------------------------|----------------------------------------------------------------------------------------|
| Úvod do AI agentov a ich prípadov použitia       | [Odkaz](./01-intro-to-ai-agents/README.md)          | [Video](https://youtu.be/3zgm60bXmQk?si=z8QygFvYQv-9WtO1)  | [Odkaz](https://aka.ms/ai-agents-beginners/collection?WT.mc_id=academic-105485-koreyst) |
| Preskúmanie agentických rámcov AI              | [Odkaz](./02-explore-agentic-frameworks/README.md)  | [Video](https://youtu.be/ODwF-EZo_O8?si=Vawth4hzVaHv-u0H)  | [Odkaz](https://aka.ms/ai-agents-beginners/collection?WT.mc_id=academic-105485-koreyst) |
...
| Metakognitívny návrhový vzor                 | [Odkaz](./09-metacognition/README.md)               | [Video](https://youtu.be/His9R6gw6Ec?si=8gck6vvdSNCt6OcF)  | [Odkaz](https://aka.ms/ai-agents-beginners/collection?WT.mc_id=academic-105485-koreyst) |
...
| Správa agentickej pamäti                      | [Odkaz](./13-agent-memory/README.md)     |      [Video](https://youtu.be/QrYbHesIxpw?si=vZkVwKrQ4ieCcIPx)                                                      |                                                                                        |
| Preskúmanie Microsoft Agent Framework                         | [Odkaz](./14-microsoft-agent-framework/README.md)                            |                                                            |                                                                                        |
| Vytváranie agentov pre použitie počítača (CUA)           | Čoskoro                            |                                                            |                                                                                        |
...
Náš tím pripravuje ďalšie kurzy! Pozrite si:
...
Tento projekt vítá príspevky a návrhy. Väčšina príspevkov si vyžaduje, aby ste súhlasili s
Dohodou o licencii prispievateľa (Contributor License Agreement, CLA), ktorá deklaruje, že máte právo a skutočne nám udeľujete
...
CLA a primerane označí PR (napr. kontrola stavu, komentár). Postupujte podľa pokynov,
ktoré poskytne bot. Toto bude potrebné urobiť len raz pre všetky repozitáre používajúce našu CLA.

Tento projekt prijal [Microsoft Open Source Kódex správania](https://opensource.microsoft.com/codeofconduct/).
Pre viac informácií pozrite [Časté otázky kódexu správania](https://opensource.microsoft.com/codeofconduct/faq/) alebo
kontaktujte [opencode@microsoft.com](mailto:opencode@microsoft.com) s akýmikoľvek ďalšími otázkami alebo pripomienkami.

## Ochranné známky

Tento projekt môže obsahovať ochranné známky alebo logá projektov, produktov alebo služieb. Autorizované používanie značiek alebo log Microsoftu podlieha a musí byť v súlade so
[Smernice Microsoftu pre ochranné známky a značku](https://www.microsoft.com/legal/intellectualproperty/trademarks/usage/general).
...
Ak máte spätnú väzbu k produktu alebo sa vyskytli chyby pri vývoji, navštívte:
...
Tento dokument bol preložený pomocou služby strojového prekladu založenej na umelej inteligencii [Co-op Translator](https://github.com/Azure/co-op-translator). Aj keď sa snažíme o presnosť, majte na pamäti, že automatické preklady môžu obsahovať chyby alebo nepresnosti. Pôvodný dokument v jeho pôvodnom jazyku by sa mal považovať za autoritatívny zdroj. Pre kritické informácie odporúčame profesionálny preklad vykonaný človekom. Nie sme zodpovední za žiadne nedorozumenia ani nesprávne interpretácie vyplývajúce z použitia tohto prekladu.
