...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-10-24T09:10:55+00:00",
...
Tento kurz obsahuje lekcie pokrývajúce základy tvorby AI agentov. Každá lekcia sa venuje vlastnej téme, takže môžete začať kdekoľvek!

Kurz podporuje viacero jazykov. Prejdite na [dostupné jazyky tu](../..).  

Ak je to váš prvý kontakt s generatívnymi AI modelmi, pozrite si náš kurz [Generatívna AI pre začiatočníkov](https://aka.ms/genai-beginners), ktorý obsahuje 21 lekcií o práci s GenAI.
...
Ak sa zaseknete alebo máte otázky ohľadom tvorby AI agentov, pripojte sa na náš dedikovaný Discord kanál v [Azure AI Foundry Community Discord](https://aka.ms/ai-agents/discord).
...
- [Github Models](https://aka.ms/ai-agents-beginners/github-models) - zdarma / obmedzené
...
- Ukážky kódu v Pythone podporujúce Azure AI Foundry a Github Models (zdarma)
...
| Porozumenie návrhovým vzorom AI agentov      | [Link](./03-agentic-design-patterns/README.md)     | [Video](https://youtu.be/m9lM8qqoOEA?si=BIzHwzstTPL8o9GF)  | [Link](https://aka.ms/ai-agents-beginners/collection?WT.mc_id=academic-105485-koreyst) |
...
| Vytváranie agentov na používanie počítača (CUA)      | Už čoskoro                            |                                                            |                                                                                        |
...
Tento projekt môže obsahovať ochranné známky alebo logá pre projekty, produkty alebo služby. Povolené používanie ochranných známok alebo log Microsoftu podlieha a musí dodržiavať
