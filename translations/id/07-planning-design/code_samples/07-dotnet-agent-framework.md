...
Pelajaran ini menyertakan implementasi .NET Single File App. Untuk menjalankannya:
...
- Mengonfigurasi klien Azure OpenAI untuk Responses API
...
Agen dikonfigurasi untuk mengembalikan respons yang cocok dengan skema TravelPlan:
...
- CarRental: Untuk memesan mobil dan memberikan informasi sewa mobil
- ActivitiesBooking: Untuk memesan aktivitas dan memberikan informasi aktivitas
- DestinationInfo: Untuk menyediakan informasi tentang destinasi
- DefaultAgent: Untuk menangani permintaan umum

## Output yang Diharapkan

Ketika Anda menjalankan agen dengan permintaan perencanaan perjalanan, agen akan menganalisis permintaan dan menghasilkan rencana terstruktur dengan penugasan tugas yang sesuai ke agen khusus, diformat sebagai JSON yang sesuai dengan skema TravelPlan.
