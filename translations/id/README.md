...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-08-21T12:33:18+00:00",
...
![Generative AI Untuk Pemula](../../translated_images/repo-thumbnail.083b24afed61b6dd27a7fc53798bebe9edf688a41031163a1fca9f61c64d63ec.id.png)

## 11 Pelajaran yang mengajarkan semua yang perlu Anda ketahui untuk mulai membangun AI Agen
...
Kursus ini memiliki 11 pelajaran yang mencakup dasar-dasar membangun AI Agen. Setiap pelajaran mencakup topiknya sendiri, jadi mulailah dari mana saja yang Anda suka!
...
Kursus ini juga menggunakan kerangka kerja dan layanan AI Agen berikut dari Microsoft:
...
Jika Anda mengalami kesulitan atau memiliki pertanyaan tentang membangun AI Agen, bergabunglah dengan [Komunitas Discord Azure AI Foundry](https://discord.gg/kzRShWzttr) 

Jika Anda memiliki umpan balik produk atau menemukan kesalahan saat membangun, kunjungi [Forum Pengembang Azure AI Foundry](https://aka.ms/azureaifoundry/forum)
...
|-------------------------------------------|--------------------------------------------------|------------------------------------------------------------|----------------------------------------------------------------------------------------|
| Pengantar AI Agen dan Kasus Penggunaan    | [Link](./01-intro-to-ai-agents/README.md)        | [Video](https://youtu.be/3zgm60bXmQk?si=z8QygFvYQv-9WtO1)  | [Link](https://aka.ms/ai-agents-beginners/collection?WT.mc_id=academic-105485-koreyst) |
...
| AI Agen dalam Produksi                    | [Link](./10-ai-agents-production/README.md)      | [Video](https://youtu.be/l4TP6IyJxmQ?si=31dnhexRo6yLRJDl)  | [Link](https://aka.ms/ai-agents-beginners/collection?WT.mc_id=academic-105485-koreyst) |
| AI Agen dengan MCP                        | [Link](./11-mcp/README.md)                       |                                                            | [Link](https://aka.ms/mcp-for-beginners)                                               |

## 🎒 Kursus Lainnya

Tim kami juga membuat kursus lainnya! Lihat:
- [**BARU** Protokol Model Context (MCP) untuk Pemula](https://github.com/microsoft/mcp-for-beginners?WT.mc_id=academic-105485-koreyst)
...
- [Machine Learning untuk Pemula](https://aka.ms/ml-beginners?WT.mc_id=academic-105485-koreyst)
...
- [Menguasai GitHub Copilot untuk Pemrograman Berpasangan dengan AI](https://aka.ms/GitHubCopilotAI?WT.mc_id=academic-105485-koreyst)
