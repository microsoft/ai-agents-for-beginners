# AI Agen untuk Pemula - Sebuah Kursus

![Generative AI For Beginners](../../translated_images/id/repo-thumbnailv2.06f4a48036fde647.webp)

## Sebuah kursus yang mengajarkan segala yang perlu Anda ketahui untuk mulai membangun AI Agen
...
**Jika Anda ingin mendukung bahasa terjemahan tambahan yang didukung, daftarnya tersedia [di sini](https://github.com/Azure/co-op-translator/blob/main/getting_started/supported-languages.md)**
...
Kursus ini memiliki pelajaran yang mencakup dasar-dasar membangun AI Agen. Setiap pelajaran membahas topik tersendiri jadi mulai dari mana saja yang Anda suka!
...
Jika Anda mengalami kesulitan atau memiliki pertanyaan tentang membangun AI Agen, bergabunglah dengan Saluran Discord khusus kami di [Microsoft Foundry Discord](https://aka.ms/ai-agents/discord).
...
Kursus ini juga menggunakan framework dan layanan AI Agen dari Microsoft berikut:
...
|------------------------------------------------|-------------------------------------------------|-------------------------------------------------------------|-----------------------------------------------------------------------------------------|
| Intro ke AI Agen dan Kasus Penggunaan Agen      | [Link](./01-intro-to-ai-agents/README.md)        | [Video](https://youtu.be/3zgm60bXmQk?si=z8QygFvYQv-9WtO1)   | [Link](https://aka.ms/ai-agents-beginners/collection?WT.mc_id=academic-105485-koreyst)  |
...
| Pola Desain Pemakaian Alat                      | [Link](./04-tool-use/README.md)                  | [Video](https://youtu.be/vieRiPRx-gI?si=2z6O2Xu2cu_Jz46N)   | [Link](https://aka.ms/ai-agents-beginners/collection?WT.mc_id=academic-105485-koreyst)  |
...
| Membangun AI Agen yang Dapat Dipercaya          | [Link](./06-building-trustworthy-agents/README.md)| [Video](https://youtu.be/iZKkMEGBCUQ?si=jZjpiMnGFOE9L8OK)  | [Link](https://aka.ms/ai-agents-beginners/collection?WT.mc_id=academic-105485-koreyst)  |
...
| Menerapkan Agen yang Skalabel                    | Segera Hadir                            |                                                            |                                                                                        |
...
### Seri Copilot
[![Copilot untuk Pemrograman Berpasangan dengan AI](https://img.shields.io/badge/Copilot%20for%20AI%20Paired%20Programming-FACC15?style=for-the-badge&labelColor=E5E7EB&color=FACC15)](https://aka.ms/GitHubCopilotAI?WT.mc_id=academic-105485-koreyst)
...
Saat Anda mengirimkan permintaan tarik, bot CLA secara otomatis akan menentukan apakah Anda perlu menyediakan
CLA dan menandai PR yang sesuai (misalnya, pemeriksaan status, komentar). Cukup ikuti instruksi yang
diberikan oleh bot. Anda hanya perlu melakukan ini sekali untuk semua repo yang menggunakan CLA kami.
...
Penggunaan merek dagang atau logo Microsoft dalam versi modifikasi proyek ini tidak boleh menyebabkan kebingungan atau menyiratkan dukungan Microsoft.
