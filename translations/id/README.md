...
## Sebuah kursus yang mengajarkan segala hal yang perlu Anda ketahui untuk mulai membangun Agen AI
...
#### Didukung melalui GitHub Action (Otomatis & Selalu Terupdate)
...
**Jika Anda ingin menambahkan bahasa terjemahan lain yang didukung tercantum [di sini](https://github.com/Azure/co-op-translator/blob/main/getting_started/supported-languages.md)**
...
Kursus ini memiliki pelajaran yang mencakup dasar-dasar membangun Agen AI. Setiap pelajaran membahas topik sendiri-sendiri sehingga Anda dapat memulai dari mana saja yang Anda suka!

Ada dukungan multi-bahasa untuk kursus ini. Kunjungi [bahasa yang tersedia di sini](../..).

Jika ini adalah pertama kalinya Anda membangun dengan model Generative AI, lihat kursus kami [Generative AI For Beginners](https://aka.ms/genai-beginners), yang mencakup 21 pelajaran tentang pembangunan dengan GenAI.
...
### Bertemu Pelajar Lain, Dapatkan Jawaban Pertanyaan Anda
...
Untuk informasi lebih lanjut tentang menjalankan kode untuk kursus ini, kunjungi [Persiapan Kursus](./00-course-setup/README.md).
...
- Pelajaran tertulis yang terdapat dalam README dan video singkat
...
| RAG Agen AI                                    | [Tautan](./05-agentic-rag/README.md)                 | [Video](https://youtu.be/WcjAARvdL7I?si=gKPWsQpKiIlDH9A3)  | [Tautan](https://aka.ms/ai-agents-beginners/collection?WT.mc_id=academic-105485-koreyst) |
...
Tim kami memproduksi kursus lainnya! Periksa:
...
Perjanjian Lisensi Kontributor (CLA) yang menyatakan bahwa Anda memiliki hak untuk, dan memang memberikan,
hak kepada kami untuk menggunakan kontribusi Anda. Untuk rincian, kunjungi <https://cla.opensource.microsoft.com>.

Saat Anda mengajukan pull request, bot CLA akan secara otomatis menentukan apakah Anda perlu menyediakan
CLA dan menghiasi PR secara tepat (misalnya, pemeriksaan status, komentar). Cukup ikuti instruksi
...
Penggunaan merek dagang atau logo Microsoft dalam versi proyek yang diubah tidak boleh menimbulkan kebingungan atau mengisyaratkan sponsor Microsoft.
Penggunaan merek dagang atau logo pihak ketiga tunduk pada kebijakan pihak ketiga tersebut.

## Mendapatkan Bantuan

Jika Anda mengalami kendala atau memiliki pertanyaan tentang membangun aplikasi AI, bergabunglah dengan:
...
**Penafian**:  
Dokumen ini telah diterjemahkan menggunakan layanan terjemahan AI [Co-op Translator](https://github.com/Azure/co-op-translator). Meskipun kami berupaya menjaga akurasi, harap diingat bahwa terjemahan otomatis dapat mengandung kesalahan atau ketidakakuratan. Dokumen asli dalam bahasa aslinya harus dianggap sebagai sumber yang sahih. Untuk informasi yang penting, disarankan menggunakan terjemahan profesional oleh manusia. Kami tidak bertanggung jawab atas kesalahpahaman atau salah tafsir yang timbul dari penggunaan terjemahan ini.
