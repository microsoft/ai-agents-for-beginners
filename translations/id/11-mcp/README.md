...
- **Komunikasi Terstandarisasi**: MCP menetapkan bahasa umum untuk aplikasi berkomunikasi dengan model AI
...
- **Integrasi Tanpa Hambatan**: Memungkinkan pengembang dengan mudah mengintegrasikan berbagai model AI ke dalam aplikasi mereka

MCP sangat berguna dalam pengembangan agen AI karena memungkinkan agen untuk berinteraksi dengan berbagai sistem dan sumber data melalui protokol yang terintegrasi, menjadikan agen lebih fleksibel dan kuat.
...
Untuk instruksi penyiapan lebih rinci dan informasi tambahan, lihat [Github MCP Server Example README](./code_samples/github-mcp/README.md).
