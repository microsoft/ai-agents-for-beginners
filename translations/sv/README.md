...
>
> Detta förråd innehåller fler än 50 språkversioner vilket avsevärt ökar nedladdningsstorleken. För att klona utan översättningar, använd sparsamt utcheckning:
>
> **Bash / macOS / Linux:**
> ```bash
...
Den här kursen innehåller lektioner som täcker grunderna i att bygga AI-agenter. Varje lektion behandlar sitt eget ämne, så börja vart du vill!

Det finns flerspråkigt stöd för denna kurs. Gå till våra [tillgängliga språk här](#-multi-language-support).

Om detta är första gången du bygger med Generativa AI-modeller, kolla in vår [Generative AI For Beginners](https://aka.ms/genai-beginners)-kurs, som innehåller 21 lektioner om att bygga med GenAI.

Glöm inte att [stjärnmärka (🌟) detta förråd](https://docs.github.com/en/get-started/exploring-projects-on-github/saving-repositories-with-stars?WT.mc_id=academic-105485-koreyst) och [fork:a detta förråd](https://github.com/microsoft/ai-agents-for-beginners/fork) för att köra koden.

### Träffa andra studerande, få dina frågor besvarade
...
Varje lektion i denna kurs innehåller kodexempel, vilka finns i mappen code_samples. Du kan [fork:a detta förråd](https://github.com/microsoft/ai-agents-for-beginners/fork) för att skapa din egen kopia.
...
Vissa kodexempel stödjer också alternativa OpenAI-kompatibla leverantörer som [MiniMax](https://platform.minimaxi.com/), som erbjuder modeller med stort sammanhang (upp till 204K tokens). Se [Kursuppsättning](./00-course-setup/README.md) för konfigurationsdetaljer.

För mer information om hur du kör koden för denna kurs, gå till [Kursuppsättning](./00-course-setup/README.md).

## 🙏 Vill du hjälpa till?

Har du förslag eller hittat stavfel eller kodfel? [Rapportera ett problem](https://github.com/microsoft/ai-agents-for-beginners/issues?WT.mc_id=academic-105485-koreyst) eller [skapa en pull-begäran](https://github.com/microsoft/ai-agents-for-beginners/pulls?WT.mc_id=academic-105485-koreyst)
...
- Pythonkodexempel som använder Microsoft Agent Framework med Microsoft Foundry
- Länkar till extra resurser för att fortsätta ditt lärande


## 🗃️ Lektioner

| **Lektion**                                   | **Text & Kod**                                    | **Video**                                                  | **Extra Lärare**                                                                     |
|----------------------------------------------|----------------------------------------------------|------------------------------------------------------------|----------------------------------------------------------------------------------------|
...
rätten att använda ditt bidrag. För detaljer, besök <https://cla.opensource.microsoft.com>.

När du skickar in en pull request kommer en CLA-bot automatiskt avgöra om du behöver lämna
in en CLA och märka PR:n lämpligt (t.ex. statuskontroll, kommentar). Följ bara instruktionerna
som boten ger. Du behöver bara göra detta en gång för alla repos som använder vår CLA.

Detta projekt har antagit [Microsofts riktlinjer för öppen källkods uppförande](https://opensource.microsoft.com/codeofconduct/).
...
varumärken eller logotyper följer och måste följa
...
All användning av tredje parts varumärken eller logotyper är föremål för tredjeparts policyer.

## Få hjälp


Om du fastnar eller har frågor om att bygga AI-appar, anslut till:
