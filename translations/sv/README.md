...
> Detta repository inkluderar 50+ språköversättningar vilket avsevärt ökar nedladdningsstorleken. För att klona utan översättningar, använd sparse checkout:
> ```bash
...
**Om du vill ha ytterligare språkstöd finns listan [här](https://github.com/Azure/co-op-translator/blob/main/getting_started/supported-languages.md)**
...
Denna kurs har lektioner som täcker grunderna i att bygga AI-agenter. Varje lektion täcker ett eget ämne, så börja där du vill!

Det finns stöd för flera språk för denna kurs. Gå till våra [tillgängliga språk här](../..).

Om detta är första gången du bygger med generativa AI-modeller, kolla in vår kurs [Generativ AI för nybörjare](https://aka.ms/genai-beginners), som innehåller 21 lektioner om byggande med GenAI.

Glöm inte att [ge denna repo en stjärna (🌟)](https://docs.github.com/en/get-started/exploring-projects-on-github/saving-repositories-with-stars?WT.mc_id=academic-105485-koreyst) och [forka denna repo](https://github.com/microsoft/ai-agents-for-beginners/fork) för att köra koden.
...
För mer information om hur man kör koden för denna kurs, gå till [Course Setup](./00-course-setup/README.md).

## 🙏 Vill du hjälpa till?

Har du förslag eller hittat stavfel eller kodfel? [Skapa en issue](https://github.com/microsoft/ai-agents-for-beginners/issues?WT.mc_id=academic-105485-koreyst) eller [Skapa en pull request](https://github.com/microsoft/ai-agents-for-beginners/pulls?WT.mc_id=academic-105485-koreyst)
...
|----------------------------------------------|----------------------------------------------------|------------------------------------------------------------|-------------------------------------------------------------------------------------|
| Introduktion till AI-agenter och agentanvändningsområden | [Länk](./01-intro-to-ai-agents/README.md)          | [Video](https://youtu.be/3zgm60bXmQk?si=z8QygFvYQv-9WtO1)  | [Länk](https://aka.ms/ai-agents-beginners/collection?WT.mc_id=academic-105485-koreyst) |
...
Contributor License Agreement (CLA) som anger att du har rätt att, och faktiskt gör det, att bevilja oss
rätten att använda ditt bidrag. För mer information, besök <https://cla.opensource.microsoft.com>.

När du skickar en pull-begäran kommer en CLA-bot automatiskt att avgöra om du behöver tillhandahålla
...
Detta projekt har antagit [Microsofts Open Source Code of Conduct](https://opensource.microsoft.com/codeofconduct/).
