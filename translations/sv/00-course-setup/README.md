...
![Förgrenat Repo](../../../translated_images/sv/forked-repo.33f27ca1901baa6a.png)
...
1. Välj alternativet `Fine-grained tokens` på vänster sida av skärmen genom att navigera till **Utvecklarinställningar**
   ...
   ![Utvecklarinställningar](../../../translated_images/sv/profile_developer_settings.410a859fe749c755.png)

   Välj sedan `Generate new token`.

   ![Generera Token](../../../translated_images/sv/fga_new_token.1c1a234afe202ab3.png)
...
2. Ange ett beskrivande namn för din token som reflekterar dess syfte, vilket gör det enkelt att identifiera senare.
    ...
    ![Token Namn och Utgångsdatum](../../../translated_images/sv/token-name-expiry-date.a095fb0de6386864.png)

3. Begränsa tokenens räckvidd till din förgrening av detta repositorium.

    ![Begränsa räckvidd till förgreningsrepo](../../../translated_images/sv/token_repository_limit.924ade5e11d9d8bb.png)
...
4. Begränsa tokenens behörigheter: Under **Behörigheter**, klicka på fliken **Konto**, och klicka på knappen "+ Lägg till behörigheter". En dropdown kommer att visas. Sök efter **Modeller** och markera rutan för det.
    ...
    ![Lägg till Modeller Behörighet](../../../translated_images/sv/add_models_permissions.c0c44ed8b40fc143.png)

5. Verifiera de behörigheter som krävs innan du genererar token. ![Verifiera Behörigheter](../../../translated_images/sv/verify_permissions.06bd9e43987a8b21.png)

6. Innan du genererar token, se till att du är redo att lagra token på en säker plats som ett lösenordshanteringsvalv, eftersom den inte kommer att visas igen efter att du skapat den. ![Lagra Token Säkert](../../../translated_images/sv/store_token_securely.08ee2274c6ad6caf.png)
...
![GitHub Token Fält](../../../translated_images/sv/github_token_field.20491ed3224b5f4a.png)
...
![Projektanslutningssträng](../../../translated_images/sv/project-endpoint.8cf04c9975bbfbf1.png)
