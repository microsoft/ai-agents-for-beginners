...
> ```
>
> 這樣可以更快速地下載你完成課程所需的所有內容。
<!-- CO-OP TRANSLATOR LANGUAGES TABLE END -->

**如需新增其他翻譯語言支持，請參考此處 [here](https://github.com/Azure/co-op-translator/blob/main/getting_started/supported-languages.md)**
...
本課程涵蓋構建 AI 代理的基礎知識。每節課程涵蓋獨立主題，可自由從任一課程開始！

本課程支援多語言。請參閱我們的[可用語言支持](../..)。

如果這是您第一次使用生成式 AI 模型，請參考我們的[新手生成式 AI 課程](https://aka.ms/genai-beginners)，內含 21 節如何使用生成式 AI 的課程。

別忘了[收藏（🌟）此倉庫](https://docs.github.com/en/get-started/exploring-projects-on-github/saving-repositories-with-stars?WT.mc_id=academic-105485-koreyst)及[分叉此倉庫](https://github.com/microsoft/ai-agents-for-beginners/fork)，以便運行程式碼。

### 與其他學習者交流、解決問題

若在建構 AI 代理時遇到問題或有任何疑問，請加入我們專屬的 Discord 頻道，位於 [Microsoft Foundry Discord](https://aka.ms/ai-agents/discord)。

### 您需要具備的條件

課程中每節課皆包含程式碼範例，位於 code_samples 資料夾。您可以[分叉本儲存庫](https://github.com/microsoft/ai-agents-for-beginners/fork)建立自己的副本。

本課程範例使用 Microsoft 代理框架與 Azure AI Foundry Agent Service V2：

- [Microsoft Foundry](https://aka.ms/ai-agents-beginners/ai-foundry) - 需要 Azure 帳戶

本課程使用 Microsoft 的以下 AI 代理框架及服務：

- [Microsoft Agent Framework (MAF)](https://aka.ms/ai-agents-beginners/agent-framewrok)
- [Azure AI Foundry Agent Service V2](https://aka.ms/ai-agents-beginners/ai-agent-service)

如需更多關於本課程程式碼執行資訊，請參閱[課程設定](./00-course-setup/README.md)。

## 🙏 想要幫忙嗎？

您有建議或發現拼寫、程式碼錯誤嗎？請[提出問題](https://github.com/microsoft/ai-agents-for-beginners/issues?WT.mc_id=academic-105485-koreyst)或[建立合併請求](https://github.com/microsoft/ai-agents-for-beginners/pulls?WT.mc_id=academic-105485-koreyst)。



## 📂 每堂課包含

- 位於 README 的文字教學與簡短影片
...
| **課程**                                    | **文字與程式碼**                                    | **影片**                                                    | **額外學習資源**                                                                       |
|----------------------------------------------|----------------------------------------------------|------------------------------------------------------------|----------------------------------------------------------------------------------------|
| AI 代理介紹與應用案例                        | [鏈結](./01-intro-to-ai-agents/README.md)          | [影片](https://youtu.be/3zgm60bXmQk?si=z8QygFvYQv-9WtO1)    | [鏈結](https://aka.ms/ai-agents-beginners/collection?WT.mc_id=academic-105485-koreyst)  |
| 探索 AI 代理框架                            | [鏈結](./02-explore-agentic-frameworks/README.md)  | [影片](https://youtu.be/ODwF-EZo_O8?si=Vawth4hzVaHv-u0H)    | [鏈結](https://aka.ms/ai-agents-beginners/collection?WT.mc_id=academic-105485-koreyst)  |
| 了解 AI 代理設計模式                        | [鏈結](./03-agentic-design-patterns/README.md)     | [影片](https://youtu.be/m9lM8qqoOEA?si=BIzHwzstTPL8o9GF)    | [鏈結](https://aka.ms/ai-agents-beginners/collection?WT.mc_id=academic-105485-koreyst)  |
| 工具使用設計模式                            | [鏈結](./04-tool-use/README.md)                    | [影片](https://youtu.be/vieRiPRx-gI?si=2z6O2Xu2cu_Jz46N)    | [鏈結](https://aka.ms/ai-agents-beginners/collection?WT.mc_id=academic-105485-koreyst)  |
| AI 代理 RAG                                | [鏈結](./05-agentic-rag/README.md)                 | [影片](https://youtu.be/WcjAARvdL7I?si=gKPWsQpKiIlDH9A3)    | [鏈結](https://aka.ms/ai-agents-beginners/collection?WT.mc_id=academic-105485-koreyst)  |
| 建立可信賴的 AI 代理                        | [鏈結](./06-building-trustworthy-agents/README.md) | [影片](https://youtu.be/iZKkMEGBCUQ?si=jZjpiMnGFOE9L8OK)    | [鏈結](https://aka.ms/ai-agents-beginners/collection?WT.mc_id=academic-105485-koreyst)  |
| 計畫設計模式                               | [鏈結](./07-planning-design/README.md)             | [影片](https://youtu.be/kPfJ2BrBCMY?si=6SC_iv_E5-mzucnC)    | [鏈結](https://aka.ms/ai-agents-beginners/collection?WT.mc_id=academic-105485-koreyst)  |
| 多代理設計模式                             | [鏈結](./08-multi-agent/README.md)                 | [影片](https://youtu.be/V6HpE9hZEx0?si=rMgDhEu7wXo2uo6g)    | [鏈結](https://aka.ms/ai-agents-beginners/collection?WT.mc_id=academic-105485-koreyst)  |
| 元認知設計模式                             | [鏈結](./09-metacognition/README.md)               | [影片](https://youtu.be/His9R6gw6Ec?si=8gck6vvdSNCt6OcF)    | [鏈結](https://aka.ms/ai-agents-beginners/collection?WT.mc_id=academic-105485-koreyst)  |
| AI Agents in Production                      | [連結](./10-ai-agents-production/README.md)        | [影片](https://youtu.be/l4TP6IyJxmQ?si=31dnhexRo6yLRJDl)  | [連結](https://aka.ms/ai-agents-beginners/collection?WT.mc_id=academic-105485-koreyst) |
| 使用 Agentic Protocols (MCP, A2A and NLWeb) | [連結](./11-agentic-protocols/README.md)           | [影片](https://youtu.be/X-Dh9R3Opn8)                                 | [連結](https://aka.ms/ai-agents-beginners/collection?WT.mc_id=academic-105485-koreyst) |
| AI Agents 的 Context Engineering             | [連結](./12-context-engineering/README.md)         | [影片](https://youtu.be/F5zqRV7gEag)                                 | [連結](https://aka.ms/ai-agents-beginners/collection?WT.mc_id=academic-105485-koreyst) |
...
感謝 [Shivam Goyal](https://www.linkedin.com/in/shivam2003/) 貢獻展示 Agentic RAG 重要範例程式碼。

## 貢獻

歡迎對本專案進行貢獻和建議。大多數貢獻需要您同意
貢獻者授權協議（CLA），聲明您擁有權利並確實授權我們使用您的貢獻。
詳情請見 <https://cla.opensource.microsoft.com>。

當您提交拉取請求時，CLA 機器人將自動判斷您是否需要提供
CLA，並對 PR 適當標示（例如，狀態檢查、評論）。請依照機器人的指示操作。
您只需在所有使用我們 CLA 的倉庫中執行此步驟一次。
...
聯絡 [opencode@microsoft.com](mailto:opencode@microsoft.com) 以詢問更多問題或意見。
...
修改版本中使用 Microsoft 商標或標誌，不得造成混淆或暗示微軟贊助。
...
**免責聲明**：  
本文件係使用 AI 翻譯服務 [Co-op Translator](https://github.com/Azure/co-op-translator) 進行翻譯。雖然我們力求準確，但請注意自動翻譯可能包含錯誤或不精確之處。原始文件以其母語版本為準，具有最高權威性。對於重要資訊，建議採用專業人工翻譯。我們不對因使用本翻譯而產生的任何誤解或曲解承擔責任。
