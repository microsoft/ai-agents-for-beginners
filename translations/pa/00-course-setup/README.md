...
![Forked Repo](../../../translated_images/pa/forked-repo.33f27ca1901baa6a.png)
...
1. **Developer settings** ਵਿੱਚ ਜਾ ਕੇ `Fine-grained tokens` ਵਿਕਲਪ ਚੁਣੋ।
   ...
   ![Developer settings](../../../translated_images/pa/profile_developer_settings.410a859fe749c755.png)

   ਫਿਰ `Generate new token` ਚੁਣੋ।

   ![Generate Token](../../../translated_images/pa/fga_new_token.1c1a234afe202ab3.png)
...
2. ਆਪਣੇ ਟੋਕਨ ਲਈ ਇੱਕ ਵਰਣਨਾਤਮਕ ਨਾਮ ਦਿਓ ਜੋ ਇਸਦੇ ਉਦੇਸ਼ ਨੂੰ ਦਰਸਾਉਂਦਾ ਹੋਵੇ, ਇਸਨੂੰ ਬਾਅਦ ਵਿੱਚ ਪਛਾਣਨਾ ਆਸਾਨ ਬਣਾਉਂਦਾ ਹੈ।
    ...
    ![Token Name and Expiration](../../../translated_images/pa/token-name-expiry-date.a095fb0de6386864.png)

3. ਟੋਕਨ ਦੀ ਸਕੋਪ ਨੂੰ ਇਸ ਰਿਪੋਜ਼ਟਰੀ ਦੇ ਫੋਰਕ ਤੱਕ ਸੀਮਿਤ ਕਰੋ।

    ![Limit scope to fork repository](../../../translated_images/pa/token_repository_limit.924ade5e11d9d8bb.png)
...
4. ਟੋਕਨ ਦੇ ਅਧਿਕਾਰਾਂ ਨੂੰ ਸੀਮਿਤ ਕਰੋ: **Permissions** ਦੇ ਅਧੀਨ, **Account** ਟੈਬ 'ਤੇ ਕਲਿੱਕ ਕਰੋ, ਅਤੇ "+ Add permissions" ਬਟਨ 'ਤੇ ਕਲਿੱਕ ਕਰੋ। ਇੱਕ ਡ੍ਰਾਪਡਾਊਨ ਪ੍ਰਗਟ ਹੋਵੇਗਾ। ਕਿਰਪਾ ਕਰਕੇ **Models** ਦੀ ਖੋਜ ਕਰੋ ਅਤੇ ਇਸਦੇ ਲਈ ਬਾਕਸ ਚੈੱਕ ਕਰੋ।
    ...
    ![Add Models Permission](../../../translated_images/pa/add_models_permissions.c0c44ed8b40fc143.png)

5. ਟੋਕਨ ਬਣਾਉਣ ਤੋਂ ਪਹਿਲਾਂ ਲੋੜੀਂਦੇ ਅਧਿਕਾਰਾਂ ਦੀ ਪੁਸ਼ਟੀ ਕਰੋ। ![Verify Permissions](../../../translated_images/pa/verify_permissions.06bd9e43987a8b21.png)

6. ਟੋਕਨ ਬਣਾਉਣ ਤੋਂ ਪਹਿਲਾਂ, ਯਕੀਨੀ ਬਣਾਓ ਕਿ ਤੁਸੀਂ ਟੋਕਨ ਨੂੰ ਸੁਰੱਖਿਅਤ ਜਗ੍ਹਾ ਜਿਵੇਂ ਕਿ ਪਾਸਵਰਡ ਮੈਨੇਜਰ ਵਾਲਟ ਵਿੱਚ ਸਟੋਰ ਕਰਨ ਲਈ ਤਿਆਰ ਹੋ, ਕਿਉਂਕਿ ਇਹ ਤੁਹਾਨੂੰ ਦੁਬਾਰਾ ਨਹੀਂ ਦਿਖਾਇਆ ਜਾਵੇਗਾ। ![Store Token Securely](../../../translated_images/pa/store_token_securely.08ee2274c6ad6caf.png)
...
![GitHub Token Field](../../../translated_images/pa/github_token_field.20491ed3224b5f4a.png)
...
![Project Connection String](../../../translated_images/pa/project-endpoint.8cf04c9975bbfbf1.png)
