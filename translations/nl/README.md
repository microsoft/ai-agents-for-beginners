...
![AI Agents voor Beginners](../../translated_images/nl/repo-thumbnailv2.06f4a48036fde647.webp)
...
>
> Deze repository bevat vertalingen in meer dan 50 talen, wat de downloadgrootte aanzienlijk vergroot. Om zonder vertalingen te klonen, gebruik je sparse checkout:
>
> **Bash / macOS / Linux:**
> ```bash
...
**Als je wilt dat er meer vertaaltalen worden ondersteund, zijn deze hier te vinden: [hier](https://github.com/Azure/co-op-translator/blob/main/getting_started/supported-languages.md).**
...
Als dit je eerste keer is dat je werkt met Generatieve AI-modellen, bekijk dan onze cursus [Generative AI Voor Beginners](https://aka.ms/genai-beginners), die 21 lessen bevat over bouwen met GenAI.
...
Heb je suggesties of vond je spelfouten of codefouten? [Maak een issue aan](https://github.com/microsoft/ai-agents-for-beginners/issues?WT.mc_id=academic-105485-koreyst) of [maak een pull request](https://github.com/microsoft/ai-agents-for-beginners/pulls?WT.mc_id=academic-105485-koreyst)
...
- Python-codevoorbeelden met Microsoft Agent Framework en Microsoft Foundry
...
| Vertrouwbare AI Agents Bouwen                  | [Link](./06-building-trustworthy-agents/README.md) | [Video](https://youtu.be/iZKkMEGBCUQ?si=jZjpiMnGFOE9L8OK ) | [Link](https://aka.ms/ai-agents-beginners/collection?WT.mc_id=academic-105485-koreyst) |
...
| Gebruik van Agentgebaseerde Protocollen (MCP, A2A en NLWeb) | [Link](./11-agentic-protocols/README.md)           | [Video](https://youtu.be/X-Dh9R3Opn8)                                 | [Link](https://aka.ms/ai-agents-beginners/collection?WT.mc_id=academic-105485-koreyst) |
...
| Bouwen van Computer Gebruik Agents (CUA)           | [Link](./15-browser-use/README.md)     |                                                            | [Link](https://docs.browser-use.com/examples/templates/playwright-integration)         |
| Schalen van Agents                    | Binnenkort Beschikbaar                            |                                                            |                                                                                        |
| Creëren van Lokale AI Agents                     | Binnenkort Beschikbaar                               |                                                            |                                                                                        |
| Beveiligen van AI Agents                           | [Link](./18-securing-ai-agents/README.md)  |                                                            | [Link](https://aka.ms/ai-agents-beginners/collection?WT.mc_id=academic-105485-koreyst) |
...
Contributor License Agreement (CLA) waarin u verklaart dat u het recht hebt om, en daadwerkelijk doet, ons
de rechten geeft om uw bijdrage te gebruiken. Voor details, bezoek <https://cla.opensource.microsoft.com>.

Wanneer u een pull request indient, zal een CLA-bot automatisch bepalen of u een
CLA moet aanleveren en zal de PR dienovereenkomstig markeren (bijv. statuscontrole, opmerking). Volg gewoon de instructies
die door de bot worden gegeven. U hoeft dit slechts één keer te doen voor alle repos die onze CLA gebruiken.
...
Dit project kan handelsmerken of logo's bevatten voor projecten, producten of diensten. Het geautoriseerde gebruik van Microsoft
handelsmerken of logo's is onderhevig aan en moet volgen
[Microsofts Handelsmerk & Merkrichtlijnen](https://www.microsoft.com/legal/intellectualproperty/trademarks/usage/general).
...
Als u vastloopt of vragen hebt over het bouwen van AI-apps, sluit aan bij:
