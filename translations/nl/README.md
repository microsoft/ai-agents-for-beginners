...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-08-21T12:29:39+00:00",
...
**Als je extra vertalingen wilt toevoegen, bekijk dan de beschikbare talen [hier](https://github.com/Azure/co-op-translator/blob/main/getting_started/supported-languages.md)**
...
Deze cursus bevat 11 lessen die de basisprincipes van het bouwen van AI Agents behandelen. Elke les heeft een eigen onderwerp, dus je kunt beginnen waar je wilt!
...
Vergeet niet om [deze repo te sterven (🌟)](https://docs.github.com/en/get-started/exploring-projects-on-github/saving-repositories-with-stars?WT.mc_id=academic-105485-koreyst) en [deze repo te forken](https://github.com/microsoft/ai-agents-for-beginners/fork) om de code uit te voeren.
...
De codevoorbeelden in deze oefeningen maken gebruik van Azure AI Foundry en GitHub Model Catalogs om te werken met Language Models:
...
Als je productfeedback hebt of fouten tegenkomt tijdens het bouwen, bezoek dan ons [Azure AI Foundry Developer Forum](https://aka.ms/azureaifoundry/forum).
...
|------------------------------------------|---------------------------------------------------|------------------------------------------------------------|-------------------------------------------------------------------------------------|
| Introductie tot AI Agents en Use Cases   | [Link](./01-intro-to-ai-agents/README.md)         | [Video](https://youtu.be/3zgm60bXmQk?si=z8QygFvYQv-9WtO1)  | [Link](https://aka.ms/ai-agents-beginners/collection?WT.mc_id=academic-105485-koreyst) |
...
- [GitHub Copilot Beheersen voor AI Pair Programming](https://aka.ms/GitHubCopilotAI?WT.mc_id=academic-105485-koreyst)  
