...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-10-24T09:05:36+00:00",
...
Er is ondersteuning voor meerdere talen beschikbaar voor deze cursus. Bekijk onze [beschikbare talen hier](../..).

Als dit je eerste keer is dat je werkt met Generatieve AI-modellen, bekijk dan onze [Generatieve AI Voor Beginners](https://aka.ms/genai-beginners) cursus, die 21 lessen bevat over het werken met GenAI.

Vergeet niet om [deze repository te sterven (🌟)](https://docs.github.com/en/get-started/exploring-projects-on-github/saving-repositories-with-stars?WT.mc_id=academic-105485-koreyst) en [deze repository te forken](https://github.com/microsoft/ai-agents-for-beginners/fork) om de code uit te voeren.
...
Elke les in deze cursus bevat codevoorbeelden, die te vinden zijn in de map code_samples. Je kunt [deze repository forken](https://github.com/microsoft/ai-agents-for-beginners/fork) om je eigen kopie te maken.
...
Heb je suggesties of fouten in de spelling of code gevonden? [Meld een probleem](https://github.com/microsoft/ai-agents-for-beginners/issues?WT.mc_id=academic-105485-koreyst) of [Maak een pull request aan](https://github.com/microsoft/ai-agents-for-beginners/pulls?WT.mc_id=academic-105485-koreyst).
...
|----------------------------------------------|--------------------------------------------------|------------------------------------------------------------|--------------------------------------------------------------------------------------|
| Introductie tot AI Agents en gebruikstoepassingen | [Link](./01-intro-to-ai-agents/README.md)        | [Video](https://youtu.be/3zgm60bXmQk?si=z8QygFvYQv-9WtO1)  | [Link](https://aka.ms/ai-agents-beginners/collection?WT.mc_id=academic-105485-koreyst) |
...
| Begrijpen van AI Agentic Ontwerpprincipes    | [Link](./03-agentic-design-patterns/README.md)   | [Video](https://youtu.be/m9lM8qqoOEA?si=BIzHwzstTPL8o9GF)  | [Link](https://aka.ms/ai-agents-beginners/collection?WT.mc_id=academic-105485-koreyst) |
| Toolgebruik Ontwerpprincipe                  | [Link](./04-tool-use/README.md)                  | [Video](https://youtu.be/vieRiPRx-gI?si=2z6O2Xu2cu_Jz46N)  | [Link](https://aka.ms/ai-agents-beginners/collection?WT.mc_id=academic-105485-koreyst) |
...
| Planningsontwerpprincipe                     | [Link](./07-planning-design/README.md)           | [Video](https://youtu.be/kPfJ2BrBCMY?si=6SC_iv_E5-mzucnC)  | [Link](https://aka.ms/ai-agents-beginners/collection?WT.mc_id=academic-105485-koreyst) |
| Multi-Agent Ontwerpprincipe                  | [Link](./08-multi-agent/README.md)               | [Video](https://youtu.be/V6HpE9hZEx0?si=rMgDhEu7wXo2uo6g)  | [Link](https://aka.ms/ai-agents-beginners/collection?WT.mc_id=academic-105485-koreyst) |
| Metacognitie Ontwerpprincipe                 | [Link](./09-metacognition/README.md)             | [Video](https://youtu.be/His9R6gw6Ec?si=8gck6vvdSNCt6OcF)  | [Link](https://aka.ms/ai-agents-beginners/collection?WT.mc_id=academic-105485-koreyst) |
...
| Gebruik van Agentic Protocols (MCP, A2A en NLWeb) | [Link](./11-agentic-protocols/README.md)           | [Video](https://youtu.be/X-Dh9R3Opn8)                                 | [Link](https://aka.ms/ai-agents-beginners/collection?WT.mc_id=academic-105485-koreyst) |
...
| Bouwen van Computergebruik Agents (CUA)          | Binnenkort beschikbaar                            |                                                            |                                                                                        |
| Schaalbare Agents implementeren                  | Binnenkort beschikbaar                            |                                                            |                                                                                        |
| Lokale AI Agents creëren                         | Binnenkort beschikbaar                               |                                                            |                                                                                        |
...
Contributor License Agreement (CLA) waarin je verklaart dat je het recht hebt om, en daadwerkelijk doet, ons de rechten te geven
om jouw bijdrage te gebruiken. Voor details, bezoek <https://cla.opensource.microsoft.com>.
