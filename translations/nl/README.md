...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-12-17T11:38:36+00:00",
...
**Als je wilt dat er extra vertalingen worden ondersteund, staan deze vermeld [hier](https://github.com/Azure/co-op-translator/blob/main/getting_started/supported-languages.md)**
...
Als dit je eerste keer is dat je bouwt met Generatieve AI-modellen, bekijk dan onze cursus [Generatieve AI Voor Beginners](https://aka.ms/genai-beginners), die 21 lessen bevat over bouwen met GenAI.
...
De codevoorbeelden in deze oefeningen maken gebruik van Azure AI Foundry en GitHub Model Catalogi voor interactie met taalmodellen:
...
Heb je suggesties of spelling- of codefouten gevonden? [Meld een issue](https://github.com/microsoft/ai-agents-for-beginners/issues?WT.mc_id=academic-105485-koreyst) of [Maak een pull request](https://github.com/microsoft/ai-agents-for-beginners/pulls?WT.mc_id=academic-105485-koreyst)
...
| Verkennen van het Microsoft Agent Framework                         | [Link](./14-microsoft-agent-framework/README.md)                            |                                                            |                                                                                        |
