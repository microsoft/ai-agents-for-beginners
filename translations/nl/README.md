...
**Als je wilt dat er extra vertaaltalen worden ondersteund, staan ze [hier](https://github.com/Azure/co-op-translator/blob/main/getting_started/supported-languages.md) vermeld.**
...
Als dit je eerste keer is dat je bouwt met Generatieve AI-modellen, bekijk dan onze cursus [Generative AI For Beginners](https://aka.ms/genai-beginners), die 21 lessen bevat over het bouwen met GenAI.

Vergeet niet om [deze repo te sterren (🌟)](https://docs.github.com/en/get-started/exploring-projects-on-github/saving-repositories-with-stars?WT.mc_id=academic-105485-koreyst) en [deze repo te fork-en](https://github.com/microsoft/ai-agents-for-beginners/fork) om de code uit te voeren.

### Ontmoet Andere Leerlingen, Krijg Je Vragen Beantwoord

Als je vastloopt of vragen hebt over het bouwen van AI Agents, sluit je dan aan bij onze speciale Discord-kanaal in de [Microsoft Foundry Discord](https://aka.ms/ai-agents/discord).

### Wat Je Nodig Hebt

Elke les in deze cursus bevat codevoorbeelden, die te vinden zijn in de code_samples map. Je kan [deze repo fork-en](https://github.com/microsoft/ai-agents-for-beginners/fork) om je eigen kopie te maken.  

De codevoorbeelden in deze oefeningen gebruiken Microsoft Agent Framework met Microsoft Foundry Agent Service V2:

- [Microsoft Foundry](https://aka.ms/ai-agents-beginners/ai-foundry) - Azure-account vereist

Deze cursus gebruikt de volgende AI Agent-frameworks en -diensten van Microsoft:

- [Microsoft Agent Framework (MAF)](https://learn.microsoft.com/agent-framework/overview/)
- [Microsoft Foundry Agent Service V2](https://aka.ms/ai-agents-beginners/ai-agent-service)

Sommige codevoorbeelden ondersteunen ook alternatieve OpenAI-compatibele providers zoals [MiniMax](https://platform.minimaxi.com/), die modellen met een grote context bieden (tot 204K tokens). Zie de [Cursus Setup](./00-course-setup/README.md) voor configuratiedetails.

Voor meer informatie over het draaien van de code voor deze cursus, ga naar de [Cursus Setup](./00-course-setup/README.md).

## 🙏 Wil je Helpen?

Heb je suggesties of heb je spelfouten of codefouten gevonden? [Meld een issue](https://github.com/microsoft/ai-agents-for-beginners/issues?WT.mc_id=academic-105485-koreyst) of [Maak een pull request](https://github.com/microsoft/ai-agents-for-beginners/pulls?WT.mc_id=academic-105485-koreyst)
...
- Python codevoorbeelden die Microsoft Agent Framework gebruiken met Microsoft Foundry
...
| Verkenning van AI Agentic Frameworks           | [Link](./02-explore-agentic-frameworks/README.md)  | [Video](https://youtu.be/ODwF-EZo_O8?si=Vawth4hzVaHv-u0H)  | [Link](https://aka.ms/ai-agents-beginners/collection?WT.mc_id=academic-105485-koreyst) |
| Begrip van AI Agentic Ontwerppatronen           | [Link](./03-agentic-design-patterns/README.md)     | [Video](https://youtu.be/m9lM8qqoOEA?si=BIzHwzstTPL8o9GF)  | [Link](https://aka.ms/ai-agents-beginners/collection?WT.mc_id=academic-105485-koreyst) |
| Toolgebruik Ontwerppatroon                       | [Link](./04-tool-use/README.md)                    | [Video](https://youtu.be/vieRiPRx-gI?si=2z6O2Xu2cu_Jz46N)  | [Link](https://aka.ms/ai-agents-beginners/collection?WT.mc_id=academic-105485-koreyst) |
...
| Het Gebruik van Agent-protocollen (MCP, A2A en NLWeb) | [Link](./11-agentic-protocols/README.md)           | [Video](https://youtu.be/X-Dh9R3Opn8)                                 | [Link](https://aka.ms/ai-agents-beginners/collection?WT.mc_id=academic-105485-koreyst) |
...
| Het Bouwen van Computer Gebruik Agenten (CUA)           | [Link](./15-browser-use/README.md)     |                                                            | [Link](https://docs.browser-use.com/examples/templates/playwright-integration)         |
| Implementatie van Schaalbare Agenten                    | [Link](./16-deploying-scalable-agents/README.md) |                                                    | [Link](https://learn.microsoft.com/azure/ai-foundry/agents/overview)                   |
| Het Creëren van Lokale AI Agenten                     | [Link](./17-creating-local-ai-agents/README.md)  |                                                    | [Link](https://learn.microsoft.com/azure/ai-foundry/foundry-local/)                    |
| Beveiliging van AI Agenten                           | [Link](./18-securing-ai-agents/README.md)  |                                                            | [Link](https://aka.ms/ai-agents-beginners/collection?WT.mc_id=academic-105485-koreyst) |
...
Contributor License Agreement (CLA) waarin verklaard wordt dat je het recht hebt om, en daadwerkelijk doet,
ons de rechten verleent om je bijdrage te gebruiken. Voor details, bezoek <https://cla.opensource.microsoft.com>.

Wanneer je een pull request indient, bepaalt een CLA-bot automatisch of je een CLA moet verstrekken
en voorziet het PR indien nodig van de juiste markeringen (bijv. statuscontrole, commentaar). Volg gewoon de instructies
die door de bot worden gegeven. Dit hoef je maar één keer te doen voor alle repos die onze CLA gebruiken.

Dit project heeft de [Microsoft Open Source Gedragscode](https://opensource.microsoft.com/codeofconduct/) aangenomen.
Voor meer informatie zie de [FAQ Gedragscode](https://opensource.microsoft.com/codeofconduct/faq/) of
...
Gebruik van Microsoft handelsmerken of logo's in gewijzigde versies van dit project mag geen verwarring veroorzaken of Microsoft sponsorship impliceren.
Elk gebruik van handelsmerken of logo's van derden is onderhevig aan de beleidsregels van die derden.
