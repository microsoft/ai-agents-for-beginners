...
## Een cursus waarin alles wordt uitgelegd wat je moet weten om AI-agents te bouwen
...
**Als je extra vertalingen wenst, zijn de ondersteunde talen hier te vinden [hier](https://github.com/Azure/co-op-translator/blob/main/getting_started/supported-languages.md)**
...
Als dit je eerste keer is dat je bouwt met generatieve AI-modellen, bekijk dan onze cursus [Generative AI For Beginners](https://aka.ms/genai-beginners), met 21 lessen over bouwen met GenAI.
...
Voor meer informatie over het draaien van de code bij deze cursus, ga naar de [Course Setup](./00-course-setup/README.md).

## 🙏 Wil je helpen?

Heb je suggesties of spelling- of codefouten gevonden? [Meld een issue](https://github.com/microsoft/ai-agents-for-beginners/issues?WT.mc_id=academic-105485-koreyst) of [maak een pull request aan](https://github.com/microsoft/ai-agents-for-beginners/pulls?WT.mc_id=academic-105485-koreyst)
...
- Links naar extra bronnen om je verdere leerproces te ondersteunen
...
|----------------------------------------------|----------------------------------------------------|------------------------------------------------------------|-----------------------------------------------------------------------------------------|
| Introductie tot AI-agenten en agent-use cases | [Link](./01-intro-to-ai-agents/README.md)          | [Video](https://youtu.be/3zgm60bXmQk?si=z8QygFvYQv-9WtO1)  | [Link](https://aka.ms/ai-agents-beginners/collection?WT.mc_id=academic-105485-koreyst)   |
...
| Betrouwbare AI-agenten bouwen                 | [Link](./06-building-trustworthy-agents/README.md) | [Video](https://youtu.be/iZKkMEGBCUQ?si=jZjpiMnGFOE9L8OK ) | [Link](https://aka.ms/ai-agents-beginners/collection?WT.mc_id=academic-105485-koreyst)   |
...
| Beheren van Agentisch Geheugen                      | [Link](./13-agent-memory/README.md)     |      [Video](https://youtu.be/QrYbHesIxpw?si=vZkVwKrQ4ieCcIPx)                                                      |                                                                                        |
| Verkenning van Microsoft Agent Framework                         | [Link](./14-microsoft-agent-framework/README.md)                            |                                                            |                                                                                        |
| Bouwen van Computer Use Agents (CUA)           | Binnenkort beschikbaar                            |                                                            |                                                                                        |
| Uitrollen van Schaalbare Agents                    | Binnenkort beschikbaar                            |                                                            |                                                                                        |
| Creëren van Lokale AI Agents                     | Binnenkort beschikbaar                               |                                                            |                                                                                        |
| Beveiligen van AI Agents                           | Binnenkort beschikbaar                               |                                                            |                                                                                        |
...
Contributor License Agreement (CLA) waarin je verklaart dat je het recht hebt om, en daadwerkelijk doet, ons de
rechten te verlenen om je bijdrage te gebruiken. Voor details, bezoek <https://cla.opensource.microsoft.com>.

Wanneer je een pull request indient, zal een CLA-bot automatisch bepalen of je een
CLA moet verstrekken en het PR dienovereenkomstig markeren (bijv. statuscontrole, commentaar). Volg gewoon de instructies
...
Dit project kan handelsmerken of logo’s bevatten van projecten, producten, of diensten. Gerechtigd gebruik van Microsoft
...
Als je productfeedback hebt of fouten bij het bouwen, bezoek dan:
...
**Disclaimer**:
Dit document is vertaald met behulp van de AI-vertalingsdienst [Co-op Translator](https://github.com/Azure/co-op-translator). Hoewel we streven naar nauwkeurigheid, verzoeken wij u er rekening mee te houden dat automatische vertalingen fouten of onnauwkeurigheden kunnen bevatten. Het originele document in de oorspronkelijke taal dient beschouwd te worden als de gezaghebbende bron. Voor cruciale informatie wordt professionele menselijke vertaling aanbevolen. Wij zijn niet aansprakelijk voor enige misverstanden of verkeerd interpreteren die voortvloeien uit het gebruik van deze vertaling.
