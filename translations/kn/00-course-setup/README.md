...
![Forked Repo](../../../translated_images/kn/forked-repo.33f27ca1901baa6a.png)
...
1. **Developer settings** ಗೆ ಹೋಗಿ, ಎಡಭಾಗದಲ್ಲಿ `Fine-grained tokens` ಆಯ್ಕೆಯನ್ನು ಆಯ್ಕೆಮಾಡಿ.
   ...
   ![Developer settings](../../../translated_images/kn/profile_developer_settings.410a859fe749c755.png)

   ನಂತರ `Generate new token` ಆಯ್ಕೆಮಾಡಿ.

   ![Generate Token](../../../translated_images/kn/fga_new_token.1c1a234afe202ab3.png)
...
2. ನಿಮ್ಮ ಟೋಕನ್‌ಗೆ ವಿವರಣಾತ್ಮಕ ಹೆಸರನ್ನು ನಮೂದಿಸಿ, ಇದು ಅದರ ಉದ್ದೇಶವನ್ನು ಪ್ರತಿಬಿಂಬಿಸುತ್ತದೆ, ನಂತರದಲ್ಲಿ ಅದನ್ನು ಗುರುತಿಸಲು ಸುಲಭವಾಗುತ್ತದೆ.
    ...
    ![Token Name and Expiration](../../../translated_images/kn/token-name-expiry-date.a095fb0de6386864.png)

3. ಟೋಕನ್‌ನ ವ್ಯಾಪ್ತಿಯನ್ನು ಈ ರೆಪೊ ಫೋರ್ಕ್‌ಗೆ ಮಾತ್ರ ಮಿತಿಗೊಳಿಸಿ.

    ![Limit scope to fork repository](../../../translated_images/kn/token_repository_limit.924ade5e11d9d8bb.png)
...
4. ಟೋಕನ್‌ನ ಅನುಮತಿಗಳನ್ನು ನಿರ್ಬಂಧಿಸಿ: **Permissions** ಅಡಿಯಲ್ಲಿ, **Account** ಟ್ಯಾಬ್ ಕ್ಲಿಕ್ ಮಾಡಿ, ಮತ್ತು "+ Add permissions" ಬಟನ್ ಕ್ಲಿಕ್ ಮಾಡಿ. ಡ್ರಾಪ್‌ಡೌನ್ ಕಾಣಿಸುತ್ತದೆ. **Models** ಅನ್ನು ಹುಡುಕಿ ಮತ್ತು ಅದರ ಬಾಕ್ಸ್ ಅನ್ನು ಟಿಕ್ ಮಾಡಿ.
    ...
    ![Add Models Permission](../../../translated_images/kn/add_models_permissions.c0c44ed8b40fc143.png)

5. ಟೋಕನ್ ರಚಿಸುವ ಮೊದಲು ಅಗತ್ಯವಿರುವ ಅನುಮತಿಗಳನ್ನು ಪರಿಶೀಲಿಸಿ. ![Verify Permissions](../../../translated_images/kn/verify_permissions.06bd9e43987a8b21.png)

6. ಟೋಕನ್ ರಚಿಸುವ ಮೊದಲು, ನೀವು ಟೋಕನ್ ಅನ್ನು ಪಾಸ್ವರ್ಡ್ ಮ್ಯಾನೇಜರ್ ವಾಲ್ಟ್‌ನಂತಹ ಸುರಕ್ಷಿತ ಸ್ಥಳದಲ್ಲಿ ಸಂಗ್ರಹಿಸಲು ಸಿದ್ಧರಾಗಿದ್ದೀರಿ ಎಂದು ಖಚಿತಪಡಿಸಿಕೊಳ್ಳಿ, ಏಕೆಂದರೆ ನೀವು ಅದನ್ನು ರಚಿಸಿದ ನಂತರ ಮತ್ತೆ ತೋರಿಸಲಾಗುವುದಿಲ್ಲ. ![Store Token Securely](../../../translated_images/kn/store_token_securely.08ee2274c6ad6caf.png)
...
![GitHub Token Field](../../../translated_images/kn/github_token_field.20491ed3224b5f4a.png)
...
![Project Connection String](../../../translated_images/kn/project-endpoint.8cf04c9975bbfbf1.png)
