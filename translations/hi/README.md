...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-12-19T08:32:52+00:00",
...
## एक कोर्स जो आपको एआई एजेंट्स बनाने की शुरुआत करने के लिए सब कुछ सिखाता है
...
यदि यह आपकी पहली बार जनरेटिव एआई मॉडल के साथ निर्माण है, तो हमारा [शुरुआती लोगों के लिए जनरेटिव एआई](https://aka.ms/genai-beginners) कोर्स देखें, जिसमें GenAI के साथ निर्माण पर 21 पाठ शामिल हैं।
...
अपने योगदान का उपयोग करने के अधिकार हैं और आप हमें वे अधिकार प्रदान करते हैं। विवरण के लिए देखें <https://cla.opensource.microsoft.com>।
