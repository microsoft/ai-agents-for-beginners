...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-08-21T12:10:33+00:00",
...
इस कोर्स में AI एजेंट्स बनाने की मूल बातें कवर करने वाले 11 पाठ हैं। प्रत्येक पाठ एक अलग विषय को कवर करता है, इसलिए आप कहीं से भी शुरू कर सकते हैं!
...
[इस रिपॉजिटरी को स्टार (🌟) करें](https://docs.github.com/en/get-started/exploring-projects-on-github/saving-repositories-with-stars?WT.mc_id=academic-105485-koreyst) और [इस रिपॉजिटरी को फोर्क करें](https://github.com/microsoft/ai-agents-for-beginners/fork) ताकि आप कोड चला सकें।

### आपको क्या चाहिए

इस कोर्स के प्रत्येक पाठ में कोड उदाहरण शामिल हैं, जो code_samples फोल्डर में पाए जा सकते हैं। आप [इस रिपॉजिटरी को फोर्क करें](https://github.com/microsoft/ai-agents-for-beginners/fork) और अपनी कॉपी बनाएं।
...
यदि आपके पास उत्पाद प्रतिक्रिया है या निर्माण के दौरान कोई त्रुटि आती है, तो हमारे [Azure AI Foundry Developer Forum](https://aka.ms/azureaifoundry/forum) पर जाएं।
...
| AI एजेंटिक फ्रेमवर्क्स की खोज             | [लिंक](./02-explore-agentic-frameworks/README.md)| [वीडियो](https://youtu.be/ODwF-EZo_O8?si=Vawth4hzVaHv-u0H)  | [लिंक](https://aka.ms/ai-agents-beginners/collection?WT.mc_id=academic-105485-koreyst)   |
...
[शिवम गोयल](https://www.linkedin.com/in/shivam2003/) का धन्यवाद, जिन्होंने Agentic RAG को दर्शाने वाले महत्वपूर्ण कोड नमूने प्रदान किए। 

## योगदान

यह प्रोजेक्ट योगदान और सुझावों का स्वागत करता है। अधिकांश योगदानों के लिए आपको एक 
Contributor License Agreement (CLA) से सहमत होना होगा, जिसमें यह घोषित किया जाएगा कि आपके पास अधिकार हैं और आप हमें अपने योगदान का उपयोग करने का अधिकार प्रदान करते हैं। अधिक जानकारी के लिए देखें 
...
[opencode@microsoft.com](mailto:opencode@microsoft.com) पर संपर्क करें यदि आपके पास कोई अतिरिक्त प्रश्न या टिप्पणियां हों।
