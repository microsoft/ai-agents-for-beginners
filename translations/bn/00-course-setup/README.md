...
![Forked Repo](../../../translated_images/bn/forked-repo.33f27ca1901baa6a.png)
...
1. **Developer settings** এ গিয়ে বাম পাশে `Fine-grained tokens` অপশনটি নির্বাচন করুন।
   ...
   ![Developer settings](../../../translated_images/bn/profile_developer_settings.410a859fe749c755.png)

   তারপর `Generate new token` নির্বাচন করুন।

   ![Generate Token](../../../translated_images/bn/fga_new_token.1c1a234afe202ab3.png)
...
2. আপনার টোকেনের জন্য একটি বর্ণনামূলক নাম লিখুন যা এর উদ্দেশ্য প্রতিফলিত করে, যাতে এটি পরে সহজে চিহ্নিত করা যায়।
    ...
    ![Token Name and Expiration](../../../translated_images/bn/token-name-expiry-date.a095fb0de6386864.png)

3. টোকেনের স্কোপ আপনার এই রিপোজিটরির ফর্কে সীমাবদ্ধ করুন।

    ![Limit scope to fork repository](../../../translated_images/bn/token_repository_limit.924ade5e11d9d8bb.png)
...
4. টোকেনের অনুমতিগুলি সীমিত করুন: **Permissions** এর অধীনে **Account** ট্যাবে ক্লিক করুন এবং "+ Add permissions" বোতামে ক্লিক করুন। একটি ড্রপডাউন প্রদর্শিত হবে। অনুগ্রহ করে **Models** অনুসন্ধান করুন এবং এর জন্য বক্সটি চেক করুন।
    ...
    ![Add Models Permission](../../../translated_images/bn/add_models_permissions.c0c44ed8b40fc143.png)

5. টোকেন তৈরি করার আগে প্রয়োজনীয় অনুমতিগুলি যাচাই করুন। ![Verify Permissions](../../../translated_images/bn/verify_permissions.06bd9e43987a8b21.png)

6. টোকেন তৈরি করার আগে নিশ্চিত করুন যে আপনি এটি একটি নিরাপদ স্থানে সংরক্ষণ করতে প্রস্তুত, যেমন একটি পাসওয়ার্ড ম্যানেজার ভল্ট, কারণ এটি তৈরি করার পরে আবার দেখানো হবে না। ![Store Token Securely](../../../translated_images/bn/store_token_securely.08ee2274c6ad6caf.png)
...
![GitHub Token Field](../../../translated_images/bn/github_token_field.20491ed3224b5f4a.png)
...
![Project Connection String](../../../translated_images/bn/project-endpoint.8cf04c9975bbfbf1.png)
