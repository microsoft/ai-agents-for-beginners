...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-11-11T10:52:01+00:00",
  "source_file": "README.md",
  "language_code": "fa"
}
-->
# دوره آموزش عوامل هوش مصنوعی برای مبتدیان

![هوش مصنوعی تولیدی برای مبتدیان](../../translated_images/repo-thumbnailv2.06f4a48036fde647f6ba4eb19f5651babe59bb30e972748afb349e47725d7601.fa.png)
...
اگر اولین بار است که با مدل‌های هوش مصنوعی تولیدی کار می‌کنید، دوره [هوش مصنوعی تولیدی برای مبتدیان](https://aka.ms/genai-beginners) را بررسی کنید که شامل ۲۱ درس در مورد ساخت با GenAI است.
...
اگر در ساخت عوامل هوش مصنوعی به مشکل برخوردید یا سوالی داشتید، به کانال اختصاصی دیسکورد ما در [جامعه دیسکورد Azure AI Foundry](https://aka.ms/ai-agents/discord) بپیوندید.

### چه چیزی نیاز دارید

هر درس در این دوره شامل نمونه‌های کد است که در پوشه code_samples قابل دسترسی هستند. شما می‌توانید [این مخزن را فورک کنید](https://github.com/microsoft/ai-agents-for-beginners/fork) تا نسخه‌ای از آن را برای خود ایجاد کنید.
...
آیا پیشنهادی دارید یا خطاهای املایی یا کدی پیدا کرده‌اید؟ [یک مشکل مطرح کنید](https://github.com/microsoft/ai-agents-for-beginners/issues?WT.mc_id=academic-105485-koreyst) یا [یک درخواست کشیدن ایجاد کنید](https://github.com/microsoft/ai-agents-for-beginners/pulls?WT.mc_id=academic-105485-koreyst).
...
این پروژه از مشارکت‌ها و پیشنهادات استقبال می‌کند. بیشتر مشارکت‌ها نیاز دارند که شما توافقنامه مجوز مشارکت‌کننده (CLA) را امضا کنید که اعلام می‌کند شما حق دارید و واقعاً حقوق استفاده از مشارکت خود را به ما اعطا می‌کنید. برای جزئیات، به <https://cla.opensource.microsoft.com> مراجعه کنید.
...
اگر بازخورد محصول دارید یا در هنگام ساخت خطاهایی رخ داد، به اینجا مراجعه کنید:
