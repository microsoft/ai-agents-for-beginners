...
[![خوش آمدید درخواست‌های کشش](https://img.shields.io/badge/PRs-welcome-brightgreen.svg?style=flat-square)](http://makeapullrequest.com?WT.mc_id=academic-105485-koreyst)
...
>
> این مخزن شامل ترجمه‌هایی به بیش از ۵۰ زبان است که به طور قابل توجهی حجم دانلود را افزایش می‌دهد. برای کلون بدون ترجمه‌ها، از sparse checkout استفاده کنید:
>
> **Bash / macOS / Linux:**
> ```bash
...
> ```
>
> این همه چیز لازم برای تکمیل دوره را با دانلود بسیار سریع‌تر در اختیار شما قرار می‌دهد.
<!-- CO-OP TRANSLATOR LANGUAGES TABLE END -->

**اگر مایلید زبان‌های ترجمه اضافی پشتیبانی شوند، در اینجا فهرست شده‌اند [here](https://github.com/Azure/co-op-translator/blob/main/getting_started/supported-languages.md)**
...
[![شعب GitHub](https://img.shields.io/github/forks/microsoft/ai-agents-for-beginners.svg?style=social&label=Fork)](https://GitHub.com/microsoft/ai-agents-for-beginners/network/?WT.mc_id=academic-105485-koreyst)
...
این دوره شامل درس‌هایی است که اصول ساخت عوامل هوش مصنوعی را پوشش می‌دهد. هر درس موضوع خاص خود را پوشش می‌دهد، بنابراین هر جایی که دوست داشتید شروع کنید!

برای این دوره، پشتیبانی چندزبانه وجود دارد. به بخش [زبان‌های موجود اینجا](../..) مراجعه کنید.

اگر برای اولین بار با مدل‌های هوش مصنوعی مولد کار می‌کنید، دوره [هوش مصنوعی مولد برای مبتدیان](https://aka.ms/genai-beginners) ما را بررسی کنید که شامل ۲۱ درس در ساخت با GenAI است.

فراموش نکنید که به این مخزن [ستاره (🌟) دهید](https://docs.github.com/en/get-started/exploring-projects-on-github/saving-repositories-with-stars?WT.mc_id=academic-105485-koreyst) و این مخزن را [فورک کنید](https://github.com/microsoft/ai-agents-for-beginners/fork) تا کد را اجرا کنید.

### ملاقات با دیگر یادگیرندگان، پاسخ گرفتن به سوالات خود

اگر گیر کردید یا سوالی درباره ساخت عوامل هوش مصنوعی داشتید، به کانال دیسکورد اختصاصی ما در [Microsoft Foundry Discord](https://aka.ms/ai-agents/discord) بپیوندید.

### آنچه نیاز دارید

هر درس در این دوره شامل مثال‌های کد است که می‌توانید در پوشه code_samples پیدا کنید. می‌توانید [این مخزن را فورک کنید](https://github.com/microsoft/ai-agents-for-beginners/fork) تا نسخه خود را بسازید.

مثال‌های کد در این تمرین‌ها از فریمورک Microsoft Agent با سرویس Azure AI Foundry Agent نسخه ۲ استفاده می‌کنند:

- [Microsoft Foundry](https://aka.ms/ai-agents-beginners/ai-foundry) - نیاز به حساب Azure

این دوره از فریمورک‌ها و سرویس‌های عوامل هوش مصنوعی زیر از مایکروسافت استفاده می‌کند:

- [Microsoft Agent Framework (MAF)](https://aka.ms/ai-agents-beginners/agent-framewrok)
- [Azure AI Foundry Agent Service V2](https://aka.ms/ai-agents-beginners/ai-agent-service)

برای اطلاعات بیشتر درباره اجرای کد این دوره به بخش [راه‌اندازی دوره](./00-course-setup/README.md) مراجعه کنید.

## 🙏 می‌خواهید کمک کنید؟

اگر پیشنهادی دارید یا خطاهای املایی یا کدنویسی یافتید، [یک issue ثبت کنید](https://github.com/microsoft/ai-agents-for-beginners/issues?WT.mc_id=academic-105485-koreyst) یا [یک pull request ایجاد کنید](https://github.com/microsoft/ai-agents-for-beginners/pulls?WT.mc_id=academic-105485-koreyst)



## 📂 هر درس شامل

- درسی مکتوب که در README ویدیو کوتاه دارد
- نمونه‌های کد پایتون با استفاده از Microsoft Agent Framework و Azure AI Foundry
- لینک‌های منابع اضافی برای ادامه یادگیری شما
...
|----------------------------------------------|----------------------------------------------------|------------------------------------------------------------|----------------------------------------------------------------------------------------|
| معرفی عوامل هوش مصنوعی و کاربردهای آنها       | [لینک](./01-intro-to-ai-agents/README.md)           | [ویدیو](https://youtu.be/3zgm60bXmQk?si=z8QygFvYQv-9WtO1)  | [لینک](https://aka.ms/ai-agents-beginners/collection?WT.mc_id=academic-105485-koreyst) |
| بررسی فریمورک‌های عامل هوشمند                | [لینک](./02-explore-agentic-frameworks/README.md)   | [ویدیو](https://youtu.be/ODwF-EZo_O8?si=Vawth4hzVaHv-u0H)  | [لینک](https://aka.ms/ai-agents-beginners/collection?WT.mc_id=academic-105485-koreyst) |
| درک الگوهای طراحی عامل هوشمند                  | [لینک](./03-agentic-design-patterns/README.md)      | [ویدیو](https://youtu.be/m9lM8qqoOEA?si=BIzHwzstTPL8o9GF)  | [لینک](https://aka.ms/ai-agents-beginners/collection?WT.mc_id=academic-105485-koreyst) |
...
| RAG عامل هوشمند                                 | [لینک](./05-agentic-rag/README.md)                  | [ویدیو](https://youtu.be/WcjAARvdL7I?si=gKPWsQpKiIlDH9A3)  | [لینک](https://aka.ms/ai-agents-beginners/collection?WT.mc_id=academic-105485-koreyst) |
...
| الگوی طراحی متاکاگنیشن                         | [لینک](./09-metacognition/README.md)                | [ویدیو](https://youtu.be/His9R6gw6Ec?si=8gck6vvdSNCt6OcF)  | [لینک](https://aka.ms/ai-agents-beginners/collection?WT.mc_id=academic-105485-koreyst) |
...
| تأمین امنیت عوامل هوش مصنوعی                           | به زودی منتشر می‌شود                               |                                                            |                                                                                        |
...
از [Shivam Goyal](https://www.linkedin.com/in/shivam2003/) به خاطر مشارکت نمونه‌های کد مهمی که Agentic RAG را نشان می‌دهند، سپاسگزاریم.

## مشارکت

این پروژه خوش‌آمدگوی مشارکت‌ها و پیشنهادات است. اکثر مشارکت‌ها نیاز دارد که با
توافقنامه مجوز مشارکت‌کننده (CLA) موافقت کنید که اعلام می‌دارد شما حق دارید و در واقع این حق را به ما می‌دهید
برای استفاده از مشارکت شما. برای جزئیات، به <https://cla.opensource.microsoft.com> مراجعه کنید.

وقتی درخواست کششی ارسال می‌کنید، ربات CLA به‌صورت خودکار تعیین می‌کند که آیا نیاز به ارائه
CLA دارید و درخواست کشش را به‌طور مناسب علامت‌گذاری می‌کند (مثلاً بررسی وضعیت، نظر). فقط دستورالعمل‌های
ربات را دنبال کنید. شما فقط یک بار در تمام مخازنی که از CLA ما استفاده می‌کنند باید این کار را انجام دهید.

این پروژه کد رفتاری متن‌باز مایکروسافت ([Microsoft Open Source Code of Conduct](https://opensource.microsoft.com/codeofconduct/)) را پذیرفته است.
...
این پروژه ممکن است شامل علائم تجاری یا لوگوهای پروژه‌ها، محصولات یا خدمات باشد. استفاده مجاز از علائم تجاری یا لوگوهای مایکروسافت تابع
و باید از [راهنمای علائم تجاری و برند مایکروسافت](https://www.microsoft.com/legal/intellectualproperty/trademarks/usage/general) پیروی کند.
استفاده از علائم تجاری یا لوگوهای مایکروسافت در نسخه‌های تغییر یافته از این پروژه نباید باعث سردرگمی شود یا حمایت مایکروسافت را القا کند.
هرگونه استفاده از علائم تجاری یا لوگوهای اشخاص ثالث تابع سیاست‌های آن اشخاص ثالث است.

## دریافت کمک

اگر گیر کرده‌اید یا سؤال دارید درباره ساخت برنامه‌های هوش مصنوعی، به موارد زیر بپیوندید:

[![Microsoft Foundry Discord](https://img.shields.io/badge/Discord-Azure_AI_Foundry_Community_Discord-blue?style=for-the-badge&logo=discord&color=5865f2&logoColor=fff)](https://aka.ms/foundry/discord)

اگر بازخورد محصول دارید یا در طول ساخت خطا دارید، مراجعه کنید به:
...
**سلب مسئولیت**:
این سند با استفاده از سرویس ترجمه هوش مصنوعی [Co-op Translator](https://github.com/Azure/co-op-translator) ترجمه شده است. اگرچه ما در راستای دقت تلاش می‌کنیم، لطفاً توجه داشته باشید که ترجمه‌های خودکار ممکن است حاوی خطاها یا نادرستی‌هایی باشند. سند اصلی به زبان مادری آن باید به عنوان منبع معتبر در نظر گرفته شود. برای اطلاعات حیاتی، ترجمه حرفه‌ای انسانی توصیه می‌شود. ما مسئول هیچ‌گونه سوء تفاهم یا تفسیر نادرست ناشی از استفاده از این ترجمه نیستیم.
