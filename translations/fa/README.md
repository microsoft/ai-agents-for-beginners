...
![هوش مصنوعی تولیدی برای مبتدیان](../../translated_images/fa/repo-thumbnailv2.06f4a48036fde647.webp)

## دوره‌ای که همه چیزهایی که باید بدانید تا شروع به ساخت عامل‌های هوش مصنوعی کنید را آموزش می‌دهد
...
[![ایشوهای گیت‌هاب](https://img.shields.io/github/issues/microsoft/ai-agents-for-beginners.svg)](https://GitHub.com/microsoft/ai-agents-for-beginners/issues/?WT.mc_id=academic-105485-koreyst)
[![درخواست‌های پول گیت‌هاب](https://img.shields.io/github/issues-pr/microsoft/ai-agents-for-beginners.svg)](https://GitHub.com/microsoft/ai-agents-for-beginners/pulls/?WT.mc_id=academic-105485-koreyst)
[![درخواست‌های پول خوش‌آمدید](https://img.shields.io/badge/PRs-welcome-brightgreen.svg?style=flat-square)](http://makeapullrequest.com?WT.mc_id=academic-105485-koreyst)
...
> این مخزن شامل بیش از 50 ترجمه زبان است که حجم دانلود را به طور قابل توجهی افزایش می‌دهد. برای کلون بدون ترجمه‌ها، از sparse checkout استفاده کنید:
> ```bash
...
این دوره شامل درس‌هایی است که اصول ساخت عامل‌های هوش مصنوعی را پوشش می‌دهد. هر درس موضوع خاص خود را دارد، پس هر جایی که دوست دارید شروع کنید!

این دوره پشتیبانی چندزبانه دارد. به [زبان‌های موجود در اینجا](../..) مراجعه کنید.

اگر این اولین بار است که با مدل‌های هوش مصنوعی تولیدی کار می‌کنید، دوره [هوش مصنوعی تولیدی برای مبتدیان](https://aka.ms/genai-beginners) ما را بررسی کنید که شامل 21 درس درباره ساخت با GenAI است.

فراموش نکنید که به این مخزن [ستاره (🌟) بدهید](https://docs.github.com/en/get-started/exploring-projects-on-github/saving-repositories-with-stars?WT.mc_id=academic-105485-koreyst) و [از آن فورک بگیرید](https://github.com/microsoft/ai-agents-for-beginners/fork) تا کد را اجرا کنید.

### ملاقات با سایر یادگیرندگان، دریافت پاسخ سوالات خود

اگر گیر کردید یا سوالی درباره ساخت عامل‌های هوش مصنوعی دارید، به کانال دیسکورد اختصاصی ما در [Microsoft Foundry Discord](https://aka.ms/ai-agents/discord) بپیوندید.

### ملزومات

هر درس در این دوره شامل نمونه کد است که در پوشه code_samples یافت می‌شود. می‌توانید [این مخزن را فورک کنید](https://github.com/microsoft/ai-agents-for-beginners/fork) تا نسخه خود را بسازید.

نمونه کدهای این تمرین‌ها از Azure AI Foundry و کاتالوگ مدل‌های GitHub برای تعامل با مدل‌های زبانی استفاده می‌کند:
...
این دوره همچنین از فریم‌ورک‌ها و خدمات زیر عامل هوش مصنوعی مایکروسافت استفاده می‌کند:
...
آیا پیشنهاد دارید یا اشتباهات املایی یا کدی پیدا کرده‌اید؟ [یک مسئله ثبت کنید](https://github.com/microsoft/ai-agents-for-beginners/issues?WT.mc_id=academic-105485-koreyst) یا [یک درخواست پول ایجاد کنید](https://github.com/microsoft/ai-agents-for-beginners/pulls?WT.mc_id=academic-105485-koreyst)



## 📂 هر درس شامل

- درسی نوشتاری در README و یک ویدئوی کوتاه
...
|----------------------------------------------|----------------------------------------------------|------------------------------------------------------------|----------------------------------------------------------------------------------------|
| معرفی عامل‌های هوش مصنوعی و موارد استفاده آن‌ها | [لینک](./01-intro-to-ai-agents/README.md)          | [ویدئو](https://youtu.be/3zgm60bXmQk?si=z8QygFvYQv-9WtO1)  | [لینک](https://aka.ms/ai-agents-beginners/collection?WT.mc_id=academic-105485-koreyst) |
| کاوش فریم‌ورک‌های عامل‌محور                 | [لینک](./02-explore-agentic-frameworks/README.md)  | [ویدئو](https://youtu.be/ODwF-EZo_O8?si=Vawth4hzVaHv-u0H)  | [لینک](https://aka.ms/ai-agents-beginners/collection?WT.mc_id=academic-105485-koreyst) |
...
| Agentic RAG                                  | [لینک](./05-agentic-rag/README.md)                 | [ویدئو](https://youtu.be/WcjAARvdL7I?si=gKPWsQpKiIlDH9A3)  | [لینک](https://aka.ms/ai-agents-beginners/collection?WT.mc_id=academic-105485-koreyst) |
...
| الگوی طراحی چنده عامله                      | [لینک](./08-multi-agent/README.md)                 | [ویدئو](https://youtu.be/V6HpE9hZEx0?si=rMgDhEu7wXo2uo6g)  | [لینک](https://aka.ms/ai-agents-beginners/collection?WT.mc_id=academic-105485-koreyst) |
| الگوی طراحی متاکاگنیشن                 | [لینک](./09-metacognition/README.md)               | [ویدئو](https://youtu.be/His9R6gw6Ec?si=8gck6vvdSNCt6OcF)  | [لینک](https://aka.ms/ai-agents-beginners/collection?WT.mc_id=academic-105485-koreyst) |
| عامل‌های هوش مصنوعی در محیط تولید                      | [لینک](./10-ai-agents-production/README.md)        | [ویدئو](https://youtu.be/l4TP6IyJxmQ?si=31dnhexRo6yLRJDl)  | [لینک](https://aka.ms/ai-agents-beginners/collection?WT.mc_id=academic-105485-koreyst) |
...
| ایجاد عامل‌های هوش مصنوعی محلی                     | به‌زودی                               |                                                            |                                                                                        |
...
این پروژه مشارکت‌ها و پیشنهادات را خوش‌آمد می‌گوید. بیشتر مشارکت‌ها نیاز به موافقت شما با
توافقنامه مجوز مشارکت‌کننده (CLA) دارند که اعلام می‌کند شما حق دارید و واقعاً اجازه می‌دهید
که ما از مشارکت شما استفاده کنیم. برای جزئیات، به آدرس <https://cla.opensource.microsoft.com> مراجعه کنید.

زمانی که درخواست Pull ارسال می‌کنید، یک ربات CLA به‌صورت خودکار تعیین می‌کند که آیا شما نیاز به ارائه
یک CLA دارید و PR را به طور مناسب علامت‌گذاری می‌کند (برای مثال، بررسی وضعیت، نظر). فقط دستورالعمل‌های
ربات را دنبال کنید. شما تنها یک بار در تمام مخازنی که از CLA ما استفاده می‌کنند، این کار را انجام خواهید داد.
...
این پروژه ممکن است حاوی علائم تجاری یا لوگوهای پروژه‌ها، محصولات یا خدمات باشد. استفاده مجاز از علائم تجاری یا لوگوهای مایکروسافت مشروط به رعایت
[راهنمایی‌های علائم تجاری و برند مایکروسافت](https://www.microsoft.com/legal/intellectualproperty/trademarks/usage/general) است.
...
اگر گیر کردید یا سوالی در مورد ساخت برنامه‌های هوش مصنوعی داشتید، به اینجا بپیوندید:

[![Microsoft Foundry Discord](https://dcbadge.limes.pink/api/server/nTYy5BXMWG)](https://discord.gg/nTYy5BXMWG)

اگر بازخورد محصول یا اروری در حین ساخت دارید، مراجعه کنید به:
...
**سلب مسئولیت**:  
این سند با استفاده از سرویس ترجمه هوش مصنوعی [Co-op Translator](https://github.com/Azure/co-op-translator) ترجمه شده است. در حالی که ما در تلاش برای دقت هستیم، لطفاً توجه داشته باشید که ترجمه‌های خودکار ممکن است شامل خطاها یا نواقصی باشند. سند اصلی به زبان بومی آن باید به عنوان منبع معتبر در نظر گرفته شود. برای اطلاعات حیاتی، ترجمه حرفه‌ای توسط انسان توصیه می‌شود. ما در قبال هرگونه سوءتفاهم یا برداشت نادرست ناشی از استفاده از این ترجمه مسئولیتی نداریم.
