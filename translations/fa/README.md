...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2026-01-01T10:00:46+00:00",
...
[عربی](../ar/README.md) | [بنگالی](../bn/README.md) | [بلغاری](../bg/README.md) | [بورمه (میانمار)](../my/README.md) | [چینی (ساده‌شده)](../zh/README.md) | [چینی (سنتی، هنگ‌کنگ)](../hk/README.md) | [چینی (سنتی، ماکائو)](../mo/README.md) | [چینی (سنتی، تایوان)](../tw/README.md) | [کرواتی](../hr/README.md) | [چک](../cs/README.md) | [دانمارکی](../da/README.md) | [هلندی](../nl/README.md) | [استونیایی](../et/README.md) | [فنلاندی](../fi/README.md) | [فرانسوی](../fr/README.md) | [آلمانی](../de/README.md) | [یونانی](../el/README.md) | [عبری](../he/README.md) | [هندی](../hi/README.md) | [مجارستانی](../hu/README.md) | [اندونزیایی](../id/README.md) | [ایتالیایی](../it/README.md) | [ژاپنی](../ja/README.md) | [کانادا](../kn/README.md) | [کره‌ای](../ko/README.md) | [لیتوانیایی](../lt/README.md) | [مالایی](../ms/README.md) | [مالایالام](../ml/README.md) | [ماراتی](../mr/README.md) | [نپالی](../ne/README.md) | [پیجین نیجریه‌ای](../pcm/README.md) | [نروژی](../no/README.md) | [فارسی (Farsi)](./README.md) | [لهستانی](../pl/README.md) | [پرتغالی (برزیل)](../br/README.md) | [پرتغالی (پرتغال)](../pt/README.md) | [پنجابی (گرموکھی)](../pa/README.md) | [رومانیایی](../ro/README.md) | [روسی](../ru/README.md) | [صربی (سیریلیک)](../sr/README.md) | [اسلواکی](../sk/README.md) | [اسلوونیایی](../sl/README.md) | [اسپانیایی](../es/README.md) | [سواحیلی](../sw/README.md) | [سوئدی](../sv/README.md) | [تاگالوگ (فلیپینی)](../tl/README.md) | [تامیلی](../ta/README.md) | [تلوگو](../te/README.md) | [تایلندی](../th/README.md) | [ترکی](../tr/README.md) | [اوکراینی](../uk/README.md) | [اردو](../ur/README.md) | [ویتنامی](../vi/README.md)
<!-- CO-OP TRANSLATOR LANGUAGES TABLE END -->

**اگر مایل به افزودن زبان‌های ترجمه بیشتر هستید، زبان‌های پشتیبانی‌شده در [اینجا](https://github.com/Azure/co-op-translator/blob/main/getting_started/supported-languages.md) فهرست شده‌اند**
...
این دوره شامل درس‌هایی است که اصول ساخت عامل‌های هوش مصنوعی را پوشش می‌دهند. هر درس موضوع خاص خود را دارد، پس از هر جایی که مایلید شروع کنید!

این دوره از چندین زبان پشتیبانی می‌کند. به [زبان‌های در دسترس اینجا](../..) مراجعه کنید. 

اگر برای اولین بار با مدل‌های هوش تولیدی کار می‌کنید، دورهٔ ما را با عنوان [هوش تولیدی برای مبتدیان](https://aka.ms/genai-beginners) بررسی کنید که شامل 21 درس در مورد ساخت با GenAI است.

فراموش نکنید که به این مخزن [ستاره (🌟) بدهید](https://docs.github.com/en/get-started/exploring-projects-on-github/saving-repositories-with-stars?WT.mc_id=academic-105485-koreyst) و برای اجرای کد، این مخزن را [فورک کنید](https://github.com/microsoft/ai-agents-for-beginners/fork).

### با سایر یادگیرندگان آشنا شوید و سوالات‌تان را پاسخ بگیرید

اگر در حین کار گیر کردید یا سوالی در مورد ساخت عامل‌های هوش مصنوعی دارید، به کانال دیسکورد اختصاصی ما در [Microsoft Foundry Discord](https://aka.ms/ai-agents/discord) بپیوندید.

### چه چیزهایی نیاز دارید

هر درس این دوره شامل مثال‌های کدنویسی است که در پوشهٔ code_samples قرار دارند. می‌توانید برای ایجاد نسخهٔ خود، این مخزن را [فورک کنید](https://github.com/microsoft/ai-agents-for-beginners/fork).  

مثال‌های کد در این تمرین‌ها از Azure AI Foundry و فهرست‌های مدل GitHub برای تعامل با مدل‌های زبانی استفاده می‌کنند:
...
این دوره همچنین از فریم‌ورک‌ها و خدمات زیر برای عامل‌های هوش مصنوعی مایکروسافت استفاده می‌کند:

- [Microsoft Agent Framework (MAF) - جدید!](https://aka.ms/ai-agents-beginners/agent-framewrok)
- [Azure AI Agent Service](https://aka.ms/ai-agents-beginners/ai-agent-service)
- [Semantic Kernel](https://aka.ms/ai-agents-beginners/semantic-kernel)
- [AutoGen](https://aka.ms/ai-agents/autogen)


برای اطلاعات بیشتر در مورد اجرای کد این دوره، به [Course Setup](./00-course-setup/README.md) مراجعه کنید.

## 🙏 مایل به کمک هستید؟

آیا پیشنهاد یا اشکال املایی یا خطای کد پیدا کردید؟ [یک issue باز کنید](https://github.com/microsoft/ai-agents-for-beginners/issues?WT.mc_id=academic-105485-koreyst) یا [یک pull request ایجاد کنید](https://github.com/microsoft/ai-agents-for-beginners/pulls?WT.mc_id=academic-105485-koreyst)



## 📂 هر درس شامل

- یک درس نوشته‌شده که در README قرار دارد و یک ویدیوی کوتاه
- نمونه‌های کد Python که از Azure AI Foundry و Github Models (رایگان) پشتیبانی می‌کنند
- لینک‌هایی به منابع اضافی برای ادامهٔ یادگیری شما


## 🗃️ دروس

| **درس**                                     | **متن و کد**                                       | **ویدیو**                                                  | **مطالب تکمیلی**                                                                     |
|----------------------------------------------|----------------------------------------------------|------------------------------------------------------------|----------------------------------------------------------------------------------------|
| معرفی عامل‌های هوش مصنوعی و موارد استفاده   | [لینک](./01-intro-to-ai-agents/README.md)          | [ویدیو](https://youtu.be/3zgm60bXmQk?si=z8QygFvYQv-9WtO1)  | [لینک](https://aka.ms/ai-agents-beginners/collection?WT.mc_id=academic-105485-koreyst) |
| بررسی فریم‌ورک‌های عامل‌محور                 | [لینک](./02-explore-agentic-frameworks/README.md)  | [ویدیو](https://youtu.be/ODwF-EZo_O8?si=Vawth4hzVaHv-u0H)  | [لینک](https://aka.ms/ai-agents-beginners/collection?WT.mc_id=academic-105485-koreyst) |
...
| ساخت عامل‌های قابل‌اعتماد                     | [لینک](./06-building-trustworthy-agents/README.md) | [ویدیو](https://youtu.be/iZKkMEGBCUQ?si=jZjpiMnGFOE9L8OK ) | [لینک](https://aka.ms/ai-agents-beginners/collection?WT.mc_id=academic-105485-koreyst) |
...
| الگوی طراحی فرابینی (Metacognition)          | [لینک](./09-metacognition/README.md)               | [ویدیو](https://youtu.be/His9R6gw6Ec?si=8gck6vvdSNCt6OcF)  | [لینک](https://aka.ms/ai-agents-beginners/collection?WT.mc_id=academic-105485-koreyst) |
...
| مهندسی زمینه برای عامل‌های هوش مصنوعی            | [لینک](./12-context-engineering/README.md)         | [ویدئو](https://youtu.be/F5zqRV7gEag)                                 | [لینک](https://aka.ms/ai-agents-beginners/collection?WT.mc_id=academic-105485-koreyst) |
| مدیریت حافظه عاملیت                      | [لینک](./13-agent-memory/README.md)     |      [ویدئو](https://youtu.be/QrYbHesIxpw?si=vZkVwKrQ4ieCcIPx)                                                      |                                                                                        |
| کاوش چارچوب عامل مایکروسافت                         | [لینک](./14-microsoft-agent-framework/README.md)                            |                                                            |                                                                                        |
| ساخت عامل‌های استفاده‌کننده از کامپیوتر (CUA)           | به‌زودی                            |                                                            |                                                                                        |
...
تیم ما دوره‌های دیگری تولید می‌کند! نگاه کنید:
...
از [Shivam Goyal](https://www.linkedin.com/in/shivam2003/) برای مشارکت در ارائه نمونه‌های کد مهم که RAG عاملیت‌دار را نشان می‌دهند، سپاسگزاریم. 

## مشارکت

این پروژه از مشارکت‌ها و پیشنهادها استقبال می‌کند. بیشتر مشارکت‌ها از شما می‌طلبند که با یک
توافقنامه مجوز مشارکت‌کننده (Contributor License Agreement - CLA) موافقت کنید که اعلام می‌کند شما حق دارید و در واقع این حق را به ما می‌دهید که از مشارکت شما استفاده کنیم. برای جزئیات، به <https://cla.opensource.microsoft.com> مراجعه کنید.

زمانی که یک pull request ارسال می‌کنید، ربات CLA به‌طور خودکار تعیین می‌کند که آیا نیاز دارید یک CLA ارائه دهید
و PR را به‌طور مناسب علامت‌گذاری می‌کند (مثلاً بررسی وضعیت، نظر). به سادگی دستورالعمل‌های ارائه‌شده توسط ربات را دنبال کنید.
شما تنها یک بار برای همه مخازنی که از CLA ما استفاده می‌کنند باید این کار را انجام دهید.

این پروژه [Microsoft Open Source Code of Conduct](https://opensource.microsoft.com/codeofconduct/) را پذیرفته است.
برای اطلاعات بیشتر به [Code of Conduct FAQ](https://opensource.microsoft.com/codeofconduct/faq/) مراجعه کنید یا برای سوالات یا نظرات اضافی با [opencode@microsoft.com](mailto:opencode@microsoft.com) تماس بگیرید.

## علائم تجاری

این پروژه ممکن است شامل علائم تجاری یا لوگوهایی برای پروژه‌ها، محصولات یا خدمات باشد. استفاده مجاز از علائم تجاری یا لوگوهای Microsoft مشمول قوانین است و باید از
[Microsoft's Trademark & Brand Guidelines](https://www.microsoft.com/legal/intellectualproperty/trademarks/usage/general) پیروی کند.
استفاده از علائم تجاری یا لوگوهای Microsoft در نسخه‌های تغییر‌یافته این پروژه نباید موجب سردرگمی یا دلالت بر حمایت مایکروسافت شود.
هرگونه استفاده از علائم تجاری یا لوگوهای شخص ثالث تابع سیاست‌های آن اشخاص ثالث است.

## دریافت کمک


اگر گیر کردید یا هر سوالی درباره ساخت برنامه‌های هوش مصنوعی دارید، بپیوندید به:

[![دیسکورد Microsoft Foundry](https://dcbadge.limes.pink/api/server/nTYy5BXMWG)](https://discord.gg/nTYy5BXMWG)

اگر بازخورد محصول یا خطاهایی هنگام ساخت دارید لطفاً مراجعه کنید به:
...
سلب مسئولیت:
این سند با استفاده از سرویس ترجمهٔ هوش مصنوعی Co‑op Translator (https://github.com/Azure/co-op-translator) ترجمه شده است. هرچند ما در تلاش برای دقت هستیم، لطفاً توجه داشته باشید که ترجمه‌های خودکار ممکن است شامل خطاها یا نادرستی‌هایی باشند. نسخهٔ اصلی سند به زبان مادری آن باید به‌عنوان مرجع معتبر در نظر گرفته شود. برای اطلاعات حساس یا حیاتی، ترجمهٔ حرفه‌ای انسانی توصیه می‌شود. ما در قبال هرگونه سوءتفاهم یا تفسیر نادرست ناشی از استفاده از این ترجمه مسئولیتی نداریم.
