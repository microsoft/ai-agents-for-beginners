...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-06-05T14:52:55+00:00",
...
این دستور فایل نمونه را کپی کرده و یک فایل `.env` in your directory and where you fill in the values for the environment variables.
...
## اگر در جایی گیر کردید؟

اگر در اجرای این تنظیمات با مشکلی مواجه شدید، به کانال ما در
