...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-12-25T00:11:43+00:00",
...
Ako vam je ovo prvi put da gradite s generativnim AI modelima, pogledajte naš tečaj [Generativna AI za početnike](https://aka.ms/genai-beginners), koji uključuje 21 lekciju o izgradnji s GenAI.

Ne zaboravite [označiti zvjezdicom (🌟) ovaj repo](https://docs.github.com/en/get-started/exploring-projects-on-github/saving-repositories-with-stars?WT.mc_id=academic-105485-koreyst) i [forkati ovaj repo](https://github.com/microsoft/ai-agents-for-beginners/fork) kako biste pokrenuli kod.
...
Svaka lekcija u ovom tečaju uključuje primjere koda, koji se mogu naći u mapi code_samples. Možete [forkati ovaj repo](https://github.com/microsoft/ai-agents-for-beginners/fork) kako biste stvorili vlastitu kopiju.  
...
Za više informacija o pokretanju koda za ovaj tečaj, idite na [Course Setup](./00-course-setup/README.md).
...
- Python primjere koda koji podržavaju Azure AI Foundry i Github Models (Besplatno)
...
|----------------------------------------------|----------------------------------------------------|------------------------------------------------------------|----------------------------------------------------------------------------------------|
| Uvod u AI agente i slučajevi upotrebe        | [Poveznica](./01-intro-to-ai-agents/README.md)     | [Video](https://youtu.be/3zgm60bXmQk?si=z8QygFvYQv-9WtO1)  | [Poveznica](https://aka.ms/ai-agents-beginners/collection?WT.mc_id=academic-105485-koreyst) |
| Istraživanje agentnih AI okvira              | [Poveznica](./02-explore-agentic-frameworks/README.md) | [Video](https://youtu.be/ODwF-EZo_O8?si=Vawth4hzVaHv-u0H)  | [Poveznica](https://aka.ms/ai-agents-beginners/collection?WT.mc_id=academic-105485-koreyst) |
| Razumijevanje agentnih dizajnerskih obrazaca  | [Poveznica](./03-agentic-design-patterns/README.md) | [Video](https://youtu.be/m9lM8qqoOEA?si=BIzHwzstTPL8o9GF)  | [Poveznica](https://aka.ms/ai-agents-beginners/collection?WT.mc_id=academic-105485-koreyst) |
| Dizajnerski obrazac korištenja alata          | [Poveznica](./04-tool-use/README.md)               | [Video](https://youtu.be/vieRiPRx-gI?si=2z6O2Xu2cu_Jz46N)  | [Poveznica](https://aka.ms/ai-agents-beginners/collection?WT.mc_id=academic-105485-koreyst) |
...
| Dizajnerski obrazac za više agenata           | [Poveznica](./08-multi-agent/README.md)            | [Video](https://youtu.be/V6HpE9hZEx0?si=rMgDhEu7wXo2uo6g)  | [Poveznica](https://aka.ms/ai-agents-beginners/collection?WT.mc_id=academic-105485-koreyst) |
| Dizajnerski obrazac metakognicije             | [Poveznica](./09-metacognition/README.md)          | [Video](https://youtu.be/His9R6gw6Ec?si=8gck6vvdSNCt6OcF)  | [Poveznica](https://aka.ms/ai-agents-beginners/collection?WT.mc_id=academic-105485-koreyst) |
...
Ovaj projekt poziva na doprinose i prijedloge. Većina doprinosa zahtijeva da se složite s
Ugovorom o licenci za suradnike (Contributor License Agreement, CLA) kojim izjavljujete da imate pravo i zaista nam dajete
...
CLA i prikazati odgovarajuće oznake na PR-u (npr. statusnu provjeru, komentar). Jednostavno slijedite upute
...
Upotreba Microsoftovih zaštitnih znakova ili logotipa u izmijenjenim verzijama ovog projekta ne smije izazvati zabunu niti
sugerisati sponzorstvo od strane Microsofta. Svaka upotreba zaštitnih znakova ili logotipa trećih strana podliježe pravilima tih trećih strana.
