...
## Tečaj koji uči sve što trebate znati da počnete graditi AI Agente
...
Ovaj tečaj ima lekcije koje pokrivaju osnove gradnje AI Agenata. Svaka lekcija obrađuje svoju temu, pa počnite gdje želite!

Postoji višejezična podrška za ovaj tečaj. Posjetite našu [dostupne jezike ovdje](#-multi-language-support).

Ako je ovo prvi put da gradite s Generativnim AI modelima, pogledajte naš tečaj [Generativni AI za Početnike](https://aka.ms/genai-beginners), koji uključuje 21 lekciju o gradnji s GenAI.

Ne zaboravite [označiti (🌟) ovaj repozitorij](https://docs.github.com/en/get-started/exploring-projects-on-github/saving-repositories-with-stars?WT.mc_id=academic-105485-koreyst) i [forkati ovaj repozitorij](https://github.com/microsoft/ai-agents-for-beginners/fork) da biste mogli pokretati kod.

### Upoznajte druge polaznike, postavite pitanja

Ako zapnete ili imate bilo kakvih pitanja o gradnji AI Agenata, pridružite se našem posebnom Discord kanalu u [Microsoft Foundry Discord](https://aka.ms/ai-agents/discord).

### Što vam treba

Svaka lekcija u ovom tečaju uključuje primjere koda, koji se mogu pronaći u mapi code_samples. Možete [forkati ovaj repozitorij](https://github.com/microsoft/ai-agents-for-beginners/fork) da biste stvorili vlastitu kopiju.
...
Neki primjeri koda također podržavaju alternativne davatelje kompatibilne s OpenAI poput [MiniMax](https://platform.minimaxi.com/), koji nudi modele s velikim kontekstom (do 204K tokena). Pogledajte [Postavljanje tečaja](./00-course-setup/README.md) za detalje konfiguracije.

Za više informacija o pokretanju koda za ovaj tečaj, idite na [Postavljanje tečaja](./00-course-setup/README.md).

## 🙏 Želite pomoći?

Imate li prijedloge ili ste pronašli pravopisne ili greške u kodu? [Otvorite issue](https://github.com/microsoft/ai-agents-for-beginners/issues?WT.mc_id=academic-105485-koreyst) ili [Kreirajte pull request](https://github.com/microsoft/ai-agents-for-beginners/pulls?WT.mc_id=academic-105485-koreyst)



## 📂 Svaka lekcija uključuje

- Lekciju s tekstom koja se nalazi u README-u i kratki video
...
| Višageagentni uzorak dizajna                  | [Link](./08-multi-agent/README.md)                 | [Video](https://youtu.be/V6HpE9hZEx0?si=rMgDhEu7wXo2uo6g)  | [Link](https://aka.ms/ai-agents-beginners/collection?WT.mc_id=academic-105485-koreyst) |
...
| Izrada agenata za korištenje računala (CUA) | [Link](./15-browser-use/README.md)     |                                                            | [Link](https://docs.browser-use.com/examples/templates/playwright-integration)         |
...
Ugovorom o licenciranju doprinosa (CLA) kojim potvrđujete da imate pravo i zaista nam dajete
...
koje pruža bot. To ćete trebati napraviti samo jednom za sve repozitorije koji koriste naš CLA.

Ovaj projekt je usvojio [Microsoftov Kodeks ponašanja za otvoreni kod](https://opensource.microsoft.com/codeofconduct/).
...
[Microsoftove smjernice za zaštitne znakove i marke](https://www.microsoft.com/legal/intellectualproperty/trademarks/usage/general).
Korištenje Microsoftovih zaštitnih znakova ili logotipa u izmijenjenim verzijama ovog projekta ne smije dovesti do zabune niti implicirati Microsoftovo sponzorstvo.
