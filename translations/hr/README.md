...
![AI Agents for Beginners](../../translated_images/hr/repo-thumbnailv2.06f4a48036fde647.webp)

## Tečaj koji podučava sve što trebate znati da započnete s izradom AI Agenata
...
>
> Ovaj repozitorij uključuje prijevode na preko 50 jezika što značajno povećava veličinu preuzimanja. Za kloniranje bez prijevoda, koristite smeđi checkout:
>
> **Bash / macOS / Linux:**
> ```bash
...
> ```
>
> Ovo vam daje sve što je potrebno za završetak tečaja uz puno brže preuzimanje.
...
Ovaj tečaj sadrži lekcije koje pokrivaju osnove izrade AI Agenata. Svaka lekcija obrađuje svoju temu pa počnite odakle želite!

Postoji višejezična podrška za ovaj tečaj. Pogledajte naše [dostupne jezike ovdje](#-multi-language-support).

Ako vam je prvi put da radite s Generativnim AI modelima, pogledajte naš tečaj [Generative AI For Beginners](https://aka.ms/genai-beginners) koji uključuje 21 lekciju o radu s GenAI.

Ne zaboravite [dati zvjezdicu (🌟) ovom repozitoriju](https://docs.github.com/en/get-started/exploring-projects-on-github/saving-repositories-with-stars?WT.mc_id=academic-105485-koreyst) i [forkajte ovaj repozitorij](https://github.com/microsoft/ai-agents-for-beginners/fork) da biste mogli pokrenuti kod.

### Upoznajte druge učenike, postavite pitanja i dobijte odgovore
...
Svaka lekcija u ovom tečaju uključuje primjere koda koji se mogu pronaći u mapi code_samples. Možete [forkati ovaj repozitorij](https://github.com/microsoft/ai-agents-for-beginners/fork) da biste napravili svoju kopiju.

Primjeri koda u ovim vježbama koriste Microsoft Agent Framework sa Microsoft Foundry Agent Service V2:
...
Neki primjeri koda također podržavaju alternativne OpenAI-kompatibilne pružatelje poput [MiniMax](https://platform.minimaxi.com/), koji nudi modele velikog konteksta (do 204K tokena). Pogledajte [Postavljanje tečaja](./00-course-setup/README.md) za detalje konfiguracije.

Za dodatne informacije o pokretanju koda za ovaj tečaj, idite na [Postavljanje tečaja](./00-course-setup/README.md).

## 🙏 Želite li pomoći?

Imate li prijedloge ili ste pronašli pravopisne ili kodne greške? [Otvorite issue](https://github.com/microsoft/ai-agents-for-beginners/issues?WT.mc_id=academic-105485-koreyst) ili [kreirajte pull request](https://github.com/microsoft/ai-agents-for-beginners/pulls?WT.mc_id=academic-105485-koreyst)



## 📂 Svaka lekcija uključuje

- Pisanu lekciju u README i kratki video
- Primjere koda u Pythonu koristeći Microsoft Agent Framework sa Microsoft Foundry
...
|----------------------------------------------|----------------------------------------------------|------------------------------------------------------------|----------------------------------------------------------------------------------------|
| Uvod u AI Agente i primjenu agenata           | [Link](./01-intro-to-ai-agents/README.md)          | [Video](https://youtu.be/3zgm60bXmQk?si=z8QygFvYQv-9WtO1)  | [Link](https://aka.ms/ai-agents-beginners/collection?WT.mc_id=academic-105485-koreyst) |
...
| Uzorak dizajna za korištenje alata             | [Link](./04-tool-use/README.md)                    | [Video](https://youtu.be/vieRiPRx-gI?si=2z6O2Xu2cu_Jz46N)  | [Link](https://aka.ms/ai-agents-beginners/collection?WT.mc_id=academic-105485-koreyst) |
...
| Uzorak dizajna za planiranje                     | [Link](./07-planning-design/README.md)             | [Video](https://youtu.be/kPfJ2BrBCMY?si=6SC_iv_E5-mzucnC)  | [Link](https://aka.ms/ai-agents-beginners/collection?WT.mc_id=academic-105485-koreyst) |
| Uzorak dizajna za više agenata                    | [Link](./08-multi-agent/README.md)                 | [Video](https://youtu.be/V6HpE9hZEx0?si=rMgDhEu7wXo2uo6g)  | [Link](https://aka.ms/ai-agents-beginners/collection?WT.mc_id=academic-105485-koreyst) |

| Metakognitivni dizajn obrazac                  | [Poveznica](./09-metacognition/README.md)               | [Video](https://youtu.be/His9R6gw6Ec?si=8gck6vvdSNCt6OcF)  | [Poveznica](https://aka.ms/ai-agents-beginners/collection?WT.mc_id=academic-105485-koreyst) |
...
| Korištenje agentskih protokola (MCP, A2A i NLWeb) | [Poveznica](./11-agentic-protocols/README.md)           | [Video](https://youtu.be/X-Dh9R3Opn8)                                 | [Poveznica](https://aka.ms/ai-agents-beginners/collection?WT.mc_id=academic-105485-koreyst) |
...
| Upravljanje agentskom memorijom                | [Poveznica](./13-agent-memory/README.md)     |      [Video](https://youtu.be/QrYbHesIxpw?si=vZkVwKrQ4ieCcIPx)                                                      |                                                                                        |
| Istraživanje Microsoft Agent Frameworka       | [Poveznica](./14-microsoft-agent-framework/README.md)                            |                                                            |                                                                                        |
| Izrada agenata za korištenje računala (CUA)   | [Poveznica](./15-browser-use/README.md)     |                                                            | [Poveznica](https://docs.browser-use.com/examples/templates/playwright-integration)         |
| Implementacija skalabilnih agenata             | Dolazi uskoro                            |                                                            |                                                                                        |
| Izrada lokalnih AI agenata                      | Dolazi uskoro                               |                                                            |                                                                                        |
| Osiguranje AI agenata                           | [Poveznica](./18-securing-ai-agents/README.md)  |                                                            | [Poveznica](https://aka.ms/ai-agents-beginners/collection?WT.mc_id=academic-105485-koreyst) |
...
### Serija Copilot
[![Copilot za AI sparno programiranje](https://img.shields.io/badge/Copilot%20for%20AI%20Paired%20Programming-FACC15?style=for-the-badge&labelColor=E5E7EB&color=FACC15)](https://aka.ms/GitHubCopilotAI?WT.mc_id=academic-105485-koreyst)
...
Zahvala [Shivam Goyal](https://www.linkedin.com/in/shivam2003/) za doprinos važnim primjerima koda koji prikazuju Agentic RAG. 

## Doprinos

Ovaj projekt pozdravlja doprinose i prijedloge. Većina doprinosa zahtijeva da pristanete na
Ugovor o licenci za doprinositelje (Contributor License Agreement - CLA) koji izjavljuje da imate pravo, i zapravo dajete,
prava na korištenje vašeg doprinosa. Za detalje posjetite <https://cla.opensource.microsoft.com>.

Kada pošaljete zahtjev za povlačenje (pull request), CLA bot će automatski odrediti trebate li pružiti
CLA i označiti PR na odgovarajući način (npr. provjera statusa, komentar). Jednostavno slijedite upute
koje daje bot. To trebate učiniti samo jednom za sve repozitorije koji koriste našu CLA.
...
Korištenje Microsoftovih zaštitnih znakova ili logotipa u modificiranim verzijama ovog projekta ne smije izazvati zabunu niti implicirati Microsoftovu sponzorstvo.
...
Ako imate povratnu informaciju o proizvodu ili pogreške prilikom izrade, posjetite:
