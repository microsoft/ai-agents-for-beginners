...
![分叉倉庫](../../../translated_images/zh-MO/forked-repo.33f27ca1901baa6a.webp)
...
1. 在屏幕左側的 **開發者設置** 中選擇 `細粒度令牌` 選項。
   ...
   ![開發者設置](../../../translated_images/zh-MO/profile_developer_settings.410a859fe749c755.webp)

   然後選擇 `生成新令牌`。

   ![生成令牌](../../../translated_images/zh-MO/fga_new_token.1c1a234afe202ab3.webp)
...
2. 為您的令牌輸入一個描述性名稱，反映其用途，方便以後識別。
    ...
    ![令牌名稱和到期日期](../../../translated_images/zh-MO/token-name-expiry-date.a095fb0de6386864.webp)

3. 將令牌的範圍限制為此倉庫的分叉。

    ![限制範圍到分叉倉庫](../../../translated_images/zh-MO/token_repository_limit.924ade5e11d9d8bb.webp)

4. 限制令牌的權限：在 **權限** 下，點擊 **帳戶** 標籤，然後點擊 "+ 添加權限" 按鈕。將出現下拉菜單。請搜索 **Models** 並勾選它。

    ![添加 Models 權限](../../../translated_images/zh-MO/add_models_permissions.c0c44ed8b40fc143.webp)

5. 在生成令牌之前，請驗證所需的權限。 ![驗證權限](../../../translated_images/zh-MO/verify_permissions.06bd9e43987a8b21.webp)

6. 在生成令牌之前，請確保您準備好將令牌存儲在安全的地方，例如密碼管理器保險庫，因為生成後將無法再次查看。 ![安全存儲令牌](../../../translated_images/zh-MO/store_token_securely.08ee2274c6ad6caf.webp)
...
![GitHub Token 字段](../../../translated_images/zh-MO/github_token_field.20491ed3224b5f4a.webp)
...
![項目連接字符串](../../../translated_images/zh-MO/project-endpoint.8cf04c9975bbfbf1.webp)
