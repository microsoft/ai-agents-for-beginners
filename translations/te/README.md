...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-12-17T14:50:23+00:00",
...
![Generative AI For Beginners](../../translated_images/repo-thumbnailv2.06f4a48036fde647f6ba4eb19f5651babe59bb30e972748afb349e47725d7601.te.png)

## AI ఏజెంట్లు నిర్మించడం ప్రారంభించడానికి మీరు తెలుసుకోవలసిన అన్ని విషయాలను బోధించే కోర్సు
...
ఈ కోర్సులో AI ఏజెంట్లు నిర్మించడంలో ప్రాథమిక అంశాలను కవర్ చేసే పాఠాలు ఉన్నాయి. ప్రతి పాఠం తన స్వంత విషయాన్ని కవర్ చేస్తుంది కాబట్టి మీరు ఇష్టమైన చోటు నుండి ప్రారంభించండి!

ఈ కోర్సుకు బహుభాషా మద్దతు ఉంది. మా [ఇక్కడ అందుబాటులో ఉన్న భాషలు](../..) చూడండి.

మీరు మొదటిసారి Generative AI మోడల్స్‌తో నిర్మిస్తున్నట్లయితే, మా [Generative AI For Beginners](https://aka.ms/genai-beginners) కోర్సును చూడండి, ఇందులో GenAI తో నిర్మించడంపై 21 పాఠాలు ఉన్నాయి.

ఈ రిపోను [స్టార్ (🌟) చేయడం](https://docs.github.com/en/get-started/exploring-projects-on-github/saving-repositories-with-stars?WT.mc_id=academic-105485-koreyst) మరియు కోడ్ నడపడానికి [ఫోర్క్ చేయడం](https://github.com/microsoft/ai-agents-for-beginners/fork) మర్చిపోకండి.

### ఇతర అభ్యాసకులను కలవండి, మీ ప్రశ్నలకు సమాధానాలు పొందండి

మీరు ఇబ్బంది పడితే లేదా AI ఏజెంట్లు నిర్మించడంపై ఏవైనా ప్రశ్నలు ఉంటే, మా ప్రత్యేక Discord ఛానెల్‌లో చేరండి [Microsoft Foundry Discord](https://aka.ms/ai-agents/discord).
...
ఈ కోర్సు కోడ్ నడపడం గురించి మరింత సమాచారం కోసం, [Course Setup](./00-course-setup/README.md) చూడండి.

## 🙏 సహాయం చేయాలనుకుంటున్నారా?

మీకు సూచనలు ఉన్నాయా లేదా స్పెల్లింగ్ లేదా కోడ్ లో తప్పులు కనుగొన్నారు? [ఇష్యూ రైజ్ చేయండి](https://github.com/microsoft/ai-agents-for-beginners/issues?WT.mc_id=academic-105485-koreyst) లేదా [పుల్ రిక్వెస్ట్ సృష్టించండి](https://github.com/microsoft/ai-agents-for-beginners/pulls?WT.mc_id=academic-105485-koreyst)
...
| టూల్ ఉపయోగ డిజైన్ ప్యాటర్న్                      | [లింక్](./04-tool-use/README.md)                    | [వీడియో](https://youtu.be/vieRiPRx-gI?si=2z6O2Xu2cu_Jz46N)  | [లింక్](https://aka.ms/ai-agents-beginners/collection?WT.mc_id=academic-105485-koreyst) |
...
| మైక్రోసాఫ్ట్ ఏజెంట్ ఫ్రేమ్‌వర్క్ అన్వేషణ                         | [లింక్](./14-microsoft-agent-framework/README.md)                            |                                                            |                                                                                        |
| కంప్యూటర్ యూజ్ ఏజెంట్లు (CUA) నిర్మించడం           | త్వరలో రాబోతుంది                            |                                                            |                                                                                        |
| స్కేలబుల్ ఏజెంట్లను డిప్లాయ్ చేయడం                    | త్వరలో రాబోతుంది                            |                                                            |                                                                                        |
| స్థానిక AI ఏజెంట్లను సృష్టించడం                     | త్వరలో రాబోతుంది                               |                                                            |                                                                                        |
...
Agentic RAG ను ప్రదర్శించే ముఖ్యమైన కోడ్ నమూనాలను అందించినందుకు [Shivam Goyal](https://www.linkedin.com/in/shivam2003/) కు ధన్యవాదాలు.

## సహకారం

ఈ ప్రాజెక్ట్ సహకారాలు మరియు సూచనలను స్వాగతిస్తుంది. చాలా సహకారాలకు మీరు ఒక
కాంట్రిబ్యూటర్ లైసెన్స్ అగ్రిమెంట్ (CLA) కు అంగీకరించాలి, ఇది మీరు మీ కాంట్రిబ్యూషన్ ఉపయోగించడానికి హక్కు కలిగి ఉన్నారని మరియు వాస్తవంగా హక్కులు మాకు ఇస్తున్నారని ప్రకటిస్తుంది. వివరాలకు, సందర్శించండి <https://cla.opensource.microsoft.com>.
...
ట్రేడ్మార్కులు లేదా లోగోల అధికారిక ఉపయోగం [Microsoft's Trademark & Brand Guidelines](https://www.microsoft.com/legal/intellectualproperty/trademarks/usage/general) ను అనుసరించాలి.
ఈ ప్రాజెక్ట్ యొక్క సవరించిన సంస్కరణలలో మైక్రోసాఫ్ట్ ట్రేడ్మార్కులు లేదా లోగోల ఉపయోగం గందరగోళం కలిగించకూడదు లేదా మైక్రోసాఫ్ట్ స్పాన్సర్షిప్ సూచించకూడదు.
మూడవ పక్ష ట్రేడ్మార్కులు లేదా లోగోల ఏదైనా ఉపయోగం ఆ మూడవ పక్షాల విధానాలకు అనుగుణంగా ఉండాలి.

## సహాయం పొందడం

మీరు అడ్డుకుపోయినట్లయితే లేదా AI యాప్స్ నిర్మాణం గురించి ఏవైనా ప్రశ్నలు ఉంటే, చేరండి:
