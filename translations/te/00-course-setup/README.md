...
![ఫోర్క్ చేసిన రిపో](../../../translated_images/forked-repo.33f27ca1901baa6a.te.png)
...
1. **డెవలపర్ సెట్టింగ్స్** కు వెళ్లి, ఎడమ వైపున `ఫైన్-గ్రెయిన్ టోకెన్స్` ఎంపికను ఎంచుకోండి.
   ...
   ![డెవలపర్ సెట్టింగ్స్](../../../translated_images/profile_developer_settings.410a859fe749c755.te.png)

   ఆపై `కొత్త టోకెన్ సృష్టించండి` ను ఎంచుకోండి.

   ![టోకెన్ సృష్టించండి](../../../translated_images/fga_new_token.1c1a234afe202ab3.te.png)
...
2. మీ టోకెన్ యొక్క ఉద్దేశాన్ని ప్రతిబింబించే వివరణాత్మక పేరును నమోదు చేయండి, తద్వారా దానిని తర్వాత గుర్తించడం సులభం అవుతుంది.
    ...
    ![టోకెన్ పేరు మరియు గడువు తేదీ](../../../translated_images/token-name-expiry-date.a095fb0de6386864.te.png)

3. టోకెన్ యొక్క స్కోప్‌ను ఈ రిపోజిటరీ యొక్క మీ ఫోర్క్‌కు పరిమితం చేయండి.

    ![ఫోర్క్ రిపోజిటరీకి స్కోప్ పరిమితం చేయండి](../../../translated_images/token_repository_limit.924ade5e11d9d8bb.te.png)
...
4. టోకెన్ యొక్క అనుమతులను పరిమితం చేయండి: **Permissions** కింద, **Account** ట్యాబ్‌ను క్లిక్ చేయండి, మరియు "+ Add permissions" బటన్‌ను క్లిక్ చేయండి. డ్రాప్‌డౌన్ కనిపిస్తుంది. దయచేసి **Models** కోసం శోధించి, బాక్స్‌ను టిక్ చేయండి.
    ...
    ![మోడల్స్ అనుమతిని జోడించండి](../../../translated_images/add_models_permissions.c0c44ed8b40fc143.te.png)

5. టోకెన్ సృష్టించే ముందు అవసరమైన అనుమతులను ధృవీకరించండి. ![అనుమతులను ధృవీకరించండి](../../../translated_images/verify_permissions.06bd9e43987a8b21.te.png)

6. టోకెన్ సృష్టించే ముందు, దయచేసి టోకెన్‌ను పాస్‌వర్డ్ మేనేజర్ వాల్ట్ వంటి సురక్షిత ప్రదేశంలో నిల్వ చేయడానికి సిద్ధంగా ఉండండి, ఎందుకంటే మీరు దాన్ని సృష్టించిన తర్వాత మళ్లీ చూపబడదు. ![టోకెన్‌ను సురక్షితంగా నిల్వ చేయండి](../../../translated_images/store_token_securely.08ee2274c6ad6caf.te.png)
...
![GitHub టోకెన్ ఫీల్డ్](../../../translated_images/github_token_field.20491ed3224b5f4a.te.png)
...
![ప్రాజెక్ట్ కనెక్షన్ స్ట్రింగ్](../../../translated_images/project-endpoint.8cf04c9975bbfbf1.te.png)
