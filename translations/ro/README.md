...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2026-01-01T11:26:10+00:00",
...
[![Pull request-uri GitHub](https://img.shields.io/github/issues-pr/microsoft/ai-agents-for-beginners.svg)](https://GitHub.com/microsoft/ai-agents-for-beginners/pulls/?WT.mc_id=academic-105485-koreyst)
...
**Dacă doriți ca limbi suplimentare de traducere să fie acceptate, acestea sunt listate [aici](https://github.com/Azure/co-op-translator/blob/main/getting_started/supported-languages.md)**
...
Acest curs conține lecții care acoperă fundamentele construirii agenților AI. Fiecare lecție tratează un subiect propriu, așa că începe de unde dorești!

Există suport multilingv pentru acest curs. Accesează [limbile disponibile aici](../..). 

Dacă este prima dată când construiești cu modele de AI generativ, consultă cursul nostru [AI generativ pentru începători](https://aka.ms/genai-beginners), care include 21 de lecții despre construirea cu GenAI.

Nu uita să [dai o stea (🌟) acestui repo](https://docs.github.com/en/get-started/exploring-projects-on-github/saving-repositories-with-stars?WT.mc_id=academic-105485-koreyst) și să [faci fork acestui repo](https://github.com/microsoft/ai-agents-for-beginners/fork) pentru a rula codul.

### Cunoaște alți cursanți, obține răspunsuri la întrebările tale

Dacă întâmpini probleme sau ai întrebări despre construirea agenților AI, alătură-te canalului nostru dedicat pe Discord în [Discord Microsoft Foundry](https://aka.ms/ai-agents/discord).
...
Exemplele de cod din aceste exerciții utilizează Azure AI Foundry și Catalogurile de modele GitHub pentru a interacționa cu modele de limbaj:

- [Modele GitHub](https://aka.ms/ai-agents-beginners/github-models) - Gratuit / Limitat
- [Azure AI Foundry](https://aka.ms/ai-agents-beginners/ai-foundry) - Necesită cont Azure

Acest curs folosește, de asemenea, următoarele framework-uri și servicii pentru agenți AI de la Microsoft:
...
Pentru mai multe informații despre rularea codului pentru acest curs, accesează [Configurare curs](./00-course-setup/README.md).

## 🙏 Vrei să ajuți?

Ai sugestii sau ai găsit erori de ortografie ori de cod? [Deschide o problemă](https://github.com/microsoft/ai-agents-for-beginners/issues?WT.mc_id=academic-105485-koreyst) sau [Creează un pull request](https://github.com/microsoft/ai-agents-for-beginners/pulls?WT.mc_id=academic-105485-koreyst)
...
- Exemple de cod Python care suportă Azure AI Foundry și Modele GitHub (Gratuit)
- Linkuri către resurse suplimentare pentru a-ți continua învățarea


## 🗃️ Lecții

| **Lecție**                                   | **Text & Cod**                                    | **Videoclip**                                                  | **Resurse suplimentare**                                                                     |
|----------------------------------------------|----------------------------------------------------|------------------------------------------------------------|----------------------------------------------------------------------------------------|
| Introducere în agenții AI și cazuri de utilizare       | [Legătură](./01-intro-to-ai-agents/README.md)          | [Videoclip](https://youtu.be/3zgm60bXmQk?si=z8QygFvYQv-9WtO1)  | [Legătură](https://aka.ms/ai-agents-beginners/collection?WT.mc_id=academic-105485-koreyst) |
| Explorarea framework-urilor agentice AI              | [Legătură](./02-explore-agentic-frameworks/README.md)  | [Videoclip](https://youtu.be/ODwF-EZo_O8?si=Vawth4hzVaHv-u0H)  | [Legătură](https://aka.ms/ai-agents-beginners/collection?WT.mc_id=academic-105485-koreyst) |
| Înțelegerea tiparelor de proiectare agentice AI     | [Legătură](./03-agentic-design-patterns/README.md)     | [Videoclip](https://youtu.be/m9lM8qqoOEA?si=BIzHwzstTPL8o9GF)  | [Legătură](https://aka.ms/ai-agents-beginners/collection?WT.mc_id=academic-105485-koreyst) |
| Tiparul de utilizare a uneltelor                      | [Legătură](./04-tool-use/README.md)                    | [Videoclip](https://youtu.be/vieRiPRx-gI?si=2z6O2Xu2cu_Jz46N)  | [Legătură](https://aka.ms/ai-agents-beginners/collection?WT.mc_id=academic-105485-koreyst) |
| RAG agentic                                  | [Legătură](./05-agentic-rag/README.md)                 | [Videoclip](https://youtu.be/WcjAARvdL7I?si=gKPWsQpKiIlDH9A3)  | [Legătură](https://aka.ms/ai-agents-beginners/collection?WT.mc_id=academic-105485-koreyst) |
| Construirea agenților AI de încredere               | [Legătură](./06-building-trustworthy-agents/README.md) | [Videoclip](https://youtu.be/iZKkMEGBCUQ?si=jZjpiMnGFOE9L8OK ) | [Legătură](https://aka.ms/ai-agents-beginners/collection?WT.mc_id=academic-105485-koreyst) |
| Tiparul de proiectare pentru planificare                      | [Legătură](./07-planning-design/README.md)             | [Videoclip](https://youtu.be/kPfJ2BrBCMY?si=6SC_iv_E5-mzucnC)  | [Legătură](https://aka.ms/ai-agents-beginners/collection?WT.mc_id=academic-105485-koreyst) |
| Tiparul de proiectare multi-agent                   | [Legătură](./08-multi-agent/README.md)                 | [Videoclip](https://youtu.be/V6HpE9hZEx0?si=rMgDhEu7wXo2uo6g)  | [Legătură](https://aka.ms/ai-agents-beginners/collection?WT.mc_id=academic-105485-koreyst) |
| Tiparul de proiectare metacognitivă                 | [Legătură](./09-metacognition/README.md)               | [Videoclip](https://youtu.be/His9R6gw6Ec?si=8gck6vvdSNCt6OcF)  | [Legătură](https://aka.ms/ai-agents-beginners/collection?WT.mc_id=academic-105485-koreyst) |
...
| Utilizarea protocoalelor agentice (MCP, A2A și NLWeb) | [Legătură](./11-agentic-protocols/README.md)           | [Video](https://youtu.be/X-Dh9R3Opn8)                                 | [Legătură](https://aka.ms/ai-agents-beginners/collection?WT.mc_id=academic-105485-koreyst) |
...
| Construirea agenților de utilizare a calculatorului (CUA)           | În curând                            |                                                            |                                                                                        |
...
Mulțumim lui [Shivam Goyal](https://www.linkedin.com/in/shivam2003/) pentru contribuirea unor exemple de cod importante care demonstrează Agentic RAG. 

## Contribuții

Acest proiect acceptă contribuții și sugestii. Majoritatea contribuțiilor necesită să fii de acord cu un Acord de Licență pentru Contribuitori (Contributor License Agreement - CLA) prin care declari că ai dreptul și efectiv ne acorzi drepturile de a utiliza contribuția ta. Pentru detalii, vizitează <https://cla.opensource.microsoft.com>.

Când trimiți un pull request, un bot CLA va determina automat dacă trebuie să furnizezi un CLA și va decora PR-ul în mod corespunzător (de ex., verificare de stare, comentariu). Urmează pur și simplu instrucțiunile oferite de bot. Va trebui să faci acest lucru o singură dată pentru toate repo-urile care utilizează CLA-ul nostru.

Acest proiect a adoptat [Codul de conduită open source Microsoft](https://opensource.microsoft.com/codeofconduct/).
Pentru mai multe informații vezi [Întrebări frecvente despre Codul de Conduită](https://opensource.microsoft.com/codeofconduct/faq/) sau contactează [opencode@microsoft.com](mailto:opencode@microsoft.com) pentru orice întrebări sau comentarii suplimentare.
...
Utilizarea mărcilor comerciale sau siglelor Microsoft în versiuni modificate ale acestui proiect nu trebuie să creeze confuzie sau să sugereze sponsorizarea de către Microsoft.
Orice utilizare a mărcilor comerciale sau siglelor terților este supusă politicilor acelora terți.
