...
[![Cereri de tragere GitHub](https://img.shields.io/github/issues-pr/microsoft/ai-agents-for-beginners.svg)](https://GitHub.com/microsoft/ai-agents-for-beginners/pulls/?WT.mc_id=academic-105485-koreyst)
...
[![Observatori GitHub](https://img.shields.io/github/watchers/microsoft/ai-agents-for-beginners.svg?style=social&label=Watch)](https://GitHub.com/microsoft/ai-agents-for-beginners/watchers/?WT.mc_id=academic-105485-koreyst)
...
Acest curs cuprinde lecții care acoperă fundamentele construirii Agenților AI. Fiecare lecție tratează un subiect propriu, așa că începe de unde dorești!

Există suport multi-limbaj pentru acest curs. Mergi la [limbile disponibile aici](#-multi-language-support). 

Dacă este pentru prima dată când construiești cu modele AI Generative, consultă cursul nostru [Generative AI Pentru Începători](https://aka.ms/genai-beginners), care include 21 de lecții despre construirea cu GenAI.

Nu uita să [acordă ⭐ acestui repo](https://docs.github.com/en/get-started/exploring-projects-on-github/saving-repositories-with-stars?WT.mc_id=academic-105485-koreyst) și să [faci fork acestui repo](https://github.com/microsoft/ai-agents-for-beginners/fork) pentru a rula codul.
...
Unele exemple de cod acceptă, de asemenea, furnizori alternativi compatibili OpenAI, cum ar fi [MiniMax](https://platform.minimaxi.com/), care oferă modele cu context mare (până la 204K tokenuri). Vezi [Configurarea cursului](./00-course-setup/README.md) pentru detalii de configurare.
...
Ai sugestii sau ai găsit greșeli de ortografie ori cod? [Ridică o problemă](https://github.com/microsoft/ai-agents-for-beginners/issues?WT.mc_id=academic-105485-koreyst) sau [Creează o cerere de tragere](https://github.com/microsoft/ai-agents-for-beginners/pulls?WT.mc_id=academic-105485-koreyst)



## 📂 Fiecare lecție include

- O lecție scrisă localizată în README și un video scurt
- Exemple de cod Python utilizând Microsoft Agent Framework cu Microsoft Foundry
...
| Folosirea Protocoalelor Agentice (MCP, A2A și NLWeb) | [Link](./11-agentic-protocols/README.md)           | [Video](https://youtu.be/X-Dh9R3Opn8)                                 | [Link](https://aka.ms/ai-agents-beginners/collection?WT.mc_id=academic-105485-koreyst) |
...
Acord de Licență pentru Contribuitor (CLA) declaraând că aveți dreptul să acordați și chiar acordați
...
un CLA și va decora PR-ul în mod corespunzător (de exemplu, verificarea statusului, comentariu). Pur și simplu urmați instrucțiunile
oferite de bot. Va trebui să faceți acest lucru o singură dată pentru toate depozitele care folosesc CLA-ul nostru.
...
Acest proiect poate conține mărci comerciale sau logo-uri pentru proiecte, produse sau servicii. Utilizarea autorizată a mărcilor comerciale Microsoft
sau a logo-urilor este supusă și trebuie să urmeze
...
Utilizarea mărcilor comerciale Microsoft sau a logo-urilor în versiuni modificate ale acestui proiect nu trebuie să creeze confuzie sau să sugereze sponsorizarea Microsoft.
