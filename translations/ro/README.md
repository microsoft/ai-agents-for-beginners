...
![Agenți AI pentru Începători](../../translated_images/ro/repo-thumbnailv2.06f4a48036fde647.webp)
...
[![Cereri de extragere GitHub](https://img.shields.io/github/issues-pr/microsoft/ai-agents-for-beginners.svg)](https://GitHub.com/microsoft/ai-agents-for-beginners/pulls/?WT.mc_id=academic-105485-koreyst)
...
[![Furci GitHub](https://img.shields.io/github/forks/microsoft/ai-agents-for-beginners.svg?style=social&label=Fork)](https://GitHub.com/microsoft/ai-agents-for-beginners/network/?WT.mc_id=academic-105485-koreyst)
...
Acest curs conține lecții care acoperă bazele construirii Agenților AI. Fiecare lecție abordează propriul său subiect, așa că începe de unde dorești!

Există suport multilingv pentru acest curs. Accesează [limbile disponibile aici](#-multi-language-support).

Dacă este prima dată când construiești cu modele Generative AI, verifică cursul nostru [Generative AI For Beginners](https://aka.ms/genai-beginners), care include 21 de lecții despre construirea cu GenAI.

Nu uita să [acordezi stea (🌟) acestui depozit](https://docs.github.com/en/get-started/exploring-projects-on-github/saving-repositories-with-stars?WT.mc_id=academic-105485-koreyst) și să [îl forchezi](https://github.com/microsoft/ai-agents-for-beginners/fork) pentru a rula codul.

### Cunoaște alți cursanți, obține răspunsuri la întrebările tale

Dacă întâmpini dificultăți sau ai întrebări despre construirea Agenților AI, alătură-te canalului nostru dedicat de Discord în [Microsoft Foundry Discord](https://aka.ms/ai-agents/discord).

### Ce ai nevoie

Fiecare lecție din acest curs include exemple de cod, care pot fi găsite în folderul code_samples. Poți [forca acest depozit](https://github.com/microsoft/ai-agents-for-beginners/fork) pentru a-ți crea propria copie.  
...
Unele exemple de cod suportă, de asemenea, furnizori alternativi compatibili cu OpenAI, cum ar fi [MiniMax](https://platform.minimaxi.com/), care oferă modele cu context mare (până la 204K tokeni). Vezi [Configurarea cursului](./00-course-setup/README.md) pentru detalii de configurare.
...
Ai sugestii sau ai găsit greșeli de scriere ori erori în cod? [Deschide o problemă](https://github.com/microsoft/ai-agents-for-beginners/issues?WT.mc_id=academic-105485-koreyst) sau [creează o cerere de extragere](https://github.com/microsoft/ai-agents-for-beginners/pulls?WT.mc_id=academic-105485-koreyst)
...
| Înțelegerea Schemelor de Proiectare Agentice AI | [Link](./03-agentic-design-patterns/README.md)     | [Video](https://youtu.be/m9lM8qqoOEA?si=BIzHwzstTPL8o9GF)  | [Link](https://aka.ms/ai-agents-beginners/collection?WT.mc_id=academic-105485-koreyst) |
| Schema de Proiectare pentru Utilizarea Instrumentelor | [Link](./04-tool-use/README.md)                    | [Video](https://youtu.be/vieRiPRx-gI?si=2z6O2Xu2cu_Jz46N)  | [Link](https://aka.ms/ai-agents-beginners/collection?WT.mc_id=academic-105485-koreyst) |
...
| Schema de Proiectare pentru Planificare      | [Link](./07-planning-design/README.md)             | [Video](https://youtu.be/kPfJ2BrBCMY?si=6SC_iv_E5-mzucnC)  | [Link](https://aka.ms/ai-agents-beginners/collection?WT.mc_id=academic-105485-koreyst) |
| Schema de Proiectare Multi-Agent             | [Link](./08-multi-agent/README.md)                 | [Video](https://youtu.be/V6HpE9hZEx0?si=rMgDhEu7wXo2uo6g)  | [Link](https://aka.ms/ai-agents-beginners/collection?WT.mc_id=academic-105485-koreyst) |
...
| Utilizarea Protocoalelor Agente (MCP, A2A și NLWeb) | [Link](./11-agentic-protocols/README.md)           | [Video](https://youtu.be/X-Dh9R3Opn8)                                 | [Link](https://aka.ms/ai-agents-beginners/collection?WT.mc_id=academic-105485-koreyst) |
| Ingineria Contextului pentru Agenții AI            | [Link](./12-context-engineering/README.md)         | [Video](https://youtu.be/F5zqRV7gEag)                                 | [Link](https://aka.ms/ai-agents-beginners/collection?WT.mc_id=academic-105485-koreyst) |
| Gestionarea Memoriei Agente                      | [Link](./13-agent-memory/README.md)     |      [Video](https://youtu.be/QrYbHesIxpw?si=vZkVwKrQ4ieCcIPx)                                                      |                                                                                        |
| Explorarea Cadrului Agent Microsoft                         | [Link](./14-microsoft-agent-framework/README.md)                            |                                                            |                                                                                        |
| Construirea Agenților pentru Utilizarea Calculatorului (CUA)           | [Link](./15-browser-use/README.md)     |                                                            | [Link](https://docs.browser-use.com/examples/templates/playwright-integration)         |
...
Mulțumim lui [Shivam Goyal](https://www.linkedin.com/in/shivam2003/) pentru contribuirea unor exemple importante de cod demonstrând Agentic RAG.

## Contribuții

Acest proiect acceptă contribuții și sugestii. Majoritatea contribuțiilor necesită să fi de acord cu un
Acord de Licență pentru Contribuitor (CLA) care declară că ai dreptul să ne oferi și chiar oferi
...
un CLA și va decora PR-ul corespunzător (de exemplu, verificare de stare, comentariu). Urmează pur și simplu instrucțiunile
oferite de bot. Vei fi nevoit să faci asta o singură dată pentru toate repo-urile care folosesc CLA-ul nostru.

Acest proiect a adoptat [Codul de Conduită Open Source Microsoft](https://opensource.microsoft.com/codeofconduct/).
Pentru mai multe informații, vezi [FAQ pentru Codul de Conduită](https://opensource.microsoft.com/codeofconduct/faq/) sau
...
Orice utilizare a mărcilor sau logo-urilor terțe este supusă politicilor acelora.

## Obține Ajutor

Dacă întâmpini probleme sau ai întrebări despre construirea aplicațiilor AI, alătură-te:
