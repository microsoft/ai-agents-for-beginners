...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-12-21T11:45:58+00:00",
...
![Inteligență Generativă pentru Începători](../../translated_images/repo-thumbnailv2.06f4a48036fde647f6ba4eb19f5651babe59bb30e972748afb349e47725d7601.ro.png)
...
Acest curs conține lecții care acoperă fundamentele construirii Agenților AI. Fiecare lecție tratează un subiect separat, așa că începe de oriunde dorești!

Acest curs oferă suport multilingv. Accesează [limbile disponibile aici](../..). 

Dacă aceasta este prima dată când construiești cu modele de Inteligență Generativă, consultă cursul nostru [Generative AI For Beginners](https://aka.ms/genai-beginners), care include 21 de lecții despre construire cu GenAI.
...
Dacă te blochezi sau ai întrebări despre construirea Agenților AI, alătură-te canalului nostru dedicat pe Discord în [Microsoft Foundry Discord](https://aka.ms/ai-agents/discord).
...
- [Azure AI Foundry](https://aka.ms/ai-agents-beginners/ai-foundry) - Cont Azure necesar
...
Ai sugestii sau ai găsit greșeli de ortografie ori erori în cod? [Deschide un issue](https://github.com/microsoft/ai-agents-for-beginners/issues?WT.mc_id=academic-105485-koreyst) sau [Creează un pull request](https://github.com/microsoft/ai-agents-for-beginners/pulls?WT.mc_id=academic-105485-koreyst)
...
|----------------------------------------------|----------------------------------------------------|------------------------------------------------------------|----------------------------------------------------------------------------------------|
| Introducere în Agenți AI și Cazuri de Utilizare ale Agenților       | [Legătură](./01-intro-to-ai-agents/README.md)          | [Video](https://youtu.be/3zgm60bXmQk?si=z8QygFvYQv-9WtO1)  | [Legătură](https://aka.ms/ai-agents-beginners/collection?WT.mc_id=academic-105485-koreyst) |
| Explorarea cadrelor agentice AI              | [Legătură](./02-explore-agentic-frameworks/README.md)  | [Video](https://youtu.be/ODwF-EZo_O8?si=Vawth4hzVaHv-u0H)  | [Legătură](https://aka.ms/ai-agents-beginners/collection?WT.mc_id=academic-105485-koreyst) |
| Înțelegerea tiparelor de proiectare agentică pentru AI     | [Legătură](./03-agentic-design-patterns/README.md)     | [Video](https://youtu.be/m9lM8qqoOEA?si=BIzHwzstTPL8o9GF)  | [Legătură](https://aka.ms/ai-agents-beginners/collection?WT.mc_id=academic-105485-koreyst) |
| Tiparul de utilizare a uneltelor                      | [Legătură](./04-tool-use/README.md)                    | [Video](https://youtu.be/vieRiPRx-gI?si=2z6O2Xu2cu_Jz46N)  | [Legătură](https://aka.ms/ai-agents-beginners/collection?WT.mc_id=academic-105485-koreyst) |
| RAG agentic                                  | [Legătură](./05-agentic-rag/README.md)                 | [Video](https://youtu.be/WcjAARvdL7I?si=gKPWsQpKiIlDH9A3)  | [Legătură](https://aka.ms/ai-agents-beginners/collection?WT.mc_id=academic-105485-koreyst) |
...
| Tipar de proiectare pentru planificare                      | [Legătură](./07-planning-design/README.md)             | [Video](https://youtu.be/kPfJ2BrBCMY?si=6SC_iv_E5-mzucnC)  | [Legătură](https://aka.ms/ai-agents-beginners/collection?WT.mc_id=academic-105485-koreyst) |
| Tipar de proiectare multi-agent                   | [Legătură](./08-multi-agent/README.md)                 | [Video](https://youtu.be/V6HpE9hZEx0?si=rMgDhEu7wXo2uo6g)  | [Legătură](https://aka.ms/ai-agents-beginners/collection?WT.mc_id=academic-105485-koreyst) |
| Tipar de proiectare pentru metacogniție                 | [Legătură](./09-metacognition/README.md)               | [Video](https://youtu.be/His9R6gw6Ec?si=8gck6vvdSNCt6OcF)  | [Legătură](https://aka.ms/ai-agents-beginners/collection?WT.mc_id=academic-105485-koreyst) |
...
| Construirea agenților de utilizare a calculatorului (CUA)           | Coming Soon                            |                                                            |                                                                                        |
| Implementarea agenților scalabili                    | Coming Soon                            |                                                            |                                                                                        |
| Crearea agenților AI locali                     | Coming Soon                               |                                                            |                                                                                        |
| Securizarea agenților AI                           | Coming Soon                               |                                                            |                                                                                        |
...
Acest proiect primește cu plăcere contribuții și sugestii. Majoritatea contribuțiilor necesită să fiți de acord cu un Acord de Licență pentru Contribuitori (CLA) care declară că aveți dreptul și, efectiv, ne acordați drepturile de a utiliza contribuția dumneavoastră. Pentru detalii, vizitați <https://cla.opensource.microsoft.com>.

Când trimiteți un pull request, un bot CLA va determina automat dacă trebuie să furnizați un CLA și va marca PR-ul în mod corespunzător (de ex., verificare de stare, comentariu). Pur și simplu urmați instrucțiunile furnizate de bot. Va trebui să faceți acest lucru o singură dată pentru toate repo-urile care folosesc CLA-ul nostru.
...
Pentru mai multe informații vedeți [Întrebări frecvente despre Codul de conduită](https://opensource.microsoft.com/codeofconduct/faq/) sau contactați [opencode@microsoft.com](mailto:opencode@microsoft.com) pentru întrebări sau comentarii suplimentare.
...
[Ghidul Microsoft privind mărci și branduri](https://www.microsoft.com/legal/intellectualproperty/trademarks/usage/general).
Utilizarea mărcilor sau logo-urilor Microsoft în versiuni modificate ale acestui proiect nu trebuie să creeze confuzie sau să sugereze sponsorizarea de către Microsoft.
Orice utilizare a mărcilor sau logo-urilor terților este supusă politicilor acelor terțe părți.
...
Dacă aveți feedback privind produsul sau întâmpinați erori în timpul dezvoltării, vizitați:
