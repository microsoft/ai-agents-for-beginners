...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-12-19T10:37:49+00:00",
...
## Курс, който ви учи на всичко необходимо, за да започнете да създавате AI агенти
...
Този курс съдържа уроци, обхващащи основите на създаването на AI агенти. Всеки урок разглежда своята тема, така че започнете откъдето пожелаете!

Курсът поддържа множество езици. Вижте нашите [налични езици тук](../..).

Ако това е първият ви път да работите с генеративни AI модели, разгледайте нашия курс [Генеративен AI за начинаещи](https://aka.ms/genai-beginners), който включва 21 урока за работа с GenAI.
...
- [Github модели](https://aka.ms/ai-agents-beginners/github-models) - Безплатни / Ограничени
...
| Модел за многоагентен дизайн                   | [Връзка](./08-multi-agent/README.md)               | [Видео](https://youtu.be/V6HpE9hZEx0?si=rMgDhEu7wXo2uo6g)  | [Връзка](https://aka.ms/ai-agents-beginners/collection?WT.mc_id=academic-105485-koreyst) |
...
| Създаване на агенти за използване на компютър (CUA)           | Скоро предстои                            |                                                            |                                                                                        |
| Разгръщане на мащабируеми агенти                    | Скоро предстои                            |                                                            |                                                                                        |
| Създаване на локални AI агенти                     | Скоро предстои                               |                                                            |                                                                                        |
| Защита на AI агенти                           | Скоро предстои                               |                                                            |                                                                                        |
...
Лицензионно споразумение за приносители (CLA), в което декларирате, че имате право и наистина предоставяте
