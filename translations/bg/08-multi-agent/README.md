...
-->
[![Многоагентен дизайн](../../../translated_images/bg/lesson-8-thumbnail.278a3e4a59137d62.png)](https://youtu.be/V6HpE9hZEx0?si=A7K44uMCqgvLQVCa)
...
![Групов чат](../../../translated_images/bg/multi-agent-group-chat.ec10f4cde556babd.png)

### Предаване на задачи

Този модел е полезен, когато искате да създадете приложение, където множество агенти могат да предават задачи един на друг.

![Предаване на задачи](../../../translated_images/bg/multi-agent-hand-off.4c5fb00ba6f8750a.png)
...
![Препоръки](../../../translated_images/bg/multi-agent-filtering.d959cb129dc9f608.png)
