...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2026-01-01T10:35:46+00:00",
...
![Generatywna AI dla początkujących](../../translated_images/repo-thumbnailv2.06f4a48036fde647.pl.png)
...
[![PR-y mile widziane](https://img.shields.io/badge/PRs-welcome-brightgreen.svg?style=flat-square)](http://makeapullrequest.com?WT.mc_id=academic-105485-koreyst)
...
**Jeśli chcesz, aby dodane były dodatkowe języki, są one wymienione [tutaj](https://github.com/Azure/co-op-translator/blob/main/getting_started/supported-languages.md)**
...
Ten kurs zawiera lekcje obejmujące podstawy tworzenia agentów AI. Każda lekcja omawia odrębny temat, więc zacznij tam, gdzie chcesz!

Kurs obsługuje wiele języków. Przejdź do naszych [dostępnych języków tutaj](../..). 

Jeśli to Twój pierwszy raz z modelami generatywnej AI, sprawdź nasz kurs [Generative AI For Beginners](https://aka.ms/genai-beginners), który zawiera 21 lekcji dotyczących tworzenia z użyciem GenAI.

Nie zapomnij [dodać gwiazdki (🌟) temu repozytorium](https://docs.github.com/en/get-started/exploring-projects-on-github/saving-repositories-with-stars?WT.mc_id=academic-105485-koreyst) i [zrób fork tego repozytorium](https://github.com/microsoft/ai-agents-for-beginners/fork), aby uruchomić kod.

### Poznaj innych uczestników, uzyskaj odpowiedzi na swoje pytania

Jeśli utkniesz lub masz pytania dotyczące tworzenia agentów AI, dołącz do naszego dedykowanego kanału Discord na [Microsoft Foundry Discord](https://aka.ms/ai-agents/discord).

### Czego potrzebujesz

Każda lekcja w tym kursie zawiera przykłady kodu, które można znaleźć w folderze code_samples. Możesz [zrobić fork tego repozytorium](https://github.com/microsoft/ai-agents-for-beginners/fork), aby stworzyć własną kopię.  
...
Kurs korzysta również z następujących frameworków i usług dla agentów AI od Microsoftu:
...
Aby uzyskać więcej informacji o uruchamianiu kodu dla tego kursu, przejdź do [Konfiguracja kursu](./00-course-setup/README.md).

## 🙏 Chcesz pomóc?

Masz sugestie lub znalazłeś błędy ortograficzne albo w kodzie? [Zgłoś problem](https://github.com/microsoft/ai-agents-for-beginners/issues?WT.mc_id=academic-105485-koreyst) lub [Utwórz pull request](https://github.com/microsoft/ai-agents-for-beginners/pulls?WT.mc_id=academic-105485-koreyst)



## 📂 Każda lekcja zawiera

- Lekcja w formie tekstowej znajdująca się w README oraz krótki film
- Przykłady kodu w Pythonie obsługujące Azure AI Foundry i GitHub Models (Darmowe)
...
|----------------------------------------------|----------------------------------------------------|------------------------------------------------------------|---------------------------------------------------------------------------------------------|
| Wstęp do agentów AI i przypadków użycia       | [Link](./01-intro-to-ai-agents/README.md)          | [Wideo](https://youtu.be/3zgm60bXmQk?si=z8QygFvYQv-9WtO1)  | [Link](https://aka.ms/ai-agents-beginners/collection?WT.mc_id=academic-105485-koreyst)      |
| Eksploracja agentowych frameworków AI              | [Link](./02-explore-agentic-frameworks/README.md)  | [Wideo](https://youtu.be/ODwF-EZo_O8?si=Vawth4hzVaHv-u0H)  | [Link](https://aka.ms/ai-agents-beginners/collection?WT.mc_id=academic-105485-koreyst)      |
| Zrozumienie wzorców projektowych dla agentów AI     | [Link](./03-agentic-design-patterns/README.md)     | [Wideo](https://youtu.be/m9lM8qqoOEA?si=BIzHwzstTPL8o9GF)  | [Link](https://aka.ms/ai-agents-beginners/collection?WT.mc_id=academic-105485-koreyst)      |
| Wzorzec użycia narzędzi                      | [Link](./04-tool-use/README.md)                    | [Wideo](https://youtu.be/vieRiPRx-gI?si=2z6O2Xu2cu_Jz46N)  | [Link](https://aka.ms/ai-agents-beginners/collection?WT.mc_id=academic-105485-koreyst)      |
...
| Wzorzec metapoznawczy                 | [Link](./09-metacognition/README.md)               | [Wideo](https://youtu.be/His9R6gw6Ec?si=8gck6vvdSNCt6OcF)  | [Link](https://aka.ms/ai-agents-beginners/collection?WT.mc_id=academic-105485-koreyst)      |
...
| Używanie protokołów agentowych (MCP, A2A and NLWeb) | [Link](./11-agentic-protocols/README.md)           | [Wideo](https://youtu.be/X-Dh9R3Opn8)                                 | [Link](https://aka.ms/ai-agents-beginners/collection?WT.mc_id=academic-105485-koreyst) |
...
| Poznawanie Microsoft Agent Framework                         | [Link](./14-microsoft-agent-framework/README.md)                            |                                                            |                                                                                        |
| Tworzenie Agentów Użytkowania Komputera (CUA)           | Wkrótce                            |                                                            |                                                                                        |
...
Dziękujemy [Shivam Goyal](https://www.linkedin.com/in/shivam2003/) za udostępnienie istotnych przykładów kodu demonstrujących Agentic RAG. 

## Współtworzenie

Ten projekt zachęca do wkładu i sugestii. Większość wkładów wymaga zgody na
umowę licencyjną współautora (Contributor License Agreement, CLA), w której oświadczasz, że masz prawo i faktycznie udzielasz nam
praw do wykorzystania Twojego wkładu. Szczegóły znajdziesz na <https://cla.opensource.microsoft.com>.

Kiedy zgłosisz pull request, bot CLA automatycznie ustali, czy musisz dostarczyć
...
Ten projekt przyjął [Otwartoźródłowy Kodeks Postępowania Microsoftu](https://opensource.microsoft.com/codeofconduct/).
Po więcej informacji zobacz [FAQ dotyczące Kodeksu Postępowania](https://opensource.microsoft.com/codeofconduct/faq/) lub
...
Ten dokument został przetłumaczony przy użyciu usługi tłumaczenia AI Co-op Translator (https://github.com/Azure/co-op-translator). Dokładamy starań, aby tłumaczenie było jak najbardziej poprawne, jednak prosimy pamiętać, że tłumaczenia automatyczne mogą zawierać błędy lub nieścisłości. Oryginalny dokument w języku źródłowym należy uznać za dokument nadrzędny. W przypadku informacji o krytycznym znaczeniu zalecane jest skorzystanie z profesjonalnego tłumaczenia wykonanego przez człowieka. Nie ponosimy odpowiedzialności za jakiekolwiek nieporozumienia lub błędne interpretacje wynikające z korzystania z tego tłumaczenia.
