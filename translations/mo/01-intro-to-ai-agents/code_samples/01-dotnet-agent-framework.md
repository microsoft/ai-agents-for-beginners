...
此筆記本展示如何使用 Microsoft Agent Framework for .NET 建立一個智能旅行規劃代理。該代理可以自動生成針對世界各地隨機目的地的個性化一日遊行程。
...
### 核心技術
- **Microsoft Agent Framework**：最新的 .NET AI 代理開發實現
