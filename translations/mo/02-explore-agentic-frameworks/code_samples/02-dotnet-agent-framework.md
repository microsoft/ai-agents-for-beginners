...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-11-07T09:32:15+00:00",
...
本筆記本通過在 .NET 中實現基本代理，探索 Microsoft 代理框架的基本概念。您將學習核心代理模式，並了解智能代理如何在 C# 和 .NET 生態系統中運作。
...
此示例展示了 .NET 中 Microsoft 代理框架與其他平台的對比：
...
| **性能** | 編譯代碼性能 | 解釋執行 |
| **企業級** | 為生產級 .NET 應用構建 | 取決於框架 |
| **工具支持** | Visual Studio 整合 | 依賴於 IDE |

## 🚀 開始使用

按照以下步驟構建您的第一個基本代理，並理解基礎代理概念！

## 📦 安裝與設置

此示例可作為可運行的 .NET 單文件應用使用。請參閱附帶的 `02-dotnet-agent-framework.cs` 文件以獲取完整實現。
...
1. **代理架構**：Microsoft 代理框架提供了一種乾淨、類型安全的方式來在 .NET 中構建 AI 代理
2. **工具整合**：使用 `[Description]` 屬性修飾的函數成為代理可用的工具
3. **對話上下文**：線程管理支持多輪對話並具備完整的上下文感知
4. **配置管理**：環境變數和安全憑證處理遵循 .NET 最佳實踐
5. **OpenAI 兼容性**：GitHub 模型整合通過 OpenAI 兼容的 API 無縫運作

## 🔗 其他資源

- [Microsoft 代理框架文檔](https://learn.microsoft.com/en-us/dotnet/ai/agents)
