...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-12-17T11:09:33+00:00",
...
如果你是第一次使用生成式 AI 模型，請參考我們的[生成式 AI 初學者課程](https://aka.ms/genai-beginners)，其中包含 21 節關於使用 GenAI 的課程。
...
欲了解更多關於執行本課程程式碼的資訊，請參閱[課程設定](./00-course-setup/README.md)。
