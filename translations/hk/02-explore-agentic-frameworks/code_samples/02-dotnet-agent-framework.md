...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-11-07T09:32:26+00:00",
...
此筆記本通過在 .NET 中實現基本代理，探索 Microsoft Agent Framework 的基本概念。您將學習核心代理模式，並了解智能代理如何在 C# 和 .NET 生態系統中運作。
...
此示例可作為可運行的 .NET 單文件應用使用。完整實現請參閱附帶的 `02-dotnet-agent-framework.cs` 文件。
...
1. **代理架構**：Microsoft Agent Framework 提供了一種乾淨、類型安全的方式來在 .NET 中構建 AI 代理
2. **工具整合**：使用 `[Description]` 屬性修飾的函數成為代理可用的工具
3. **對話上下文**：線程管理支持多輪對話並具備完整的上下文感知
4. **配置管理**：環境變量和安全憑證處理遵循 .NET 的最佳實踐
5. **OpenAI 兼容性**：GitHub Models 整合通過 OpenAI 兼容的 API 無縫運作

## 🔗 其他資源

- [Microsoft Agent Framework 文檔](https://learn.microsoft.com/en-us/dotnet/ai/agents)
