...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-11-07T09:44:07+00:00",
  "source_file": "03-agentic-design-patterns/code_samples/03-dotnet-agent-framework.md",
  "language_code": "hk"
}
-->
# 🎨 使用 GitHub 模型 (.NET) 的智能代理設計模式

## 📋 學習目標

此筆記本展示了使用 Microsoft Agent Framework 和 GitHub 模型整合在 .NET 中構建智能代理的企業級設計模式。您將學習專業的設計模式和架構方法，使代理具備生產就緒性、可維護性和可擴展性。
