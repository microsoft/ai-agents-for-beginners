...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-10-24T09:15:53+00:00",
...
Jei pirmą kartą dirbate su generatyviniais AI modeliais, peržiūrėkite mūsų kursą [Generatyvinis AI pradedantiesiems](https://aka.ms/genai-beginners), kuriame yra 21 pamoka apie darbą su GenAI.

Nepamirškite [pažymėti žvaigždute (🌟) šį repo](https://docs.github.com/en/get-started/exploring-projects-on-github/saving-repositories-with-stars?WT.mc_id=academic-105485-koreyst) ir [sukurti šio repo šakę](https://github.com/microsoft/ai-agents-for-beginners/fork), kad galėtumėte paleisti kodą.
...
Kiekvienoje šio kurso pamokoje yra kodų pavyzdžių, kuriuos rasite aplanke code_samples. Galite [sukurti šio repo šakę](https://github.com/microsoft/ai-agents-for-beginners/fork), kad sukurtumėte savo kopiją.  
...
- Nuorodas į papildomus mokymosi išteklius
...
CLA ir atitinkamai pažymės PR (pvz., būsenos patikrinimas, komentaras). Tiesiog vykdykite bot'o pateiktas instrukcijas.
...
Šis dokumentas buvo išverstas naudojant AI vertimo paslaugą [Co-op Translator](https://github.com/Azure/co-op-translator). Nors siekiame tikslumo, prašome atkreipti dėmesį, kad automatiniai vertimai gali turėti klaidų ar netikslumų. Originalus dokumentas jo gimtąja kalba turėtų būti laikomas autoritetingu šaltiniu. Dėl svarbios informacijos rekomenduojama profesionali žmogaus vertimo paslauga. Mes neprisiimame atsakomybės už nesusipratimus ar neteisingus interpretavimus, atsiradusius dėl šio vertimo naudojimo.