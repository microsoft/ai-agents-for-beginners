...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-12-17T12:04:34+00:00",
...
![Generatyvioji AI pradedantiesiems](../../translated_images/repo-thumbnailv2.06f4a48036fde647f6ba4eb19f5651babe59bb30e972748afb349e47725d7601.lt.png)
...
Šiame kurse yra pamokos, apimančios AI agentų kūrimo pagrindus. Kiekviena pamoka apima savo temą, tad pradėkite nuo bet kurios jums patinkančios!

Šiam kursui yra daugiakalbė palaikymas. Peržiūrėkite mūsų [galimas kalbas čia](../..).
...
Jei užstrigote arba turite klausimų apie AI agentų kūrimą, prisijunkite prie mūsų specialaus Discord kanalo [Microsoft Foundry Discord](https://aka.ms/ai-agents/discord).
...
Šis kursas taip pat naudoja šias Microsoft AI agentų sistemas ir paslaugas:

- [Microsoft Agent Framework (MAF) – naujiena!](https://aka.ms/ai-agents-beginners/agent-framewrok)
- [Azure AI Agent Service](https://aka.ms/ai-agents-beginners/ai-agent-service)
- [Semantic Kernel](https://aka.ms/ai-agents-beginners/semantic-kernel)
- [AutoGen](https://aka.ms/ai-agents/autogen)

Daugiau informacijos apie kodo paleidimą šiame kurse rasite [Kurso nustatymuose](./00-course-setup/README.md).

## 🙏 Norite padėti?

Ar turite pasiūlymų arba radote rašybos ar kodo klaidų? [Pateikite problemą](https://github.com/microsoft/ai-agents-for-beginners/issues?WT.mc_id=academic-105485-koreyst) arba [sukurkite pull užklausą](https://github.com/microsoft/ai-agents-for-beginners/pulls?WT.mc_id=academic-105485-koreyst)
...
- Python kodo pavyzdžius, palaikančius Azure AI Foundry ir Github modelius (nemokamus)
...
|----------------------------------------------|----------------------------------------------------|------------------------------------------------------------|----------------------------------------------------------------------------------------|
| Įvadas į AI agentus ir agentų naudojimo atvejus | [Nuoroda](./01-intro-to-ai-agents/README.md)       | [Vaizdo įrašas](https://youtu.be/3zgm60bXmQk?si=z8QygFvYQv-9WtO1)  | [Nuoroda](https://aka.ms/ai-agents-beginners/collection?WT.mc_id=academic-105485-koreyst) |
...
| AI agentinių dizaino šablonų supratimas       | [Nuoroda](./03-agentic-design-patterns/README.md)  | [Vaizdo įrašas](https://youtu.be/m9lM8qqoOEA?si=BIzHwzstTPL8o9GF)  | [Nuoroda](https://aka.ms/ai-agents-beginners/collection?WT.mc_id=academic-105485-koreyst) |
...
| Kompiuterinių naudotojų agentų kūrimas           | Greitai bus                            |                                                            |                                                                                        |
...
Jei susiduriate su sunkumais ar turite klausimų apie AI programų kūrimą, prisijunkite prie:
