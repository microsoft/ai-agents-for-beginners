...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-11-11T11:47:41+00:00",
...
Šiame kurse pateikiamos pamokos, apimančios AI agentų kūrimo pagrindus. Kiekviena pamoka apima atskirą temą, todėl pradėkite nuo bet kurios jums patinkančios!

Šis kursas palaiko daugiakalbę paramą. Eikite į mūsų [galimas kalbas čia](../..).  

Jei tai jūsų pirmas kartas dirbant su generatyviniais AI modeliais, peržiūrėkite mūsų [Generatyvinis AI pradedantiesiems](https://aka.ms/genai-beginners) kursą, kuriame yra 21 pamoka apie GenAI kūrimą.

Nepamirškite [pažymėti žvaigždute (🌟) šį repo](https://docs.github.com/en/get-started/exploring-projects-on-github/saving-repositories-with-stars?WT.mc_id=academic-105485-koreyst) ir [sukurti šakę šiam repo](https://github.com/microsoft/ai-agents-for-beginners/fork), kad galėtumėte paleisti kodą.
...
Kiekvienoje šio kurso pamokoje yra kodų pavyzdžių, kuriuos rasite code_samples aplanke. Galite [sukurti šakę šiam repo](https://github.com/microsoft/ai-agents-for-beginners/fork), kad sukurtumėte savo kopiją.  
...
Daugiau informacijos apie kodo paleidimą šiam kursui rasite [Kurso nustatymai](./00-course-setup/README.md).
...
- Python kodų pavyzdžius, palaikančius Azure AI Foundry ir Github modelius (nemokamai)  
...
|----------------------------------------------|--------------------------------------------------|------------------------------------------------------------|---------------------------------------------------------------------------------------|
| Įvadas į AI agentus ir jų panaudojimo atvejus | [Nuoroda](./01-intro-to-ai-agents/README.md)     | [Vaizdo įrašas](https://youtu.be/3zgm60bXmQk?si=z8QygFvYQv-9WtO1) | [Nuoroda](https://aka.ms/ai-agents-beginners/collection?WT.mc_id=academic-105485-koreyst) |
...
| Microsoft agentų struktūros tyrinėjimas                         | [Nuoroda](./14-microsoft-agent-framework/README.md)                            |                                                            |                                                                                        |
