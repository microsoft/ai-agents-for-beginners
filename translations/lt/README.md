...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2026-01-01T11:45:14+00:00",
...
![Generatyvus DI pradedantiesiems](../../translated_images/repo-thumbnailv2.06f4a48036fde647.lt.png)
...
[![GitHub prisidėjusieji](https://img.shields.io/github/contributors/microsoft/ai-agents-for-beginners.svg)](https://GitHub.com/microsoft/ai-agents-for-beginners/graphs/contributors/?WT.mc_id=academic-105485-koreyst)
...
[![GitHub pull-prašymai](https://img.shields.io/github/issues-pr/microsoft/ai-agents-for-beginners.svg)](https://GitHub.com/microsoft/ai-agents-for-beginners/pulls/?WT.mc_id=academic-105485-koreyst)
[![PR prašymai laukiami](https://img.shields.io/badge/PRs-welcome-brightgreen.svg?style=flat-square)](http://makeapullrequest.com?WT.mc_id=academic-105485-koreyst)
...
[![GitHub fork'ai](https://img.shields.io/github/forks/microsoft/ai-agents-for-beginners.svg?style=social&label=Fork)](https://GitHub.com/microsoft/ai-agents-for-beginners/network/?WT.mc_id=academic-105485-koreyst)
...
Šiame kurse yra pamokos, apimančios DI agentų kūrimo pagrindus. Kiekviena pamoka nagrinėja atskirą temą, tad pradėkite nuo bet kurios!

Šiam kursui teikiama daugiakalbė parama. Peržiūrėkite mūsų [prieinamas kalbas čia](../..). 

Jei tai jūsų pirmasis kartas dirbant su generatyviniais DI modeliais, peržiūrėkite mūsų kursą [Generative AI For Beginners](https://aka.ms/genai-beginners), kuriame yra 21 pamoka apie darbą su GenAI.

Neužmirškite [įvertinti (🌟) šią saugyklą](https://docs.github.com/en/get-started/exploring-projects-on-github/saving-repositories-with-stars?WT.mc_id=academic-105485-koreyst) ir [sukurti šios saugyklos kopiją](https://github.com/microsoft/ai-agents-for-beginners/fork) norėdami paleisti kodą.

### Susipažinkite su kitais besimokančiais, gaukite atsakymus į savo klausimus

Jei užstrigsite arba turėsite klausimų apie DI agentų kūrimą, prisijunkite prie mūsų skirto Discord kanalo [Microsoft Foundry Discord](https://aka.ms/ai-agents/discord).

### Ko reikia

Kiekviena šio kurso pamoka turi kodo pavyzdžių, kuriuos rasite code_samples aplanke. Galite [sukurti šios saugyklos kopiją](https://github.com/microsoft/ai-agents-for-beginners/fork) kurdami savo versiją.

Šiuose pratybų kodo pavyzdžiuose naudojami Azure AI Foundry ir GitHub Model Catalogs darbui su kalbos modeliais:
...
Šis kursas taip pat naudoja šiuos Microsoft DI agentų karkasus ir paslaugas:
...
Ar turite pasiūlymų arba radote klaidų rašyboje ar kode? [Atidarykite problemą](https://github.com/microsoft/ai-agents-for-beginners/issues?WT.mc_id=academic-105485-koreyst) arba [sukurkite pull request](https://github.com/microsoft/ai-agents-for-beginners/pulls?WT.mc_id=academic-105485-koreyst)
...
|----------------------------------------------|----------------------------------------------------|------------------------------------------------------------|----------------------------------------------------------------------------------------|
| Įvadas į DI agentus ir jų naudojimo atvejai  | [Nuoroda](./01-intro-to-ai-agents/README.md)       | [Vaizdo įrašas](https://youtu.be/3zgm60bXmQk?si=z8QygFvYQv-9WtO1)  | [Nuoroda](https://aka.ms/ai-agents-beginners/collection?WT.mc_id=academic-105485-koreyst) |
| DI agentinių karkasų tyrinėjimas              | [Nuoroda](./02-explore-agentic-frameworks/README.md) | [Vaizdo įrašas](https://youtu.be/ODwF-EZo_O8?si=Vawth4hzVaHv-u0H)  | [Nuoroda](https://aka.ms/ai-agents-beginners/collection?WT.mc_id=academic-105485-koreyst) |
| DI agentinio dizaino šablonų supratimas      | [Nuoroda](./03-agentic-design-patterns/README.md)  | [Vaizdo įrašas](https://youtu.be/m9lM8qqoOEA?si=BIzHwzstTPL8o9GF)  | [Nuoroda](https://aka.ms/ai-agents-beginners/collection?WT.mc_id=academic-105485-koreyst) |
| Priemonių naudojimo dizaino šablonas         | [Nuoroda](./04-tool-use/README.md)                 | [Vaizdo įrašas](https://youtu.be/vieRiPRx-gI?si=2z6O2Xu2cu_Jz46N)  | [Nuoroda](https://aka.ms/ai-agents-beginners/collection?WT.mc_id=academic-105485-koreyst) |
...
| Daugialypio agento dizaino šablonas          | [Nuoroda](./08-multi-agent/README.md)              | [Vaizdo įrašas](https://youtu.be/V6HpE9hZEx0?si=rMgDhEu7wXo2uo6g)  | [Nuoroda](https://aka.ms/ai-agents-beginners/collection?WT.mc_id=academic-105485-koreyst) |
...
Šis projektas kviečia prisidėti ir teikti pasiūlymus. Dauguma indėlių reikalauja, kad sutiktumėte su Contributor License Agreement (CLA), kuriuo deklaruojate, jog turite teisę ir iš tikrųjų suteikiate mums teisę naudoti jūsų indėlį. Daugiau informacijos: <https://cla.opensource.microsoft.com>.

Siųsdami pull request'ą, CLA robotas automatiškai nustatys, ar turite pateikti CLA, ir pažymės PR tinkamai (pvz., statuso patikrinimas, komentaras). Tiesiog vadovaukitės roboto nurodymais. To reikės padaryti tik vieną kartą visuose saugyklose, kurios naudoja mūsų CLA.

Šis projektas priėmė [Microsoft atvirojo kodo elgesio kodeksą](https://opensource.microsoft.com/codeofconduct/).
Daugiau informacijos rasite [Elgesio kodekso DUK](https://opensource.microsoft.com/codeofconduct/faq/) arba kreipkitės el. paštu [opencode@microsoft.com](mailto:opencode@microsoft.com) dėl papildomų klausimų ar pastabų.

## Prekių ženklai

Šiame projekte gali būti projektų, produktų ar paslaugų prekių ženklų arba logotipų. Leidžiamas Microsoft prekių ženklų ar logotipų naudojimas yra reguliuojamas ir turi atitikti
...
Microsoft prekių ženklų ar logotipų naudojimas modifikuotose šio projekto versijose neturi klaidinti arba kurti neteisingos Microsoft rėmimo prielaidos.
Trečiųjų šalių prekių ženklų ar logotipų naudojimas priklauso tų trečiųjų šalių politikoms.

## Pagalba


Jei užstringate arba turite klausimų apie AI programų kūrimą, prisijunkite:

[![Microsoft Foundry Discord](https://dcbadge.limes.pink/api/server/nTYy5BXMWG)](https://discord.gg/nTYy5BXMWG)

Jei turite atsiliepimų apie produktą arba randate klaidų kuriant, apsilankykite:
