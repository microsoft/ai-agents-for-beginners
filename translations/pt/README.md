...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-10-24T08:58:57+00:00",
...
Se tiver dificuldades ou dúvidas sobre como criar Agentes de IA, junte-se ao nosso canal dedicado no Discord na [Comunidade Azure AI Foundry no Discord](https://aka.ms/ai-agents/discord).
...
Os exemplos de código nestes exercícios utilizam Azure AI Foundry e os Catálogos de Modelos do GitHub para interagir com Modelos de Linguagem:
...
Tem sugestões ou encontrou erros de ortografia ou código? [Relate um problema](https://github.com/microsoft/ai-agents-for-beginners/issues?WT.mc_id=academic-105485-koreyst) ou [Crie um pull request](https://github.com/microsoft/ai-agents-for-beginners/pulls?WT.mc_id=academic-105485-koreyst).
...
| Utilizando Protocolos Agênticos (MCP, A2A e NLWeb) | [Link](./11-agentic-protocols/README.md)           | [Vídeo](https://youtu.be/X-Dh9R3Opn8)                                 | [Link](https://aka.ms/ai-agents-beginners/collection?WT.mc_id=academic-105485-koreyst) |
...
Se ficar preso ou tiver dúvidas sobre como construir apps de IA, junte-se a:
