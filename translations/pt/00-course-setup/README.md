...
![Repositório com Fork](../../../translated_images/pt/forked-repo.33f27ca1901baa6a.png)
...
1. Selecione a opção `Fine-grained tokens` no lado esquerdo da tela, navegando até as **Configurações de Desenvolvedor**.
   ...
   ![Configurações de Desenvolvedor](../../../translated_images/pt/profile_developer_settings.410a859fe749c755.png)

   Em seguida, selecione `Generate new token`.

   ![Gerar Token](../../../translated_images/pt/fga_new_token.1c1a234afe202ab3.png)
...
2. Insira um nome descritivo para o seu token que reflita seu propósito, facilitando a identificação posterior.
    ...
    ![Nome e Expiração do Token](../../../translated_images/pt/token-name-expiry-date.a095fb0de6386864.png)

3. Limite o escopo do token ao seu fork deste repositório.

    ![Limitar escopo ao repositório fork](../../../translated_images/pt/token_repository_limit.924ade5e11d9d8bb.png)
...
4. Restrinja as permissões do token: Em **Permissions**, clique na aba **Account** e no botão "+ Add permissions". Um menu suspenso aparecerá. Procure por **Models** e marque a caixa correspondente.
    ...
    ![Adicionar Permissão de Modelos](../../../translated_images/pt/add_models_permissions.c0c44ed8b40fc143.png)

5. Verifique as permissões necessárias antes de gerar o token. ![Verificar Permissões](../../../translated_images/pt/verify_permissions.06bd9e43987a8b21.png)

6. Antes de gerar o token, certifique-se de que está pronto para armazená-lo em um local seguro, como um cofre de gerenciador de senhas, pois ele não será exibido novamente após a criação. ![Armazenar Token com Segurança](../../../translated_images/pt/store_token_securely.08ee2274c6ad6caf.png)
...
![Campo do Token do GitHub](../../../translated_images/pt/github_token_field.20491ed3224b5f4a.png)
...
![String de Conexão do Projeto](../../../translated_images/pt/project-endpoint.8cf04c9975bbfbf1.png)
