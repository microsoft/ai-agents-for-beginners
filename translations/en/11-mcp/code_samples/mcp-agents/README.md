...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-08-21T12:50:42+00:00",
...
One limitation is that polling resources or subscribing for updates can consume resources at scale. There is an open community proposal (#992) exploring webhooks or triggers for server-initiated client notifications.
...
Elicitation enables agents to request user input mid-execution, essential for confirmations, clarifications, or approvals during long-running tasks.
...
Sampling allows agents to request LLM assistance for complex decisions or content generation during execution, enabling hybrid human-AI workflows.
