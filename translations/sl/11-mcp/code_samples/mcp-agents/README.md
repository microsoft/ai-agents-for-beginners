...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-07-24T08:42:25+00:00",
...
| Funkcija      | Primer uporabe                                                                                                                                                   | Podpora MCP                                                                |
| ------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------- | -------------------------------------------------------------------------- |
| Ponovna vzpostavitev | Odjemalec se prekine med dolgotrajno nalogo. Ob ponovni povezavi se seja nadaljuje z predvajanjem zamujenih dogodkov, brezhibno nadaljuje od tam, kjer je končala. | ✅ Transport StreamableHTTP z ID-ji sej, predvajanjem dogodkov in EventStore |
