...
[![GitHub pull zahtevki](https://img.shields.io/github/issues-pr/microsoft/ai-agents-for-beginners.svg)](https://GitHub.com/microsoft/ai-agents-for-beginners/pulls/?WT.mc_id=academic-105485-koreyst)
...
> ```
>
> Tako boste imeli vse, kar potrebujete za dokončanje tečaja s veliko hitrejšim prenosom.
<!-- CO-OP TRANSLATOR LANGUAGES TABLE END -->

**Če želite podprte dodatne jezikovne prevode, jih najdete [tukaj](https://github.com/Azure/co-op-translator/blob/main/getting_started/supported-languages.md).**
...
Ta tečaj vsebuje lekcije, ki pokrivajo osnove gradnje AI agentov. Vsaka lekcija obravnava svojo temo, zato začnite kjer koli želite!

Obstaja večjezična podpora za ta tečaj. Pojdite na [razpoložljive jezike tukaj](#-multi-language-support).

Če je to vaš prvič, da gradite z modeli generativne umetne inteligence, si oglejte naš tečaj [Generative AI For Beginners](https://aka.ms/genai-beginners), ki vsebuje 21 lekcij o gradnji z GenAI.

Ne pozabite [ozvezdite (🌟) ta repozitorij](https://docs.github.com/en/get-started/exploring-projects-on-github/saving-repositories-with-stars?WT.mc_id=academic-105485-koreyst) in [razvejite ta repozitorij](https://github.com/microsoft/ai-agents-for-beginners/fork), da boste lahko izvajali kodo.

### Spoznajte druge udeležence, dobite odgovore na vaša vprašanja

Če naletite na težave ali imate vprašanja o gradnji AI agentov, se pridružite našemu namenski Discord kanalu v [Microsoft Foundry Discord](https://aka.ms/ai-agents/discord).

### Kaj potrebujete 

Vsaka lekcija tega tečaja vključuje primere kode, ki jih najdete v mapi code_samples. Lahko [razvejite ta repozitorij](https://github.com/microsoft/ai-agents-for-beginners/fork), da ustvarite svojo kopijo.  
...
Nekateri primeri kode podpirajo tudi alternative ponudnike, združljive z OpenAI, kot je [MiniMax](https://platform.minimaxi.com/), ki ponuja modele z velikim kontekstom (do 204K tokenov). Več podrobnosti najdete v [Course Setup](./00-course-setup/README.md).

Za več informacij o zagonu kode za ta tečaj pojdite na [Course Setup](./00-course-setup/README.md).

## 🙏 Želite pomagati?

Imate predloge ali ste našli pravopisne ali kode napake? [Odprite težavo](https://github.com/microsoft/ai-agents-for-beginners/issues?WT.mc_id=academic-105485-koreyst) ali [ustvarite pull zahtevo](https://github.com/microsoft/ai-agents-for-beginners/pulls?WT.mc_id=academic-105485-koreyst)
...
- Primeri kode v Pythonu z uporabo Microsoft Agent Framework in Microsoft Foundry
...
| Raziščite AI agentne ogrodja                 | [Povezava](./02-explore-agentic-frameworks/README.md) | [Video](https://youtu.be/ODwF-EZo_O8?si=Vawth4hzVaHv-u0H) | [Povezava](https://aka.ms/ai-agents-beginners/collection?WT.mc_id=academic-105485-koreyst) |
| Razumevanje oblikovalskih vzorcev AI agentov | [Povezava](./03-agentic-design-patterns/README.md)   | [Video](https://youtu.be/m9lM8qqoOEA?si=BIzHwzstTPL8o9GF) | [Povezava](https://aka.ms/ai-agents-beginners/collection?WT.mc_id=academic-105485-koreyst) |
...
| Vzorec za več agentov                        | [Povezava](./08-multi-agent/README.md)                 | [Video](https://youtu.be/V6HpE9hZEx0?si=rMgDhEu7wXo2uo6g) | [Povezava](https://aka.ms/ai-agents-beginners/collection?WT.mc_id=academic-105485-koreyst) |
...
| Raziščite Microsoft Agent Framework                         | [Povezava](./14-microsoft-agent-framework/README.md)                            |                                                            |                                                                                        |
...
| Namestitev razširljivih agentov                    | [Povezava](./16-deploying-scalable-agents/README.md) |                                                    | [Povezava](https://learn.microsoft.com/azure/ai-foundry/agents/overview)                   |
...
### Serija Copilot
[![Copilot za AI programsko partnerstvo](https://img.shields.io/badge/Copilot%20for%20AI%20Paired%20Programming-FACC15?style=for-the-badge&labelColor=E5E7EB&color=FACC15)](https://aka.ms/GitHubCopilotAI?WT.mc_id=academic-105485-koreyst)
...
Zahvala [Shivamu Goyalu](https://www.linkedin.com/in/shivam2003/) za prispevek pomembnih vzorcev kode, ki prikazujejo agentno RAG. 

## Prispevanje

Ta projekt sprejema prispevke in predloge. Večina prispevkov zahteva, da se strinjate z
pogodbo o licenciranju prispevkov (CLA), s katero izjavljate, da imate pravico in dejansko dovoljujete,
da uporabljamo vaš prispevek. Podrobnosti najdete na <https://cla.opensource.microsoft.com>.

Ko pošljete zahtevo za združitev, bo bot samodejno preveril, ali morate priskrbeti
CLA in ustrezno označil PR (npr. preverjanje stanja, komentar). Preprosto sledite navodilom
, ki jih zagotovi bot. To boste morali storiti le enkrat za vse repozitorije, ki uporabljajo naš CLA.

Ta projekt je sprejel [Microsoftov kodeks ravnanja za odprto kodo](https://opensource.microsoft.com/codeofconduct/).
Več informacij najdete v [FAQ za kodeks ravnanja](https://opensource.microsoft.com/codeofconduct/faq/) ali
kontaktirajte [opencode@microsoft.com](mailto:opencode@microsoft.com) za dodatna vprašanja ali komentarje.

## Zaščitni znaki

Ta projekt lahko vsebuje zaščitne znake ali logotipe projektov, produktov ali storitev. Pooblaščena uporaba Microsoftovih
...
Uporaba Microsoftovih zaščitnih znakov ali logotipov v spremenjenih različicah tega projekta ne sme povzročati zmede ali nakazovati sponzorstva podjetja Microsoft.
Vsaka uporaba zaščitnih znakov ali logotipov tretjih oseb je predmet njihovih pravilnikov.
...
Če imate povratne informacije o produktu ali napake pri gradnji, obiščite:

[![Microsoft Foundry Developerski forum](https://img.shields.io/badge/GitHub-Azure_AI_Foundry_Developer_Forum-blue?style=for-the-badge&logo=github&color=000000&logoColor=fff)](https://aka.ms/foundry/forum)
