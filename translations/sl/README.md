...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-11-11T11:43:15+00:00",
...
Ta tečaj vključuje lekcije, ki pokrivajo osnove gradnje AI agentov. Vsaka lekcija obravnava svojo temo, zato začnite kjerkoli želite!
...
Ne pozabite [dati zvezdice (🌟) temu repozitoriju](https://docs.github.com/en/get-started/exploring-projects-on-github/saving-repositories-with-stars?WT.mc_id=academic-105485-koreyst) in [viliciti ta repozitorij](https://github.com/microsoft/ai-agents-for-beginners/fork), da zaženete kodo.
...
| Upravljanje agentnega pomnilnika                      | [Povezava](./13-agent-memory/README.md)     |      [Video](https://youtu.be/QrYbHesIxpw?si=vZkVwKrQ4ieCcIPx)                                                      |                                                                                        |
| Raziskovanje Microsoftovega okvira za agente                         | [Povezava](./14-microsoft-agent-framework/README.md)                            |                                                            |                                                                                        |
| Gradnja agentov za uporabo računalnika (CUA)           | Kmalu                            |                                                            |                                                                                        |
| Uvajanje skalabilnih agentov                    | Kmalu                            |                                                            |                                                                                        |
| Ustvarjanje lokalnih AI agentov                     | Kmalu                               |                                                            |                                                                                        |
| Varnost AI agentov                           | Kmalu                               |                                                            |                                                                                        |
...
[![Razvoj spletnih aplikacij za začetnike](https://img.shields.io/badge/Web%20Dev%20for%20Beginners-EC4899?style=for-the-badge&labelColor=E5E7EB&color=EC4899)](https://aka.ms/webdev-beginners?WT.mc_id=academic-105485-koreyst)
