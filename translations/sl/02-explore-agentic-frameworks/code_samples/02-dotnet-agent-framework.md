...
Ta primer raziskuje temeljne koncepte Microsoft Agent Frameworka skozi osnovno implementacijo agenta v .NET. Naučili se boste osnovnih vzorcev agentov in razumeli, kako inteligentni agenti delujejo v ozadju z uporabo C# in .NET ekosistema.

### Kaj boste odkrili

- 🏗️ **Agentna arhitektura**: Razumevanje osnovne strukture AI agentov v .NET
...
- **Socialne sposobnosti**: Interakcija skozi naravni jezik z nitmi pogovorov

### Tehnične komponente

- **AIAgent**: Osnovno orkestriranje agenta in upravljanje pogovorov (.NET)
...
- Integracija z Azure OpenAI (Responses API)
- Vzorce odjemalca Azure.AI.OpenAI
...
- Odzivi, zavedajoči se konteksta z nitmi pogovorov
- Razširljiva arhitektura z vzorci odvisnostne injekcije
...
- [Azure naročnina](https://azure.microsoft.com/free/) z Azure OpenAI virom in nameščeno modelom
...
Ogledate si lahko [`02-dotnet-agent-framework.cs`](../../../../02-explore-agentic-frameworks/code_samples/02-dotnet-agent-framework.cs) za celotno kodo.
...
1. **Agentna arhitektura**: Microsoft Agent Framework ponuja čist, tipvarničen pristop k gradnji AI agentov v .NET
2. **Integracija orodij**: Funkcije, označene z atributi `[Description]`, postanejo na voljo kot orodja agentu
3. **Kontekst pogovora**: Upravljanje niti omogoča večkratne pogovore s polno zavedanjem konteksta
...
- [.NET Samostojne aplikacije](https://devblogs.microsoft.com/dotnet/announcing-dotnet-run-app)
