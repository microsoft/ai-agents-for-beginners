...
Este curso tem lições que cobrem os fundamentos para construir Agentes de IA. Cada lição aborda seu próprio tópico, então comece por onde preferir!

Há suporte multilíngue para este curso. Veja nossas [línguas disponíveis aqui](#-suporte-multilíngue). 

Se esta é sua primeira vez construindo com modelos de IA Generativa, confira nosso curso [IA Generativa para Iniciantes](https://aka.ms/genai-beginners), que inclui 21 lições sobre criação com GenAI.

Não se esqueça de [dar estrela (🌟) neste repositório](https://docs.github.com/en/get-started/exploring-projects-on-github/saving-repositories-with-stars?WT.mc_id=academic-105485-koreyst) e [fazer um fork deste repositório](https://github.com/microsoft/ai-agents-for-beginners/fork) para executar o código.

### Conheça Outros Estudantes, Tire Suas Dúvidas

Se ficar preso ou tiver dúvidas sobre como construir Agentes de IA, junte-se ao nosso canal dedicado no Discord em [Microsoft Foundry Discord](https://aka.ms/ai-agents/discord).

### O que Você Precisa 

Cada lição deste curso inclui exemplos de código, que podem ser encontrados na pasta code_samples. Você pode [fazer o fork deste repositório](https://github.com/microsoft/ai-agents-for-beginners/fork) para criar sua própria cópia.  
...
Você tem sugestões ou encontrou erros ortográficos ou de código? [Abra uma issue](https://github.com/microsoft/ai-agents-for-beginners/issues?WT.mc_id=academic-105485-koreyst) ou [Crie um pull request](https://github.com/microsoft/ai-agents-for-beginners/pulls?WT.mc_id=academic-105485-koreyst)
...
| Explorando Frameworks de Agentes              | [Link](./02-explore-agentic-frameworks/README.md)  | [Vídeo](https://youtu.be/ODwF-EZo_O8?si=Vawth4hzVaHv-u0H)  | [Link](https://aka.ms/ai-agents-beginners/collection?WT.mc_id=academic-105485-koreyst) |
| Entendendo Padrões de Design Agêntico         | [Link](./03-agentic-design-patterns/README.md)     | [Vídeo](https://youtu.be/m9lM8qqoOEA?si=BIzHwzstTPL8o9GF)  | [Link](https://aka.ms/ai-agents-beginners/collection?WT.mc_id=academic-105485-koreyst) |
| Padrão de Uso de Ferramentas                  | [Link](./04-tool-use/README.md)                    | [Vídeo](https://youtu.be/vieRiPRx-gI?si=2z6O2Xu2cu_Jz46N)  | [Link](https://aka.ms/ai-agents-beginners/collection?WT.mc_id=academic-105485-koreyst) |
| RAG Agêntico                                   | [Link](./05-agentic-rag/README.md)                 | [Vídeo](https://youtu.be/WcjAARvdL7I?si=gKPWsQpKiIlDH9A3)  | [Link](https://aka.ms/ai-agents-beginners/collection?WT.mc_id=academic-105485-koreyst) |
...
| Explorando o Framework Microsoft Agent      | [Link](./14-microsoft-agent-framework/README.md)                            |                                                            |                                                                                        |
...
Acordo de Licença de Contribuidor (CLA) declarando que você tem o direito, e realmente o faz, de nos conceder
...
entre em contato pelo email [opencode@microsoft.com](mailto:opencode@microsoft.com) para qualquer dúvida ou comentário adicional.
...
[Diretrizes de Marcas e Marcas Registradas da Microsoft](https://www.microsoft.com/legal/intellectualproperty/trademarks/usage/general).
...
Se tiver dúvidas ou precisar de ajuda para construir apps de IA, entre:

[![Microsoft Foundry Discord](https://img.shields.io/badge/Discord-Azure_AI_Foundry_Community_Discord-blue?style=for-the-badge&logo=discord&color=5865f2&logoColor=fff)](https://aka.ms/foundry/discord)

Se quiser enviar feedback de produto ou reportar erros durante a construção, visite:
