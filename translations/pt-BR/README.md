...
>
> Este repositório inclui traduções para mais de 50 idiomas, o que aumenta significativamente o tamanho do download. Para clonar sem as traduções, use o sparse checkout:
>
> **Bash / macOS / Linux:**
> ```bash
...
Este curso tem lições que cobrem os fundamentos da construção de Agentes de IA. Cada lição cobre seu próprio tópico, então comece de onde quiser!

Há suporte multilíngue para este curso. Consulte nossos [idiomas disponíveis aqui](../..). 
...
Não se esqueça de [dar estrela (🌟) neste repositório](https://docs.github.com/en/get-started/exploring-projects-on-github/saving-repositories-with-stars?WT.mc_id=academic-105485-koreyst) e [bifurcar este repositório](https://github.com/microsoft/ai-agents-for-beginners/fork) para executar o código.

### Encontre Outros Estudantes, Tire Suas Dúvidas

Se você ficar travado ou tiver dúvidas sobre construir Agentes de IA, junte-se ao nosso Canal dedicado no Discord no [Microsoft Foundry Discord](https://aka.ms/ai-agents/discord).
...
| Entendendo Padrões de Design Agenticos        | [Link](./03-agentic-design-patterns/README.md)     | [Vídeo](https://youtu.be/m9lM8qqoOEA?si=BIzHwzstTPL8o9GF)   | [Link](https://aka.ms/ai-agents-beginners/collection?WT.mc_id=academic-105485-koreyst)  |
...
| Construindo Agentes de Uso de Computadores (CUA)           | Em Breve                            |                                                            |                                                                                        |
...
### Série Copilot
[![Copilot para Programação Emparelhada IA](https://img.shields.io/badge/Copilot%20for%20AI%20Paired%20Programming-FACC15?style=for-the-badge&labelColor=E5E7EB&color=FACC15)](https://aka.ms/GitHubCopilotAI?WT.mc_id=academic-105485-koreyst)
...
Acordo de Licença de Contribuinte (CLA) declarando que você tem o direito de, e de fato concede a nós,
...
fornecidas pelo bot. Você precisará fazer isso apenas uma vez em todos os repositórios usando nosso CLA.
...
Este projeto pode conter marcas registradas ou logotipos de projetos, produtos ou serviços. O uso autorizado das marcas ou logotipos da Microsoft está sujeito a e deve seguir
