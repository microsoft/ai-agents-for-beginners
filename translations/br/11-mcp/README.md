...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-07-24T07:37:06+00:00",
...
- **Gestão Aprimorada de Contexto**: Permite a passagem eficiente de informações contextuais para os modelos de IA
...
1. Problemas de Conexão com o MCP
   ...
   - Certifique-se de que os tokens do GitHub estão corretos
