...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-08-21T12:18:20+00:00",
...
Este curso tem 11 lições cobrindo os fundamentos de construção de Agentes de IA. Cada lição aborda um tópico específico, então comece por onde preferir!
...
- [Azure AI Foundry](https://aka.ms/ai-agents-beginners/ai-foundry) - Requer conta no Azure
...
Se você estiver com dúvidas ou tiver perguntas sobre como construir Agentes de IA, junte-se à nossa [Comunidade Azure AI Foundry no Discord](https://discord.gg/kzRShWzttr).

Se você tiver feedback sobre produtos ou erros durante a construção, visite nosso [Fórum de Desenvolvedores do Azure AI Foundry](https://aka.ms/azureaifoundry/forum).
