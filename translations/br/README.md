...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2026-01-01T10:31:31+00:00",
...
![IA Generativa Para Iniciantes](../../translated_images/br/repo-thumbnailv2.06f4a48036fde647.png)
...
Este curso tem lições cobrindo os fundamentos de construção de Agentes de IA. Cada lição cobre seu próprio tópico, então comece de onde quiser!

Este curso tem suporte multilíngue. Vá para nossos [idiomas disponíveis aqui](../..). 

Se esta é sua primeira vez construindo com modelos de IA Generativa, confira nosso curso [IA Generativa Para Iniciantes](https://aka.ms/genai-beginners), que inclui 21 lições sobre construção com GenAI.

Não esqueça de [dar estrela (🌟) a este repositório](https://docs.github.com/en/get-started/exploring-projects-on-github/saving-repositories-with-stars?WT.mc_id=academic-105485-koreyst) e [fazer um fork deste repositório](https://github.com/microsoft/ai-agents-for-beginners/fork) para executar o código.

### Conheça Outros Aprendizes, Tire Suas Dúvidas

Se você ficar preso ou tiver alguma dúvida sobre a construção de Agentes de IA, junte-se ao nosso Canal dedicado no Discord em [Microsoft Foundry Discord](https://aka.ms/ai-agents/discord).

### O Que Você Precisa

Cada lição neste curso inclui exemplos de código, que podem ser encontrados na pasta code_samples. Você pode [fazer um fork deste repositório](https://github.com/microsoft/ai-agents-for-beginners/fork) para criar sua própria cópia.  
...
Para mais informações sobre como executar o código deste curso, vá para o [Course Setup](./00-course-setup/README.md).
...
- Exemplos de código em Python com suporte ao Azure AI Foundry e Github Models (Gratuito)
- Links para recursos extras para continuar seu aprendizado


## 🗃️ Lições

| **Lição**                                    | **Texto & Código**                                | **Vídeo**                                                  | **Recursos Adicionais**                                                               |
|----------------------------------------------|----------------------------------------------------|------------------------------------------------------------|----------------------------------------------------------------------------------------|
...
| Entendendo Padrões de Projeto de Agentes de IA | [Link](./03-agentic-design-patterns/README.md)     | [Vídeo](https://youtu.be/m9lM8qqoOEA?si=BIzHwzstTPL8o9GF)  | [Link](https://aka.ms/ai-agents-beginners/collection?WT.mc_id=academic-105485-koreyst) |
...
| Usando Protocolos Agenticos (MCP, A2A and NLWeb) | [Link](./11-agentic-protocols/README.md)           | [Vídeo](https://youtu.be/X-Dh9R3Opn8)                                 | [Link](https://aka.ms/ai-agents-beginners/collection?WT.mc_id=academic-105485-koreyst) |
...
Acordo de Licença de Contribuinte (CLA) declarando que você tem o direito e realmente concede a nós
...
um CLA e marcará o PR apropriadamente (por exemplo, verificação de status, comentário). Simplesmente siga as instruções
...
marcas registradas ou logotipos da Microsoft está sujeito e deve seguir as
[Diretrizes de Marca e Marcas Registradas da Microsoft](https://www.microsoft.com/legal/intellectualproperty/trademarks/usage/general).
...
Se você ficar preso ou tiver alguma dúvida sobre como desenvolver aplicativos de IA, participe de:
