...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-12-21T10:52:52+00:00",
...
Este curso tem lições que cobrem os fundamentos de construção de Agentes de IA. Cada lição aborda seu próprio tópico, então comece onde quiser!

Este curso tem suporte a múltiplos idiomas. Veja nossos [idiomas disponíveis aqui](../..). 
...
### Conheça outros aprendizes, obtenha respostas para suas perguntas

Se você ficar preso ou tiver dúvidas sobre como construir Agentes de IA, entre no nosso canal dedicado no Discord em [Discord do Microsoft Foundry](https://aka.ms/ai-agents/discord).
...
Para mais informações sobre como executar o código deste curso, veja a [Configuração do Curso](./00-course-setup/README.md).
...
- Exemplos de código em Python que suportam Azure AI Foundry e Modelos do GitHub (Gratuito)
...
| Entendendo Padrões de Projeto Agentivos de IA| [Link](./03-agentic-design-patterns/README.md)     | [Vídeo](https://youtu.be/m9lM8qqoOEA?si=BIzHwzstTPL8o9GF)  | [Link](https://aka.ms/ai-agents-beginners/collection?WT.mc_id=academic-105485-koreyst) |
| Padrão de Projeto de Uso de Ferramentas      | [Link](./04-tool-use/README.md)                    | [Vídeo](https://youtu.be/vieRiPRx-gI?si=2z6O2Xu2cu_Jz46N)  | [Link](https://aka.ms/ai-agents-beginners/collection?WT.mc_id=academic-105485-koreyst) |
...
| Padrão de Projeto de Planejamento            | [Link](./07-planning-design/README.md)             | [Vídeo](https://youtu.be/kPfJ2BrBCMY?si=6SC_iv_E5-mzucnC)  | [Link](https://aka.ms/ai-agents-beginners/collection?WT.mc_id=academic-105485-koreyst) |
| Padrão de Projeto Multiagente                | [Link](./08-multi-agent/README.md)                 | [Vídeo](https://youtu.be/V6HpE9hZEx0?si=rMgDhEu7wXo2uo6g)  | [Link](https://aka.ms/ai-agents-beginners/collection?WT.mc_id=academic-105485-koreyst) |
| Padrão de Projeto de Metacognição            | [Link](./09-metacognition/README.md)               | [Vídeo](https://youtu.be/His9R6gw6Ec?si=8gck6vvdSNCt6OcF)  | [Link](https://aka.ms/ai-agents-beginners/collection?WT.mc_id=academic-105485-koreyst) |
...
| Usando Protocolos Agênicos (MCP, A2A and NLWeb) | [Link](./11-agentic-protocols/README.md)           | [Vídeo](https://youtu.be/X-Dh9R3Opn8)                                 | [Link](https://aka.ms/ai-agents-beginners/collection?WT.mc_id=academic-105485-koreyst) |
...
| Gerenciando Memória Agênica                      | [Link](./13-agent-memory/README.md)     |      [Vídeo](https://youtu.be/QrYbHesIxpw?si=vZkVwKrQ4ieCcIPx)                                                      |                                                                                        |
| Explorando o Microsoft Agent Framework                         | [Link](./14-microsoft-agent-framework/README.md)                            |                                                            |                                                                                        |
| Construindo Agentes de Uso de Computador (CUA)           | Coming Soon                            |                                                            |                                                                                        |
| Implantando Agentes Escaláveis                    | Coming Soon                            |                                                            |                                                                                        |
| Criando Agentes de IA Locais                     | Coming Soon                               |                                                            |                                                                                        |
| Protegendo Agentes de IA                           | Coming Soon                               |                                                            |                                                                                        |
...
Agradecimentos a [Shivam Goyal](https://www.linkedin.com/in/shivam2003/) por contribuir com exemplos de código importantes demonstrando Agentic RAG. 

## Contribuindo

Este projeto aceita contribuições e sugestões.  A maioria das contribuições exige que você concorde com um Acordo de Licença de Contribuidor (CLA) declarando que você tem o direito de, e de fato, nos concede os direitos de usar sua contribuição. Para detalhes, visite <https://cla.opensource.microsoft.com>.
...
Para mais informações veja o [Code of Conduct FAQ](https://opensource.microsoft.com/codeofconduct/faq/) ou entre em contato com [opencode@microsoft.com](mailto:opencode@microsoft.com) para quaisquer perguntas ou comentários adicionais.
...
[![Microsoft Foundry no Discord](https://dcbadge.limes.pink/api/server/nTYy5BXMWG)](https://discord.gg/nTYy5BXMWG)
