...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-11-11T10:47:16+00:00",
...
Si es tu primera vez construyendo con modelos de IA Generativa, revisa nuestro curso [IA Generativa para Principiantes](https://aka.ms/genai-beginners), que incluye 21 lecciones sobre cómo trabajar con GenAI.
...
Si te quedas atascado o tienes preguntas sobre cómo construir Agentes de IA, únete a nuestro canal dedicado en Discord en la [Comunidad de Azure AI Foundry en Discord](https://aka.ms/ai-agents/discord).
...
- [Kernel Semántico](https://aka.ms/ai-agents-beginners/semantic-kernel)
...
| Seguridad de los Agentes de IA               | Próximamente                               |                                                            |                                                                                        |
...
Acuerdo de Licencia de Contribuidor (CLA) declarando que tienes el derecho de, y realmente otorgas, los derechos para usar tu contribución. Para más detalles, visita <https://cla.opensource.microsoft.com>.
...
Si te quedas atascado o tienes preguntas sobre la creación de aplicaciones de IA, únete a:
