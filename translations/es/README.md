...
**Si deseas que se agreguen idiomas adicionales, la lista está disponible [aquí](https://github.com/Azure/co-op-translator/blob/main/getting_started/supported-languages.md)**
...
Este curso tiene lecciones que cubren los fundamentos para construir Agentes de IA. Cada lección cubre un tema específico, ¡así que comienza donde quieras!

Hay soporte multilingüe para este curso. Consulta nuestros [idiomas disponibles aquí](../..).

Si es tu primera vez construyendo con modelos de IA Generativa, revisa nuestro curso [IA Generativa para Principiantes](https://aka.ms/genai-beginners), que incluye 21 lecciones para construir con GenAI.

No olvides [apoyar con una estrella (🌟) a este repositorio](https://docs.github.com/en/get-started/exploring-projects-on-github/saving-repositories-with-stars?WT.mc_id=academic-105485-koreyst) y [hacer un fork de este repositorio](https://github.com/microsoft/ai-agents-for-beginners/fork) para ejecutar el código.

### Conoce a Otros Estudiantes, Resuelve Tus Dudas

Si tienes problemas o preguntas sobre cómo construir Agentes de IA, únete a nuestro canal dedicado en Discord en el [Microsoft Foundry Discord](https://aka.ms/ai-agents/discord).
...
Los ejemplos de código en estos ejercicios utilizan Azure AI Foundry y Catálogos de Modelos de GitHub para interactuar con Modelos de Lenguaje:
...
Este curso también usa los siguientes marcos y servicios de Agentes de IA de Microsoft:

- [Marco de Agentes de Microsoft (MAF) - ¡Nuevo!](https://aka.ms/ai-agents-beginners/agent-framewrok)
- [Servicio de Agente de IA de Azure](https://aka.ms/ai-agents-beginners/ai-agent-service)
- [Semantic Kernel](https://aka.ms/ai-agents-beginners/semantic-kernel)
- [AutoGen](https://aka.ms/ai-agents/autogen)


Para más información sobre cómo ejecutar el código para este curso, visita la página de [Configuración del Curso](./00-course-setup/README.md).
...
- Ejemplos de código Python compatibles con Azure AI Foundry y Modelos de Github (Gratis)
...
| Construcción de Agentes de Uso Computacional (CUA)           | Próximamente                            |                                                            |                                                                                        |
...
Gracias a [Shivam Goyal](https://www.linkedin.com/in/shivam2003/) por contribuir con importantes muestras de código que demuestran Agentic RAG.
...
un CLA y decorará la PR adecuadamente (por ejemplo, revisión de estado, comentarios). Simplemente sigue las instrucciones
...
Si tienes comentarios sobre el producto o errores durante el desarrollo, visita:
