...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-08-30T07:12:09+00:00",
...
Las herramientas son interesantes porque permiten que los agentes de IA tengan un rango más amplio de capacidades. En lugar de que el agente tenga un conjunto limitado de acciones que puede realizar, al agregar una herramienta, el agente puede ejecutar una variedad de acciones. En este capítulo, exploraremos el Patrón de Diseño para el Uso de Herramientas, que describe cómo los agentes de IA pueden utilizar herramientas específicas para alcanzar sus objetivos.
...
- ¿Qué consideraciones especiales se deben tener en cuenta al usar el Patrón de Diseño para el Uso de Herramientas para construir agentes de IA confiables?
...
El **Patrón de Diseño para el Uso de Herramientas** se centra en proporcionar a los Modelos de Lenguaje Extenso (LLMs) la capacidad de interactuar con herramientas externas para alcanzar objetivos específicos. Las herramientas son fragmentos de código que un agente puede ejecutar para realizar acciones. Una herramienta puede ser una función simple, como una calculadora, o una llamada a una API de un servicio externo, como la consulta de precios de acciones o el pronóstico del clima. En el contexto de los agentes de IA, las herramientas están diseñadas para ser ejecutadas por los agentes en respuesta a **llamadas a funciones generadas por el modelo**.
...
A continuación, profundicemos en las llamadas a funciones/herramientas.
...
El Agent Service nos permite usar estas herramientas juntas como un `toolset`. También utiliza `threads`, que rastrean el historial de mensajes de una conversación en particular.
