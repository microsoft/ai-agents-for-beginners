...
![Forked Repo](../../../translated_images/th/forked-repo.33f27ca1901baa6a.png)
...
1. เลือกตัวเลือก `Fine-grained tokens` ทางด้านซ้ายของหน้าจอโดยไปที่ **Developer settings**
   ...
   ![Developer settings](../../../translated_images/th/profile_developer_settings.410a859fe749c755.png)

   จากนั้นเลือก `Generate new token`.

   ![Generate Token](../../../translated_images/th/fga_new_token.1c1a234afe202ab3.png)
...
2. ใส่ชื่อที่อธิบายได้สำหรับ token ของคุณที่สะท้อนถึงวัตถุประสงค์ ทำให้ง่ายต่อการระบุในภายหลัง
    ...
    ![Token Name and Expiration](../../../translated_images/th/token-name-expiry-date.a095fb0de6386864.png)

3. จำกัดขอบเขตของ token ให้กับ fork ของ repository นี้

    ![Limit scope to fork repository](../../../translated_images/th/token_repository_limit.924ade5e11d9d8bb.png)
...
4. จำกัดสิทธิ์ของ token: ภายใต้ **Permissions** คลิกแท็บ **Account** และคลิกปุ่ม "+ Add permissions" จะปรากฏ dropdown โปรดค้นหา **Models** และทำเครื่องหมายในช่อง
    ...
    ![Add Models Permission](../../../translated_images/th/add_models_permissions.c0c44ed8b40fc143.png)

5. ตรวจสอบสิทธิ์ที่จำเป็นก่อนสร้าง token ![Verify Permissions](../../../translated_images/th/verify_permissions.06bd9e43987a8b21.png)

6. ก่อนสร้าง token ตรวจสอบให้แน่ใจว่าคุณพร้อมที่จะเก็บ token ไว้ในที่ปลอดภัย เช่น password manager vault เนื่องจากจะไม่แสดงอีกหลังจากที่คุณสร้างมัน ![Store Token Securely](../../../translated_images/th/store_token_securely.08ee2274c6ad6caf.png)
...
![GitHub Token Field](../../../translated_images/th/github_token_field.20491ed3224b5f4a.png)
...
![Project Connection String](../../../translated_images/th/project-endpoint.8cf04c9975bbfbf1.png)
