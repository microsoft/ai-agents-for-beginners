...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-12-19T10:02:28+00:00",
...
이 저장소에 [별(🌟)을 눌러](https://docs.github.com/en/get-started/exploring-projects-on-github/saving-repositories-with-stars?WT.mc_id=academic-105485-koreyst) 주시하고, [포크하여](https://github.com/microsoft/ai-agents-for-beginners/fork) 코드를 실행하는 것을 잊지 마세요.
...
| AI 에이전트 실전 적용                      | [Link](./10-ai-agents-production/README.md)        | [Video](https://youtu.be/l4TP6IyJxmQ?si=31dnhexRo6yLRJDl)  | [Link](https://aka.ms/ai-agents-beginners/collection?WT.mc_id=academic-105485-koreyst) |
