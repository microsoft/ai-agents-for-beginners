...
![포크된 저장소](../../../translated_images/ko/forked-repo.33f27ca1901baa6a.png)
...
1. 화면 왼쪽의 **개발자 설정**으로 이동하여 `세분화된 토큰` 옵션을 선택하세요.
   ...
   ![개발자 설정](../../../translated_images/ko/profile_developer_settings.410a859fe749c755.png)

   그런 다음 `새 토큰 생성`을 선택하세요.

   ![토큰 생성](../../../translated_images/ko/fga_new_token.1c1a234afe202ab3.png)
...
2. 나중에 쉽게 식별할 수 있도록 토큰의 목적을 반영하는 설명적인 이름을 입력하세요.
    ...
    ![토큰 이름 및 만료일](../../../translated_images/ko/token-name-expiry-date.a095fb0de6386864.png)

3. 토큰의 범위를 이 저장소의 포크로 제한하세요.

    ![저장소 범위 제한](../../../translated_images/ko/token_repository_limit.924ade5e11d9d8bb.png)

4. 토큰의 권한을 제한하세요: **권한** 아래에서 **계정** 탭을 클릭하고 "+ 권한 추가" 버튼을 클릭하세요. 드롭다운이 나타납니다. **모델**을 검색하고 해당 상자를 선택하세요.

    ![모델 권한 추가](../../../translated_images/ko/add_models_permissions.c0c44ed8b40fc143.png)

5. 토큰을 생성하기 전에 필요한 권한을 확인하세요. ![권한 확인](../../../translated_images/ko/verify_permissions.06bd9e43987a8b21.png)

6. 토큰을 생성하기 전에 비밀번호 관리자 금고와 같은 안전한 장소에 토큰을 저장할 준비가 되었는지 확인하세요. 생성 후에는 다시 표시되지 않습니다. ![토큰 안전하게 저장](../../../translated_images/ko/store_token_securely.08ee2274c6ad6caf.png)
...
![GitHub 토큰 필드](../../../translated_images/ko/github_token_field.20491ed3224b5f4a.png)
...
![프로젝트 연결 문자열](../../../translated_images/ko/project-endpoint.8cf04c9975bbfbf1.png)
