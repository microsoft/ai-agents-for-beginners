...
- **OpenAI API مطابقت**: حسب ضرورت اینڈ پوائنٹس کے ساتھ OpenAI کلائنٹ لائبریریوں کا فائدہ اٹھاتا ہے
...
**ضروریات:**
- .NET 9.0 یا اس سے زیادہ
- GitHub ماڈلز API تک رسائی کا ٹوکن
- `.env` فائل میں ترتیب دی گئی ماحول کی متغیرات

**ضروری ماحول کی متغیرات:**
```env
...
نیچے دیے گئے سیلز کو ترتیب وار چلائیں تاکہ سفر ایجنٹ کو عمل میں دیکھ سکیں!
...
نیچے دیئے گئے کوڈ کے نمونے کو چلائیں:
