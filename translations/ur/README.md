...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-12-17T11:07:12+00:00",
...
یہ کورس AI ایجنٹس بنانے کے بنیادی اصولوں پر مبنی اسباق پر مشتمل ہے۔ ہر سبق اپنا موضوع رکھتا ہے، لہٰذا جہاں چاہیں وہاں سے شروع کریں!
...
اس ریپوزٹری کو [ستارہ (🌟) دینا نہ بھولیں](https://docs.github.com/en/get-started/exploring-projects-on-github/saving-repositories-with-stars?WT.mc_id=academic-105485-koreyst) اور [اسے فورک کریں](https://github.com/microsoft/ai-agents-for-beginners/fork) تاکہ کوڈ چلایا جا سکے۔
...
اس کورس کے ہر سبق میں کوڈ کی مثالیں شامل ہیں، جو code_samples فولڈر میں مل سکتی ہیں۔ آپ [اس ریپوزٹری کو فورک کر کے](https://github.com/microsoft/ai-agents-for-beginners/fork) اپنی کاپی بنا سکتے ہیں۔
...
یہ پروجیکٹ پروجیکٹس، مصنوعات، یا خدمات کے لیے تجارتی نشان یا لوگوز رکھ سکتا ہے۔ مائیکروسافٹ کے
