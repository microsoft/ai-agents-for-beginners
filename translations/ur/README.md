...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-12-19T09:53:56+00:00",
...
**اگر آپ چاہتے ہیں کہ اضافی ترجمہ شدہ زبانیں شامل کی جائیں تو وہ یہاں [دیکھیے](https://github.com/Azure/co-op-translator/blob/main/getting_started/supported-languages.md) پر درج ہیں**
...
اگر یہ آپ کا پہلا موقع ہے کہ آپ جنریٹو AI ماڈلز کے ساتھ کام کر رہے ہیں، تو ہمارا [ابتدائیوں کے لیے جنریٹو AI](https://aka.ms/genai-beginners) کورس دیکھیں، جس میں GenAI کے ساتھ کام کرنے کے 21 اسباق شامل ہیں۔
...
اگر آپ پھنس جائیں یا AI ایجنٹس بنانے کے بارے میں کوئی سوال ہو، تو ہمارے مخصوص Discord چینل میں شامل ہوں [Microsoft Foundry Discord](https://aka.ms/ai-agents/discord) پر۔

### آپ کو کیا چاہیے

اس کورس کے ہر سبق میں کوڈ کی مثالیں شامل ہیں، جو code_samples فولڈر میں مل سکتی ہیں۔ آپ [اس ریپوزٹری کو فورک](https://github.com/microsoft/ai-agents-for-beginners/fork) کر کے اپنی کاپی بنا سکتے ہیں۔
