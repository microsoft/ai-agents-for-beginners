...
![分叉倉庫](../../../translated_images/forked-repo.33f27ca1901baa6a.tw.png)
...
1. 在螢幕左側選擇 `Fine-grained tokens` 選項，進入 **開發者設定**。
   ...
   ![開發者設定](../../../translated_images/profile_developer_settings.410a859fe749c755.tw.png)

   然後選擇 `Generate new token`。

   ![生成權杖](../../../translated_images/fga_new_token.1c1a234afe202ab3.tw.png)
...
2. 為您的權杖輸入一個描述性名稱，反映其用途，方便日後識別。
    ...
    ![權杖名稱和到期日期](../../../translated_images/token-name-expiry-date.a095fb0de6386864.tw.png)

3. 將權杖的範圍限制在此倉庫的分叉版本。

    ![限制範圍至分叉倉庫](../../../translated_images/token_repository_limit.924ade5e11d9d8bb.tw.png)

4. 限制權杖的權限：在 **Permissions** 下，點擊 **Account** 標籤，然後點擊 "+ Add permissions" 按鈕。下拉選單會出現。請搜尋 **Models** 並勾選它。

    ![新增 Models 權限](../../../translated_images/add_models_permissions.c0c44ed8b40fc143.tw.png)

5. 在生成權杖之前，請確認所需的權限。 ![確認權限](../../../translated_images/verify_permissions.06bd9e43987a8b21.tw.png)

6. 在生成權杖之前，請確保您已準備好將權杖存放在安全的地方，例如密碼管理器保險庫，因為生成後將無法再次查看。 ![安全存放權杖](../../../translated_images/store_token_securely.08ee2274c6ad6caf.tw.png)
...
![GitHub 權杖欄位](../../../translated_images/github_token_field.20491ed3224b5f4a.tw.png)
...
![專案連接字串](../../../translated_images/project-endpoint.8cf04c9975bbfbf1.tw.png)
