...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-12-19T10:00:19+00:00",
...
本課程涵蓋構建 AI 代理的基礎知識。每個課程涵蓋不同主題，您可以從任何一課開始！

本課程支援多語言。請參閱我們的[可用語言列表](../..)。

如果您是第一次使用生成式 AI 模型，請參考我們的[生成式 AI 初學者課程](https://aka.ms/genai-beginners)，其中包含 21 節關於生成式 AI 構建的課程。
...
如果您遇到困難或有任何關於構建 AI 代理的問題，歡迎加入我們在 [Microsoft Foundry Discord](https://aka.ms/ai-agents/discord) 的專屬 Discord 頻道。
...
欲了解本課程程式碼運行的更多資訊，請參閱[課程設置](./00-course-setup/README.md)。
...
提供的指示操作。您只需在所有使用我們 CLA 的倉庫中執行一次。
