...
此筆記本展示如何使用 Microsoft Agent Framework for .NET 建立一個智能旅行規劃代理人。該代理人能自動生成個性化的日程安排，為世界各地的隨機目的地提供行程建議。

**主要功能：**
- 🎲 **隨機目的地選擇**：使用自定義工具選擇度假地點
- 🗺️ **智能行程規劃**：創建詳細的每日行程安排
- 🔄 **即時串流回應**：支持即時和串流回應
- 🛠️ **自定義工具整合**：展示如何擴展代理人的功能
