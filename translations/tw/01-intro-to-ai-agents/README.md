...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-11-11T10:58:49+00:00",
  "source_file": "01-intro-to-ai-agents/README.md",
  "language_code": "tw"
}
-->
[![AI代理入門](../../../translated_images/zh-TW/lesson-1-thumbnail.d21b2c34b32d35bb.webp)](https://youtu.be/3zgm60bXmQk?si=QA4CW2-cmul5kk3D)
...
加入 <a href="https://discord.gg/kzRShWzttr" target="_blank">Azure AI Discord社群</a>，與其他學習者和AI代理開發者交流，並提出您對本課程的任何問題。

開始本課程之前，我們先來了解什麼是AI代理，以及如何在我們構建的應用程序和工作流程中使用它們。
...
- **系統** - 重要的是要將代理視為由多個組件組成的系統，而不是單一組件。AI代理的基本組件包括：
  ...
  - **執行器** - 一旦AI代理接收到環境的當前狀態，代理會根據當前任務決定採取的行動以改變環境。對於旅行預訂代理，可能是為用戶預訂可用的房間。

![什麼是AI代理？](../../../translated_images/zh-TW/what-are-ai-agents.1ec8c4d548af601a.webp)
...
![何時使用AI代理？](../../../translated_images/zh-TW/when-to-use-ai-agents.54becb3bed74a479.webp)
