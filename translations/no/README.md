...
**Hvis du ønsker støtte for flere oversettelsesspråk, er de listet opp [her](https://github.com/Azure/co-op-translator/blob/main/getting_started/supported-languages.md).**
...
Dette kurset har leksjoner som dekker grunnlaget for å bygge AI-agenter. Hver leksjon dekker sitt eget tema, så start der du vil!

Det er støtte for flere språk i dette kurset. Gå til våre [tilgjengelige språk her](#-multi-language-support). 
...
Hvis du blir sittende fast eller har spørsmål om hvordan bygge AI-agenter, bli med i vår dedikerte Discord-kanal i [Microsoft Foundry Discord](https://aka.ms/ai-agents/discord).

### Hva du trenger

Hver leksjon i dette kurset inkluderer kodeeksempler, som du finner i mappen code_samples. Du kan [forke dette depotet](https://github.com/microsoft/ai-agents-for-beginners/fork) for å opprette din egen kopi.  
...
Noen kodeeksempler støtter også alternative OpenAI-kompatible leverandører som [MiniMax](https://platform.minimaxi.com/), som tilbyr modeller med lang kontekst (opptil 204K tokens). Se [Course Setup](./00-course-setup/README.md) for konfigurasjonsdetaljer.

For mer informasjon om hvordan kjøre koden for dette kurset, gå til [Course Setup](./00-course-setup/README.md).

## 🙏 Vil du hjelpe?

Har du forslag eller har funnet stave- eller kodefeil? [Opprett et issue](https://github.com/microsoft/ai-agents-for-beginners/issues?WT.mc_id=academic-105485-koreyst) eller [Lag en pull request](https://github.com/microsoft/ai-agents-for-beginners/pulls?WT.mc_id=academic-105485-koreyst)



## 📂 Hver leksjon inkluderer

- En skriftlig lekse i README og en kort video
...
| Bygge troverdige AI-agenter                    | [Lenke](./06-building-trustworthy-agents/README.md) | [Video](https://youtu.be/iZKkMEGBCUQ?si=jZjpiMnGFOE9L8OK ) | [Lenke](https://aka.ms/ai-agents-beginners/collection?WT.mc_id=academic-105485-koreyst) |
...
| Bygge datamaskinbrukagenter (CUA)           | [Link](./15-browser-use/README.md)     |                                                            | [Link](https://docs.browser-use.com/examples/templates/playwright-integration)         |
...
### Copilot-serie
[![Copilot for AI-samtaleprogrammering](https://img.shields.io/badge/Copilot%20for%20AI%20Paired%20Programming-FACC15?style=for-the-badge&labelColor=E5E7EB&color=FACC15)](https://aka.ms/GitHubCopilotAI?WT.mc_id=academic-105485-koreyst)
...
Når du sender inn en pull request, vil en CLA-bot automatisk avgjøre om du må oppgi
en CLA og dekorere PR-en passende (f.eks. statuskontroll, kommentar). Følg ganske enkelt instruksjonene
fra boten. Du trenger bare å gjøre dette én gang for alle repoer som bruker vår CLA.

Dette prosjektet har vedtatt [Microsofts retningslinjer for åpen kildekode](https://opensource.microsoft.com/codeofconduct/).
...
Bruk av Microsofts varemerker eller logoer i modifiserte versjoner av dette prosjektet må ikke skape forvirring eller antyde støtte fra Microsoft.
...
Hvis du har produkt tilbakemelding eller feil under bygging, besøk:
