...
>
> Dette depotet inneholder 50+ språkoversettelser som øker nedlastingsstørrelsen betydelig. For å klone uten oversettelser, bruk sparse checkout:
>
> **Bash / macOS / Linux:**
> ```bash
...
**Hvis du ønsker at ytterligere oversettelser skal støttes er språkene oppført [her](https://github.com/Azure/co-op-translator/blob/main/getting_started/supported-languages.md)**
...
Dette kurset har leksjoner som dekker det grunnleggende for å bygge AI-agenter. Hver leksjon dekker sitt eget emne, så start hvor du vil!
...
Hver leksjon i dette kurset inkluderer kodeeksempler, som kan finnes i mappen code_samples. Du kan [fork dette repoet](https://github.com/microsoft/ai-agents-for-beginners/fork) for å opprette din egen kopi.  
...
| Utforske agentiske AI-rammeverk              | [Lenke](./02-explore-agentic-frameworks/README.md)  | [Video](https://youtu.be/ODwF-EZo_O8?si=Vawth4hzVaHv-u0H)  | [Lenke](https://aka.ms/ai-agents-beginners/collection?WT.mc_id=academic-105485-koreyst) |
...
| Designmønster for flere agenter                   | [Lenke](./08-multi-agent/README.md)                 | [Video](https://youtu.be/V6HpE9hZEx0?si=rMgDhEu7wXo2uo6g)  | [Lenke](https://aka.ms/ai-agents-beginners/collection?WT.mc_id=academic-105485-koreyst) |
...
| Bruk av agentiske protokoller (MCP, A2A and NLWeb) | [Lenke](./11-agentic-protocols/README.md)           | [Video](https://youtu.be/X-Dh9R3Opn8)                                 | [Lenke](https://aka.ms/ai-agents-beginners/collection?WT.mc_id=academic-105485-koreyst) |
| Kontekstsutforming for AI-agenter            | [Lenke](./12-context-engineering/README.md)         | [Video](https://youtu.be/F5zqRV7gEag)                                 | [Lenke](https://aka.ms/ai-agents-beginners/collection?WT.mc_id=academic-105485-koreyst) |
...
Teamet vårt lager andre kurs! Sjekk dem ut:
...
Når du sender en pull request, vil en CLA-bot automatisk avgjøre om du trenger å sende inn en CLA og merke PR-en passende (f.eks. status-sjekk, kommentar). Følg bare instruksjonene gitt av boten. Du må bare gjøre dette én gang på tvers av alle repos som bruker vår CLA.
...
Bruk av Microsofts varemerker eller logoer i endrede versjoner av dette prosjektet må ikke skape forvirring eller antyde Microsofts sponsing.
...
Hvis du har produkt-tilbakemeldinger eller finner feil under utvikling, besøk:
