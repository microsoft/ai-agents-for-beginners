...
>
> Dette repositoriet inkluderer 50+ språkoversettelser som betydelig øker nedlastingsstørrelsen. For å klone uten oversettelser, bruk sparse checkout:
>
> **Bash / macOS / Linux:**
> ```bash
...
Dette kurset har leksjoner som dekker det grunnleggende i å bygge AI-agenter. Hver leksjon dekker sitt eget tema, så start hvor du vil!

Det er flerspråklig støtte for dette kurset. Gå til våre [tilgjengelige språk her](#-multi-language-support).

Hvis dette er første gang du bygger med generative AI-modeller, sjekk ut vårt kurs [Generative AI For Beginners](https://aka.ms/genai-beginners), som inkluderer 21 leksjoner om å bygge med GenAI.
...
For mer informasjon om kjøring av koden for dette kurset se [Course Setup](./00-course-setup/README.md).

## 🙏 Vil du bidra?

Har du forslag eller funnet stave- eller kodefeil? [Opprett en issue](https://github.com/microsoft/ai-agents-for-beginners/issues?WT.mc_id=academic-105485-koreyst) eller [lag en pull request](https://github.com/microsoft/ai-agents-for-beginners/pulls?WT.mc_id=academic-105485-koreyst)



## 📂 Hver leksjon inkluderer

- En skriftlig leksjon plassert i README og en kort video
...
| Utforske AI Agentic Frameworks                | [Lenke](./02-explore-agentic-frameworks/README.md)  | [Video](https://youtu.be/ODwF-EZo_O8?si=Vawth4hzVaHv-u0H)  | [Lenke](https://aka.ms/ai-agents-beginners/collection?WT.mc_id=academic-105485-koreyst) |
...
| Håndtering av Agentminne                      | [Link](./13-agent-memory/README.md)     |      [Video](https://youtu.be/QrYbHesIxpw?si=vZkVwKrQ4ieCcIPx)                                                      |                                                                                        |
| Utforske Microsoft Agent Framework                         | [Link](./14-microsoft-agent-framework/README.md)                            |                                                            |                                                                                        |
| Lage Computer Use Agents (CUA)           | [Link](./15-browser-use/README.md)     |                                                            | [Link](https://docs.browser-use.com/examples/templates/playwright-integration)         |
...
en CLA og merke PR-en riktig (f.eks. statuskontroll, kommentar). Følg enkelt veiledningen
...
varemerker eller logoer krever at man følger
...
Bruk av Microsoft varemerker eller logoer i endrede versjoner av dette prosjektet må ikke føre til forvirring eller antyde Microsoft-sponsing.
Enhver bruk av tredjeparts varemerker eller logoer er underlagt disse tredjepartenes policyer.
...
Hvis du har produktfeedback eller feil under bygging, gå til:
