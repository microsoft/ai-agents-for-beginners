...
### Aspire — Χρησιμοποιήστε Aspire MCP Server (προτιμώμενο) ή Context7
...
These ship in Aspire CLI 13.2 ([PR #14028](https://github.com/microsoft/aspire/pull/14028)). To update: `aspire update --self --channel daily`. Αναφορά: https://davidpine.dev/posts/aspire-docs-mcp-tools/
