...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-12-19T08:46:50+00:00",
...
Εάν είναι η πρώτη φορά που δημιουργείτε με μοντέλα Γενετικής Τεχνητής Νοημοσύνης, δείτε το μάθημά μας [Γενετική Τεχνητή Νοημοσύνη για Αρχάριους](https://aka.ms/genai-beginners), το οποίο περιλαμβάνει 21 μαθήματα για τη δημιουργία με GenAI.
...
Το παράδειγμα κώδικα σε αυτές τις ασκήσεις χρησιμοποιεί το Azure AI Foundry και τα Καταλόγους Μοντέλων GitHub για αλληλεπίδραση με Μοντέλα Γλώσσας:
...
| Πρότυπο Σχεδίασης Πολλαπλών Πρακτόρων          | [Σύνδεσμος](./08-multi-agent/README.md)             | [Βίντεο](https://youtu.be/V6HpE9hZEx0?si=rMgDhEu7wXo2uo6g)  | [Σύνδεσμος](https://aka.ms/ai-agents-beginners/collection?WT.mc_id=academic-105485-koreyst) |
...
| Μηχανική Συμφραζομένων για Πράκτορες Τεχνητής Νοημοσύνης            | [Link](./12-context-engineering/README.md)         | [Video](https://youtu.be/F5zqRV7gEag)                                 | [Link](https://aka.ms/ai-agents-beginners/collection?WT.mc_id=academic-105485-koreyst) |
| Διαχείριση Μνήμης Πρακτόρων                      | [Link](./13-agent-memory/README.md)     |      [Video](https://youtu.be/QrYbHesIxpw?si=vZkVwKrQ4ieCcIPx)                                                      |                                                                                        |
| Εξερεύνηση του Πλαισίου Εργασίας Microsoft Agent                         | [Link](./14-microsoft-agent-framework/README.md)                            |                                                            |                                                                                        |
...
### Σειρά Copilot
[![Copilot για Προγραμματισμό με Τεχνητή Νοημοσύνη σε Ζεύγη](https://img.shields.io/badge/Copilot%20for%20AI%20Paired%20Programming-FACC15?style=for-the-badge&labelColor=E5E7EB&color=FACC15)](https://aka.ms/GitHubCopilotAI?WT.mc_id=academic-105485-koreyst)
