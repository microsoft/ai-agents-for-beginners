...
| Πράκτορες AI στην Παραγωγή                  | [Σύνδεσμος](./10-ai-agents-production/README.md)        | [Βίντεο](https://youtu.be/l4TP6IyJxmQ?si=31dnhexRo6yLRJDl)  | [Σύνδεσμος](https://aka.ms/ai-agents-beginners/collection?WT.mc_id=academic-105485-koreyst) |
...
| Δημιουργία Πρακτόρων Χρήσης Υπολογιστή (CUA) | Προσεχώς                            |                                                            |                                                                                        |
| Ανάπτυξη Κλιμακούμενων Πρακτόρων            | Προσεχώς                            |                                                            |                                                                                        |
| Δημιουργία Τοπικών Πρακτόρων AI             | Προσεχώς                               |                                                            |                                                                                        |
| Ασφάλεια Πρακτόρων AI                       | Προσεχώς                               |                                                            |                                                                                        |
